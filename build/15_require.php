...
$x35 = $x33->call;
$global->trace[++$global->trace_sp] = array('<image>/15_require.js', 11, 24);
$x36 = $x35($global, $x29, $x33, array(0.0), false);
unset($global->trace[$global->trace_sp--], $global->scope[$global->scope_sp--]);
...
unset($global->trace[$global->trace_sp--], $global->scope[$global->scope_sp--]);
$x158 = !(((gettype($x168) === gettype((-1.0 * JS::toNumber(1.0, $global))) && $x168 === (-1.0 * JS::toNumber(1.0, $global))))|| (((is_float($x168) || is_int($x168)) && (is_float((-1.0 * JS::toNumber(1.0, $global))) || is_int((-1.0 * JS::toNumber(1.0, $global))))) && $x168 == (-1.0 * JS::toNumber(1.0, $global))));
$x157 = $x158;
...
unset($global->trace[$global->trace_sp--], $global->scope[$global->scope_sp--]);
$x172 = !(((gettype($x182) === gettype((-1.0 * JS::toNumber(1.0, $global))) && $x182 === (-1.0 * JS::toNumber(1.0, $global))))|| (((is_float($x182) || is_int($x182)) && (is_float((-1.0 * JS::toNumber(1.0, $global))) || is_int((-1.0 * JS::toNumber(1.0, $global))))) && $x182 == (-1.0 * JS::toNumber(1.0, $global))));
$x157 = $x172; }
if (JS::toBoolean($x157, $global)) {
unset($_Error, $WError, $SError, $UError);
...
if (!is_object($global)) {$global = (object) array('properties' => array(),'attributes' => array(),'getters' => array(),'setters' => array(),'prototype' => NULL,'up' => NULL,'trace' => array(), 'trace_sp' => 0, 'scope_sp' => 0);$set_scope = TRUE;$global->trace = array(array('<image>/15_require.js', NULL, NULL)); $global->trace_sp = 0;}
