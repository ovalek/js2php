...
$x173 = (((gettype($x174) === gettype(0.0) && $x174 === 0.0))|| (((is_float($x174) || is_int($x174)) && (is_float(0.0) || is_int(0.0))) && $x174 == 0.0));
$x172 = $x173;
if (!JS::toBoolean($x172, $global)) {
$x176 = (((gettype($_totalLength) === gettype(0.0) && $_totalLength === 0.0))|| (((is_float($_totalLength) || is_int($_totalLength)) && (is_float(0.0) || is_int(0.0))) && $_totalLength == 0.0));
$x172 = $x176; }
if (JS::toBoolean($x172, $global)) {
...
$x193 = $x189->call;
$global->trace[++$global->trace_sp] = array('<image>/20_buffer.js', 46, 10);
$x194 = $x193($global, $x177, $x189, array(0.0), true);
unset($global->trace[$global->trace_sp--], $global->scope[$global->scope_sp--]);
$x178 = $x194;
...
$x198 = (((gettype($x199) === gettype(1.0) && $x199 === 1.0))|| (((is_float($x199) || is_int($x199)) && (is_float(1.0) || is_int(1.0))) && $x199 == 1.0));
if (JS::toBoolean($x198, $global)) {
unset($x201, $W201, $S201, $U201);
$x202 = _f915aaba5b76f6e13a986dca9da58f68_3($global, $scope, $_list, JS::toString(0.0, $global), 49, 14, '<image>/20_buffer.js');
...
$x485 = $x483->call;
$global->trace[++$global->trace_sp] = array('<image>/20_buffer.js', 113, 25);
$x486 = $x485($global, $x479, $x483, array(0.0, 1.0), false);
unset($global->trace[$global->trace_sp--], $global->scope[$global->scope_sp--]);
if ($Uvalue) {$global->properties['value'] = $_value; $_value =& $global->properties['value']; }
$_value = $x486;
$x490 = $_offset;
