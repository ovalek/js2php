...
$x112 = $x110->call;
$global->trace[++$global->trace_sp] = array('<image>/18_path.js', 45, 19);
$x113 = $x112($global, $x106, $x110, array(0.0), false);
unset($global->trace[$global->trace_sp--], $global->scope[$global->scope_sp--]);
...
$x228 = _dc8b81f3d85c475b76d3fad15e533f32_4($global, $scope, $_from, JS::toString(0.0, $global), 60, 15, '<image>/18_path.js');
$x227 =& $x228[0]; list(,$W227,$S227,$U227) = $x228;
unset($x229, $W229, $S229, $U229);
$x230 = _dc8b81f3d85c475b76d3fad15e533f32_4($global, $scope, $_to, JS::toString(0.0, $global), 60, 25, '<image>/18_path.js');
...
$x264 = JS::toPrimitive(1.0, $global);
...
$x305 = $x301->call;
$global->trace[++$global->trace_sp] = array('<image>/18_path.js', 68, 22);
$x306 = $x305($global, $x297, $x301, array((JS::toNumber($x303, $global) - JS::toNumber(1.0, $global))), false);
unset($global->trace[$global->trace_sp--], $global->scope[$global->scope_sp--]);
...
$x318 = $x314->call;
$global->trace[++$global->trace_sp] = array('<image>/18_path.js', 69, 29);
$x319 = $x318($global, $x310, $x314, array(0.0, (JS::toNumber($x316, $global) - JS::toNumber(1.0, $global))), false);
unset($global->trace[$global->trace_sp--], $global->scope[$global->scope_sp--]);
return $x319;;
};
return $_newPath;
...
unset($global->trace[$global->trace_sp--], $global->scope[$global->scope_sp--]);
$x343 = !(((gettype($x351) === gettype((-1.0 * JS::toNumber(1.0, $global))) && $x351 === (-1.0 * JS::toNumber(1.0, $global))))|| (((is_float($x351) || is_int($x351)) && (is_float((-1.0 * JS::toNumber(1.0, $global))) || is_int((-1.0 * JS::toNumber(1.0, $global))))) && $x351 == (-1.0 * JS::toNumber(1.0, $global))));
...
$x362 = JS::toPrimitive(1.0, $global);
...
unset($global->trace[$global->trace_sp--], $global->scope[$global->scope_sp--]);
$x384 = (((gettype($x392) === gettype(0.0) && $x392 === 0.0))|| (((is_float($x392) || is_int($x392)) && (is_float(0.0) || is_int(0.0))) && $x392 == 0.0));
$x380 = $x384; }
$x379 = $x380;
...
unset($global->trace[$global->trace_sp--], $global->scope[$global->scope_sp--]);
$x396 = (((gettype($x404) === gettype((-1.0 * JS::toNumber(1.0, $global))) && $x404 === (-1.0 * JS::toNumber(1.0, $global))))|| (((is_float($x404) || is_int($x404)) && (is_float((-1.0 * JS::toNumber(1.0, $global))) || is_int((-1.0 * JS::toNumber(1.0, $global))))) && $x404 == (-1.0 * JS::toNumber(1.0, $global))));
$x379 = $x396; }
if (JS::toBoolean($x379, $global)) {
...
if (!is_object($global)) {$global = (object) array('properties' => array(),'attributes' => array(),'getters' => array(),'setters' => array(),'prototype' => NULL,'up' => NULL,'trace' => array(), 'trace_sp' => 0, 'scope_sp' => 0);$set_scope = TRUE;$global->trace = array(array('<image>/18_path.js', NULL, NULL)); $global->trace_sp = 0;}
