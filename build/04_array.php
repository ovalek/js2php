function _61c60c86aef535e2824e55eb30517a85_2($global, $scope, $base, $id, $line, $column, $file) {
...
unset($_TypeError, $WTypeError, $STypeError, $UTypeError);
$x7 = _61c60c86aef535e2824e55eb30517a85_2($global, $scope, $scope, JS::toString('TypeError', $global), 7, 15, '<image>/04_array.js');
...
$x14 = _61c60c86aef535e2824e55eb30517a85_3($global, $scope, $_array, JS::toString($x4, $global), 7, 15, '<image>/04_array.js');
...
$x21 = _61c60c86aef535e2824e55eb30517a85_2($global, $scope, $scope, JS::toString('arguments', $global), 11, 6, '<image>/04_array.js');
$_arguments =& $x21[0]; list(,$Warguments,$Sarguments,$Uarguments) = $x21;
if ($Uarguments) {
unset($_ReferenceError, $WReferenceError, $SReferenceError, $UReferenceError);
$x22 = _61c60c86aef535e2824e55eb30517a85_2($global, $scope, $scope, JS::toString('ReferenceError', $global), 11, 6, '<image>/04_array.js');
...
$x31 = _61c60c86aef535e2824e55eb30517a85_4($global, $scope, $_arguments, JS::toString('length', $global), 11, 15, '<image>/04_array.js');
$x25 =& $x31[0]; list(,$W25,$S25,$U25) = $x31;
$x20 = (((gettype($x25) === gettype(1.0) && $x25 === 1.0))|| (((is_float($x25) || is_int($x25)) && (is_float(1.0) || is_int(1.0))) && $x25 == 1.0));
$x19 = $x20;
if (JS::toBoolean($x19, $global)) {
unset($x33, $W33, $S33, $U33);
$x34 = _61c60c86aef535e2824e55eb30517a85_4($global, $scope, $_arguments, JS::toString(0.0, $global), 11, 48, '<image>/04_array.js');
...
$x37 = _61c60c86aef535e2824e55eb30517a85_4($global, $scope, $_arguments, JS::toString(0.0, $global), 12, 22, '<image>/04_array.js');
...
$x40 = _61c60c86aef535e2824e55eb30517a85_2($global, $scope, $scope, JS::toString('RangeError', $global), 15, 14, '<image>/04_array.js');
$_RangeError =& $x40[0]; list(,$WRangeError,$SRangeError,$URangeError) = $x40;
if ($URangeError) {
unset($_ReferenceError, $WReferenceError, $SReferenceError, $UReferenceError);
$x41 = _61c60c86aef535e2824e55eb30517a85_2($global, $scope, $scope, JS::toString('ReferenceError', $global), 15, 14, '<image>/04_array.js');
...
$x45 = _61c60c86aef535e2824e55eb30517a85_4($global, $scope, $_RangeError, JS::toString('prototype', $global), 15, 10, '<image>/04_array.js');
$x44 =& $x45[0]; list(,$W44,$S44,$U44) = $x45;
$x39 = $x44;
$x38->prototype = $x39;
if (!(is_object($_RangeError) && isset($_RangeError->call))) { 
unset($_TypeError, $WTypeError, $STypeError, $UTypeError);
$x48 = _61c60c86aef535e2824e55eb30517a85_2($global, $scope, $scope, JS::toString('TypeError', $global), 15, 10, '<image>/04_array.js');
...
if ($_array === JS::$undefined || $_array === NULL) {
unset($_TypeError, $WTypeError, $STypeError, $UTypeError);
$x52 = _61c60c86aef535e2824e55eb30517a85_2($global, $scope, $scope, JS::toString('TypeError', $global), 18, 16, '<image>/04_array.js');
...
$x56 = _61c60c86aef535e2824e55eb30517a85_3($global, $scope, $_array, JS::toString($x51, $global), 18, 16, '<image>/04_array.js');
...
$x63 = _61c60c86aef535e2824e55eb30517a85_4($global, $scope, $_arguments, JS::toString('length', $global), 23, 31, '<image>/04_array.js');
...
$x71 = _61c60c86aef535e2824e55eb30517a85_4($global, $scope, $_arguments, JS::toString($_i, $global), 24, 23, '<image>/04_array.js');
$x70 =& $x71[0]; list(,$W70,$S70,$U70) = $x71;
$x72 = JS::toString($_i, $global);
if ($_array === JS::$undefined || $_array === NULL) {
unset($_TypeError, $WTypeError, $STypeError, $UTypeError);
$x73 = _61c60c86aef535e2824e55eb30517a85_2($global, $scope, $scope, JS::toString('TypeError', $global), 24, 12, '<image>/04_array.js');
...
$x77 = _61c60c86aef535e2824e55eb30517a85_3($global, $scope, $_array, JS::toString($x72, $global), 24, 12, '<image>/04_array.js');
...
unset($_TypeError, $WTypeError, $STypeError, $UTypeError);
$x143 = _61c60c86aef535e2824e55eb30517a85_2($global, $scope, $scope, JS::toString('TypeError', $global), 47, 18, '<image>/04_array.js');
...
$x147 = _61c60c86aef535e2824e55eb30517a85_4($global, $scope, $x142, JS::toString('join', $global), 47, 18, '<image>/04_array.js');
$x146 =& $x147[0]; list(,$W146,$S146,$U146) = $x147;
if (!(is_object($x146) && isset($x146->call))) { 
unset($_TypeError, $WTypeError, $STypeError, $UTypeError);
$x150 = _61c60c86aef535e2824e55eb30517a85_2($global, $scope, $scope, JS::toString('TypeError', $global), 47, 18, '<image>/04_array.js');
...
echo 'function _61c60c86aef535e2824e55eb30517a85_6($global,$leThis,$fn,$args,$constructor=FALSE){if(isset($fn->boundThis)&&!$constructor){$leThis=$fn->boundThis;}if(isset($fn->boundArgs)){$args=array_merge($fn->boundArgs,$args);}$scope=clone JS::$emptyScope;$scope->up=$fn->scope;$scope->properties[\'arguments\']=clone JS::$argumentsTemplate;$x141=&$scope->properties[\'arguments\'];$x141->properties[\'length\']=count($args);foreach($args as$i=>$arg){$x141->properties[$i]=$args[$i];$x141->attributes[$i]=JS::WRITABLE|JS::ENUMERABLE|JS::CONFIGURABLE;}$global->scope[++$global->scope_sp]=$scope;if($leThis===JS::$undefined||$leThis===NULL){unset($_TypeError,$WTypeError,$STypeError,$UTypeError);$x143=_61c60c86aef535e2824e55eb30517a85_2($global,$scope,$scope,JS::toString(\'TypeError\',$global),47,18,\'<image>/04_array.js\');$_TypeError=&$x143[0];list(,$WTypeError,$STypeError,$UTypeError)=$x143;$x144=$_TypeError->call;$global->trace[++$global->trace_sp]=array(\'<image>/04_array.js\',47,18);$x145=$x144($global,$global,$_TypeError,array(\'Cannot call function on undefined/null.\'),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);if(isset($x145->class)&&$x145->class===\'Error\'&&!isset($x145->properties[\'file\'])&&!isset($x145->properties[\'line\'])&&!isset($x145->properties[\'column\'])){$x145->properties[\'file\']=\'<image>/04_array.js\';$x145->properties[\'line\']=47;$x145->properties[\'column\']=18;$x145->attributes[\'file\']=$x145->attributes[\'line\']=$x145->attributes[\'column\']=0;}throw new JSException($x145,47,18,\'<image>/04_array.js\');}$x142=JS::toObject($leThis,$global);unset($x146,$W146,$S146,$U146);$x147=_61c60c86aef535e2824e55eb30517a85_4($global,$scope,$x142,JS::toString(\'join\',$global),47,18,\'<image>/04_array.js\');$x146=&$x147[0];list(,$W146,$S146,$U146)=$x147;if(!(is_object($x146)&&isset($x146->call))){unset($_TypeError,$WTypeError,$STypeError,$UTypeError);$x150=_61c60c86aef535e2824e55eb30517a85_2($global,$scope,$scope,JS::toString(\'TypeError\',$global),47,18,\'<image>/04_array.js\');$_TypeError=&$x150[0];list(,$WTypeError,$STypeError,$UTypeError)=$x150;$x151=$_TypeError->call;$global->trace[++$global->trace_sp]=array(\'<image>/04_array.js\',47,18);$x152=$x151($global,$global,$_TypeError,array(\'Trying to call what is not a function.\'),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);if(isset($x152->class)&&$x152->class===\'Error\'&&!isset($x152->properties[\'file\'])&&!isset($x152->properties[\'line\'])&&!isset($x152->properties[\'column\'])){$x152->properties[\'file\']=\'<image>/04_array.js\';$x152->properties[\'line\']=47;$x152->properties[\'column\']=18;$x152->attributes[\'file\']=$x152->attributes[\'line\']=$x152->attributes[\'column\']=0;}throw new JSException($x152,47,18,\'<image>/04_array.js\');}$x148=$x146->call;$global->trace[++$global->trace_sp]=array(\'<image>/04_array.js\',47,18);$x149=$x148($global,$x142,$x146,array(),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);return$x149;return JS::$undefined;}', "\n";
function _61c60c86aef535e2824e55eb30517a85_7($global, $leThis, $fn, $args, $constructor = FALSE) {
...
$x187 = _61c60c86aef535e2824e55eb30517a85_4($global, $scope, $leThis, JS::toString('length', $global), 55, 26, '<image>/04_array.js');
...
unset($_TypeError, $WTypeError, $STypeError, $UTypeError);
$x195 = _61c60c86aef535e2824e55eb30517a85_2($global, $scope, $scope, JS::toString('TypeError', $global), 56, 16, '<image>/04_array.js');
...
$x199 = _61c60c86aef535e2824e55eb30517a85_4($global, $scope, $x194, JS::toString('push', $global), 56, 16, '<image>/04_array.js');
$x198 =& $x199[0]; list(,$W198,$S198,$U198) = $x199;
unset($x200, $W200, $S200, $U200);
$x201 = _61c60c86aef535e2824e55eb30517a85_4($global, $scope, $leThis, JS::toString($_i, $global), 56, 21, '<image>/04_array.js');
$x200 =& $x201[0]; list(,$W200,$S200,$U200) = $x201;
if (!(is_object($x198) && isset($x198->call))) { 
unset($_TypeError, $WTypeError, $STypeError, $UTypeError);
$x204 = _61c60c86aef535e2824e55eb30517a85_2($global, $scope, $scope, JS::toString('TypeError', $global), 56, 16, '<image>/04_array.js');
...
$_i = 0.0;
unset($_arguments, $Warguments, $Sarguments, $Uarguments);
$x208 = _61c60c86aef535e2824e55eb30517a85_2($global, $scope, $scope, JS::toString('arguments', $global), 59, 22, '<image>/04_array.js');
$_arguments =& $x208[0]; list(,$Warguments,$Sarguments,$Uarguments) = $x208;
if ($Uarguments) {
unset($_ReferenceError, $WReferenceError, $SReferenceError, $UReferenceError);
$x209 = _61c60c86aef535e2824e55eb30517a85_2($global, $scope, $scope, JS::toString('ReferenceError', $global), 59, 22, '<image>/04_array.js');
...
$x213 = _61c60c86aef535e2824e55eb30517a85_4($global, $scope, $_arguments, JS::toString('length', $global), 59, 31, '<image>/04_array.js');
...
$x220 = _61c60c86aef535e2824e55eb30517a85_2($global, $scope, $scope, JS::toString('Array', $global), 60, 7, '<image>/04_array.js');
$_Array =& $x220[0]; list(,$WArray,$SArray,$UArray) = $x220;
if ($UArray) {
unset($_ReferenceError, $WReferenceError, $SReferenceError, $UReferenceError);
$x221 = _61c60c86aef535e2824e55eb30517a85_2($global, $scope, $scope, JS::toString('ReferenceError', $global), 60, 7, '<image>/04_array.js');
...
if ($_Array === JS::$undefined || $_Array === NULL) {
unset($_TypeError, $WTypeError, $STypeError, $UTypeError);
$x225 = _61c60c86aef535e2824e55eb30517a85_2($global, $scope, $scope, JS::toString('TypeError', $global), 60, 20, '<image>/04_array.js');
...
$x229 = _61c60c86aef535e2824e55eb30517a85_4($global, $scope, $x224, JS::toString('isArray', $global), 60, 20, '<image>/04_array.js');
$x228 =& $x229[0]; list(,$W228,$S228,$U228) = $x229;
unset($x230, $W230, $S230, $U230);
$x231 = _61c60c86aef535e2824e55eb30517a85_4($global, $scope, $_arguments, JS::toString($_i, $global), 60, 30, '<image>/04_array.js');
$x230 =& $x231[0]; list(,$W230,$S230,$U230) = $x231;
if (!(is_object($x228) && isset($x228->call))) { 
unset($_TypeError, $WTypeError, $STypeError, $UTypeError);
$x234 = _61c60c86aef535e2824e55eb30517a85_2($global, $scope, $scope, JS::toString('TypeError', $global), 60, 20, '<image>/04_array.js');
...
$x239 = _61c60c86aef535e2824e55eb30517a85_4($global, $scope, $_arguments, JS::toString($_i, $global), 61, 33, '<image>/04_array.js');
$x238 =& $x239[0]; list(,$W238,$S238,$U238) = $x239;
unset($x240, $W240, $S240, $U240);
$x241 = _61c60c86aef535e2824e55eb30517a85_4($global, $scope, $x238, JS::toString('length', $global), 61, 36, '<image>/04_array.js');
...
if ($_newArray === JS::$undefined || $_newArray === NULL) {
unset($_TypeError, $WTypeError, $STypeError, $UTypeError);
$x249 = _61c60c86aef535e2824e55eb30517a85_2($global, $scope, $scope, JS::toString('TypeError', $global), 62, 18, '<image>/04_array.js');
...
$x253 = _61c60c86aef535e2824e55eb30517a85_4($global, $scope, $x248, JS::toString('push', $global), 62, 18, '<image>/04_array.js');
$x252 =& $x253[0]; list(,$W252,$S252,$U252) = $x253;
unset($x254, $W254, $S254, $U254);
$x255 = _61c60c86aef535e2824e55eb30517a85_4($global, $scope, $_arguments, JS::toString($_i, $global), 62, 28, '<image>/04_array.js');
$x254 =& $x255[0]; list(,$W254,$S254,$U254) = $x255;
unset($x256, $W256, $S256, $U256);
$x257 = _61c60c86aef535e2824e55eb30517a85_4($global, $scope, $x254, JS::toString($_j, $global), 62, 31, '<image>/04_array.js');
$x256 =& $x257[0]; list(,$W256,$S256,$U256) = $x257;
if (!(is_object($x252) && isset($x252->call))) { 
unset($_TypeError, $WTypeError, $STypeError, $UTypeError);
$x260 = _61c60c86aef535e2824e55eb30517a85_2($global, $scope, $scope, JS::toString('TypeError', $global), 62, 18, '<image>/04_array.js');
...
if ($_newArray === JS::$undefined || $_newArray === NULL) {
unset($_TypeError, $WTypeError, $STypeError, $UTypeError);
$x264 = _61c60c86aef535e2824e55eb30517a85_2($global, $scope, $scope, JS::toString('TypeError', $global), 66, 17, '<image>/04_array.js');
...
$x268 = _61c60c86aef535e2824e55eb30517a85_4($global, $scope, $x263, JS::toString('push', $global), 66, 17, '<image>/04_array.js');
$x267 =& $x268[0]; list(,$W267,$S267,$U267) = $x268;
unset($x269, $W269, $S269, $U269);
$x270 = _61c60c86aef535e2824e55eb30517a85_4($global, $scope, $_arguments, JS::toString($_i, $global), 66, 27, '<image>/04_array.js');
$x269 =& $x270[0]; list(,$W269,$S269,$U269) = $x270;
if (!(is_object($x267) && isset($x267->call))) { 
unset($_TypeError, $WTypeError, $STypeError, $UTypeError);
$x273 = _61c60c86aef535e2824e55eb30517a85_2($global, $scope, $scope, JS::toString('TypeError', $global), 66, 17, '<image>/04_array.js');
...
echo 'function _61c60c86aef535e2824e55eb30517a85_7($global,$leThis,$fn,$args,$constructor=FALSE){if(isset($fn->boundThis)&&!$constructor){$leThis=$fn->boundThis;}if(isset($fn->boundArgs)){$args=array_merge($fn->boundArgs,$args);}$scope=clone JS::$emptyScope;$scope->up=$fn->scope;$scope->properties[\'arguments\']=clone JS::$argumentsTemplate;$x183=&$scope->properties[\'arguments\'];$x183->properties[\'length\']=count($args);foreach($args as$i=>$arg){$x183->properties[$i]=$args[$i];$x183->attributes[$i]=JS::WRITABLE|JS::ENUMERABLE|JS::CONFIGURABLE;}$scope->properties[\'item\']=array_key_exists(0,$args)?$args[0]:JS::$undefined;$_item=&$scope->properties[\'item\'];$Uitem=FALSE;$global->scope[++$global->scope_sp]=$scope;$x184=clone JS::$arrayTemplate;$x184->properties[\'length\']=0;$x184->attributes[\'length\']=JS::WRITABLE;$scope->properties[\'newArray\']=JS::$undefined;$_newArray=&$scope->properties[\'newArray\'];$UnewArray=FALSE;$_newArray=$x184;for($x185=0;;++$x185){if($x185===0){$scope->properties[\'i\']=JS::$undefined;$_i=&$scope->properties[\'i\'];$Ui=FALSE;$_i=0.0;unset($x186,$W186,$S186,$U186);$x187=_61c60c86aef535e2824e55eb30517a85_4($global,$scope,$leThis,JS::toString(\'length\',$global),55,26,\'<image>/04_array.js\');$x186=&$x187[0];list(,$W186,$S186,$U186)=$x187;$scope->properties[\'l\']=JS::$undefined;$_l=&$scope->properties[\'l\'];$Ul=FALSE;$_l=$x186;}if($x185!==0){$x188=++$_i;}$x189=JS::toPrimitive($_i,$global);$x190=JS::toPrimitive($_l,$global);$x191=(is_string($x189)&&is_string($x190)?strcmp($x189,$x190)<0:(!is_nan($x192=JS::toNumber($x189,$global))&&!is_nan($x193=JS::toNumber($x190,$global))&&$x192<$x193));if(!JS::toBoolean($x191,$global)){break;}if($_newArray===JS::$undefined||$_newArray===NULL){unset($_TypeError,$WTypeError,$STypeError,$UTypeError);$x195=_61c60c86aef535e2824e55eb30517a85_2($global,$scope,$scope,JS::toString(\'TypeError\',$global),56,16,\'<image>/04_array.js\');$_TypeError=&$x195[0];list(,$WTypeError,$STypeError,$UTypeError)=$x195;$x196=$_TypeError->call;$global->trace[++$global->trace_sp]=array(\'<image>/04_array.js\',56,16);$x197=$x196($global,$global,$_TypeError,array(\'Cannot call function on undefined/null.\'),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);if(isset($x197->class)&&$x197->class===\'Error\'&&!isset($x197->properties[\'file\'])&&!isset($x197->properties[\'line\'])&&!isset($x197->properties[\'column\'])){$x197->properties[\'file\']=\'<image>/04_array.js\';$x197->properties[\'line\']=56;$x197->properties[\'column\']=16;$x197->attributes[\'file\']=$x197->attributes[\'line\']=$x197->attributes[\'column\']=0;}throw new JSException($x197,56,16,\'<image>/04_array.js\');}$x194=JS::toObject($_newArray,$global);unset($x198,$W198,$S198,$U198);$x199=_61c60c86aef535e2824e55eb30517a85_4($global,$scope,$x194,JS::toString(\'push\',$global),56,16,\'<image>/04_array.js\');$x198=&$x199[0];list(,$W198,$S198,$U198)=$x199;unset($x200,$W200,$S200,$U200);$x201=_61c60c86aef535e2824e55eb30517a85_4($global,$scope,$leThis,JS::toString($_i,$global),56,21,\'<image>/04_array.js\');$x200=&$x201[0];list(,$W200,$S200,$U200)=$x201;if(!(is_object($x198)&&isset($x198->call))){unset($_TypeError,$WTypeError,$STypeError,$UTypeError);$x204=_61c60c86aef535e2824e55eb30517a85_2($global,$scope,$scope,JS::toString(\'TypeError\',$global),56,16,\'<image>/04_array.js\');$_TypeError=&$x204[0];list(,$WTypeError,$STypeError,$UTypeError)=$x204;$x205=$_TypeError->call;$global->trace[++$global->trace_sp]=array(\'<image>/04_array.js\',56,16);$x206=$x205($global,$global,$_TypeError,array(\'Trying to call what is not a function.\'),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);if(isset($x206->class)&&$x206->class===\'Error\'&&!isset($x206->properties[\'file\'])&&!isset($x206->properties[\'line\'])&&!isset($x206->properties[\'column\'])){$x206->properties[\'file\']=\'<image>/04_array.js\';$x206->properties[\'line\']=56;$x206->properties[\'column\']=16;$x206->attributes[\'file\']=$x206->attributes[\'line\']=$x206->attributes[\'column\']=0;}throw new JSException($x206,56,16,\'<image>/04_array.js\');}$x202=$x198->call;$global->trace[++$global->trace_sp]=array(\'<image>/04_array.js\',56,16);$x203=$x202($global,$x194,$x198,array($x200),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);}for($x207=0;;++$x207){if($x207===0){unset($_i);$scope->properties[\'i\']=JS::$undefined;$_i=&$scope->properties[\'i\'];$Ui=FALSE;$_i=0.0;unset($_arguments,$Warguments,$Sarguments,$Uarguments);$x208=_61c60c86aef535e2824e55eb30517a85_2($global,$scope,$scope,JS::toString(\'arguments\',$global),59,22,\'<image>/04_array.js\');$_arguments=&$x208[0];list(,$Warguments,$Sarguments,$Uarguments)=$x208;if($Uarguments){unset($_ReferenceError,$WReferenceError,$SReferenceError,$UReferenceError);$x209=_61c60c86aef535e2824e55eb30517a85_2($global,$scope,$scope,JS::toString(\'ReferenceError\',$global),59,22,\'<image>/04_array.js\');$_ReferenceError=&$x209[0];list(,$WReferenceError,$SReferenceError,$UReferenceError)=$x209;$x210=$_ReferenceError->call;$global->trace[++$global->trace_sp]=array(\'<image>/04_array.js\',59,22);$x211=$x210($global,$global,$_ReferenceError,array(\'arguments is not defined\'),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);if(isset($x211->class)&&$x211->class===\'Error\'&&!isset($x211->properties[\'file\'])&&!isset($x211->properties[\'line\'])&&!isset($x211->properties[\'column\'])){$x211->properties[\'file\']=\'<image>/04_array.js\';$x211->properties[\'line\']=59;$x211->properties[\'column\']=22;$x211->attributes[\'file\']=$x211->attributes[\'line\']=$x211->attributes[\'column\']=0;}throw new JSException($x211,59,22,\'<image>/04_array.js\');}unset($x212,$W212,$S212,$U212);$x213=_61c60c86aef535e2824e55eb30517a85_4($global,$scope,$_arguments,JS::toString(\'length\',$global),59,31,\'<image>/04_array.js\');$x212=&$x213[0];list(,$W212,$S212,$U212)=$x213;unset($_l);$scope->properties[\'l\']=JS::$undefined;$_l=&$scope->properties[\'l\'];$Ul=FALSE;$_l=$x212;}if($x207!==0){$x214=++$_i;}$x215=JS::toPrimitive($_i,$global);$x216=JS::toPrimitive($_l,$global);$x217=(is_string($x215)&&is_string($x216)?strcmp($x215,$x216)<0:(!is_nan($x218=JS::toNumber($x215,$global))&&!is_nan($x219=JS::toNumber($x216,$global))&&$x218<$x219));if(!JS::toBoolean($x217,$global)){break;}unset($_Array,$WArray,$SArray,$UArray);$x220=_61c60c86aef535e2824e55eb30517a85_2($global,$scope,$scope,JS::toString(\'Array\',$global),60,7,\'<image>/04_array.js\');$_Array=&$x220[0];list(,$WArray,$SArray,$UArray)=$x220;if($UArray){unset($_ReferenceError,$WReferenceError,$SReferenceError,$UReferenceError);$x221=_61c60c86aef535e2824e55eb30517a85_2($global,$scope,$scope,JS::toString(\'ReferenceError\',$global),60,7,\'<image>/04_array.js\');$_ReferenceError=&$x221[0];list(,$WReferenceError,$SReferenceError,$UReferenceError)=$x221;$x222=$_ReferenceError->call;$global->trace[++$global->trace_sp]=array(\'<image>/04_array.js\',60,7);$x223=$x222($global,$global,$_ReferenceError,array(\'Array is not defined\'),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);if(isset($x223->class)&&$x223->class===\'Error\'&&!isset($x223->properties[\'file\'])&&!isset($x223->properties[\'line\'])&&!isset($x223->properties[\'column\'])){$x223->properties[\'file\']=\'<image>/04_array.js\';$x223->properties[\'line\']=60;$x223->properties[\'column\']=7;$x223->attributes[\'file\']=$x223->attributes[\'line\']=$x223->attributes[\'column\']=0;}throw new JSException($x223,60,7,\'<image>/04_array.js\');}if($_Array===JS::$undefined||$_Array===NULL){unset($_TypeError,$WTypeError,$STypeError,$UTypeError);$x225=_61c60c86aef535e2824e55eb30517a85_2($global,$scope,$scope,JS::toString(\'TypeError\',$global),60,20,\'<image>/04_array.js\');$_TypeError=&$x225[0];list(,$WTypeError,$STypeError,$UTypeError)=$x225;$x226=$_TypeError->call;$global->trace[++$global->trace_sp]=array(\'<image>/04_array.js\',60,20);$x227=$x226($global,$global,$_TypeError,array(\'Cannot call function on undefined/null.\'),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);if(isset($x227->class)&&$x227->class===\'Error\'&&!isset($x227->properties[\'file\'])&&!isset($x227->properties[\'line\'])&&!isset($x227->properties[\'column\'])){$x227->properties[\'file\']=\'<image>/04_array.js\';$x227->properties[\'line\']=60;$x227->properties[\'column\']=20;$x227->attributes[\'file\']=$x227->attributes[\'line\']=$x227->attributes[\'column\']=0;}throw new JSException($x227,60,20,\'<image>/04_array.js\');}$x224=JS::toObject($_Array,$global);unset($x228,$W228,$S228,$U228);$x229=_61c60c86aef535e2824e55eb30517a85_4($global,$scope,$x224,JS::toString(\'isArray\',$global),60,20,\'<image>/04_array.js\');$x228=&$x229[0];list(,$W228,$S228,$U228)=$x229;unset($x230,$W230,$S230,$U230);$x231=_61c60c86aef535e2824e55eb30517a85_4($global,$scope,$_arguments,JS::toString($_i,$global),60,30,\'<image>/04_array.js\');$x230=&$x231[0];list(,$W230,$S230,$U230)=$x231;if(!(is_object($x228)&&isset($x228->call))){unset($_TypeError,$WTypeError,$STypeError,$UTypeError);$x234=_61c60c86aef535e2824e55eb30517a85_2($global,$scope,$scope,JS::toString(\'TypeError\',$global),60,20,\'<image>/04_array.js\');$_TypeError=&$x234[0];list(,$WTypeError,$STypeError,$UTypeError)=$x234;$x235=$_TypeError->call;$global->trace[++$global->trace_sp]=array(\'<image>/04_array.js\',60,20);$x236=$x235($global,$global,$_TypeError,array(\'Trying to call what is not a function.\'),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);if(isset($x236->class)&&$x236->class===\'Error\'&&!isset($x236->properties[\'file\'])&&!isset($x236->properties[\'line\'])&&!isset($x236->properties[\'column\'])){$x236->properties[\'file\']=\'<image>/04_array.js\';$x236->properties[\'line\']=60;$x236->properties[\'column\']=20;$x236->attributes[\'file\']=$x236->attributes[\'line\']=$x236->attributes[\'column\']=0;}throw new JSException($x236,60,20,\'<image>/04_array.js\');}$x232=$x228->call;$global->trace[++$global->trace_sp]=array(\'<image>/04_array.js\',60,20);$x233=$x232($global,$x224,$x228,array($x230),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);if(JS::toBoolean($x233,$global)){for($x237=0;;++$x237){if($x237===0){$scope->properties[\'j\']=JS::$undefined;$_j=&$scope->properties[\'j\'];$Uj=FALSE;$_j=0.0;unset($x238,$W238,$S238,$U238);$x239=_61c60c86aef535e2824e55eb30517a85_4($global,$scope,$_arguments,JS::toString($_i,$global),61,33,\'<image>/04_array.js\');$x238=&$x239[0];list(,$W238,$S238,$U238)=$x239;unset($x240,$W240,$S240,$U240);$x241=_61c60c86aef535e2824e55eb30517a85_4($global,$scope,$x238,JS::toString(\'length\',$global),61,36,\'<image>/04_array.js\');$x240=&$x241[0];list(,$W240,$S240,$U240)=$x241;$scope->properties[\'m\']=JS::$undefined;$_m=&$scope->properties[\'m\'];$Um=FALSE;$_m=$x240;}if($x237!==0){$x242=++$_j;}$x243=JS::toPrimitive($_j,$global);$x244=JS::toPrimitive($_m,$global);$x245=(is_string($x243)&&is_string($x244)?strcmp($x243,$x244)<0:(!is_nan($x246=JS::toNumber($x243,$global))&&!is_nan($x247=JS::toNumber($x244,$global))&&$x246<$x247));if(!JS::toBoolean($x245,$global)){break;}if($_newArray===JS::$undefined||$_newArray===NULL){unset($_TypeError,$WTypeError,$STypeError,$UTypeError);$x249=_61c60c86aef535e2824e55eb30517a85_2($global,$scope,$scope,JS::toString(\'TypeError\',$global),62,18,\'<image>/04_array.js\');$_TypeError=&$x249[0];list(,$WTypeError,$STypeError,$UTypeError)=$x249;$x250=$_TypeError->call;$global->trace[++$global->trace_sp]=array(\'<image>/04_array.js\',62,18);$x251=$x250($global,$global,$_TypeError,array(\'Cannot call function on undefined/null.\'),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);if(isset($x251->class)&&$x251->class===\'Error\'&&!isset($x251->properties[\'file\'])&&!isset($x251->properties[\'line\'])&&!isset($x251->properties[\'column\'])){$x251->properties[\'file\']=\'<image>/04_array.js\';$x251->properties[\'line\']=62;$x251->properties[\'column\']=18;$x251->attributes[\'file\']=$x251->attributes[\'line\']=$x251->attributes[\'column\']=0;}throw new JSException($x251,62,18,\'<image>/04_array.js\');}$x248=JS::toObject($_newArray,$global);unset($x252,$W252,$S252,$U252);$x253=_61c60c86aef535e2824e55eb30517a85_4($global,$scope,$x248,JS::toString(\'push\',$global),62,18,\'<image>/04_array.js\');$x252=&$x253[0];list(,$W252,$S252,$U252)=$x253;unset($x254,$W254,$S254,$U254);$x255=_61c60c86aef535e2824e55eb30517a85_4($global,$scope,$_arguments,JS::toString($_i,$global),62,28,\'<image>/04_array.js\');$x254=&$x255[0];list(,$W254,$S254,$U254)=$x255;unset($x256,$W256,$S256,$U256);$x257=_61c60c86aef535e2824e55eb30517a85_4($global,$scope,$x254,JS::toString($_j,$global),62,31,\'<image>/04_array.js\');$x256=&$x257[0];list(,$W256,$S256,$U256)=$x257;if(!(is_object($x252)&&isset($x252->call))){unset($_TypeError,$WTypeError,$STypeError,$UTypeError);$x260=_61c60c86aef535e2824e55eb30517a85_2($global,$scope,$scope,JS::toString(\'TypeError\',$global),62,18,\'<image>/04_array.js\');$_TypeError=&$x260[0];list(,$WTypeError,$STypeError,$UTypeError)=$x260;$x261=$_TypeError->call;$global->trace[++$global->trace_sp]=array(\'<image>/04_array.js\',62,18);$x262=$x261($global,$global,$_TypeError,array(\'Trying to call what is not a function.\'),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);if(isset($x262->class)&&$x262->class===\'Error\'&&!isset($x262->properties[\'file\'])&&!isset($x262->properties[\'line\'])&&!isset($x262->properties[\'column\'])){$x262->properties[\'file\']=\'<image>/04_array.js\';$x262->properties[\'line\']=62;$x262->properties[\'column\']=18;$x262->attributes[\'file\']=$x262->attributes[\'line\']=$x262->attributes[\'column\']=0;}throw new JSException($x262,62,18,\'<image>/04_array.js\');}$x258=$x252->call;$global->trace[++$global->trace_sp]=array(\'<image>/04_array.js\',62,18);$x259=$x258($global,$x248,$x252,array($x256),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);}}else{if($_newArray===JS::$undefined||$_newArray===NULL){unset($_TypeError,$WTypeError,$STypeError,$UTypeError);$x264=_61c60c86aef535e2824e55eb30517a85_2($global,$scope,$scope,JS::toString(\'TypeError\',$global),66,17,\'<image>/04_array.js\');$_TypeError=&$x264[0];list(,$WTypeError,$STypeError,$UTypeError)=$x264;$x265=$_TypeError->call;$global->trace[++$global->trace_sp]=array(\'<image>/04_array.js\',66,17);$x266=$x265($global,$global,$_TypeError,array(\'Cannot call function on undefined/null.\'),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);if(isset($x266->class)&&$x266->class===\'Error\'&&!isset($x266->properties[\'file\'])&&!isset($x266->properties[\'line\'])&&!isset($x266->properties[\'column\'])){$x266->properties[\'file\']=\'<image>/04_array.js\';$x266->properties[\'line\']=66;$x266->properties[\'column\']=17;$x266->attributes[\'file\']=$x266->attributes[\'line\']=$x266->attributes[\'column\']=0;}throw new JSException($x266,66,17,\'<image>/04_array.js\');}$x263=JS::toObject($_newArray,$global);unset($x267,$W267,$S267,$U267);$x268=_61c60c86aef535e2824e55eb30517a85_4($global,$scope,$x263,JS::toString(\'push\',$global),66,17,\'<image>/04_array.js\');$x267=&$x268[0];list(,$W267,$S267,$U267)=$x268;unset($x269,$W269,$S269,$U269);$x270=_61c60c86aef535e2824e55eb30517a85_4($global,$scope,$_arguments,JS::toString($_i,$global),66,27,\'<image>/04_array.js\');$x269=&$x270[0];list(,$W269,$S269,$U269)=$x270;if(!(is_object($x267)&&isset($x267->call))){unset($_TypeError,$WTypeError,$STypeError,$UTypeError);$x273=_61c60c86aef535e2824e55eb30517a85_2($global,$scope,$scope,JS::toString(\'TypeError\',$global),66,17,\'<image>/04_array.js\');$_TypeError=&$x273[0];list(,$WTypeError,$STypeError,$UTypeError)=$x273;$x274=$_TypeError->call;$global->trace[++$global->trace_sp]=array(\'<image>/04_array.js\',66,17);$x275=$x274($global,$global,$_TypeError,array(\'Trying to call what is not a function.\'),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);if(isset($x275->class)&&$x275->class===\'Error\'&&!isset($x275->properties[\'file\'])&&!isset($x275->properties[\'line\'])&&!isset($x275->properties[\'column\'])){$x275->properties[\'file\']=\'<image>/04_array.js\';$x275->properties[\'line\']=66;$x275->properties[\'column\']=17;$x275->attributes[\'file\']=$x275->attributes[\'line\']=$x275->attributes[\'column\']=0;}throw new JSException($x275,66,17,\'<image>/04_array.js\');}$x271=$x267->call;$global->trace[++$global->trace_sp]=array(\'<image>/04_array.js\',66,17);$x272=$x271($global,$x263,$x267,array($x269),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);}}return$_newArray;return JS::$undefined;}', "\n";
function _61c60c86aef535e2824e55eb30517a85_8($global, $leThis, $fn, $args, $constructor = FALSE) {
...
$x297 = _61c60c86aef535e2824e55eb30517a85_4($global, $scope, $leThis, JS::toString('length', $global), 80, 10, '<image>/04_array.js');
$x296 =& $x297[0]; list(,$W296,$S296,$U296) = $x297;
$x293 = JS::toPrimitive($x296, $global);
$x294 = JS::toPrimitive(1.0, $global);
...
$x302 = _61c60c86aef535e2824e55eb30517a85_4($global, $scope, $leThis, JS::toString('length', $global), 84, 26, '<image>/04_array.js');
...
$x309 = !(((gettype($_i) === gettype(0.0) && $_i === 0.0))|| (((is_float($_i) || is_int($_i)) && (is_float(0.0) || is_int(0.0))) && $_i == 0.0));
...
$x313 = _61c60c86aef535e2824e55eb30517a85_4($global, $scope, $leThis, JS::toString($_i, $global), 89, 14, '<image>/04_array.js');
...
$x339 = _61c60c86aef535e2824e55eb30517a85_4($global, $scope, $leThis, JS::toString('length', $global), 100, 10, '<image>/04_array.js');
$x338 =& $x339[0]; list(,$W338,$S338,$U338) = $x339;
$x335 = JS::toPrimitive($x338, $global);
$x336 = JS::toPrimitive(1.0, $global);
...
$x343 = _61c60c86aef535e2824e55eb30517a85_4($global, $scope, $leThis, JS::toString('length', $global), 104, 22, '<image>/04_array.js');
$x342 =& $x343[0]; list(,$W342,$S342,$U342) = $x343;
unset($x344, $W344, $S344, $U344);
$x345 = _61c60c86aef535e2824e55eb30517a85_4($global, $scope, $leThis, JS::toString((JS::toNumber($x342, $global) - JS::toNumber(1.0, $global)), $global), 104, 17, '<image>/04_array.js');
$x344 =& $x345[0]; list(,$W344,$S344,$U344) = $x345;
$scope->properties['item'] = JS::$undefined; $_item =& $scope->properties['item'];
$Uitem = FALSE;
$_item = $x344;
unset($x346, $W346, $S346, $U346);
$x347 = _61c60c86aef535e2824e55eb30517a85_4($global, $scope, $leThis, JS::toString('length', $global), 104, 46, '<image>/04_array.js');
$x346 =& $x347[0]; list(,$W346,$S346,$U346) = $x347;
$scope->properties['len'] = JS::$undefined; $_len =& $scope->properties['len'];
$Ulen = FALSE;
$_len = $x346;
unset($x349, $W349, $S349, $U349);
$x350 = _61c60c86aef535e2824e55eb30517a85_4($global, $scope, $leThis, JS::toString('length', $global), 105, 18, '<image>/04_array.js');
$x349 =& $x350[0]; list(,$W349,$S349,$U349) = $x350;
if (!array_key_exists((JS::toNumber($x349, $global) - JS::toNumber(1.0, $global)), $leThis->attributes)) { unset($leThis->properties[(JS::toNumber($x349, $global) - JS::toNumber(1.0, $global))]); $x348 = TRUE; }
else if ($leThis->attributes[(JS::toNumber($x349, $global) - JS::toNumber(1.0, $global))] & JS::CONFIGURABLE) { unset($leThis->properties[(JS::toNumber($x349, $global) - JS::toNumber(1.0, $global))], $leThis->attributes[(JS::toNumber($x349, $global) - JS::toNumber(1.0, $global))], $leThis->getters[(JS::toNumber($x349, $global) - JS::toNumber(1.0, $global))], $leThis->setters[(JS::toNumber($x349, $global) - JS::toNumber(1.0, $global))]); $x348 = TRUE; }
else { $x348 = FALSE; };
$x351 = (JS::toNumber($_len, $global) - JS::toNumber(1.0, $global));
$x352 = JS::toString('length', $global);
if ($leThis === JS::$undefined || $leThis === NULL) {
unset($_TypeError, $WTypeError, $STypeError, $UTypeError);
$x353 = _61c60c86aef535e2824e55eb30517a85_2($global, $scope, $scope, JS::toString('TypeError', $global), 106, 14, '<image>/04_array.js');
...
$x357 = _61c60c86aef535e2824e55eb30517a85_3($global, $scope, $leThis, JS::toString($x352, $global), 106, 14, '<image>/04_array.js');
...
echo 'function _61c60c86aef535e2824e55eb30517a85_9($global,$leThis,$fn,$args,$constructor=FALSE){if(isset($fn->boundThis)&&!$constructor){$leThis=$fn->boundThis;}if(isset($fn->boundArgs)){$args=array_merge($fn->boundArgs,$args);}$scope=clone JS::$emptyScope;$scope->up=$fn->scope;$scope->properties[\'arguments\']=clone JS::$argumentsTemplate;$x334=&$scope->properties[\'arguments\'];$x334->properties[\'length\']=count($args);foreach($args as$i=>$arg){$x334->properties[$i]=$args[$i];$x334->attributes[$i]=JS::WRITABLE|JS::ENUMERABLE|JS::CONFIGURABLE;}$global->scope[++$global->scope_sp]=$scope;unset($x338,$W338,$S338,$U338);$x339=_61c60c86aef535e2824e55eb30517a85_4($global,$scope,$leThis,JS::toString(\'length\',$global),100,10,\'<image>/04_array.js\');$x338=&$x339[0];list(,$W338,$S338,$U338)=$x339;$x335=JS::toPrimitive($x338,$global);$x336=JS::toPrimitive(1.0,$global);$x337=(is_string($x335)&&is_string($x336)?strcmp($x335,$x336)<0:(!is_nan($x340=JS::toNumber($x335,$global))&&!is_nan($x341=JS::toNumber($x336,$global))&&$x340<$x341));if(JS::toBoolean($x337,$global)){return JS::$undefined;}unset($x342,$W342,$S342,$U342);$x343=_61c60c86aef535e2824e55eb30517a85_4($global,$scope,$leThis,JS::toString(\'length\',$global),104,22,\'<image>/04_array.js\');$x342=&$x343[0];list(,$W342,$S342,$U342)=$x343;unset($x344,$W344,$S344,$U344);$x345=_61c60c86aef535e2824e55eb30517a85_4($global,$scope,$leThis,JS::toString((JS::toNumber($x342,$global)-JS::toNumber(1.0,$global)),$global),104,17,\'<image>/04_array.js\');$x344=&$x345[0];list(,$W344,$S344,$U344)=$x345;$scope->properties[\'item\']=JS::$undefined;$_item=&$scope->properties[\'item\'];$Uitem=FALSE;$_item=$x344;unset($x346,$W346,$S346,$U346);$x347=_61c60c86aef535e2824e55eb30517a85_4($global,$scope,$leThis,JS::toString(\'length\',$global),104,46,\'<image>/04_array.js\');$x346=&$x347[0];list(,$W346,$S346,$U346)=$x347;$scope->properties[\'len\']=JS::$undefined;$_len=&$scope->properties[\'len\'];$Ulen=FALSE;$_len=$x346;unset($x349,$W349,$S349,$U349);$x350=_61c60c86aef535e2824e55eb30517a85_4($global,$scope,$leThis,JS::toString(\'length\',$global),105,18,\'<image>/04_array.js\');$x349=&$x350[0];list(,$W349,$S349,$U349)=$x350;if(!array_key_exists((JS::toNumber($x349,$global)-JS::toNumber(1.0,$global)),$leThis->attributes)){unset($leThis->properties[(JS::toNumber($x349,$global)-JS::toNumber(1.0,$global))]);$x348=TRUE;}else if($leThis->attributes[(JS::toNumber($x349,$global)-JS::toNumber(1.0,$global))]&JS::CONFIGURABLE){unset($leThis->properties[(JS::toNumber($x349,$global)-JS::toNumber(1.0,$global))],$leThis->attributes[(JS::toNumber($x349,$global)-JS::toNumber(1.0,$global))],$leThis->getters[(JS::toNumber($x349,$global)-JS::toNumber(1.0,$global))],$leThis->setters[(JS::toNumber($x349,$global)-JS::toNumber(1.0,$global))]);$x348=TRUE;}else{$x348=FALSE;}$x351=(JS::toNumber($_len,$global)-JS::toNumber(1.0,$global));$x352=JS::toString(\'length\',$global);if($leThis===JS::$undefined||$leThis===NULL){unset($_TypeError,$WTypeError,$STypeError,$UTypeError);$x353=_61c60c86aef535e2824e55eb30517a85_2($global,$scope,$scope,JS::toString(\'TypeError\',$global),106,14,\'<image>/04_array.js\');$_TypeError=&$x353[0];list(,$WTypeError,$STypeError,$UTypeError)=$x353;$x354=$_TypeError->call;$global->trace[++$global->trace_sp]=array(\'<image>/04_array.js\',106,14);$x355=$x354($global,$global,$_TypeError,array(\'Cannot assign property of undefined/null.\'),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);if(isset($x355->class)&&$x355->class===\'Error\'&&!isset($x355->properties[\'file\'])&&!isset($x355->properties[\'line\'])&&!isset($x355->properties[\'column\'])){$x355->properties[\'file\']=\'<image>/04_array.js\';$x355->properties[\'line\']=106;$x355->properties[\'column\']=14;$x355->attributes[\'file\']=$x355->attributes[\'line\']=$x355->attributes[\'column\']=0;}throw new JSException($x355,106,14,\'<image>/04_array.js\');}$leThis=JS::toObject($leThis,$global);unset($x356,$W356,$S356,$U356);$x357=_61c60c86aef535e2824e55eb30517a85_3($global,$scope,$leThis,JS::toString($x352,$global),106,14,\'<image>/04_array.js\');$x356=&$x357[0];list(,$W356,$S356,$U356)=$x357;if($U356&&(!isset($leThis->extensible)||$leThis->extensible)){$leThis->properties[$x352]=$x356;$x356=&$leThis->properties[$x352];$leThis->attributes[$x352]=JS::WRITABLE|JS::ENUMERABLE|JS::CONFIGURABLE;$U356=FALSE;$W356=TRUE;}if(isset($leThis->class)&&$leThis->class===\'Array\'){if(isset($leThis->properties[\'length\'])&&$leThis->properties[\'length\']!==JS::$undefined){$x359=$leThis->properties[\'length\'];}else{$x359=0;}}if(isset($S356)){$x360=$S356->call;$global->trace[++$global->trace_sp]=array(\'<image>/04_array.js\',106,14);$x361=$x360($global,$leThis,$S356,array($x351),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);$x358=$x361;}else{if(!$U356){$x358=$x351;if($W356){$x356=$x351;}}else{$x358=JS::$undefined;}}if(isset($leThis->class)&&$leThis->class===\'Array\'){if(is_int(\'length\')&&\'length\'>=$leThis->properties[\'length\']){$leThis->properties[\'length\']=\'length\'+1;}else if($x352===\'length\'&&is_int($x351)&&$x359>$x351){for($i=$x351;$i<$x359;++$i){unset($leThis->properties[$i],$leThis->attributes[$i]);}}}return$_item;return JS::$undefined;}', "\n";
function _61c60c86aef535e2824e55eb30517a85_10($global, $leThis, $fn, $args, $constructor = FALSE) {
...
$_i = 0.0;
unset($_arguments, $Warguments, $Sarguments, $Uarguments);
$x378 = _61c60c86aef535e2824e55eb30517a85_2($global, $scope, $scope, JS::toString('arguments', $global), 112, 22, '<image>/04_array.js');
$_arguments =& $x378[0]; list(,$Warguments,$Sarguments,$Uarguments) = $x378;
if ($Uarguments) {
unset($_ReferenceError, $WReferenceError, $SReferenceError, $UReferenceError);
$x379 = _61c60c86aef535e2824e55eb30517a85_2($global, $scope, $scope, JS::toString('ReferenceError', $global), 112, 22, '<image>/04_array.js');
...
$x383 = _61c60c86aef535e2824e55eb30517a85_4($global, $scope, $_arguments, JS::toString('length', $global), 112, 31, '<image>/04_array.js');
...
$x391 = _61c60c86aef535e2824e55eb30517a85_4($global, $scope, $_arguments, JS::toString($_i, $global), 113, 32, '<image>/04_array.js');
$x390 =& $x391[0]; list(,$W390,$S390,$U390) = $x391;
unset($x392, $W392, $S392, $U392);
$x393 = _61c60c86aef535e2824e55eb30517a85_4($global, $scope, $leThis, JS::toString('length', $global), 113, 12, '<image>/04_array.js');
$x392 =& $x393[0]; list(,$W392,$S392,$U392) = $x393;
$x394 = JS::toString($x392, $global);
if ($leThis === JS::$undefined || $leThis === NULL) {
unset($_TypeError, $WTypeError, $STypeError, $UTypeError);
$x395 = _61c60c86aef535e2824e55eb30517a85_2($global, $scope, $scope, JS::toString('TypeError', $global), 113, 21, '<image>/04_array.js');
...
$x399 = _61c60c86aef535e2824e55eb30517a85_3($global, $scope, $leThis, JS::toString($x394, $global), 113, 21, '<image>/04_array.js');
...
$x405 = _61c60c86aef535e2824e55eb30517a85_4($global, $scope, $leThis, JS::toString('length', $global), 116, 13, '<image>/04_array.js');
$x404 =& $x405[0]; list(,$W404,$S404,$U404) = $x405;
return $x404;
;
return JS::$undefined;
}
echo 'function _61c60c86aef535e2824e55eb30517a85_10($global,$leThis,$fn,$args,$constructor=FALSE){for($x377=0;;++$x377){if($x377===0){if(isset($fn->boundThis)&&!$constructor){$leThis=$fn->boundThis;}if(isset($fn->boundArgs)){$args=array_merge($fn->boundArgs,$args);}$scope=clone JS::$emptyScope;$scope->up=$fn->scope;$scope->properties[\'arguments\']=clone JS::$argumentsTemplate;$x376=&$scope->properties[\'arguments\'];$x376->properties[\'length\']=count($args);foreach($args as$i=>$arg){$x376->properties[$i]=$args[$i];$x376->attributes[$i]=JS::WRITABLE|JS::ENUMERABLE|JS::CONFIGURABLE;}$scope->properties[\'item\']=array_key_exists(0,$args)?$args[0]:JS::$undefined;$_item=&$scope->properties[\'item\'];$Uitem=FALSE;$global->scope[++$global->scope_sp]=$scope;$scope->properties[\'i\']=JS::$undefined;$_i=&$scope->properties[\'i\'];$Ui=FALSE;$_i=0.0;unset($_arguments,$Warguments,$Sarguments,$Uarguments);$x378=_61c60c86aef535e2824e55eb30517a85_2($global,$scope,$scope,JS::toString(\'arguments\',$global),112,22,\'<image>/04_array.js\');$_arguments=&$x378[0];list(,$Warguments,$Sarguments,$Uarguments)=$x378;if($Uarguments){unset($_ReferenceError,$WReferenceError,$SReferenceError,$UReferenceError);$x379=_61c60c86aef535e2824e55eb30517a85_2($global,$scope,$scope,JS::toString(\'ReferenceError\',$global),112,22,\'<image>/04_array.js\');$_ReferenceError=&$x379[0];list(,$WReferenceError,$SReferenceError,$UReferenceError)=$x379;$x380=$_ReferenceError->call;$global->trace[++$global->trace_sp]=array(\'<image>/04_array.js\',112,22);$x381=$x380($global,$global,$_ReferenceError,array(\'arguments is not defined\'),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);if(isset($x381->class)&&$x381->class===\'Error\'&&!isset($x381->properties[\'file\'])&&!isset($x381->properties[\'line\'])&&!isset($x381->properties[\'column\'])){$x381->properties[\'file\']=\'<image>/04_array.js\';$x381->properties[\'line\']=112;$x381->properties[\'column\']=22;$x381->attributes[\'file\']=$x381->attributes[\'line\']=$x381->attributes[\'column\']=0;}throw new JSException($x381,112,22,\'<image>/04_array.js\');}unset($x382,$W382,$S382,$U382);$x383=_61c60c86aef535e2824e55eb30517a85_4($global,$scope,$_arguments,JS::toString(\'length\',$global),112,31,\'<image>/04_array.js\');$x382=&$x383[0];list(,$W382,$S382,$U382)=$x383;$scope->properties[\'l\']=JS::$undefined;$_l=&$scope->properties[\'l\'];$Ul=FALSE;$_l=$x382;}if($x377!==0){$x384=++$_i;}$x385=JS::toPrimitive($_i,$global);$x386=JS::toPrimitive($_l,$global);$x387=(is_string($x385)&&is_string($x386)?strcmp($x385,$x386)<0:(!is_nan($x388=JS::toNumber($x385,$global))&&!is_nan($x389=JS::toNumber($x386,$global))&&$x388<$x389));if(!JS::toBoolean($x387,$global)){break;}unset($x390,$W390,$S390,$U390);$x391=_61c60c86aef535e2824e55eb30517a85_4($global,$scope,$_arguments,JS::toString($_i,$global),113,32,\'<image>/04_array.js\');$x390=&$x391[0];list(,$W390,$S390,$U390)=$x391;unset($x392,$W392,$S392,$U392);$x393=_61c60c86aef535e2824e55eb30517a85_4($global,$scope,$leThis,JS::toString(\'length\',$global),113,12,\'<image>/04_array.js\');$x392=&$x393[0];list(,$W392,$S392,$U392)=$x393;$x394=JS::toString($x392,$global);if($leThis===JS::$undefined||$leThis===NULL){unset($_TypeError,$WTypeError,$STypeError,$UTypeError);$x395=_61c60c86aef535e2824e55eb30517a85_2($global,$scope,$scope,JS::toString(\'TypeError\',$global),113,21,\'<image>/04_array.js\');$_TypeError=&$x395[0];list(,$WTypeError,$STypeError,$UTypeError)=$x395;$x396=$_TypeError->call;$global->trace[++$global->trace_sp]=array(\'<image>/04_array.js\',113,21);$x397=$x396($global,$global,$_TypeError,array(\'Cannot assign property of undefined/null.\'),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);if(isset($x397->class)&&$x397->class===\'Error\'&&!isset($x397->properties[\'file\'])&&!isset($x397->properties[\'line\'])&&!isset($x397->properties[\'column\'])){$x397->properties[\'file\']=\'<image>/04_array.js\';$x397->properties[\'line\']=113;$x397->properties[\'column\']=21;$x397->attributes[\'file\']=$x397->attributes[\'line\']=$x397->attributes[\'column\']=0;}throw new JSException($x397,113,21,\'<image>/04_array.js\');}$leThis=JS::toObject($leThis,$global);unset($x398,$W398,$S398,$U398);$x399=_61c60c86aef535e2824e55eb30517a85_3($global,$scope,$leThis,JS::toString($x394,$global),113,21,\'<image>/04_array.js\');$x398=&$x399[0];list(,$W398,$S398,$U398)=$x399;if($U398&&(!isset($leThis->extensible)||$leThis->extensible)){$leThis->properties[$x394]=$x398;$x398=&$leThis->properties[$x394];$leThis->attributes[$x394]=JS::WRITABLE|JS::ENUMERABLE|JS::CONFIGURABLE;$U398=FALSE;$W398=TRUE;}if(isset($leThis->class)&&$leThis->class===\'Array\'){if(isset($leThis->properties[\'length\'])&&$leThis->properties[\'length\']!==JS::$undefined){$x401=$leThis->properties[\'length\'];}else{$x401=0;}}if(isset($S398)){$x402=$S398->call;$global->trace[++$global->trace_sp]=array(\'<image>/04_array.js\',113,21);$x403=$x402($global,$leThis,$S398,array($x390),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);$x400=$x403;}else{if(!$U398){$x400=$x390;if($W398){$x398=$x390;}}else{$x400=JS::$undefined;}}if(isset($leThis->class)&&$leThis->class===\'Array\'){if(is_int($x392)&&$x392>=$leThis->properties[\'length\']){$leThis->properties[\'length\']=$x392+1;}else if($x394===\'length\'&&is_int($x390)&&$x401>$x390){for($i=$x390;$i<$x401;++$i){unset($leThis->properties[$i],$leThis->attributes[$i]);}}}}unset($x404,$W404,$S404,$U404);$x405=_61c60c86aef535e2824e55eb30517a85_4($global,$scope,$leThis,JS::toString(\'length\',$global),116,13,\'<image>/04_array.js\');$x404=&$x405[0];list(,$W404,$S404,$U404)=$x405;return$x404;return JS::$undefined;}', "\n";
function _61c60c86aef535e2824e55eb30517a85_11($global, $leThis, $fn, $args, $constructor = FALSE) {
...
$x423 = _61c60c86aef535e2824e55eb30517a85_4($global, $scope, $leThis, JS::toString('length', $global), 120, 26, '<image>/04_array.js');
$x422 =& $x423[0]; list(,$W422,$S422,$U422) = $x423;
$scope->properties['r'] = JS::$undefined; $_r =& $scope->properties['r'];
$Ur = FALSE;
$_r = (JS::toNumber($x422, $global) - JS::toNumber(1.0, $global));
}
if ($x421 !== 0) {
$x424 = ++$_l;
$x425 = --$_r;
...
$x432 = _61c60c86aef535e2824e55eb30517a85_4($global, $scope, $leThis, JS::toString($_l, $global), 121, 17, '<image>/04_array.js');
$x431 =& $x432[0]; list(,$W431,$S431,$U431) = $x432;
$scope->properties['tmp'] = JS::$undefined; $_tmp =& $scope->properties['tmp'];
$Utmp = FALSE;
$_tmp = $x431;
unset($x433, $W433, $S433, $U433);
$x434 = _61c60c86aef535e2824e55eb30517a85_4($global, $scope, $leThis, JS::toString($_r, $global), 122, 17, '<image>/04_array.js');
$x433 =& $x434[0]; list(,$W433,$S433,$U433) = $x434;
$x435 = JS::toString($_l, $global);
if ($leThis === JS::$undefined || $leThis === NULL) {
unset($_TypeError, $WTypeError, $STypeError, $UTypeError);
$x436 = _61c60c86aef535e2824e55eb30517a85_2($global, $scope, $scope, JS::toString('TypeError', $global), 122, 11, '<image>/04_array.js');
...
$x440 = _61c60c86aef535e2824e55eb30517a85_3($global, $scope, $leThis, JS::toString($x435, $global), 122, 11, '<image>/04_array.js');
...
if ($leThis === JS::$undefined || $leThis === NULL) {
unset($_TypeError, $WTypeError, $STypeError, $UTypeError);
$x446 = _61c60c86aef535e2824e55eb30517a85_2($global, $scope, $scope, JS::toString('TypeError', $global), 123, 11, '<image>/04_array.js');
...
$x450 = _61c60c86aef535e2824e55eb30517a85_3($global, $scope, $leThis, JS::toString($x445, $global), 123, 11, '<image>/04_array.js');
...
echo 'function _61c60c86aef535e2824e55eb30517a85_11($global,$leThis,$fn,$args,$constructor=FALSE){for($x421=0;;++$x421){if($x421===0){if(isset($fn->boundThis)&&!$constructor){$leThis=$fn->boundThis;}if(isset($fn->boundArgs)){$args=array_merge($fn->boundArgs,$args);}$scope=clone JS::$emptyScope;$scope->up=$fn->scope;$scope->properties[\'arguments\']=clone JS::$argumentsTemplate;$x420=&$scope->properties[\'arguments\'];$x420->properties[\'length\']=count($args);foreach($args as$i=>$arg){$x420->properties[$i]=$args[$i];$x420->attributes[$i]=JS::WRITABLE|JS::ENUMERABLE|JS::CONFIGURABLE;}$global->scope[++$global->scope_sp]=$scope;$scope->properties[\'l\']=JS::$undefined;$_l=&$scope->properties[\'l\'];$Ul=FALSE;$_l=0.0;unset($x422,$W422,$S422,$U422);$x423=_61c60c86aef535e2824e55eb30517a85_4($global,$scope,$leThis,JS::toString(\'length\',$global),120,26,\'<image>/04_array.js\');$x422=&$x423[0];list(,$W422,$S422,$U422)=$x423;$scope->properties[\'r\']=JS::$undefined;$_r=&$scope->properties[\'r\'];$Ur=FALSE;$_r=(JS::toNumber($x422,$global)-JS::toNumber(1.0,$global));}if($x421!==0){$x424=++$_l;$x425=--$_r;}$x426=JS::toPrimitive($_l,$global);$x427=JS::toPrimitive($_r,$global);$x428=(is_string($x426)&&is_string($x427)?strcmp($x426,$x427)<0:(!is_nan($x429=JS::toNumber($x426,$global))&&!is_nan($x430=JS::toNumber($x427,$global))&&$x429<$x430));if(!JS::toBoolean($x428,$global)){break;}unset($x431,$W431,$S431,$U431);$x432=_61c60c86aef535e2824e55eb30517a85_4($global,$scope,$leThis,JS::toString($_l,$global),121,17,\'<image>/04_array.js\');$x431=&$x432[0];list(,$W431,$S431,$U431)=$x432;$scope->properties[\'tmp\']=JS::$undefined;$_tmp=&$scope->properties[\'tmp\'];$Utmp=FALSE;$_tmp=$x431;unset($x433,$W433,$S433,$U433);$x434=_61c60c86aef535e2824e55eb30517a85_4($global,$scope,$leThis,JS::toString($_r,$global),122,17,\'<image>/04_array.js\');$x433=&$x434[0];list(,$W433,$S433,$U433)=$x434;$x435=JS::toString($_l,$global);if($leThis===JS::$undefined||$leThis===NULL){unset($_TypeError,$WTypeError,$STypeError,$UTypeError);$x436=_61c60c86aef535e2824e55eb30517a85_2($global,$scope,$scope,JS::toString(\'TypeError\',$global),122,11,\'<image>/04_array.js\');$_TypeError=&$x436[0];list(,$WTypeError,$STypeError,$UTypeError)=$x436;$x437=$_TypeError->call;$global->trace[++$global->trace_sp]=array(\'<image>/04_array.js\',122,11);$x438=$x437($global,$global,$_TypeError,array(\'Cannot assign property of undefined/null.\'),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);if(isset($x438->class)&&$x438->class===\'Error\'&&!isset($x438->properties[\'file\'])&&!isset($x438->properties[\'line\'])&&!isset($x438->properties[\'column\'])){$x438->properties[\'file\']=\'<image>/04_array.js\';$x438->properties[\'line\']=122;$x438->properties[\'column\']=11;$x438->attributes[\'file\']=$x438->attributes[\'line\']=$x438->attributes[\'column\']=0;}throw new JSException($x438,122,11,\'<image>/04_array.js\');}$leThis=JS::toObject($leThis,$global);unset($x439,$W439,$S439,$U439);$x440=_61c60c86aef535e2824e55eb30517a85_3($global,$scope,$leThis,JS::toString($x435,$global),122,11,\'<image>/04_array.js\');$x439=&$x440[0];list(,$W439,$S439,$U439)=$x440;if($U439&&(!isset($leThis->extensible)||$leThis->extensible)){$leThis->properties[$x435]=$x439;$x439=&$leThis->properties[$x435];$leThis->attributes[$x435]=JS::WRITABLE|JS::ENUMERABLE|JS::CONFIGURABLE;$U439=FALSE;$W439=TRUE;}if(isset($leThis->class)&&$leThis->class===\'Array\'){if(isset($leThis->properties[\'length\'])&&$leThis->properties[\'length\']!==JS::$undefined){$x442=$leThis->properties[\'length\'];}else{$x442=0;}}if(isset($S439)){$x443=$S439->call;$global->trace[++$global->trace_sp]=array(\'<image>/04_array.js\',122,11);$x444=$x443($global,$leThis,$S439,array($x433),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);$x441=$x444;}else{if(!$U439){$x441=$x433;if($W439){$x439=$x433;}}else{$x441=JS::$undefined;}}if(isset($leThis->class)&&$leThis->class===\'Array\'){if(is_int($_l)&&$_l>=$leThis->properties[\'length\']){$leThis->properties[\'length\']=$_l+1;}else if($x435===\'length\'&&is_int($x433)&&$x442>$x433){for($i=$x433;$i<$x442;++$i){unset($leThis->properties[$i],$leThis->attributes[$i]);}}}$x445=JS::toString($_r,$global);if($leThis===JS::$undefined||$leThis===NULL){unset($_TypeError,$WTypeError,$STypeError,$UTypeError);$x446=_61c60c86aef535e2824e55eb30517a85_2($global,$scope,$scope,JS::toString(\'TypeError\',$global),123,11,\'<image>/04_array.js\');$_TypeError=&$x446[0];list(,$WTypeError,$STypeError,$UTypeError)=$x446;$x447=$_TypeError->call;$global->trace[++$global->trace_sp]=array(\'<image>/04_array.js\',123,11);$x448=$x447($global,$global,$_TypeError,array(\'Cannot assign property of undefined/null.\'),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);if(isset($x448->class)&&$x448->class===\'Error\'&&!isset($x448->properties[\'file\'])&&!isset($x448->properties[\'line\'])&&!isset($x448->properties[\'column\'])){$x448->properties[\'file\']=\'<image>/04_array.js\';$x448->properties[\'line\']=123;$x448->properties[\'column\']=11;$x448->attributes[\'file\']=$x448->attributes[\'line\']=$x448->attributes[\'column\']=0;}throw new JSException($x448,123,11,\'<image>/04_array.js\');}$leThis=JS::toObject($leThis,$global);unset($x449,$W449,$S449,$U449);$x450=_61c60c86aef535e2824e55eb30517a85_3($global,$scope,$leThis,JS::toString($x445,$global),123,11,\'<image>/04_array.js\');$x449=&$x450[0];list(,$W449,$S449,$U449)=$x450;if($U449&&(!isset($leThis->extensible)||$leThis->extensible)){$leThis->properties[$x445]=$x449;$x449=&$leThis->properties[$x445];$leThis->attributes[$x445]=JS::WRITABLE|JS::ENUMERABLE|JS::CONFIGURABLE;$U449=FALSE;$W449=TRUE;}if(isset($leThis->class)&&$leThis->class===\'Array\'){if(isset($leThis->properties[\'length\'])&&$leThis->properties[\'length\']!==JS::$undefined){$x452=$leThis->properties[\'length\'];}else{$x452=0;}}if(isset($S449)){$x453=$S449->call;$global->trace[++$global->trace_sp]=array(\'<image>/04_array.js\',123,11);$x454=$x453($global,$leThis,$S449,array($_tmp),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);$x451=$x454;}else{if(!$U449){$x451=$_tmp;if($W449){$x449=$_tmp;}}else{$x451=JS::$undefined;}}if(isset($leThis->class)&&$leThis->class===\'Array\'){if(is_int($_r)&&$_r>=$leThis->properties[\'length\']){$leThis->properties[\'length\']=$_r+1;}else if($x445===\'length\'&&is_int($_tmp)&&$x452>$_tmp){for($i=$_tmp;$i<$x452;++$i){unset($leThis->properties[$i],$leThis->attributes[$i]);}}}}return$leThis;return JS::$undefined;}', "\n";
function _61c60c86aef535e2824e55eb30517a85_12($global, $leThis, $fn, $args, $constructor = FALSE) {
...
$x474 = _61c60c86aef535e2824e55eb30517a85_4($global, $scope, $leThis, JS::toString('length', $global), 130, 10, '<image>/04_array.js');
$x473 =& $x474[0]; list(,$W473,$S473,$U473) = $x474;
$x470 = JS::toPrimitive($x473, $global);
$x471 = JS::toPrimitive(1.0, $global);
...
$x478 = _61c60c86aef535e2824e55eb30517a85_4($global, $scope, $leThis, JS::toString(0.0, $global), 134, 17, '<image>/04_array.js');
$x477 =& $x478[0]; list(,$W477,$S477,$U477) = $x478;
$scope->properties['item'] = JS::$undefined; $_item =& $scope->properties['item'];
$Uitem = FALSE;
$_item = $x477;
unset($x479, $W479, $S479, $U479);
$x480 = _61c60c86aef535e2824e55eb30517a85_4($global, $scope, $leThis, JS::toString('length', $global), 134, 30, '<image>/04_array.js');
...
$x489 = JS::toPrimitive(1.0, $global);
unset($x490, $W490, $S490, $U490);
$x491 = _61c60c86aef535e2824e55eb30517a85_4($global, $scope, $leThis, JS::toString((is_string($x488) || is_string($x489) ? JS::toString($x488, $global) . JS::toString($x489, $global) : JS::toNumber($x488, $global) + JS::toNumber($x489, $global)), $global), 137, 17, '<image>/04_array.js');
$x490 =& $x491[0]; list(,$W490,$S490,$U490) = $x491;
$x492 = JS::toString($_i, $global);
if ($leThis === JS::$undefined || $leThis === NULL) {
unset($_TypeError, $WTypeError, $STypeError, $UTypeError);
$x493 = _61c60c86aef535e2824e55eb30517a85_2($global, $scope, $scope, JS::toString('TypeError', $global), 137, 11, '<image>/04_array.js');
...
$x497 = _61c60c86aef535e2824e55eb30517a85_3($global, $scope, $leThis, JS::toString($x492, $global), 137, 11, '<image>/04_array.js');
...
if ($leThis === JS::$undefined || $leThis === NULL) {
unset($_TypeError, $WTypeError, $STypeError, $UTypeError);
$x504 = _61c60c86aef535e2824e55eb30517a85_2($global, $scope, $scope, JS::toString('TypeError', $global), 140, 14, '<image>/04_array.js');
...
$x508 = _61c60c86aef535e2824e55eb30517a85_3($global, $scope, $leThis, JS::toString($x503, $global), 140, 14, '<image>/04_array.js');
...
echo 'function _61c60c86aef535e2824e55eb30517a85_12($global,$leThis,$fn,$args,$constructor=FALSE){if(isset($fn->boundThis)&&!$constructor){$leThis=$fn->boundThis;}if(isset($fn->boundArgs)){$args=array_merge($fn->boundArgs,$args);}$scope=clone JS::$emptyScope;$scope->up=$fn->scope;$scope->properties[\'arguments\']=clone JS::$argumentsTemplate;$x469=&$scope->properties[\'arguments\'];$x469->properties[\'length\']=count($args);foreach($args as$i=>$arg){$x469->properties[$i]=$args[$i];$x469->attributes[$i]=JS::WRITABLE|JS::ENUMERABLE|JS::CONFIGURABLE;}$global->scope[++$global->scope_sp]=$scope;unset($x473,$W473,$S473,$U473);$x474=_61c60c86aef535e2824e55eb30517a85_4($global,$scope,$leThis,JS::toString(\'length\',$global),130,10,\'<image>/04_array.js\');$x473=&$x474[0];list(,$W473,$S473,$U473)=$x474;$x470=JS::toPrimitive($x473,$global);$x471=JS::toPrimitive(1.0,$global);$x472=(is_string($x470)&&is_string($x471)?strcmp($x470,$x471)<0:(!is_nan($x475=JS::toNumber($x470,$global))&&!is_nan($x476=JS::toNumber($x471,$global))&&$x475<$x476));if(JS::toBoolean($x472,$global)){return JS::$undefined;}unset($x477,$W477,$S477,$U477);$x478=_61c60c86aef535e2824e55eb30517a85_4($global,$scope,$leThis,JS::toString(0.0,$global),134,17,\'<image>/04_array.js\');$x477=&$x478[0];list(,$W477,$S477,$U477)=$x478;$scope->properties[\'item\']=JS::$undefined;$_item=&$scope->properties[\'item\'];$Uitem=FALSE;$_item=$x477;unset($x479,$W479,$S479,$U479);$x480=_61c60c86aef535e2824e55eb30517a85_4($global,$scope,$leThis,JS::toString(\'length\',$global),134,30,\'<image>/04_array.js\');$x479=&$x480[0];list(,$W479,$S479,$U479)=$x480;$scope->properties[\'l\']=JS::$undefined;$_l=&$scope->properties[\'l\'];$Ul=FALSE;$_l=$x479;for($x481=0;;++$x481){if($x481===0){$scope->properties[\'i\']=JS::$undefined;$_i=&$scope->properties[\'i\'];$Ui=FALSE;$_i=0.0;}if($x481!==0){$x482=++$_i;}$x483=JS::toPrimitive($_i,$global);$x484=JS::toPrimitive($_l,$global);$x485=(is_string($x483)&&is_string($x484)?strcmp($x483,$x484)<0:(!is_nan($x486=JS::toNumber($x483,$global))&&!is_nan($x487=JS::toNumber($x484,$global))&&$x486<$x487));if(!JS::toBoolean($x485,$global)){break;}$x488=JS::toPrimitive($_i,$global);$x489=JS::toPrimitive(1.0,$global);unset($x490,$W490,$S490,$U490);$x491=_61c60c86aef535e2824e55eb30517a85_4($global,$scope,$leThis,JS::toString((is_string($x488)||is_string($x489)?JS::toString($x488,$global).JS::toString($x489,$global):JS::toNumber($x488,$global)+JS::toNumber($x489,$global)),$global),137,17,\'<image>/04_array.js\');$x490=&$x491[0];list(,$W490,$S490,$U490)=$x491;$x492=JS::toString($_i,$global);if($leThis===JS::$undefined||$leThis===NULL){unset($_TypeError,$WTypeError,$STypeError,$UTypeError);$x493=_61c60c86aef535e2824e55eb30517a85_2($global,$scope,$scope,JS::toString(\'TypeError\',$global),137,11,\'<image>/04_array.js\');$_TypeError=&$x493[0];list(,$WTypeError,$STypeError,$UTypeError)=$x493;$x494=$_TypeError->call;$global->trace[++$global->trace_sp]=array(\'<image>/04_array.js\',137,11);$x495=$x494($global,$global,$_TypeError,array(\'Cannot assign property of undefined/null.\'),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);if(isset($x495->class)&&$x495->class===\'Error\'&&!isset($x495->properties[\'file\'])&&!isset($x495->properties[\'line\'])&&!isset($x495->properties[\'column\'])){$x495->properties[\'file\']=\'<image>/04_array.js\';$x495->properties[\'line\']=137;$x495->properties[\'column\']=11;$x495->attributes[\'file\']=$x495->attributes[\'line\']=$x495->attributes[\'column\']=0;}throw new JSException($x495,137,11,\'<image>/04_array.js\');}$leThis=JS::toObject($leThis,$global);unset($x496,$W496,$S496,$U496);$x497=_61c60c86aef535e2824e55eb30517a85_3($global,$scope,$leThis,JS::toString($x492,$global),137,11,\'<image>/04_array.js\');$x496=&$x497[0];list(,$W496,$S496,$U496)=$x497;if($U496&&(!isset($leThis->extensible)||$leThis->extensible)){$leThis->properties[$x492]=$x496;$x496=&$leThis->properties[$x492];$leThis->attributes[$x492]=JS::WRITABLE|JS::ENUMERABLE|JS::CONFIGURABLE;$U496=FALSE;$W496=TRUE;}if(isset($leThis->class)&&$leThis->class===\'Array\'){if(isset($leThis->properties[\'length\'])&&$leThis->properties[\'length\']!==JS::$undefined){$x499=$leThis->properties[\'length\'];}else{$x499=0;}}if(isset($S496)){$x500=$S496->call;$global->trace[++$global->trace_sp]=array(\'<image>/04_array.js\',137,11);$x501=$x500($global,$leThis,$S496,array($x490),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);$x498=$x501;}else{if(!$U496){$x498=$x490;if($W496){$x496=$x490;}}else{$x498=JS::$undefined;}}if(isset($leThis->class)&&$leThis->class===\'Array\'){if(is_int($_i)&&$_i>=$leThis->properties[\'length\']){$leThis->properties[\'length\']=$_i+1;}else if($x492===\'length\'&&is_int($x490)&&$x499>$x490){for($i=$x490;$i<$x499;++$i){unset($leThis->properties[$i],$leThis->attributes[$i]);}}}}$x502=(JS::toNumber($_l,$global)-JS::toNumber(1.0,$global));$x503=JS::toString(\'length\',$global);if($leThis===JS::$undefined||$leThis===NULL){unset($_TypeError,$WTypeError,$STypeError,$UTypeError);$x504=_61c60c86aef535e2824e55eb30517a85_2($global,$scope,$scope,JS::toString(\'TypeError\',$global),140,14,\'<image>/04_array.js\');$_TypeError=&$x504[0];list(,$WTypeError,$STypeError,$UTypeError)=$x504;$x505=$_TypeError->call;$global->trace[++$global->trace_sp]=array(\'<image>/04_array.js\',140,14);$x506=$x505($global,$global,$_TypeError,array(\'Cannot assign property of undefined/null.\'),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);if(isset($x506->class)&&$x506->class===\'Error\'&&!isset($x506->properties[\'file\'])&&!isset($x506->properties[\'line\'])&&!isset($x506->properties[\'column\'])){$x506->properties[\'file\']=\'<image>/04_array.js\';$x506->properties[\'line\']=140;$x506->properties[\'column\']=14;$x506->attributes[\'file\']=$x506->attributes[\'line\']=$x506->attributes[\'column\']=0;}throw new JSException($x506,140,14,\'<image>/04_array.js\');}$leThis=JS::toObject($leThis,$global);unset($x507,$W507,$S507,$U507);$x508=_61c60c86aef535e2824e55eb30517a85_3($global,$scope,$leThis,JS::toString($x503,$global),140,14,\'<image>/04_array.js\');$x507=&$x508[0];list(,$W507,$S507,$U507)=$x508;if($U507&&(!isset($leThis->extensible)||$leThis->extensible)){$leThis->properties[$x503]=$x507;$x507=&$leThis->properties[$x503];$leThis->attributes[$x503]=JS::WRITABLE|JS::ENUMERABLE|JS::CONFIGURABLE;$U507=FALSE;$W507=TRUE;}if(isset($leThis->class)&&$leThis->class===\'Array\'){if(isset($leThis->properties[\'length\'])&&$leThis->properties[\'length\']!==JS::$undefined){$x510=$leThis->properties[\'length\'];}else{$x510=0;}}if(isset($S507)){$x511=$S507->call;$global->trace[++$global->trace_sp]=array(\'<image>/04_array.js\',140,14);$x512=$x511($global,$leThis,$S507,array($x502),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);$x509=$x512;}else{if(!$U507){$x509=$x502;if($W507){$x507=$x502;}}else{$x509=JS::$undefined;}}if(isset($leThis->class)&&$leThis->class===\'Array\'){if(is_int(\'length\')&&\'length\'>=$leThis->properties[\'length\']){$leThis->properties[\'length\']=\'length\'+1;}else if($x503===\'length\'&&is_int($x502)&&$x510>$x502){for($i=$x502;$i<$x510;++$i){unset($leThis->properties[$i],$leThis->attributes[$i]);}}}return$_item;return JS::$undefined;}', "\n";
function _61c60c86aef535e2824e55eb30517a85_13($global, $leThis, $fn, $args, $constructor = FALSE) {
...
$x531 = JS::toPrimitive(0.0, $global);
...
$x535 = _61c60c86aef535e2824e55eb30517a85_2($global, $scope, $scope, JS::toString('Math', $global), 151, 11, '<image>/04_array.js');
$_Math =& $x535[0]; list(,$WMath,$SMath,$UMath) = $x535;
if ($UMath) {
unset($_ReferenceError, $WReferenceError, $SReferenceError, $UReferenceError);
$x536 = _61c60c86aef535e2824e55eb30517a85_2($global, $scope, $scope, JS::toString('ReferenceError', $global), 151, 11, '<image>/04_array.js');
...
unset($_TypeError, $WTypeError, $STypeError, $UTypeError);
$x540 = _61c60c86aef535e2824e55eb30517a85_2($global, $scope, $scope, JS::toString('TypeError', $global), 151, 19, '<image>/04_array.js');
...
$x544 = _61c60c86aef535e2824e55eb30517a85_4($global, $scope, $x539, JS::toString('max', $global), 151, 19, '<image>/04_array.js');
$x543 =& $x544[0]; list(,$W543,$S543,$U543) = $x544;
unset($x547, $W547, $S547, $U547);
$x548 = _61c60c86aef535e2824e55eb30517a85_4($global, $scope, $leThis, JS::toString('length', $global), 151, 24, '<image>/04_array.js');
...
unset($_TypeError, $WTypeError, $STypeError, $UTypeError);
$x551 = _61c60c86aef535e2824e55eb30517a85_2($global, $scope, $scope, JS::toString('TypeError', $global), 151, 19, '<image>/04_array.js');
...
$x549 = $x543->call;
$global->trace[++$global->trace_sp] = array('<image>/04_array.js', 151, 19);
$x550 = $x549($global, $x539, $x543, array((is_string($x545) || is_string($x546) ? JS::toString($x545, $global) . JS::toString($x546, $global) : JS::toNumber($x545, $global) + JS::toNumber($x546, $global)), 0.0), false);
unset($global->trace[$global->trace_sp--], $global->scope[$global->scope_sp--]);
if ($Ustart) {$global->properties['start'] = $_start; $_start =& $global->properties['start']; }
$_start = $x550;;
};
...
$x556 = _61c60c86aef535e2824e55eb30517a85_4($global, $scope, $leThis, JS::toString('length', $global), 155, 13, '<image>/04_array.js');
...
$x558 = JS::toPrimitive(0.0, $global);
...
$x565 = _61c60c86aef535e2824e55eb30517a85_4($global, $scope, $leThis, JS::toString('length', $global), 159, 13, '<image>/04_array.js');
...
if ($_newArray === JS::$undefined || $_newArray === NULL) {
unset($_TypeError, $WTypeError, $STypeError, $UTypeError);
$x576 = _61c60c86aef535e2824e55eb30517a85_2($global, $scope, $scope, JS::toString('TypeError', $global), 165, 16, '<image>/04_array.js');
...
$x580 = _61c60c86aef535e2824e55eb30517a85_4($global, $scope, $x575, JS::toString('push', $global), 165, 16, '<image>/04_array.js');
$x579 =& $x580[0]; list(,$W579,$S579,$U579) = $x580;
unset($x581, $W581, $S581, $U581);
$x582 = _61c60c86aef535e2824e55eb30517a85_4($global, $scope, $leThis, JS::toString($_start, $global), 165, 21, '<image>/04_array.js');
$x581 =& $x582[0]; list(,$W581,$S581,$U581) = $x582;
if (!(is_object($x579) && isset($x579->call))) { 
unset($_TypeError, $WTypeError, $STypeError, $UTypeError);
$x585 = _61c60c86aef535e2824e55eb30517a85_2($global, $scope, $scope, JS::toString('TypeError', $global), 165, 16, '<image>/04_array.js');
...
echo 'function _61c60c86aef535e2824e55eb30517a85_13($global,$leThis,$fn,$args,$constructor=FALSE){if(isset($fn->boundThis)&&!$constructor){$leThis=$fn->boundThis;}if(isset($fn->boundArgs)){$args=array_merge($fn->boundArgs,$args);}$scope=clone JS::$emptyScope;$scope->up=$fn->scope;$scope->properties[\'arguments\']=clone JS::$argumentsTemplate;$x527=&$scope->properties[\'arguments\'];$x527->properties[\'length\']=count($args);foreach($args as$i=>$arg){$x527->properties[$i]=$args[$i];$x527->attributes[$i]=JS::WRITABLE|JS::ENUMERABLE|JS::CONFIGURABLE;}$scope->properties[\'start\']=array_key_exists(0,$args)?$args[0]:JS::$undefined;$_start=&$scope->properties[\'start\'];$Ustart=FALSE;$scope->properties[\'end\']=array_key_exists(1,$args)?$args[1]:JS::$undefined;$_end=&$scope->properties[\'end\'];$Uend=FALSE;$global->scope[++$global->scope_sp]=$scope;$x528=(((gettype($_start)===gettype(JS::$undefined)&&$_start===JS::$undefined))||(((is_float($_start)||is_int($_start))&&(is_float(JS::$undefined)||is_int(JS::$undefined)))&&$_start==JS::$undefined));if(JS::toBoolean($x528,$global)){$x529=0.0;if($Ustart){$global->properties[\'start\']=$_start;$_start=&$global->properties[\'start\'];}$_start=$x529;}$x530=JS::toPrimitive($_start,$global);$x531=JS::toPrimitive(0.0,$global);$x532=(is_string($x530)&&is_string($x531)?strcmp($x530,$x531)<0:(!is_nan($x533=JS::toNumber($x530,$global))&&!is_nan($x534=JS::toNumber($x531,$global))&&$x533<$x534));if(JS::toBoolean($x532,$global)){unset($_Math,$WMath,$SMath,$UMath);$x535=_61c60c86aef535e2824e55eb30517a85_2($global,$scope,$scope,JS::toString(\'Math\',$global),151,11,\'<image>/04_array.js\');$_Math=&$x535[0];list(,$WMath,$SMath,$UMath)=$x535;if($UMath){unset($_ReferenceError,$WReferenceError,$SReferenceError,$UReferenceError);$x536=_61c60c86aef535e2824e55eb30517a85_2($global,$scope,$scope,JS::toString(\'ReferenceError\',$global),151,11,\'<image>/04_array.js\');$_ReferenceError=&$x536[0];list(,$WReferenceError,$SReferenceError,$UReferenceError)=$x536;$x537=$_ReferenceError->call;$global->trace[++$global->trace_sp]=array(\'<image>/04_array.js\',151,11);$x538=$x537($global,$global,$_ReferenceError,array(\'Math is not defined\'),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);if(isset($x538->class)&&$x538->class===\'Error\'&&!isset($x538->properties[\'file\'])&&!isset($x538->properties[\'line\'])&&!isset($x538->properties[\'column\'])){$x538->properties[\'file\']=\'<image>/04_array.js\';$x538->properties[\'line\']=151;$x538->properties[\'column\']=11;$x538->attributes[\'file\']=$x538->attributes[\'line\']=$x538->attributes[\'column\']=0;}throw new JSException($x538,151,11,\'<image>/04_array.js\');}if($_Math===JS::$undefined||$_Math===NULL){unset($_TypeError,$WTypeError,$STypeError,$UTypeError);$x540=_61c60c86aef535e2824e55eb30517a85_2($global,$scope,$scope,JS::toString(\'TypeError\',$global),151,19,\'<image>/04_array.js\');$_TypeError=&$x540[0];list(,$WTypeError,$STypeError,$UTypeError)=$x540;$x541=$_TypeError->call;$global->trace[++$global->trace_sp]=array(\'<image>/04_array.js\',151,19);$x542=$x541($global,$global,$_TypeError,array(\'Cannot call function on undefined/null.\'),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);if(isset($x542->class)&&$x542->class===\'Error\'&&!isset($x542->properties[\'file\'])&&!isset($x542->properties[\'line\'])&&!isset($x542->properties[\'column\'])){$x542->properties[\'file\']=\'<image>/04_array.js\';$x542->properties[\'line\']=151;$x542->properties[\'column\']=19;$x542->attributes[\'file\']=$x542->attributes[\'line\']=$x542->attributes[\'column\']=0;}throw new JSException($x542,151,19,\'<image>/04_array.js\');}$x539=JS::toObject($_Math,$global);unset($x543,$W543,$S543,$U543);$x544=_61c60c86aef535e2824e55eb30517a85_4($global,$scope,$x539,JS::toString(\'max\',$global),151,19,\'<image>/04_array.js\');$x543=&$x544[0];list(,$W543,$S543,$U543)=$x544;unset($x547,$W547,$S547,$U547);$x548=_61c60c86aef535e2824e55eb30517a85_4($global,$scope,$leThis,JS::toString(\'length\',$global),151,24,\'<image>/04_array.js\');$x547=&$x548[0];list(,$W547,$S547,$U547)=$x548;$x545=JS::toPrimitive($x547,$global);$x546=JS::toPrimitive($_start,$global);if(!(is_object($x543)&&isset($x543->call))){unset($_TypeError,$WTypeError,$STypeError,$UTypeError);$x551=_61c60c86aef535e2824e55eb30517a85_2($global,$scope,$scope,JS::toString(\'TypeError\',$global),151,19,\'<image>/04_array.js\');$_TypeError=&$x551[0];list(,$WTypeError,$STypeError,$UTypeError)=$x551;$x552=$_TypeError->call;$global->trace[++$global->trace_sp]=array(\'<image>/04_array.js\',151,19);$x553=$x552($global,$global,$_TypeError,array(\'Trying to call what is not a function.\'),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);if(isset($x553->class)&&$x553->class===\'Error\'&&!isset($x553->properties[\'file\'])&&!isset($x553->properties[\'line\'])&&!isset($x553->properties[\'column\'])){$x553->properties[\'file\']=\'<image>/04_array.js\';$x553->properties[\'line\']=151;$x553->properties[\'column\']=19;$x553->attributes[\'file\']=$x553->attributes[\'line\']=$x553->attributes[\'column\']=0;}throw new JSException($x553,151,19,\'<image>/04_array.js\');}$x549=$x543->call;$global->trace[++$global->trace_sp]=array(\'<image>/04_array.js\',151,19);$x550=$x549($global,$x539,$x543,array((is_string($x545)||is_string($x546)?JS::toString($x545,$global).JS::toString($x546,$global):JS::toNumber($x545,$global)+JS::toNumber($x546,$global)),0.0),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);if($Ustart){$global->properties[\'start\']=$_start;$_start=&$global->properties[\'start\'];}$_start=$x550;}$x554=(((gettype($_end)===gettype(JS::$undefined)&&$_end===JS::$undefined))||(((is_float($_end)||is_int($_end))&&(is_float(JS::$undefined)||is_int(JS::$undefined)))&&$_end==JS::$undefined));if(JS::toBoolean($x554,$global)){unset($x555,$W555,$S555,$U555);$x556=_61c60c86aef535e2824e55eb30517a85_4($global,$scope,$leThis,JS::toString(\'length\',$global),155,13,\'<image>/04_array.js\');$x555=&$x556[0];list(,$W555,$S555,$U555)=$x556;if($Uend){$global->properties[\'end\']=$_end;$_end=&$global->properties[\'end\'];}$_end=$x555;}$x557=JS::toPrimitive($_end,$global);$x558=JS::toPrimitive(0.0,$global);$x559=(is_string($x557)&&is_string($x558)?strcmp($x557,$x558)<0:(!is_nan($x560=JS::toNumber($x557,$global))&&!is_nan($x561=JS::toNumber($x558,$global))&&$x560<$x561));if(JS::toBoolean($x559,$global)){unset($x564,$W564,$S564,$U564);$x565=_61c60c86aef535e2824e55eb30517a85_4($global,$scope,$leThis,JS::toString(\'length\',$global),159,13,\'<image>/04_array.js\');$x564=&$x565[0];list(,$W564,$S564,$U564)=$x565;$x562=JS::toPrimitive($x564,$global);$x563=JS::toPrimitive($_end,$global);$x566=(is_string($x562)||is_string($x563)?JS::toString($x562,$global).JS::toString($x563,$global):JS::toNumber($x562,$global)+JS::toNumber($x563,$global));if($Uend){$global->properties[\'end\']=$_end;$_end=&$global->properties[\'end\'];}$_end=$x566;}$x567=clone JS::$arrayTemplate;$x567->properties[\'length\']=0;$x567->attributes[\'length\']=JS::WRITABLE;$scope->properties[\'newArray\']=JS::$undefined;$_newArray=&$scope->properties[\'newArray\'];$UnewArray=FALSE;$_newArray=$x567;for($x568=0;;++$x568){if($x568!==0){$x569=++$_start;}$x570=JS::toPrimitive($_start,$global);$x571=JS::toPrimitive($_end,$global);$x572=(is_string($x570)&&is_string($x571)?strcmp($x570,$x571)<0:(!is_nan($x573=JS::toNumber($x570,$global))&&!is_nan($x574=JS::toNumber($x571,$global))&&$x573<$x574));if(!JS::toBoolean($x572,$global)){break;}if($_newArray===JS::$undefined||$_newArray===NULL){unset($_TypeError,$WTypeError,$STypeError,$UTypeError);$x576=_61c60c86aef535e2824e55eb30517a85_2($global,$scope,$scope,JS::toString(\'TypeError\',$global),165,16,\'<image>/04_array.js\');$_TypeError=&$x576[0];list(,$WTypeError,$STypeError,$UTypeError)=$x576;$x577=$_TypeError->call;$global->trace[++$global->trace_sp]=array(\'<image>/04_array.js\',165,16);$x578=$x577($global,$global,$_TypeError,array(\'Cannot call function on undefined/null.\'),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);if(isset($x578->class)&&$x578->class===\'Error\'&&!isset($x578->properties[\'file\'])&&!isset($x578->properties[\'line\'])&&!isset($x578->properties[\'column\'])){$x578->properties[\'file\']=\'<image>/04_array.js\';$x578->properties[\'line\']=165;$x578->properties[\'column\']=16;$x578->attributes[\'file\']=$x578->attributes[\'line\']=$x578->attributes[\'column\']=0;}throw new JSException($x578,165,16,\'<image>/04_array.js\');}$x575=JS::toObject($_newArray,$global);unset($x579,$W579,$S579,$U579);$x580=_61c60c86aef535e2824e55eb30517a85_4($global,$scope,$x575,JS::toString(\'push\',$global),165,16,\'<image>/04_array.js\');$x579=&$x580[0];list(,$W579,$S579,$U579)=$x580;unset($x581,$W581,$S581,$U581);$x582=_61c60c86aef535e2824e55eb30517a85_4($global,$scope,$leThis,JS::toString($_start,$global),165,21,\'<image>/04_array.js\');$x581=&$x582[0];list(,$W581,$S581,$U581)=$x582;if(!(is_object($x579)&&isset($x579->call))){unset($_TypeError,$WTypeError,$STypeError,$UTypeError);$x585=_61c60c86aef535e2824e55eb30517a85_2($global,$scope,$scope,JS::toString(\'TypeError\',$global),165,16,\'<image>/04_array.js\');$_TypeError=&$x585[0];list(,$WTypeError,$STypeError,$UTypeError)=$x585;$x586=$_TypeError->call;$global->trace[++$global->trace_sp]=array(\'<image>/04_array.js\',165,16);$x587=$x586($global,$global,$_TypeError,array(\'Trying to call what is not a function.\'),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);if(isset($x587->class)&&$x587->class===\'Error\'&&!isset($x587->properties[\'file\'])&&!isset($x587->properties[\'line\'])&&!isset($x587->properties[\'column\'])){$x587->properties[\'file\']=\'<image>/04_array.js\';$x587->properties[\'line\']=165;$x587->properties[\'column\']=16;$x587->attributes[\'file\']=$x587->attributes[\'line\']=$x587->attributes[\'column\']=0;}throw new JSException($x587,165,16,\'<image>/04_array.js\');}$x583=$x579->call;$global->trace[++$global->trace_sp]=array(\'<image>/04_array.js\',165,16);$x584=$x583($global,$x575,$x579,array($x581),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);}return$_newArray;return JS::$undefined;}', "\n";
function _61c60c86aef535e2824e55eb30517a85_15($global, $leThis, $fn, $args, $constructor = FALSE) {
...
unset($_TypeError, $WTypeError, $STypeError, $UTypeError);
$x632 = _61c60c86aef535e2824e55eb30517a85_2($global, $scope, $scope, JS::toString('TypeError', $global), 192, 13, '<image>/04_array.js');
$_TypeError =& $x632[0]; list(,$WTypeError,$STypeError,$UTypeError) = $x632;
if ($UTypeError) {
unset($_ReferenceError, $WReferenceError, $SReferenceError, $UReferenceError);
$x633 = _61c60c86aef535e2824e55eb30517a85_2($global, $scope, $scope, JS::toString('ReferenceError', $global), 192, 13, '<image>/04_array.js');
...
$x637 = _61c60c86aef535e2824e55eb30517a85_4($global, $scope, $_TypeError, JS::toString('prototype', $global), 192, 9, '<image>/04_array.js');
...
echo 'function _61c60c86aef535e2824e55eb30517a85_15($global,$leThis,$fn,$args,$constructor=FALSE){if(isset($fn->boundThis)&&!$constructor){$leThis=$fn->boundThis;}if(isset($fn->boundArgs)){$args=array_merge($fn->boundArgs,$args);}$scope=clone JS::$emptyScope;$scope->up=$fn->scope;$scope->properties[\'arguments\']=clone JS::$argumentsTemplate;$x605=&$scope->properties[\'arguments\'];$x605->properties[\'length\']=count($args);foreach($args as$i=>$arg){$x605->properties[$i]=$args[$i];$x605->attributes[$i]=JS::WRITABLE|JS::ENUMERABLE|JS::CONFIGURABLE;}$scope->properties[\'a\']=array_key_exists(0,$args)?$args[0]:JS::$undefined;$_a=&$scope->properties[\'a\'];$Ua=FALSE;$scope->properties[\'b\']=array_key_exists(1,$args)?$args[1]:JS::$undefined;$_b=&$scope->properties[\'b\'];$Ub=FALSE;$global->scope[++$global->scope_sp]=$scope;$x608=$_a;$x608=($x608===JS::$undefined?\'undefined\':(is_int($x608)||is_float($x608)?\'number\':(is_bool($x608)?\'boolean\':(is_string($x608)?\'string\':(is_object($x608)&&isset($x608->call)?\'function\':\'object\')))));$x607=(((gettype($x608)===gettype(\'string\')&&$x608===\'string\'))||(((is_float($x608)||is_int($x608))&&(is_float(\'string\')||is_int(\'string\')))&&$x608==\'string\'));$x606=$x607;if(!JS::toBoolean($x606,$global)){$x610=$_b;$x610=($x610===JS::$undefined?\'undefined\':(is_int($x610)||is_float($x610)?\'number\':(is_bool($x610)?\'boolean\':(is_string($x610)?\'string\':(is_object($x610)&&isset($x610->call)?\'function\':\'object\')))));$x609=(((gettype($x610)===gettype(\'string\')&&$x610===\'string\'))||(((is_float($x610)||is_int($x610))&&(is_float(\'string\')||is_int(\'string\')))&&$x610==\'string\'));$x606=$x609;}if(JS::toBoolean($x606,$global)){$x611=JS::toString($_a,$global);if($Ua){$global->properties[\'a\']=$_a;$_a=&$global->properties[\'a\'];}$_a=$x611;$x612=JS::toString($_b,$global);if($Ub){$global->properties[\'b\']=$_b;$_b=&$global->properties[\'b\'];}$_b=$x612;$x613=JS::toPrimitive($_a,$global);$x614=JS::toPrimitive($_b,$global);$x615=(is_string($x613)&&is_string($x614)?strcmp($x613,$x614)<0:(!is_nan($x616=JS::toNumber($x613,$global))&&!is_nan($x617=JS::toNumber($x614,$global))&&$x616<$x617));if(JS::toBoolean($x615,$global)){return(-1.0*JS::toNumber(1.0,$global));}else{$x618=JS::toPrimitive($_a,$global);$x619=JS::toPrimitive($_b,$global);$x620=(is_string($x619)&&is_string($x618)?strcmp($x619,$x618)<0:(!is_nan($x621=JS::toNumber($x619,$global))&&!is_nan($x622=JS::toNumber($x618,$global))&&$x621<$x622));if(JS::toBoolean($x620,$global)){return 1.0;}else{return 0.0;}}}else{$x625=$_a;$x625=($x625===JS::$undefined?\'undefined\':(is_int($x625)||is_float($x625)?\'number\':(is_bool($x625)?\'boolean\':(is_string($x625)?\'string\':(is_object($x625)&&isset($x625->call)?\'function\':\'object\')))));$x624=(((gettype($x625)===gettype(\'number\')&&$x625===\'number\'))||(((is_float($x625)||is_int($x625))&&(is_float(\'number\')||is_int(\'number\')))&&$x625==\'number\'));$x623=$x624;if(!JS::toBoolean($x623,$global)){$x627=$_b;$x627=($x627===JS::$undefined?\'undefined\':(is_int($x627)||is_float($x627)?\'number\':(is_bool($x627)?\'boolean\':(is_string($x627)?\'string\':(is_object($x627)&&isset($x627->call)?\'function\':\'object\')))));$x626=(((gettype($x627)===gettype(\'number\')&&$x627===\'number\'))||(((is_float($x627)||is_int($x627))&&(is_float(\'number\')||is_int(\'number\')))&&$x627==\'number\'));$x623=$x626;}if(JS::toBoolean($x623,$global)){$x628=JS::toNumber($_a,$global);if($Ua){$global->properties[\'a\']=$_a;$_a=&$global->properties[\'a\'];}$_a=$x628;$x629=JS::toNumber($_b,$global);if($Ub){$global->properties[\'b\']=$_b;$_b=&$global->properties[\'b\'];}$_b=$x629;return(JS::toNumber($_a,$global)-JS::toNumber($_b,$global));}}unset($_TypeError,$WTypeError,$STypeError,$UTypeError);$x632=_61c60c86aef535e2824e55eb30517a85_2($global,$scope,$scope,JS::toString(\'TypeError\',$global),192,13,\'<image>/04_array.js\');$_TypeError=&$x632[0];list(,$WTypeError,$STypeError,$UTypeError)=$x632;if($UTypeError){unset($_ReferenceError,$WReferenceError,$SReferenceError,$UReferenceError);$x633=_61c60c86aef535e2824e55eb30517a85_2($global,$scope,$scope,JS::toString(\'ReferenceError\',$global),192,13,\'<image>/04_array.js\');$_ReferenceError=&$x633[0];list(,$WReferenceError,$SReferenceError,$UReferenceError)=$x633;$x634=$_ReferenceError->call;$global->trace[++$global->trace_sp]=array(\'<image>/04_array.js\',192,13);$x635=$x634($global,$global,$_ReferenceError,array(\'TypeError is not defined\'),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);if(isset($x635->class)&&$x635->class===\'Error\'&&!isset($x635->properties[\'file\'])&&!isset($x635->properties[\'line\'])&&!isset($x635->properties[\'column\'])){$x635->properties[\'file\']=\'<image>/04_array.js\';$x635->properties[\'line\']=192;$x635->properties[\'column\']=13;$x635->attributes[\'file\']=$x635->attributes[\'line\']=$x635->attributes[\'column\']=0;}throw new JSException($x635,192,13,\'<image>/04_array.js\');}$x630=clone JS::$objectTemplate;unset($x636,$W636,$S636,$U636);$x637=_61c60c86aef535e2824e55eb30517a85_4($global,$scope,$_TypeError,JS::toString(\'prototype\',$global),192,9,\'<image>/04_array.js\');$x636=&$x637[0];list(,$W636,$S636,$U636)=$x637;$x631=$x636;$x630->prototype=$x631;if(!(is_object($_TypeError)&&isset($_TypeError->call))){$x640=$_TypeError->call;$global->trace[++$global->trace_sp]=array(\'<image>/04_array.js\',192,9);$x641=$x640($global,$global,$_TypeError,array(\'Trying to call what is not a function.\'),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);if(isset($x641->class)&&$x641->class===\'Error\'&&!isset($x641->properties[\'file\'])&&!isset($x641->properties[\'line\'])&&!isset($x641->properties[\'column\'])){$x641->properties[\'file\']=\'<image>/04_array.js\';$x641->properties[\'line\']=192;$x641->properties[\'column\']=9;$x641->attributes[\'file\']=$x641->attributes[\'line\']=$x641->attributes[\'column\']=0;}throw new JSException($x641,192,9,\'<image>/04_array.js\');}$x638=$_TypeError->call;$global->trace[++$global->trace_sp]=array(\'<image>/04_array.js\',192,9);$x639=$x638($global,$x630,$_TypeError,array(\'Unsortable values in array.\'),true);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);$x631=$x639;if(is_object($x631)&&$x631!==JS::$undefined){$x630=$x631;}if(isset($x630->class)&&$x630->class===\'Error\'&&!isset($x630->properties[\'file\'])&&!isset($x630->properties[\'line\'])&&!isset($x630->properties[\'column\'])){$x630->properties[\'file\']=\'<image>/04_array.js\';$x630->properties[\'line\']=192;$x630->properties[\'column\']=3;$x630->attributes[\'file\']=$x630->attributes[\'line\']=$x630->attributes[\'column\']=0;}throw new JSException($x630,192,3,\'<image>/04_array.js\');return JS::$undefined;}', "\n";
function _61c60c86aef535e2824e55eb30517a85_14($global, $leThis, $fn, $args, $constructor = FALSE) {
...
$x642 = clone JS::$functionTemplate; $x642->call = '_61c60c86aef535e2824e55eb30517a85_15'; $x642->parameters = array (
  0 => 'a',
  1 => 'b',
...
$x647 = _61c60c86aef535e2824e55eb30517a85_4($global, $scope, $leThis, JS::toString('length', $global), 195, 10, '<image>/04_array.js');
$x646 =& $x647[0]; list(,$W646,$S646,$U646) = $x647;
$x643 = JS::toPrimitive($x646, $global);
$x644 = JS::toPrimitive(2.0, $global);
...
$x653 = _61c60c86aef535e2824e55eb30517a85_4($global, $scope, $leThis, JS::toString(0.0, $global), 201, 14, '<image>/04_array.js');
...
$x656 = _61c60c86aef535e2824e55eb30517a85_4($global, $scope, $leThis, JS::toString('length', $global), 203, 26, '<image>/04_array.js');
...
$x667 = _61c60c86aef535e2824e55eb30517a85_4($global, $scope, $leThis, JS::toString($_i, $global), 204, 21, '<image>/04_array.js');
$x666 =& $x667[0]; list(,$W666,$S666,$U666) = $x667;
if (!(is_object($_compareFn) && isset($_compareFn->call))) { 
unset($_TypeError, $WTypeError, $STypeError, $UTypeError);
$x670 = _61c60c86aef535e2824e55eb30517a85_2($global, $scope, $scope, JS::toString('TypeError', $global), 204, 16, '<image>/04_array.js');
...
$x664 = JS::toPrimitive(0.0, $global);
...
unset($_TypeError, $WTypeError, $STypeError, $UTypeError);
$x676 = _61c60c86aef535e2824e55eb30517a85_2($global, $scope, $scope, JS::toString('TypeError', $global), 205, 16, '<image>/04_array.js');
...
$x680 = _61c60c86aef535e2824e55eb30517a85_4($global, $scope, $x675, JS::toString('push', $global), 205, 16, '<image>/04_array.js');
$x679 =& $x680[0]; list(,$W679,$S679,$U679) = $x680;
unset($x681, $W681, $S681, $U681);
$x682 = _61c60c86aef535e2824e55eb30517a85_4($global, $scope, $leThis, JS::toString($_i, $global), 205, 21, '<image>/04_array.js');
$x681 =& $x682[0]; list(,$W681,$S681,$U681) = $x682;
if (!(is_object($x679) && isset($x679->call))) { 
unset($_TypeError, $WTypeError, $STypeError, $UTypeError);
$x685 = _61c60c86aef535e2824e55eb30517a85_2($global, $scope, $scope, JS::toString('TypeError', $global), 205, 16, '<image>/04_array.js');
...
unset($_TypeError, $WTypeError, $STypeError, $UTypeError);
$x689 = _61c60c86aef535e2824e55eb30517a85_2($global, $scope, $scope, JS::toString('TypeError', $global), 207, 15, '<image>/04_array.js');
...
$x693 = _61c60c86aef535e2824e55eb30517a85_4($global, $scope, $x688, JS::toString('push', $global), 207, 15, '<image>/04_array.js');
$x692 =& $x693[0]; list(,$W692,$S692,$U692) = $x693;
unset($x694, $W694, $S694, $U694);
$x695 = _61c60c86aef535e2824e55eb30517a85_4($global, $scope, $leThis, JS::toString($_i, $global), 207, 20, '<image>/04_array.js');
$x694 =& $x695[0]; list(,$W694,$S694,$U694) = $x695;
if (!(is_object($x692) && isset($x692->call))) { 
unset($_TypeError, $WTypeError, $STypeError, $UTypeError);
$x698 = _61c60c86aef535e2824e55eb30517a85_2($global, $scope, $scope, JS::toString('TypeError', $global), 207, 15, '<image>/04_array.js');
...
if ($_smaller === JS::$undefined || $_smaller === NULL) {
unset($_TypeError, $WTypeError, $STypeError, $UTypeError);
$x702 = _61c60c86aef535e2824e55eb30517a85_2($global, $scope, $scope, JS::toString('TypeError', $global), 211, 27, '<image>/04_array.js');
...
$x706 = _61c60c86aef535e2824e55eb30517a85_4($global, $scope, $x701, JS::toString('sort', $global), 211, 27, '<image>/04_array.js');
$x705 =& $x706[0]; list(,$W705,$S705,$U705) = $x706;
if (!(is_object($x705) && isset($x705->call))) { 
unset($_TypeError, $WTypeError, $STypeError, $UTypeError);
$x709 = _61c60c86aef535e2824e55eb30517a85_2($global, $scope, $scope, JS::toString('TypeError', $global), 211, 27, '<image>/04_array.js');
...
unset($_TypeError, $WTypeError, $STypeError, $UTypeError);
$x713 = _61c60c86aef535e2824e55eb30517a85_2($global, $scope, $scope, JS::toString('TypeError', $global), 211, 45, '<image>/04_array.js');
...
$x717 = _61c60c86aef535e2824e55eb30517a85_4($global, $scope, $x712, JS::toString('concat', $global), 211, 45, '<image>/04_array.js');
...
if ($_larger === JS::$undefined || $_larger === NULL) {
unset($_TypeError, $WTypeError, $STypeError, $UTypeError);
$x720 = _61c60c86aef535e2824e55eb30517a85_2($global, $scope, $scope, JS::toString('TypeError', $global), 211, 66, '<image>/04_array.js');
...
$x724 = _61c60c86aef535e2824e55eb30517a85_4($global, $scope, $x719, JS::toString('sort', $global), 211, 66, '<image>/04_array.js');
$x723 =& $x724[0]; list(,$W723,$S723,$U723) = $x724;
if (!(is_object($x723) && isset($x723->call))) { 
unset($_TypeError, $WTypeError, $STypeError, $UTypeError);
$x727 = _61c60c86aef535e2824e55eb30517a85_2($global, $scope, $scope, JS::toString('TypeError', $global), 211, 66, '<image>/04_array.js');
...
unset($_TypeError, $WTypeError, $STypeError, $UTypeError);
$x732 = _61c60c86aef535e2824e55eb30517a85_2($global, $scope, $scope, JS::toString('TypeError', $global), 211, 45, '<image>/04_array.js');
...
$x737 = _61c60c86aef535e2824e55eb30517a85_4($global, $scope, $_sorted, JS::toString('length', $global), 213, 28, '<image>/04_array.js');
...
$x745 = _61c60c86aef535e2824e55eb30517a85_4($global, $scope, $_sorted, JS::toString($_i, $global), 214, 19, '<image>/04_array.js');
$x744 =& $x745[0]; list(,$W744,$S744,$U744) = $x745;
$x746 = JS::toString($_i, $global);
if ($leThis === JS::$undefined || $leThis === NULL) {
unset($_TypeError, $WTypeError, $STypeError, $UTypeError);
$x747 = _61c60c86aef535e2824e55eb30517a85_2($global, $scope, $scope, JS::toString('TypeError', $global), 214, 11, '<image>/04_array.js');
...
$x751 = _61c60c86aef535e2824e55eb30517a85_3($global, $scope, $leThis, JS::toString($x746, $global), 214, 11, '<image>/04_array.js');
...
echo 'function _61c60c86aef535e2824e55eb30517a85_14($global,$leThis,$fn,$args,$constructor=FALSE){if(isset($fn->boundThis)&&!$constructor){$leThis=$fn->boundThis;}if(isset($fn->boundArgs)){$args=array_merge($fn->boundArgs,$args);}$scope=clone JS::$emptyScope;$scope->up=$fn->scope;$scope->properties[\'arguments\']=clone JS::$argumentsTemplate;$x602=&$scope->properties[\'arguments\'];$x602->properties[\'length\']=count($args);foreach($args as$i=>$arg){$x602->properties[$i]=$args[$i];$x602->attributes[$i]=JS::WRITABLE|JS::ENUMERABLE|JS::CONFIGURABLE;}$scope->properties[\'compareFn\']=array_key_exists(0,$args)?$args[0]:JS::$undefined;$_compareFn=&$scope->properties[\'compareFn\'];$UcompareFn=FALSE;$global->scope[++$global->scope_sp]=$scope;$x603=$_compareFn;if(!JS::toBoolean($x603,$global)){$x642=clone JS::$functionTemplate;$x642->call=\'_61c60c86aef535e2824e55eb30517a85_15\';$x642->parameters=array(0=>\'a\',1=>\'b\',);$x642->scope=$scope;$x642->properties[\'prototype\']=clone JS::$objectTemplate;$x642->attributes[\'prototype\']=JS::WRITABLE;$x642->properties[\'prototype\']->properties[\'constructor\']=$x642;$x642->properties[\'prototype\']->attributes[\'constructor\']=JS::WRITABLE|JS::CONFIGURABLE;$x642->properties[\'length\']=2;$x642->attributes[\'length\']=0;$x603=$x642;}if($UcompareFn){$global->properties[\'compareFn\']=$_compareFn;$_compareFn=&$global->properties[\'compareFn\'];}$_compareFn=$x603;unset($x646,$W646,$S646,$U646);$x647=_61c60c86aef535e2824e55eb30517a85_4($global,$scope,$leThis,JS::toString(\'length\',$global),195,10,\'<image>/04_array.js\');$x646=&$x647[0];list(,$W646,$S646,$U646)=$x647;$x643=JS::toPrimitive($x646,$global);$x644=JS::toPrimitive(2.0,$global);$x645=(is_string($x643)&&is_string($x644)?strcmp($x643,$x644)<0:(!is_nan($x648=JS::toNumber($x643,$global))&&!is_nan($x649=JS::toNumber($x644,$global))&&$x648<$x649));if(JS::toBoolean($x645,$global)){return$leThis;}$scope->properties[\'pivot\']=JS::$undefined;$_pivot=&$scope->properties[\'pivot\'];$Upivot=FALSE;$_pivot=JS::$undefined;$x650=clone JS::$arrayTemplate;$x650->properties[\'length\']=0;$x650->attributes[\'length\']=JS::WRITABLE;$scope->properties[\'smaller\']=JS::$undefined;$_smaller=&$scope->properties[\'smaller\'];$Usmaller=FALSE;$_smaller=$x650;$x651=clone JS::$arrayTemplate;$x651->properties[\'length\']=0;$x651->attributes[\'length\']=JS::WRITABLE;$scope->properties[\'larger\']=JS::$undefined;$_larger=&$scope->properties[\'larger\'];$Ularger=FALSE;$_larger=$x651;unset($x652,$W652,$S652,$U652);$x653=_61c60c86aef535e2824e55eb30517a85_4($global,$scope,$leThis,JS::toString(0.0,$global),201,14,\'<image>/04_array.js\');$x652=&$x653[0];list(,$W652,$S652,$U652)=$x653;if($Upivot){$global->properties[\'pivot\']=$_pivot;$_pivot=&$global->properties[\'pivot\'];}$_pivot=$x652;for($x654=0;;++$x654){if($x654===0){$scope->properties[\'i\']=JS::$undefined;$_i=&$scope->properties[\'i\'];$Ui=FALSE;$_i=1.0;unset($x655,$W655,$S655,$U655);$x656=_61c60c86aef535e2824e55eb30517a85_4($global,$scope,$leThis,JS::toString(\'length\',$global),203,26,\'<image>/04_array.js\');$x655=&$x656[0];list(,$W655,$S655,$U655)=$x656;$scope->properties[\'l\']=JS::$undefined;$_l=&$scope->properties[\'l\'];$Ul=FALSE;$_l=$x655;}if($x654!==0){$x657=++$_i;}$x658=JS::toPrimitive($_i,$global);$x659=JS::toPrimitive($_l,$global);$x660=(is_string($x658)&&is_string($x659)?strcmp($x658,$x659)<0:(!is_nan($x661=JS::toNumber($x658,$global))&&!is_nan($x662=JS::toNumber($x659,$global))&&$x661<$x662));if(!JS::toBoolean($x660,$global)){break;}unset($x666,$W666,$S666,$U666);$x667=_61c60c86aef535e2824e55eb30517a85_4($global,$scope,$leThis,JS::toString($_i,$global),204,21,\'<image>/04_array.js\');$x666=&$x667[0];list(,$W666,$S666,$U666)=$x667;if(!(is_object($_compareFn)&&isset($_compareFn->call))){unset($_TypeError,$WTypeError,$STypeError,$UTypeError);$x670=_61c60c86aef535e2824e55eb30517a85_2($global,$scope,$scope,JS::toString(\'TypeError\',$global),204,16,\'<image>/04_array.js\');$_TypeError=&$x670[0];list(,$WTypeError,$STypeError,$UTypeError)=$x670;$x671=$_TypeError->call;$global->trace[++$global->trace_sp]=array(\'<image>/04_array.js\',204,16);$x672=$x671($global,$global,$_TypeError,array(\'Trying to call what is not a function.\'),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);if(isset($x672->class)&&$x672->class===\'Error\'&&!isset($x672->properties[\'file\'])&&!isset($x672->properties[\'line\'])&&!isset($x672->properties[\'column\'])){$x672->properties[\'file\']=\'<image>/04_array.js\';$x672->properties[\'line\']=204;$x672->properties[\'column\']=16;$x672->attributes[\'file\']=$x672->attributes[\'line\']=$x672->attributes[\'column\']=0;}throw new JSException($x672,204,16,\'<image>/04_array.js\');}$x668=$_compareFn->call;$global->trace[++$global->trace_sp]=array(\'<image>/04_array.js\',204,16);$x669=$x668($global,$global,$_compareFn,array($x666,$_pivot),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);$x663=JS::toPrimitive($x669,$global);$x664=JS::toPrimitive(0.0,$global);$x665=(is_string($x663)&&is_string($x664)?strcmp($x663,$x664)<0:(!is_nan($x673=JS::toNumber($x663,$global))&&!is_nan($x674=JS::toNumber($x664,$global))&&$x673<$x674));if(JS::toBoolean($x665,$global)){if($_smaller===JS::$undefined||$_smaller===NULL){unset($_TypeError,$WTypeError,$STypeError,$UTypeError);$x676=_61c60c86aef535e2824e55eb30517a85_2($global,$scope,$scope,JS::toString(\'TypeError\',$global),205,16,\'<image>/04_array.js\');$_TypeError=&$x676[0];list(,$WTypeError,$STypeError,$UTypeError)=$x676;$x677=$_TypeError->call;$global->trace[++$global->trace_sp]=array(\'<image>/04_array.js\',205,16);$x678=$x677($global,$global,$_TypeError,array(\'Cannot call function on undefined/null.\'),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);if(isset($x678->class)&&$x678->class===\'Error\'&&!isset($x678->properties[\'file\'])&&!isset($x678->properties[\'line\'])&&!isset($x678->properties[\'column\'])){$x678->properties[\'file\']=\'<image>/04_array.js\';$x678->properties[\'line\']=205;$x678->properties[\'column\']=16;$x678->attributes[\'file\']=$x678->attributes[\'line\']=$x678->attributes[\'column\']=0;}throw new JSException($x678,205,16,\'<image>/04_array.js\');}$x675=JS::toObject($_smaller,$global);unset($x679,$W679,$S679,$U679);$x680=_61c60c86aef535e2824e55eb30517a85_4($global,$scope,$x675,JS::toString(\'push\',$global),205,16,\'<image>/04_array.js\');$x679=&$x680[0];list(,$W679,$S679,$U679)=$x680;unset($x681,$W681,$S681,$U681);$x682=_61c60c86aef535e2824e55eb30517a85_4($global,$scope,$leThis,JS::toString($_i,$global),205,21,\'<image>/04_array.js\');$x681=&$x682[0];list(,$W681,$S681,$U681)=$x682;if(!(is_object($x679)&&isset($x679->call))){unset($_TypeError,$WTypeError,$STypeError,$UTypeError);$x685=_61c60c86aef535e2824e55eb30517a85_2($global,$scope,$scope,JS::toString(\'TypeError\',$global),205,16,\'<image>/04_array.js\');$_TypeError=&$x685[0];list(,$WTypeError,$STypeError,$UTypeError)=$x685;$x686=$_TypeError->call;$global->trace[++$global->trace_sp]=array(\'<image>/04_array.js\',205,16);$x687=$x686($global,$global,$_TypeError,array(\'Trying to call what is not a function.\'),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);if(isset($x687->class)&&$x687->class===\'Error\'&&!isset($x687->properties[\'file\'])&&!isset($x687->properties[\'line\'])&&!isset($x687->properties[\'column\'])){$x687->properties[\'file\']=\'<image>/04_array.js\';$x687->properties[\'line\']=205;$x687->properties[\'column\']=16;$x687->attributes[\'file\']=$x687->attributes[\'line\']=$x687->attributes[\'column\']=0;}throw new JSException($x687,205,16,\'<image>/04_array.js\');}$x683=$x679->call;$global->trace[++$global->trace_sp]=array(\'<image>/04_array.js\',205,16);$x684=$x683($global,$x675,$x679,array($x681),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);}else{if($_larger===JS::$undefined||$_larger===NULL){unset($_TypeError,$WTypeError,$STypeError,$UTypeError);$x689=_61c60c86aef535e2824e55eb30517a85_2($global,$scope,$scope,JS::toString(\'TypeError\',$global),207,15,\'<image>/04_array.js\');$_TypeError=&$x689[0];list(,$WTypeError,$STypeError,$UTypeError)=$x689;$x690=$_TypeError->call;$global->trace[++$global->trace_sp]=array(\'<image>/04_array.js\',207,15);$x691=$x690($global,$global,$_TypeError,array(\'Cannot call function on undefined/null.\'),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);if(isset($x691->class)&&$x691->class===\'Error\'&&!isset($x691->properties[\'file\'])&&!isset($x691->properties[\'line\'])&&!isset($x691->properties[\'column\'])){$x691->properties[\'file\']=\'<image>/04_array.js\';$x691->properties[\'line\']=207;$x691->properties[\'column\']=15;$x691->attributes[\'file\']=$x691->attributes[\'line\']=$x691->attributes[\'column\']=0;}throw new JSException($x691,207,15,\'<image>/04_array.js\');}$x688=JS::toObject($_larger,$global);unset($x692,$W692,$S692,$U692);$x693=_61c60c86aef535e2824e55eb30517a85_4($global,$scope,$x688,JS::toString(\'push\',$global),207,15,\'<image>/04_array.js\');$x692=&$x693[0];list(,$W692,$S692,$U692)=$x693;unset($x694,$W694,$S694,$U694);$x695=_61c60c86aef535e2824e55eb30517a85_4($global,$scope,$leThis,JS::toString($_i,$global),207,20,\'<image>/04_array.js\');$x694=&$x695[0];list(,$W694,$S694,$U694)=$x695;if(!(is_object($x692)&&isset($x692->call))){unset($_TypeError,$WTypeError,$STypeError,$UTypeError);$x698=_61c60c86aef535e2824e55eb30517a85_2($global,$scope,$scope,JS::toString(\'TypeError\',$global),207,15,\'<image>/04_array.js\');$_TypeError=&$x698[0];list(,$WTypeError,$STypeError,$UTypeError)=$x698;$x699=$_TypeError->call;$global->trace[++$global->trace_sp]=array(\'<image>/04_array.js\',207,15);$x700=$x699($global,$global,$_TypeError,array(\'Trying to call what is not a function.\'),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);if(isset($x700->class)&&$x700->class===\'Error\'&&!isset($x700->properties[\'file\'])&&!isset($x700->properties[\'line\'])&&!isset($x700->properties[\'column\'])){$x700->properties[\'file\']=\'<image>/04_array.js\';$x700->properties[\'line\']=207;$x700->properties[\'column\']=15;$x700->attributes[\'file\']=$x700->attributes[\'line\']=$x700->attributes[\'column\']=0;}throw new JSException($x700,207,15,\'<image>/04_array.js\');}$x696=$x692->call;$global->trace[++$global->trace_sp]=array(\'<image>/04_array.js\',207,15);$x697=$x696($global,$x688,$x692,array($x694),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);}}if($_smaller===JS::$undefined||$_smaller===NULL){unset($_TypeError,$WTypeError,$STypeError,$UTypeError);$x702=_61c60c86aef535e2824e55eb30517a85_2($global,$scope,$scope,JS::toString(\'TypeError\',$global),211,27,\'<image>/04_array.js\');$_TypeError=&$x702[0];list(,$WTypeError,$STypeError,$UTypeError)=$x702;$x703=$_TypeError->call;$global->trace[++$global->trace_sp]=array(\'<image>/04_array.js\',211,27);$x704=$x703($global,$global,$_TypeError,array(\'Cannot call function on undefined/null.\'),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);if(isset($x704->class)&&$x704->class===\'Error\'&&!isset($x704->properties[\'file\'])&&!isset($x704->properties[\'line\'])&&!isset($x704->properties[\'column\'])){$x704->properties[\'file\']=\'<image>/04_array.js\';$x704->properties[\'line\']=211;$x704->properties[\'column\']=27;$x704->attributes[\'file\']=$x704->attributes[\'line\']=$x704->attributes[\'column\']=0;}throw new JSException($x704,211,27,\'<image>/04_array.js\');}$x701=JS::toObject($_smaller,$global);unset($x705,$W705,$S705,$U705);$x706=_61c60c86aef535e2824e55eb30517a85_4($global,$scope,$x701,JS::toString(\'sort\',$global),211,27,\'<image>/04_array.js\');$x705=&$x706[0];list(,$W705,$S705,$U705)=$x706;if(!(is_object($x705)&&isset($x705->call))){unset($_TypeError,$WTypeError,$STypeError,$UTypeError);$x709=_61c60c86aef535e2824e55eb30517a85_2($global,$scope,$scope,JS::toString(\'TypeError\',$global),211,27,\'<image>/04_array.js\');$_TypeError=&$x709[0];list(,$WTypeError,$STypeError,$UTypeError)=$x709;$x710=$_TypeError->call;$global->trace[++$global->trace_sp]=array(\'<image>/04_array.js\',211,27);$x711=$x710($global,$global,$_TypeError,array(\'Trying to call what is not a function.\'),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);if(isset($x711->class)&&$x711->class===\'Error\'&&!isset($x711->properties[\'file\'])&&!isset($x711->properties[\'line\'])&&!isset($x711->properties[\'column\'])){$x711->properties[\'file\']=\'<image>/04_array.js\';$x711->properties[\'line\']=211;$x711->properties[\'column\']=27;$x711->attributes[\'file\']=$x711->attributes[\'line\']=$x711->attributes[\'column\']=0;}throw new JSException($x711,211,27,\'<image>/04_array.js\');}$x707=$x705->call;$global->trace[++$global->trace_sp]=array(\'<image>/04_array.js\',211,27);$x708=$x707($global,$x701,$x705,array($_compareFn),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);if($x708===JS::$undefined||$x708===NULL){unset($_TypeError,$WTypeError,$STypeError,$UTypeError);$x713=_61c60c86aef535e2824e55eb30517a85_2($global,$scope,$scope,JS::toString(\'TypeError\',$global),211,45,\'<image>/04_array.js\');$_TypeError=&$x713[0];list(,$WTypeError,$STypeError,$UTypeError)=$x713;$x714=$_TypeError->call;$global->trace[++$global->trace_sp]=array(\'<image>/04_array.js\',211,45);$x715=$x714($global,$global,$_TypeError,array(\'Cannot call function on undefined/null.\'),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);if(isset($x715->class)&&$x715->class===\'Error\'&&!isset($x715->properties[\'file\'])&&!isset($x715->properties[\'line\'])&&!isset($x715->properties[\'column\'])){$x715->properties[\'file\']=\'<image>/04_array.js\';$x715->properties[\'line\']=211;$x715->properties[\'column\']=45;$x715->attributes[\'file\']=$x715->attributes[\'line\']=$x715->attributes[\'column\']=0;}throw new JSException($x715,211,45,\'<image>/04_array.js\');}$x712=JS::toObject($x708,$global);unset($x716,$W716,$S716,$U716);$x717=_61c60c86aef535e2824e55eb30517a85_4($global,$scope,$x712,JS::toString(\'concat\',$global),211,45,\'<image>/04_array.js\');$x716=&$x717[0];list(,$W716,$S716,$U716)=$x717;$x718=clone JS::$arrayTemplate;$x718->properties[\'length\']=1;$x718->attributes[\'length\']=JS::WRITABLE;$x718->properties[0]=$_pivot;$x718->attributes[0]=JS::WRITABLE|JS::ENUMERABLE|JS::CONFIGURABLE;if($_larger===JS::$undefined||$_larger===NULL){unset($_TypeError,$WTypeError,$STypeError,$UTypeError);$x720=_61c60c86aef535e2824e55eb30517a85_2($global,$scope,$scope,JS::toString(\'TypeError\',$global),211,66,\'<image>/04_array.js\');$_TypeError=&$x720[0];list(,$WTypeError,$STypeError,$UTypeError)=$x720;$x721=$_TypeError->call;$global->trace[++$global->trace_sp]=array(\'<image>/04_array.js\',211,66);$x722=$x721($global,$global,$_TypeError,array(\'Cannot call function on undefined/null.\'),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);if(isset($x722->class)&&$x722->class===\'Error\'&&!isset($x722->properties[\'file\'])&&!isset($x722->properties[\'line\'])&&!isset($x722->properties[\'column\'])){$x722->properties[\'file\']=\'<image>/04_array.js\';$x722->properties[\'line\']=211;$x722->properties[\'column\']=66;$x722->attributes[\'file\']=$x722->attributes[\'line\']=$x722->attributes[\'column\']=0;}throw new JSException($x722,211,66,\'<image>/04_array.js\');}$x719=JS::toObject($_larger,$global);unset($x723,$W723,$S723,$U723);$x724=_61c60c86aef535e2824e55eb30517a85_4($global,$scope,$x719,JS::toString(\'sort\',$global),211,66,\'<image>/04_array.js\');$x723=&$x724[0];list(,$W723,$S723,$U723)=$x724;if(!(is_object($x723)&&isset($x723->call))){unset($_TypeError,$WTypeError,$STypeError,$UTypeError);$x727=_61c60c86aef535e2824e55eb30517a85_2($global,$scope,$scope,JS::toString(\'TypeError\',$global),211,66,\'<image>/04_array.js\');$_TypeError=&$x727[0];list(,$WTypeError,$STypeError,$UTypeError)=$x727;$x728=$_TypeError->call;$global->trace[++$global->trace_sp]=array(\'<image>/04_array.js\',211,66);$x729=$x728($global,$global,$_TypeError,array(\'Trying to call what is not a function.\'),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);if(isset($x729->class)&&$x729->class===\'Error\'&&!isset($x729->properties[\'file\'])&&!isset($x729->properties[\'line\'])&&!isset($x729->properties[\'column\'])){$x729->properties[\'file\']=\'<image>/04_array.js\';$x729->properties[\'line\']=211;$x729->properties[\'column\']=66;$x729->attributes[\'file\']=$x729->attributes[\'line\']=$x729->attributes[\'column\']=0;}throw new JSException($x729,211,66,\'<image>/04_array.js\');}$x725=$x723->call;$global->trace[++$global->trace_sp]=array(\'<image>/04_array.js\',211,66);$x726=$x725($global,$x719,$x723,array($_compareFn),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);if(!(is_object($x716)&&isset($x716->call))){unset($_TypeError,$WTypeError,$STypeError,$UTypeError);$x732=_61c60c86aef535e2824e55eb30517a85_2($global,$scope,$scope,JS::toString(\'TypeError\',$global),211,45,\'<image>/04_array.js\');$_TypeError=&$x732[0];list(,$WTypeError,$STypeError,$UTypeError)=$x732;$x733=$_TypeError->call;$global->trace[++$global->trace_sp]=array(\'<image>/04_array.js\',211,45);$x734=$x733($global,$global,$_TypeError,array(\'Trying to call what is not a function.\'),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);if(isset($x734->class)&&$x734->class===\'Error\'&&!isset($x734->properties[\'file\'])&&!isset($x734->properties[\'line\'])&&!isset($x734->properties[\'column\'])){$x734->properties[\'file\']=\'<image>/04_array.js\';$x734->properties[\'line\']=211;$x734->properties[\'column\']=45;$x734->attributes[\'file\']=$x734->attributes[\'line\']=$x734->attributes[\'column\']=0;}throw new JSException($x734,211,45,\'<image>/04_array.js\');}$x730=$x716->call;$global->trace[++$global->trace_sp]=array(\'<image>/04_array.js\',211,45);$x731=$x730($global,$x712,$x716,array($x718,$x726),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);$scope->properties[\'sorted\']=JS::$undefined;$_sorted=&$scope->properties[\'sorted\'];$Usorted=FALSE;$_sorted=$x731;for($x735=0;;++$x735){if($x735===0){unset($_i);$scope->properties[\'i\']=JS::$undefined;$_i=&$scope->properties[\'i\'];$Ui=FALSE;$_i=0.0;unset($x736,$W736,$S736,$U736);$x737=_61c60c86aef535e2824e55eb30517a85_4($global,$scope,$_sorted,JS::toString(\'length\',$global),213,28,\'<image>/04_array.js\');$x736=&$x737[0];list(,$W736,$S736,$U736)=$x737;unset($_l);$scope->properties[\'l\']=JS::$undefined;$_l=&$scope->properties[\'l\'];$Ul=FALSE;$_l=$x736;}if($x735!==0){$x738=++$_i;}$x739=JS::toPrimitive($_i,$global);$x740=JS::toPrimitive($_l,$global);$x741=(is_string($x739)&&is_string($x740)?strcmp($x739,$x740)<0:(!is_nan($x742=JS::toNumber($x739,$global))&&!is_nan($x743=JS::toNumber($x740,$global))&&$x742<$x743));if(!JS::toBoolean($x741,$global)){break;}unset($x744,$W744,$S744,$U744);$x745=_61c60c86aef535e2824e55eb30517a85_4($global,$scope,$_sorted,JS::toString($_i,$global),214,19,\'<image>/04_array.js\');$x744=&$x745[0];list(,$W744,$S744,$U744)=$x745;$x746=JS::toString($_i,$global);if($leThis===JS::$undefined||$leThis===NULL){unset($_TypeError,$WTypeError,$STypeError,$UTypeError);$x747=_61c60c86aef535e2824e55eb30517a85_2($global,$scope,$scope,JS::toString(\'TypeError\',$global),214,11,\'<image>/04_array.js\');$_TypeError=&$x747[0];list(,$WTypeError,$STypeError,$UTypeError)=$x747;$x748=$_TypeError->call;$global->trace[++$global->trace_sp]=array(\'<image>/04_array.js\',214,11);$x749=$x748($global,$global,$_TypeError,array(\'Cannot assign property of undefined/null.\'),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);if(isset($x749->class)&&$x749->class===\'Error\'&&!isset($x749->properties[\'file\'])&&!isset($x749->properties[\'line\'])&&!isset($x749->properties[\'column\'])){$x749->properties[\'file\']=\'<image>/04_array.js\';$x749->properties[\'line\']=214;$x749->properties[\'column\']=11;$x749->attributes[\'file\']=$x749->attributes[\'line\']=$x749->attributes[\'column\']=0;}throw new JSException($x749,214,11,\'<image>/04_array.js\');}$leThis=JS::toObject($leThis,$global);unset($x750,$W750,$S750,$U750);$x751=_61c60c86aef535e2824e55eb30517a85_3($global,$scope,$leThis,JS::toString($x746,$global),214,11,\'<image>/04_array.js\');$x750=&$x751[0];list(,$W750,$S750,$U750)=$x751;if($U750&&(!isset($leThis->extensible)||$leThis->extensible)){$leThis->properties[$x746]=$x750;$x750=&$leThis->properties[$x746];$leThis->attributes[$x746]=JS::WRITABLE|JS::ENUMERABLE|JS::CONFIGURABLE;$U750=FALSE;$W750=TRUE;}if(isset($leThis->class)&&$leThis->class===\'Array\'){if(isset($leThis->properties[\'length\'])&&$leThis->properties[\'length\']!==JS::$undefined){$x753=$leThis->properties[\'length\'];}else{$x753=0;}}if(isset($S750)){$x754=$S750->call;$global->trace[++$global->trace_sp]=array(\'<image>/04_array.js\',214,11);$x755=$x754($global,$leThis,$S750,array($x744),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);$x752=$x755;}else{if(!$U750){$x752=$x744;if($W750){$x750=$x744;}}else{$x752=JS::$undefined;}}if(isset($leThis->class)&&$leThis->class===\'Array\'){if(is_int($_i)&&$_i>=$leThis->properties[\'length\']){$leThis->properties[\'length\']=$_i+1;}else if($x746===\'length\'&&is_int($x744)&&$x753>$x744){for($i=$x744;$i<$x753;++$i){unset($leThis->properties[$i],$leThis->attributes[$i]);}}}}return$leThis;return JS::$undefined;}', "\n";
function _61c60c86aef535e2824e55eb30517a85_16($global, $leThis, $fn, $args, $constructor = FALSE) {
...
$x775 = _61c60c86aef535e2824e55eb30517a85_4($global, $scope, $leThis, JS::toString('length', $global), 225, 22, '<image>/04_array.js');
...
$x783 = _61c60c86aef535e2824e55eb30517a85_4($global, $scope, $leThis, JS::toString($_i, $global), 226, 14, '<image>/04_array.js');
...
$_i = $x787;
unset($_arguments, $Warguments, $Sarguments, $Uarguments);
$x788 = _61c60c86aef535e2824e55eb30517a85_2($global, $scope, $scope, JS::toString('arguments', $global), 236, 19, '<image>/04_array.js');
$_arguments =& $x788[0]; list(,$Warguments,$Sarguments,$Uarguments) = $x788;
if ($Uarguments) {
unset($_ReferenceError, $WReferenceError, $SReferenceError, $UReferenceError);
$x789 = _61c60c86aef535e2824e55eb30517a85_2($global, $scope, $scope, JS::toString('ReferenceError', $global), 236, 19, '<image>/04_array.js');
...
$x793 = _61c60c86aef535e2824e55eb30517a85_4($global, $scope, $_arguments, JS::toString('length', $global), 236, 28, '<image>/04_array.js');
...
$x801 = _61c60c86aef535e2824e55eb30517a85_4($global, $scope, $_arguments, JS::toString($_i, $global), 237, 20, '<image>/04_array.js');
...
if ($leThis === JS::$undefined || $leThis === NULL) {
unset($_TypeError, $WTypeError, $STypeError, $UTypeError);
$x804 = _61c60c86aef535e2824e55eb30517a85_2($global, $scope, $scope, JS::toString('TypeError', $global), 244, 14, '<image>/04_array.js');
...
$x808 = _61c60c86aef535e2824e55eb30517a85_3($global, $scope, $leThis, JS::toString($x803, $global), 244, 14, '<image>/04_array.js');
...
if ($leThis === JS::$undefined || $leThis === NULL) {
unset($_TypeError, $WTypeError, $STypeError, $UTypeError);
$x814 = _61c60c86aef535e2824e55eb30517a85_2($global, $scope, $scope, JS::toString('TypeError', $global), 247, 12, '<image>/04_array.js');
...
$x818 = _61c60c86aef535e2824e55eb30517a85_4($global, $scope, $x813, JS::toString('push', $global), 247, 12, '<image>/04_array.js');
$x817 =& $x818[0]; list(,$W817,$S817,$U817) = $x818;
if (!(is_object($x817) && isset($x817->call))) { 
unset($_TypeError, $WTypeError, $STypeError, $UTypeError);
$x821 = _61c60c86aef535e2824e55eb30517a85_2($global, $scope, $scope, JS::toString('TypeError', $global), 247, 12, '<image>/04_array.js');
...
unset($_TypeError, $WTypeError, $STypeError, $UTypeError);
$x825 = _61c60c86aef535e2824e55eb30517a85_2($global, $scope, $scope, JS::toString('TypeError', $global), 251, 19, '<image>/04_array.js');
...
$x829 = _61c60c86aef535e2824e55eb30517a85_4($global, $scope, $x824, JS::toString('push', $global), 251, 19, '<image>/04_array.js');
$x828 =& $x829[0]; list(,$W828,$S828,$U828) = $x829;
if (!(is_object($x828) && isset($x828->call))) { 
unset($_TypeError, $WTypeError, $STypeError, $UTypeError);
$x832 = _61c60c86aef535e2824e55eb30517a85_2($global, $scope, $scope, JS::toString('TypeError', $global), 251, 19, '<image>/04_array.js');
...
echo 'function _61c60c86aef535e2824e55eb30517a85_16($global,$leThis,$fn,$args,$constructor=FALSE){if(isset($fn->boundThis)&&!$constructor){$leThis=$fn->boundThis;}if(isset($fn->boundArgs)){$args=array_merge($fn->boundArgs,$args);}$scope=clone JS::$emptyScope;$scope->up=$fn->scope;$scope->properties[\'arguments\']=clone JS::$argumentsTemplate;$x770=&$scope->properties[\'arguments\'];$x770->properties[\'length\']=count($args);foreach($args as$i=>$arg){$x770->properties[$i]=$args[$i];$x770->attributes[$i]=JS::WRITABLE|JS::ENUMERABLE|JS::CONFIGURABLE;}$scope->properties[\'start\']=array_key_exists(0,$args)?$args[0]:JS::$undefined;$_start=&$scope->properties[\'start\'];$Ustart=FALSE;$scope->properties[\'deleteCount\']=array_key_exists(1,$args)?$args[1]:JS::$undefined;$_deleteCount=&$scope->properties[\'deleteCount\'];$UdeleteCount=FALSE;$global->scope[++$global->scope_sp]=$scope;$scope->properties[\'i\']=JS::$undefined;$_i=&$scope->properties[\'i\'];$Ui=FALSE;$_i=JS::$undefined;$scope->properties[\'l\']=JS::$undefined;$_l=&$scope->properties[\'l\'];$Ul=FALSE;$_l=JS::$undefined;$scope->properties[\'item\']=JS::$undefined;$_item=&$scope->properties[\'item\'];$Uitem=FALSE;$_item=JS::$undefined;$x771=clone JS::$arrayTemplate;$x771->properties[\'length\']=0;$x771->attributes[\'length\']=JS::WRITABLE;$scope->properties[\'returnArray\']=JS::$undefined;$_returnArray=&$scope->properties[\'returnArray\'];$UreturnArray=FALSE;$_returnArray=$x771;$A=array();for($x772=0;;++$x772){if($x772===0){$x773=0.0;if($Ui){$global->properties[\'i\']=$_i;$_i=&$global->properties[\'i\'];}$_i=$x773;unset($x774,$W774,$S774,$U774);$x775=_61c60c86aef535e2824e55eb30517a85_4($global,$scope,$leThis,JS::toString(\'length\',$global),225,22,\'<image>/04_array.js\');$x774=&$x775[0];list(,$W774,$S774,$U774)=$x775;if($Ul){$global->properties[\'l\']=$_l;$_l=&$global->properties[\'l\'];}$_l=$x774;}if($x772!==0){$x776=++$_i;}$x777=JS::toPrimitive($_i,$global);$x778=JS::toPrimitive($_l,$global);$x779=(is_string($x777)&&is_string($x778)?strcmp($x777,$x778)<0:(!is_nan($x780=JS::toNumber($x777,$global))&&!is_nan($x781=JS::toNumber($x778,$global))&&$x780<$x781));if(!JS::toBoolean($x779,$global)){break;}unset($x782,$W782,$S782,$U782);$x783=_61c60c86aef535e2824e55eb30517a85_4($global,$scope,$leThis,JS::toString($_i,$global),226,14,\'<image>/04_array.js\');$x782=&$x783[0];list(,$W782,$S782,$U782)=$x783;if($Uitem){$global->properties[\'item\']=$_item;$_item=&$global->properties[\'item\'];}$_item=$x782;$A[]=$_item;if(!array_key_exists($_i,$leThis->attributes)){unset($leThis->properties[$_i]);$x784=TRUE;}else if($leThis->attributes[$_i]&JS::CONFIGURABLE){unset($leThis->properties[$_i],$leThis->attributes[$_i],$leThis->getters[$_i],$leThis->setters[$_i]);$x784=TRUE;}else{$x784=FALSE;}}$x785=(((gettype($_deleteCount)===gettype(JS::$undefined)&&$_deleteCount===JS::$undefined))||(((is_float($_deleteCount)||is_int($_deleteCount))&&(is_float(JS::$undefined)||is_int(JS::$undefined)))&&$_deleteCount==JS::$undefined));if(JS::toBoolean($x785,$global)){$C=array_splice($A,$_start);}else{$B=array();for($x786=0;;++$x786){if($x786===0){$x787=2.0;if($Ui){$global->properties[\'i\']=$_i;$_i=&$global->properties[\'i\'];}$_i=$x787;unset($_arguments,$Warguments,$Sarguments,$Uarguments);$x788=_61c60c86aef535e2824e55eb30517a85_2($global,$scope,$scope,JS::toString(\'arguments\',$global),236,19,\'<image>/04_array.js\');$_arguments=&$x788[0];list(,$Warguments,$Sarguments,$Uarguments)=$x788;if($Uarguments){unset($_ReferenceError,$WReferenceError,$SReferenceError,$UReferenceError);$x789=_61c60c86aef535e2824e55eb30517a85_2($global,$scope,$scope,JS::toString(\'ReferenceError\',$global),236,19,\'<image>/04_array.js\');$_ReferenceError=&$x789[0];list(,$WReferenceError,$SReferenceError,$UReferenceError)=$x789;$x790=$_ReferenceError->call;$global->trace[++$global->trace_sp]=array(\'<image>/04_array.js\',236,19);$x791=$x790($global,$global,$_ReferenceError,array(\'arguments is not defined\'),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);if(isset($x791->class)&&$x791->class===\'Error\'&&!isset($x791->properties[\'file\'])&&!isset($x791->properties[\'line\'])&&!isset($x791->properties[\'column\'])){$x791->properties[\'file\']=\'<image>/04_array.js\';$x791->properties[\'line\']=236;$x791->properties[\'column\']=19;$x791->attributes[\'file\']=$x791->attributes[\'line\']=$x791->attributes[\'column\']=0;}throw new JSException($x791,236,19,\'<image>/04_array.js\');}unset($x792,$W792,$S792,$U792);$x793=_61c60c86aef535e2824e55eb30517a85_4($global,$scope,$_arguments,JS::toString(\'length\',$global),236,28,\'<image>/04_array.js\');$x792=&$x793[0];list(,$W792,$S792,$U792)=$x793;if($Ul){$global->properties[\'l\']=$_l;$_l=&$global->properties[\'l\'];}$_l=$x792;}if($x786!==0){$x794=++$_i;}$x795=JS::toPrimitive($_i,$global);$x796=JS::toPrimitive($_l,$global);$x797=(is_string($x795)&&is_string($x796)?strcmp($x795,$x796)<0:(!is_nan($x798=JS::toNumber($x795,$global))&&!is_nan($x799=JS::toNumber($x796,$global))&&$x798<$x799));if(!JS::toBoolean($x797,$global)){break;}unset($x800,$W800,$S800,$U800);$x801=_61c60c86aef535e2824e55eb30517a85_4($global,$scope,$_arguments,JS::toString($_i,$global),237,20,\'<image>/04_array.js\');$x800=&$x801[0];list(,$W800,$S800,$U800)=$x801;if($Uitem){$global->properties[\'item\']=$_item;$_item=&$global->properties[\'item\'];}$_item=$x800;$B[]=$_item;}$C=array_splice($A,$_start,$_deleteCount,$B);}$x802=0.0;$x803=JS::toString(\'length\',$global);if($leThis===JS::$undefined||$leThis===NULL){unset($_TypeError,$WTypeError,$STypeError,$UTypeError);$x804=_61c60c86aef535e2824e55eb30517a85_2($global,$scope,$scope,JS::toString(\'TypeError\',$global),244,14,\'<image>/04_array.js\');$_TypeError=&$x804[0];list(,$WTypeError,$STypeError,$UTypeError)=$x804;$x805=$_TypeError->call;$global->trace[++$global->trace_sp]=array(\'<image>/04_array.js\',244,14);$x806=$x805($global,$global,$_TypeError,array(\'Cannot assign property of undefined/null.\'),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);if(isset($x806->class)&&$x806->class===\'Error\'&&!isset($x806->properties[\'file\'])&&!isset($x806->properties[\'line\'])&&!isset($x806->properties[\'column\'])){$x806->properties[\'file\']=\'<image>/04_array.js\';$x806->properties[\'line\']=244;$x806->properties[\'column\']=14;$x806->attributes[\'file\']=$x806->attributes[\'line\']=$x806->attributes[\'column\']=0;}throw new JSException($x806,244,14,\'<image>/04_array.js\');}$leThis=JS::toObject($leThis,$global);unset($x807,$W807,$S807,$U807);$x808=_61c60c86aef535e2824e55eb30517a85_3($global,$scope,$leThis,JS::toString($x803,$global),244,14,\'<image>/04_array.js\');$x807=&$x808[0];list(,$W807,$S807,$U807)=$x808;if($U807&&(!isset($leThis->extensible)||$leThis->extensible)){$leThis->properties[$x803]=$x807;$x807=&$leThis->properties[$x803];$leThis->attributes[$x803]=JS::WRITABLE|JS::ENUMERABLE|JS::CONFIGURABLE;$U807=FALSE;$W807=TRUE;}if(isset($leThis->class)&&$leThis->class===\'Array\'){if(isset($leThis->properties[\'length\'])&&$leThis->properties[\'length\']!==JS::$undefined){$x810=$leThis->properties[\'length\'];}else{$x810=0;}}if(isset($S807)){$x811=$S807->call;$global->trace[++$global->trace_sp]=array(\'<image>/04_array.js\',244,14);$x812=$x811($global,$leThis,$S807,array($x802),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);$x809=$x812;}else{if(!$U807){$x809=$x802;if($W807){$x807=$x802;}}else{$x809=JS::$undefined;}}if(isset($leThis->class)&&$leThis->class===\'Array\'){if(is_int(\'length\')&&\'length\'>=$leThis->properties[\'length\']){$leThis->properties[\'length\']=\'length\'+1;}else if($x803===\'length\'&&is_int($x802)&&$x810>$x802){for($i=$x802;$i<$x810;++$i){unset($leThis->properties[$i],$leThis->attributes[$i]);}}}foreach($A as$V){;if($leThis===JS::$undefined||$leThis===NULL){unset($_TypeError,$WTypeError,$STypeError,$UTypeError);$x814=_61c60c86aef535e2824e55eb30517a85_2($global,$scope,$scope,JS::toString(\'TypeError\',$global),247,12,\'<image>/04_array.js\');$_TypeError=&$x814[0];list(,$WTypeError,$STypeError,$UTypeError)=$x814;$x815=$_TypeError->call;$global->trace[++$global->trace_sp]=array(\'<image>/04_array.js\',247,12);$x816=$x815($global,$global,$_TypeError,array(\'Cannot call function on undefined/null.\'),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);if(isset($x816->class)&&$x816->class===\'Error\'&&!isset($x816->properties[\'file\'])&&!isset($x816->properties[\'line\'])&&!isset($x816->properties[\'column\'])){$x816->properties[\'file\']=\'<image>/04_array.js\';$x816->properties[\'line\']=247;$x816->properties[\'column\']=12;$x816->attributes[\'file\']=$x816->attributes[\'line\']=$x816->attributes[\'column\']=0;}throw new JSException($x816,247,12,\'<image>/04_array.js\');}$x813=JS::toObject($leThis,$global);unset($x817,$W817,$S817,$U817);$x818=_61c60c86aef535e2824e55eb30517a85_4($global,$scope,$x813,JS::toString(\'push\',$global),247,12,\'<image>/04_array.js\');$x817=&$x818[0];list(,$W817,$S817,$U817)=$x818;if(!(is_object($x817)&&isset($x817->call))){unset($_TypeError,$WTypeError,$STypeError,$UTypeError);$x821=_61c60c86aef535e2824e55eb30517a85_2($global,$scope,$scope,JS::toString(\'TypeError\',$global),247,12,\'<image>/04_array.js\');$_TypeError=&$x821[0];list(,$WTypeError,$STypeError,$UTypeError)=$x821;$x822=$_TypeError->call;$global->trace[++$global->trace_sp]=array(\'<image>/04_array.js\',247,12);$x823=$x822($global,$global,$_TypeError,array(\'Trying to call what is not a function.\'),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);if(isset($x823->class)&&$x823->class===\'Error\'&&!isset($x823->properties[\'file\'])&&!isset($x823->properties[\'line\'])&&!isset($x823->properties[\'column\'])){$x823->properties[\'file\']=\'<image>/04_array.js\';$x823->properties[\'line\']=247;$x823->properties[\'column\']=12;$x823->attributes[\'file\']=$x823->attributes[\'line\']=$x823->attributes[\'column\']=0;}throw new JSException($x823,247,12,\'<image>/04_array.js\');}$x819=$x817->call;$global->trace[++$global->trace_sp]=array(\'<image>/04_array.js\',247,12);$x820=$x819($global,$x813,$x817,array($V),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);}foreach($C as$I=>$V){;if($_returnArray===JS::$undefined||$_returnArray===NULL){unset($_TypeError,$WTypeError,$STypeError,$UTypeError);$x825=_61c60c86aef535e2824e55eb30517a85_2($global,$scope,$scope,JS::toString(\'TypeError\',$global),251,19,\'<image>/04_array.js\');$_TypeError=&$x825[0];list(,$WTypeError,$STypeError,$UTypeError)=$x825;$x826=$_TypeError->call;$global->trace[++$global->trace_sp]=array(\'<image>/04_array.js\',251,19);$x827=$x826($global,$global,$_TypeError,array(\'Cannot call function on undefined/null.\'),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);if(isset($x827->class)&&$x827->class===\'Error\'&&!isset($x827->properties[\'file\'])&&!isset($x827->properties[\'line\'])&&!isset($x827->properties[\'column\'])){$x827->properties[\'file\']=\'<image>/04_array.js\';$x827->properties[\'line\']=251;$x827->properties[\'column\']=19;$x827->attributes[\'file\']=$x827->attributes[\'line\']=$x827->attributes[\'column\']=0;}throw new JSException($x827,251,19,\'<image>/04_array.js\');}$x824=JS::toObject($_returnArray,$global);unset($x828,$W828,$S828,$U828);$x829=_61c60c86aef535e2824e55eb30517a85_4($global,$scope,$x824,JS::toString(\'push\',$global),251,19,\'<image>/04_array.js\');$x828=&$x829[0];list(,$W828,$S828,$U828)=$x829;if(!(is_object($x828)&&isset($x828->call))){unset($_TypeError,$WTypeError,$STypeError,$UTypeError);$x832=_61c60c86aef535e2824e55eb30517a85_2($global,$scope,$scope,JS::toString(\'TypeError\',$global),251,19,\'<image>/04_array.js\');$_TypeError=&$x832[0];list(,$WTypeError,$STypeError,$UTypeError)=$x832;$x833=$_TypeError->call;$global->trace[++$global->trace_sp]=array(\'<image>/04_array.js\',251,19);$x834=$x833($global,$global,$_TypeError,array(\'Trying to call what is not a function.\'),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);if(isset($x834->class)&&$x834->class===\'Error\'&&!isset($x834->properties[\'file\'])&&!isset($x834->properties[\'line\'])&&!isset($x834->properties[\'column\'])){$x834->properties[\'file\']=\'<image>/04_array.js\';$x834->properties[\'line\']=251;$x834->properties[\'column\']=19;$x834->attributes[\'file\']=$x834->attributes[\'line\']=$x834->attributes[\'column\']=0;}throw new JSException($x834,251,19,\'<image>/04_array.js\');}$x830=$x828->call;$global->trace[++$global->trace_sp]=array(\'<image>/04_array.js\',251,19);$x831=$x830($global,$x824,$x828,array($V),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);}return$_returnArray;return JS::$undefined;}', "\n";
function _61c60c86aef535e2824e55eb30517a85_17($global, $leThis, $fn, $args, $constructor = FALSE) {
...
$x852 = _61c60c86aef535e2824e55eb30517a85_4($global, $scope, $leThis, JS::toString('length', $global), 258, 19, '<image>/04_array.js');
$x851 =& $x852[0]; list(,$W851,$S851,$U851) = $x852;
$scope->properties['i'] = JS::$undefined; $_i =& $scope->properties['i'];
$Ui = FALSE;
$_i = (JS::toNumber($x851, $global) - JS::toNumber(1.0, $global));
}
if ($x850 !== 0) {
$x853 = --$_i;
}
$x854 = JS::toPrimitive($_i, $global);
$x855 = JS::toPrimitive(0.0, $global);
...
$x860 = _61c60c86aef535e2824e55eb30517a85_4($global, $scope, $leThis, JS::toString($_i, $global), 259, 36, '<image>/04_array.js');
$x859 =& $x860[0]; list(,$W859,$S859,$U859) = $x860;
unset($_arguments, $Warguments, $Sarguments, $Uarguments);
$x863 = _61c60c86aef535e2824e55eb30517a85_2($global, $scope, $scope, JS::toString('arguments', $global), 259, 12, '<image>/04_array.js');
$_arguments =& $x863[0]; list(,$Warguments,$Sarguments,$Uarguments) = $x863;
if ($Uarguments) {
unset($_ReferenceError, $WReferenceError, $SReferenceError, $UReferenceError);
$x864 = _61c60c86aef535e2824e55eb30517a85_2($global, $scope, $scope, JS::toString('ReferenceError', $global), 259, 12, '<image>/04_array.js');
...
$x868 = _61c60c86aef535e2824e55eb30517a85_4($global, $scope, $_arguments, JS::toString('length', $global), 259, 21, '<image>/04_array.js');
...
if ($leThis === JS::$undefined || $leThis === NULL) {
unset($_TypeError, $WTypeError, $STypeError, $UTypeError);
$x870 = _61c60c86aef535e2824e55eb30517a85_2($global, $scope, $scope, JS::toString('TypeError', $global), 259, 30, '<image>/04_array.js');
...
$x874 = _61c60c86aef535e2824e55eb30517a85_3($global, $scope, $leThis, JS::toString($x869, $global), 259, 30, '<image>/04_array.js');
...
$_i = 0.0;
unset($_arguments, $Warguments, $Sarguments, $Uarguments);
$x880 = _61c60c86aef535e2824e55eb30517a85_2($global, $scope, $scope, JS::toString('arguments', $global), 262, 22, '<image>/04_array.js');
$_arguments =& $x880[0]; list(,$Warguments,$Sarguments,$Uarguments) = $x880;
if ($Uarguments) {
unset($_ReferenceError, $WReferenceError, $SReferenceError, $UReferenceError);
$x881 = _61c60c86aef535e2824e55eb30517a85_2($global, $scope, $scope, JS::toString('ReferenceError', $global), 262, 22, '<image>/04_array.js');
...
$x885 = _61c60c86aef535e2824e55eb30517a85_4($global, $scope, $_arguments, JS::toString('length', $global), 262, 31, '<image>/04_array.js');
...
$x893 = _61c60c86aef535e2824e55eb30517a85_4($global, $scope, $_arguments, JS::toString($_i, $global), 263, 22, '<image>/04_array.js');
$x892 =& $x893[0]; list(,$W892,$S892,$U892) = $x893;
$x894 = JS::toString($_i, $global);
if ($leThis === JS::$undefined || $leThis === NULL) {
unset($_TypeError, $WTypeError, $STypeError, $UTypeError);
$x895 = _61c60c86aef535e2824e55eb30517a85_2($global, $scope, $scope, JS::toString('TypeError', $global), 263, 11, '<image>/04_array.js');
...
$x899 = _61c60c86aef535e2824e55eb30517a85_3($global, $scope, $leThis, JS::toString($x894, $global), 263, 11, '<image>/04_array.js');
...
$x905 = _61c60c86aef535e2824e55eb30517a85_4($global, $scope, $leThis, JS::toString('length', $global), 266, 13, '<image>/04_array.js');
$x904 =& $x905[0]; list(,$W904,$S904,$U904) = $x905;
return $x904;
;
return JS::$undefined;
}
echo 'function _61c60c86aef535e2824e55eb30517a85_17($global,$leThis,$fn,$args,$constructor=FALSE){for($x850=0;;++$x850){if($x850===0){if(isset($fn->boundThis)&&!$constructor){$leThis=$fn->boundThis;}if(isset($fn->boundArgs)){$args=array_merge($fn->boundArgs,$args);}$scope=clone JS::$emptyScope;$scope->up=$fn->scope;$scope->properties[\'arguments\']=clone JS::$argumentsTemplate;$x849=&$scope->properties[\'arguments\'];$x849->properties[\'length\']=count($args);foreach($args as$i=>$arg){$x849->properties[$i]=$args[$i];$x849->attributes[$i]=JS::WRITABLE|JS::ENUMERABLE|JS::CONFIGURABLE;}$scope->properties[\'item\']=array_key_exists(0,$args)?$args[0]:JS::$undefined;$_item=&$scope->properties[\'item\'];$Uitem=FALSE;$global->scope[++$global->scope_sp]=$scope;unset($x851,$W851,$S851,$U851);$x852=_61c60c86aef535e2824e55eb30517a85_4($global,$scope,$leThis,JS::toString(\'length\',$global),258,19,\'<image>/04_array.js\');$x851=&$x852[0];list(,$W851,$S851,$U851)=$x852;$scope->properties[\'i\']=JS::$undefined;$_i=&$scope->properties[\'i\'];$Ui=FALSE;$_i=(JS::toNumber($x851,$global)-JS::toNumber(1.0,$global));}if($x850!==0){$x853=--$_i;}$x854=JS::toPrimitive($_i,$global);$x855=JS::toPrimitive(0.0,$global);$x856=!(is_string($x854)&&is_string($x855)?strcmp($x854,$x855)<0:(!is_nan($x857=JS::toNumber($x854,$global))&&!is_nan($x858=JS::toNumber($x855,$global))&&$x857<$x858));if(!JS::toBoolean($x856,$global)){break;}unset($x859,$W859,$S859,$U859);$x860=_61c60c86aef535e2824e55eb30517a85_4($global,$scope,$leThis,JS::toString($_i,$global),259,36,\'<image>/04_array.js\');$x859=&$x860[0];list(,$W859,$S859,$U859)=$x860;unset($_arguments,$Warguments,$Sarguments,$Uarguments);$x863=_61c60c86aef535e2824e55eb30517a85_2($global,$scope,$scope,JS::toString(\'arguments\',$global),259,12,\'<image>/04_array.js\');$_arguments=&$x863[0];list(,$Warguments,$Sarguments,$Uarguments)=$x863;if($Uarguments){unset($_ReferenceError,$WReferenceError,$SReferenceError,$UReferenceError);$x864=_61c60c86aef535e2824e55eb30517a85_2($global,$scope,$scope,JS::toString(\'ReferenceError\',$global),259,12,\'<image>/04_array.js\');$_ReferenceError=&$x864[0];list(,$WReferenceError,$SReferenceError,$UReferenceError)=$x864;$x865=$_ReferenceError->call;$global->trace[++$global->trace_sp]=array(\'<image>/04_array.js\',259,12);$x866=$x865($global,$global,$_ReferenceError,array(\'arguments is not defined\'),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);if(isset($x866->class)&&$x866->class===\'Error\'&&!isset($x866->properties[\'file\'])&&!isset($x866->properties[\'line\'])&&!isset($x866->properties[\'column\'])){$x866->properties[\'file\']=\'<image>/04_array.js\';$x866->properties[\'line\']=259;$x866->properties[\'column\']=12;$x866->attributes[\'file\']=$x866->attributes[\'line\']=$x866->attributes[\'column\']=0;}throw new JSException($x866,259,12,\'<image>/04_array.js\');}unset($x867,$W867,$S867,$U867);$x868=_61c60c86aef535e2824e55eb30517a85_4($global,$scope,$_arguments,JS::toString(\'length\',$global),259,21,\'<image>/04_array.js\');$x867=&$x868[0];list(,$W867,$S867,$U867)=$x868;$x861=JS::toPrimitive($_i,$global);$x862=JS::toPrimitive($x867,$global);$x869=JS::toString((is_string($x861)||is_string($x862)?JS::toString($x861,$global).JS::toString($x862,$global):JS::toNumber($x861,$global)+JS::toNumber($x862,$global)),$global);if($leThis===JS::$undefined||$leThis===NULL){unset($_TypeError,$WTypeError,$STypeError,$UTypeError);$x870=_61c60c86aef535e2824e55eb30517a85_2($global,$scope,$scope,JS::toString(\'TypeError\',$global),259,30,\'<image>/04_array.js\');$_TypeError=&$x870[0];list(,$WTypeError,$STypeError,$UTypeError)=$x870;$x871=$_TypeError->call;$global->trace[++$global->trace_sp]=array(\'<image>/04_array.js\',259,30);$x872=$x871($global,$global,$_TypeError,array(\'Cannot assign property of undefined/null.\'),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);if(isset($x872->class)&&$x872->class===\'Error\'&&!isset($x872->properties[\'file\'])&&!isset($x872->properties[\'line\'])&&!isset($x872->properties[\'column\'])){$x872->properties[\'file\']=\'<image>/04_array.js\';$x872->properties[\'line\']=259;$x872->properties[\'column\']=30;$x872->attributes[\'file\']=$x872->attributes[\'line\']=$x872->attributes[\'column\']=0;}throw new JSException($x872,259,30,\'<image>/04_array.js\');}$leThis=JS::toObject($leThis,$global);unset($x873,$W873,$S873,$U873);$x874=_61c60c86aef535e2824e55eb30517a85_3($global,$scope,$leThis,JS::toString($x869,$global),259,30,\'<image>/04_array.js\');$x873=&$x874[0];list(,$W873,$S873,$U873)=$x874;if($U873&&(!isset($leThis->extensible)||$leThis->extensible)){$leThis->properties[$x869]=$x873;$x873=&$leThis->properties[$x869];$leThis->attributes[$x869]=JS::WRITABLE|JS::ENUMERABLE|JS::CONFIGURABLE;$U873=FALSE;$W873=TRUE;}if(isset($leThis->class)&&$leThis->class===\'Array\'){if(isset($leThis->properties[\'length\'])&&$leThis->properties[\'length\']!==JS::$undefined){$x876=$leThis->properties[\'length\'];}else{$x876=0;}}if(isset($S873)){$x877=$S873->call;$global->trace[++$global->trace_sp]=array(\'<image>/04_array.js\',259,30);$x878=$x877($global,$leThis,$S873,array($x859),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);$x875=$x878;}else{if(!$U873){$x875=$x859;if($W873){$x873=$x859;}}else{$x875=JS::$undefined;}}if(isset($leThis->class)&&$leThis->class===\'Array\'){if(is_int((is_string($x861)||is_string($x862)?JS::toString($x861,$global).JS::toString($x862,$global):JS::toNumber($x861,$global)+JS::toNumber($x862,$global)))&&(is_string($x861)||is_string($x862)?JS::toString($x861,$global).JS::toString($x862,$global):JS::toNumber($x861,$global)+JS::toNumber($x862,$global))>=$leThis->properties[\'length\']){$leThis->properties[\'length\']=(is_string($x861)||is_string($x862)?JS::toString($x861,$global).JS::toString($x862,$global):JS::toNumber($x861,$global)+JS::toNumber($x862,$global))+1;}else if($x869===\'length\'&&is_int($x859)&&$x876>$x859){for($i=$x859;$i<$x876;++$i){unset($leThis->properties[$i],$leThis->attributes[$i]);}}}}for($x879=0;;++$x879){if($x879===0){unset($_i);$scope->properties[\'i\']=JS::$undefined;$_i=&$scope->properties[\'i\'];$Ui=FALSE;$_i=0.0;unset($_arguments,$Warguments,$Sarguments,$Uarguments);$x880=_61c60c86aef535e2824e55eb30517a85_2($global,$scope,$scope,JS::toString(\'arguments\',$global),262,22,\'<image>/04_array.js\');$_arguments=&$x880[0];list(,$Warguments,$Sarguments,$Uarguments)=$x880;if($Uarguments){unset($_ReferenceError,$WReferenceError,$SReferenceError,$UReferenceError);$x881=_61c60c86aef535e2824e55eb30517a85_2($global,$scope,$scope,JS::toString(\'ReferenceError\',$global),262,22,\'<image>/04_array.js\');$_ReferenceError=&$x881[0];list(,$WReferenceError,$SReferenceError,$UReferenceError)=$x881;$x882=$_ReferenceError->call;$global->trace[++$global->trace_sp]=array(\'<image>/04_array.js\',262,22);$x883=$x882($global,$global,$_ReferenceError,array(\'arguments is not defined\'),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);if(isset($x883->class)&&$x883->class===\'Error\'&&!isset($x883->properties[\'file\'])&&!isset($x883->properties[\'line\'])&&!isset($x883->properties[\'column\'])){$x883->properties[\'file\']=\'<image>/04_array.js\';$x883->properties[\'line\']=262;$x883->properties[\'column\']=22;$x883->attributes[\'file\']=$x883->attributes[\'line\']=$x883->attributes[\'column\']=0;}throw new JSException($x883,262,22,\'<image>/04_array.js\');}unset($x884,$W884,$S884,$U884);$x885=_61c60c86aef535e2824e55eb30517a85_4($global,$scope,$_arguments,JS::toString(\'length\',$global),262,31,\'<image>/04_array.js\');$x884=&$x885[0];list(,$W884,$S884,$U884)=$x885;$scope->properties[\'l\']=JS::$undefined;$_l=&$scope->properties[\'l\'];$Ul=FALSE;$_l=$x884;}if($x879!==0){$x886=++$_i;}$x887=JS::toPrimitive($_i,$global);$x888=JS::toPrimitive($_l,$global);$x889=(is_string($x887)&&is_string($x888)?strcmp($x887,$x888)<0:(!is_nan($x890=JS::toNumber($x887,$global))&&!is_nan($x891=JS::toNumber($x888,$global))&&$x890<$x891));if(!JS::toBoolean($x889,$global)){break;}unset($x892,$W892,$S892,$U892);$x893=_61c60c86aef535e2824e55eb30517a85_4($global,$scope,$_arguments,JS::toString($_i,$global),263,22,\'<image>/04_array.js\');$x892=&$x893[0];list(,$W892,$S892,$U892)=$x893;$x894=JS::toString($_i,$global);if($leThis===JS::$undefined||$leThis===NULL){unset($_TypeError,$WTypeError,$STypeError,$UTypeError);$x895=_61c60c86aef535e2824e55eb30517a85_2($global,$scope,$scope,JS::toString(\'TypeError\',$global),263,11,\'<image>/04_array.js\');$_TypeError=&$x895[0];list(,$WTypeError,$STypeError,$UTypeError)=$x895;$x896=$_TypeError->call;$global->trace[++$global->trace_sp]=array(\'<image>/04_array.js\',263,11);$x897=$x896($global,$global,$_TypeError,array(\'Cannot assign property of undefined/null.\'),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);if(isset($x897->class)&&$x897->class===\'Error\'&&!isset($x897->properties[\'file\'])&&!isset($x897->properties[\'line\'])&&!isset($x897->properties[\'column\'])){$x897->properties[\'file\']=\'<image>/04_array.js\';$x897->properties[\'line\']=263;$x897->properties[\'column\']=11;$x897->attributes[\'file\']=$x897->attributes[\'line\']=$x897->attributes[\'column\']=0;}throw new JSException($x897,263,11,\'<image>/04_array.js\');}$leThis=JS::toObject($leThis,$global);unset($x898,$W898,$S898,$U898);$x899=_61c60c86aef535e2824e55eb30517a85_3($global,$scope,$leThis,JS::toString($x894,$global),263,11,\'<image>/04_array.js\');$x898=&$x899[0];list(,$W898,$S898,$U898)=$x899;if($U898&&(!isset($leThis->extensible)||$leThis->extensible)){$leThis->properties[$x894]=$x898;$x898=&$leThis->properties[$x894];$leThis->attributes[$x894]=JS::WRITABLE|JS::ENUMERABLE|JS::CONFIGURABLE;$U898=FALSE;$W898=TRUE;}if(isset($leThis->class)&&$leThis->class===\'Array\'){if(isset($leThis->properties[\'length\'])&&$leThis->properties[\'length\']!==JS::$undefined){$x901=$leThis->properties[\'length\'];}else{$x901=0;}}if(isset($S898)){$x902=$S898->call;$global->trace[++$global->trace_sp]=array(\'<image>/04_array.js\',263,11);$x903=$x902($global,$leThis,$S898,array($x892),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);$x900=$x903;}else{if(!$U898){$x900=$x892;if($W898){$x898=$x892;}}else{$x900=JS::$undefined;}}if(isset($leThis->class)&&$leThis->class===\'Array\'){if(is_int($_i)&&$_i>=$leThis->properties[\'length\']){$leThis->properties[\'length\']=$_i+1;}else if($x894===\'length\'&&is_int($x892)&&$x901>$x892){for($i=$x892;$i<$x901;++$i){unset($leThis->properties[$i],$leThis->attributes[$i]);}}}}unset($x904,$W904,$S904,$U904);$x905=_61c60c86aef535e2824e55eb30517a85_4($global,$scope,$leThis,JS::toString(\'length\',$global),266,13,\'<image>/04_array.js\');$x904=&$x905[0];list(,$W904,$S904,$U904)=$x905;return$x904;return JS::$undefined;}', "\n";
function _61c60c86aef535e2824e55eb30517a85_18($global, $leThis, $fn, $args, $constructor = FALSE) {
...
$x923 = JS::toPrimitive(0.0, $global);
...
unset($_Math, $WMath, $SMath, $UMath);
$x927 = _61c60c86aef535e2824e55eb30517a85_2($global, $scope, $scope, JS::toString('Math', $global), 273, 10, '<image>/04_array.js');
$_Math =& $x927[0]; list(,$WMath,$SMath,$UMath) = $x927;
if ($UMath) {
unset($_ReferenceError, $WReferenceError, $SReferenceError, $UReferenceError);
$x928 = _61c60c86aef535e2824e55eb30517a85_2($global, $scope, $scope, JS::toString('ReferenceError', $global), 273, 10, '<image>/04_array.js');
...
if ($_Math === JS::$undefined || $_Math === NULL) {
unset($_TypeError, $WTypeError, $STypeError, $UTypeError);
$x932 = _61c60c86aef535e2824e55eb30517a85_2($global, $scope, $scope, JS::toString('TypeError', $global), 273, 18, '<image>/04_array.js');
...
$x936 = _61c60c86aef535e2824e55eb30517a85_4($global, $scope, $x931, JS::toString('max', $global), 273, 18, '<image>/04_array.js');
$x935 =& $x936[0]; list(,$W935,$S935,$U935) = $x936;
unset($x939, $W939, $S939, $U939);
$x940 = _61c60c86aef535e2824e55eb30517a85_4($global, $scope, $leThis, JS::toString('length', $global), 273, 23, '<image>/04_array.js');
...
unset($_TypeError, $WTypeError, $STypeError, $UTypeError);
$x943 = _61c60c86aef535e2824e55eb30517a85_2($global, $scope, $scope, JS::toString('TypeError', $global), 273, 18, '<image>/04_array.js');
...
$x941 = $x935->call;
$global->trace[++$global->trace_sp] = array('<image>/04_array.js', 273, 18);
$x942 = $x941($global, $x931, $x935, array((is_string($x937) || is_string($x938) ? JS::toString($x937, $global) . JS::toString($x938, $global) : JS::toNumber($x937, $global) + JS::toNumber($x938, $global)), 0.0), false);
unset($global->trace[$global->trace_sp--], $global->scope[$global->scope_sp--]);
if ($Ufrom) {$global->properties['from'] = $_from; $_from =& $global->properties['from']; }
$_from = $x942;;
};
...
$x948 = _61c60c86aef535e2824e55eb30517a85_4($global, $scope, $leThis, JS::toString('length', $global), 276, 29, '<image>/04_array.js');
...
$x957 = _61c60c86aef535e2824e55eb30517a85_4($global, $scope, $leThis, JS::toString($_i, $global), 277, 11, '<image>/04_array.js');
...
echo 'function _61c60c86aef535e2824e55eb30517a85_18($global,$leThis,$fn,$args,$constructor=FALSE){if(isset($fn->boundThis)&&!$constructor){$leThis=$fn->boundThis;}if(isset($fn->boundArgs)){$args=array_merge($fn->boundArgs,$args);}$scope=clone JS::$emptyScope;$scope->up=$fn->scope;$scope->properties[\'arguments\']=clone JS::$argumentsTemplate;$x920=&$scope->properties[\'arguments\'];$x920->properties[\'length\']=count($args);foreach($args as$i=>$arg){$x920->properties[$i]=$args[$i];$x920->attributes[$i]=JS::WRITABLE|JS::ENUMERABLE|JS::CONFIGURABLE;}$scope->properties[\'search\']=array_key_exists(0,$args)?$args[0]:JS::$undefined;$_search=&$scope->properties[\'search\'];$Usearch=FALSE;$scope->properties[\'from\']=array_key_exists(1,$args)?$args[1]:JS::$undefined;$_from=&$scope->properties[\'from\'];$Ufrom=FALSE;$global->scope[++$global->scope_sp]=$scope;$x921=$_from;if(!JS::toBoolean($x921,$global)){$x921=0.0;}if($Ufrom){$global->properties[\'from\']=$_from;$_from=&$global->properties[\'from\'];}$_from=$x921;$x922=JS::toPrimitive($_from,$global);$x923=JS::toPrimitive(0.0,$global);$x924=(is_string($x922)&&is_string($x923)?strcmp($x922,$x923)<0:(!is_nan($x925=JS::toNumber($x922,$global))&&!is_nan($x926=JS::toNumber($x923,$global))&&$x925<$x926));if(JS::toBoolean($x924,$global)){unset($_Math,$WMath,$SMath,$UMath);$x927=_61c60c86aef535e2824e55eb30517a85_2($global,$scope,$scope,JS::toString(\'Math\',$global),273,10,\'<image>/04_array.js\');$_Math=&$x927[0];list(,$WMath,$SMath,$UMath)=$x927;if($UMath){unset($_ReferenceError,$WReferenceError,$SReferenceError,$UReferenceError);$x928=_61c60c86aef535e2824e55eb30517a85_2($global,$scope,$scope,JS::toString(\'ReferenceError\',$global),273,10,\'<image>/04_array.js\');$_ReferenceError=&$x928[0];list(,$WReferenceError,$SReferenceError,$UReferenceError)=$x928;$x929=$_ReferenceError->call;$global->trace[++$global->trace_sp]=array(\'<image>/04_array.js\',273,10);$x930=$x929($global,$global,$_ReferenceError,array(\'Math is not defined\'),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);if(isset($x930->class)&&$x930->class===\'Error\'&&!isset($x930->properties[\'file\'])&&!isset($x930->properties[\'line\'])&&!isset($x930->properties[\'column\'])){$x930->properties[\'file\']=\'<image>/04_array.js\';$x930->properties[\'line\']=273;$x930->properties[\'column\']=10;$x930->attributes[\'file\']=$x930->attributes[\'line\']=$x930->attributes[\'column\']=0;}throw new JSException($x930,273,10,\'<image>/04_array.js\');}if($_Math===JS::$undefined||$_Math===NULL){unset($_TypeError,$WTypeError,$STypeError,$UTypeError);$x932=_61c60c86aef535e2824e55eb30517a85_2($global,$scope,$scope,JS::toString(\'TypeError\',$global),273,18,\'<image>/04_array.js\');$_TypeError=&$x932[0];list(,$WTypeError,$STypeError,$UTypeError)=$x932;$x933=$_TypeError->call;$global->trace[++$global->trace_sp]=array(\'<image>/04_array.js\',273,18);$x934=$x933($global,$global,$_TypeError,array(\'Cannot call function on undefined/null.\'),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);if(isset($x934->class)&&$x934->class===\'Error\'&&!isset($x934->properties[\'file\'])&&!isset($x934->properties[\'line\'])&&!isset($x934->properties[\'column\'])){$x934->properties[\'file\']=\'<image>/04_array.js\';$x934->properties[\'line\']=273;$x934->properties[\'column\']=18;$x934->attributes[\'file\']=$x934->attributes[\'line\']=$x934->attributes[\'column\']=0;}throw new JSException($x934,273,18,\'<image>/04_array.js\');}$x931=JS::toObject($_Math,$global);unset($x935,$W935,$S935,$U935);$x936=_61c60c86aef535e2824e55eb30517a85_4($global,$scope,$x931,JS::toString(\'max\',$global),273,18,\'<image>/04_array.js\');$x935=&$x936[0];list(,$W935,$S935,$U935)=$x936;unset($x939,$W939,$S939,$U939);$x940=_61c60c86aef535e2824e55eb30517a85_4($global,$scope,$leThis,JS::toString(\'length\',$global),273,23,\'<image>/04_array.js\');$x939=&$x940[0];list(,$W939,$S939,$U939)=$x940;$x937=JS::toPrimitive($x939,$global);$x938=JS::toPrimitive($_from,$global);if(!(is_object($x935)&&isset($x935->call))){unset($_TypeError,$WTypeError,$STypeError,$UTypeError);$x943=_61c60c86aef535e2824e55eb30517a85_2($global,$scope,$scope,JS::toString(\'TypeError\',$global),273,18,\'<image>/04_array.js\');$_TypeError=&$x943[0];list(,$WTypeError,$STypeError,$UTypeError)=$x943;$x944=$_TypeError->call;$global->trace[++$global->trace_sp]=array(\'<image>/04_array.js\',273,18);$x945=$x944($global,$global,$_TypeError,array(\'Trying to call what is not a function.\'),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);if(isset($x945->class)&&$x945->class===\'Error\'&&!isset($x945->properties[\'file\'])&&!isset($x945->properties[\'line\'])&&!isset($x945->properties[\'column\'])){$x945->properties[\'file\']=\'<image>/04_array.js\';$x945->properties[\'line\']=273;$x945->properties[\'column\']=18;$x945->attributes[\'file\']=$x945->attributes[\'line\']=$x945->attributes[\'column\']=0;}throw new JSException($x945,273,18,\'<image>/04_array.js\');}$x941=$x935->call;$global->trace[++$global->trace_sp]=array(\'<image>/04_array.js\',273,18);$x942=$x941($global,$x931,$x935,array((is_string($x937)||is_string($x938)?JS::toString($x937,$global).JS::toString($x938,$global):JS::toNumber($x937,$global)+JS::toNumber($x938,$global)),0.0),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);if($Ufrom){$global->properties[\'from\']=$_from;$_from=&$global->properties[\'from\'];}$_from=$x942;}for($x946=0;;++$x946){if($x946===0){$scope->properties[\'i\']=JS::$undefined;$_i=&$scope->properties[\'i\'];$Ui=FALSE;$_i=$_from;unset($x947,$W947,$S947,$U947);$x948=_61c60c86aef535e2824e55eb30517a85_4($global,$scope,$leThis,JS::toString(\'length\',$global),276,29,\'<image>/04_array.js\');$x947=&$x948[0];list(,$W947,$S947,$U947)=$x948;$scope->properties[\'l\']=JS::$undefined;$_l=&$scope->properties[\'l\'];$Ul=FALSE;$_l=$x947;}if($x946!==0){$x949=++$_i;}$x950=JS::toPrimitive($_i,$global);$x951=JS::toPrimitive($_l,$global);$x952=(is_string($x950)&&is_string($x951)?strcmp($x950,$x951)<0:(!is_nan($x953=JS::toNumber($x950,$global))&&!is_nan($x954=JS::toNumber($x951,$global))&&$x953<$x954));if(!JS::toBoolean($x952,$global)){break;}unset($x956,$W956,$S956,$U956);$x957=_61c60c86aef535e2824e55eb30517a85_4($global,$scope,$leThis,JS::toString($_i,$global),277,11,\'<image>/04_array.js\');$x956=&$x957[0];list(,$W956,$S956,$U956)=$x957;$x955=(((gettype($x956)===gettype($_search)&&$x956===$_search))||(((is_float($x956)||is_int($x956))&&(is_float($_search)||is_int($_search)))&&$x956==$_search));if(JS::toBoolean($x955,$global)){return$_i;}}return(-1.0*JS::toNumber(1.0,$global));return JS::$undefined;}', "\n";
function _61c60c86aef535e2824e55eb30517a85_19($global, $leThis, $fn, $args, $constructor = FALSE) {
...
$x975 = JS::toPrimitive(0.0, $global);
...
unset($_Math, $WMath, $SMath, $UMath);
$x979 = _61c60c86aef535e2824e55eb30517a85_2($global, $scope, $scope, JS::toString('Math', $global), 289, 10, '<image>/04_array.js');
$_Math =& $x979[0]; list(,$WMath,$SMath,$UMath) = $x979;
if ($UMath) {
unset($_ReferenceError, $WReferenceError, $SReferenceError, $UReferenceError);
$x980 = _61c60c86aef535e2824e55eb30517a85_2($global, $scope, $scope, JS::toString('ReferenceError', $global), 289, 10, '<image>/04_array.js');
...
if ($_Math === JS::$undefined || $_Math === NULL) {
unset($_TypeError, $WTypeError, $STypeError, $UTypeError);
$x984 = _61c60c86aef535e2824e55eb30517a85_2($global, $scope, $scope, JS::toString('TypeError', $global), 289, 18, '<image>/04_array.js');
...
$x988 = _61c60c86aef535e2824e55eb30517a85_4($global, $scope, $x983, JS::toString('max', $global), 289, 18, '<image>/04_array.js');
$x987 =& $x988[0]; list(,$W987,$S987,$U987) = $x988;
unset($x991, $W991, $S991, $U991);
$x992 = _61c60c86aef535e2824e55eb30517a85_4($global, $scope, $leThis, JS::toString('length', $global), 289, 23, '<image>/04_array.js');
...
unset($_TypeError, $WTypeError, $STypeError, $UTypeError);
$x995 = _61c60c86aef535e2824e55eb30517a85_2($global, $scope, $scope, JS::toString('TypeError', $global), 289, 18, '<image>/04_array.js');
...
$x993 = $x987->call;
$global->trace[++$global->trace_sp] = array('<image>/04_array.js', 289, 18);
$x994 = $x993($global, $x983, $x987, array((is_string($x989) || is_string($x990) ? JS::toString($x989, $global) . JS::toString($x990, $global) : JS::toNumber($x989, $global) + JS::toNumber($x990, $global)), 0.0), false);
unset($global->trace[$global->trace_sp--], $global->scope[$global->scope_sp--]);
if ($Ufrom) {$global->properties['from'] = $_from; $_from =& $global->properties['from']; }
$_from = $x994;;
};
unset($x1002, $W1002, $S1002, $U1002);
$x1003 = _61c60c86aef535e2824e55eb30517a85_4($global, $scope, $leThis, JS::toString('length', $global), 292, 10, '<image>/04_array.js');
$x1002 =& $x1003[0]; list(,$W1002,$S1002,$U1002) = $x1003;
$x999 = JS::toPrimitive($x1002, $global);
$x1000 = JS::toPrimitive(1.0, $global);
...
$x1010 = _61c60c86aef535e2824e55eb30517a85_4($global, $scope, $leThis, JS::toString('length', $global), 292, 37, '<image>/04_array.js');
...
$x1015 = _61c60c86aef535e2824e55eb30517a85_4($global, $scope, $leThis, JS::toString('length', $global), 296, 19, '<image>/04_array.js');
$x1014 =& $x1015[0]; list(,$W1014,$S1014,$U1014) = $x1015;
$scope->properties['i'] = JS::$undefined; $_i =& $scope->properties['i'];
$Ui = FALSE;
$_i = (JS::toNumber($x1014, $global) - JS::toNumber(1.0, $global));
}
if ($x1013 !== 0) {
$x1016 = --$_i;
}
...
$x1026 = _61c60c86aef535e2824e55eb30517a85_4($global, $scope, $leThis, JS::toString($_i, $global), 297, 11, '<image>/04_array.js');
...
echo 'function _61c60c86aef535e2824e55eb30517a85_19($global,$leThis,$fn,$args,$constructor=FALSE){if(isset($fn->boundThis)&&!$constructor){$leThis=$fn->boundThis;}if(isset($fn->boundArgs)){$args=array_merge($fn->boundArgs,$args);}$scope=clone JS::$emptyScope;$scope->up=$fn->scope;$scope->properties[\'arguments\']=clone JS::$argumentsTemplate;$x972=&$scope->properties[\'arguments\'];$x972->properties[\'length\']=count($args);foreach($args as$i=>$arg){$x972->properties[$i]=$args[$i];$x972->attributes[$i]=JS::WRITABLE|JS::ENUMERABLE|JS::CONFIGURABLE;}$scope->properties[\'search\']=array_key_exists(0,$args)?$args[0]:JS::$undefined;$_search=&$scope->properties[\'search\'];$Usearch=FALSE;$scope->properties[\'from\']=array_key_exists(1,$args)?$args[1]:JS::$undefined;$_from=&$scope->properties[\'from\'];$Ufrom=FALSE;$global->scope[++$global->scope_sp]=$scope;$x973=$_from;if(!JS::toBoolean($x973,$global)){$x973=0.0;}if($Ufrom){$global->properties[\'from\']=$_from;$_from=&$global->properties[\'from\'];}$_from=$x973;$x974=JS::toPrimitive($_from,$global);$x975=JS::toPrimitive(0.0,$global);$x976=(is_string($x974)&&is_string($x975)?strcmp($x974,$x975)<0:(!is_nan($x977=JS::toNumber($x974,$global))&&!is_nan($x978=JS::toNumber($x975,$global))&&$x977<$x978));if(JS::toBoolean($x976,$global)){unset($_Math,$WMath,$SMath,$UMath);$x979=_61c60c86aef535e2824e55eb30517a85_2($global,$scope,$scope,JS::toString(\'Math\',$global),289,10,\'<image>/04_array.js\');$_Math=&$x979[0];list(,$WMath,$SMath,$UMath)=$x979;if($UMath){unset($_ReferenceError,$WReferenceError,$SReferenceError,$UReferenceError);$x980=_61c60c86aef535e2824e55eb30517a85_2($global,$scope,$scope,JS::toString(\'ReferenceError\',$global),289,10,\'<image>/04_array.js\');$_ReferenceError=&$x980[0];list(,$WReferenceError,$SReferenceError,$UReferenceError)=$x980;$x981=$_ReferenceError->call;$global->trace[++$global->trace_sp]=array(\'<image>/04_array.js\',289,10);$x982=$x981($global,$global,$_ReferenceError,array(\'Math is not defined\'),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);if(isset($x982->class)&&$x982->class===\'Error\'&&!isset($x982->properties[\'file\'])&&!isset($x982->properties[\'line\'])&&!isset($x982->properties[\'column\'])){$x982->properties[\'file\']=\'<image>/04_array.js\';$x982->properties[\'line\']=289;$x982->properties[\'column\']=10;$x982->attributes[\'file\']=$x982->attributes[\'line\']=$x982->attributes[\'column\']=0;}throw new JSException($x982,289,10,\'<image>/04_array.js\');}if($_Math===JS::$undefined||$_Math===NULL){unset($_TypeError,$WTypeError,$STypeError,$UTypeError);$x984=_61c60c86aef535e2824e55eb30517a85_2($global,$scope,$scope,JS::toString(\'TypeError\',$global),289,18,\'<image>/04_array.js\');$_TypeError=&$x984[0];list(,$WTypeError,$STypeError,$UTypeError)=$x984;$x985=$_TypeError->call;$global->trace[++$global->trace_sp]=array(\'<image>/04_array.js\',289,18);$x986=$x985($global,$global,$_TypeError,array(\'Cannot call function on undefined/null.\'),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);if(isset($x986->class)&&$x986->class===\'Error\'&&!isset($x986->properties[\'file\'])&&!isset($x986->properties[\'line\'])&&!isset($x986->properties[\'column\'])){$x986->properties[\'file\']=\'<image>/04_array.js\';$x986->properties[\'line\']=289;$x986->properties[\'column\']=18;$x986->attributes[\'file\']=$x986->attributes[\'line\']=$x986->attributes[\'column\']=0;}throw new JSException($x986,289,18,\'<image>/04_array.js\');}$x983=JS::toObject($_Math,$global);unset($x987,$W987,$S987,$U987);$x988=_61c60c86aef535e2824e55eb30517a85_4($global,$scope,$x983,JS::toString(\'max\',$global),289,18,\'<image>/04_array.js\');$x987=&$x988[0];list(,$W987,$S987,$U987)=$x988;unset($x991,$W991,$S991,$U991);$x992=_61c60c86aef535e2824e55eb30517a85_4($global,$scope,$leThis,JS::toString(\'length\',$global),289,23,\'<image>/04_array.js\');$x991=&$x992[0];list(,$W991,$S991,$U991)=$x992;$x989=JS::toPrimitive($x991,$global);$x990=JS::toPrimitive($_from,$global);if(!(is_object($x987)&&isset($x987->call))){unset($_TypeError,$WTypeError,$STypeError,$UTypeError);$x995=_61c60c86aef535e2824e55eb30517a85_2($global,$scope,$scope,JS::toString(\'TypeError\',$global),289,18,\'<image>/04_array.js\');$_TypeError=&$x995[0];list(,$WTypeError,$STypeError,$UTypeError)=$x995;$x996=$_TypeError->call;$global->trace[++$global->trace_sp]=array(\'<image>/04_array.js\',289,18);$x997=$x996($global,$global,$_TypeError,array(\'Trying to call what is not a function.\'),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);if(isset($x997->class)&&$x997->class===\'Error\'&&!isset($x997->properties[\'file\'])&&!isset($x997->properties[\'line\'])&&!isset($x997->properties[\'column\'])){$x997->properties[\'file\']=\'<image>/04_array.js\';$x997->properties[\'line\']=289;$x997->properties[\'column\']=18;$x997->attributes[\'file\']=$x997->attributes[\'line\']=$x997->attributes[\'column\']=0;}throw new JSException($x997,289,18,\'<image>/04_array.js\');}$x993=$x987->call;$global->trace[++$global->trace_sp]=array(\'<image>/04_array.js\',289,18);$x994=$x993($global,$x983,$x987,array((is_string($x989)||is_string($x990)?JS::toString($x989,$global).JS::toString($x990,$global):JS::toNumber($x989,$global)+JS::toNumber($x990,$global)),0.0),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);if($Ufrom){$global->properties[\'from\']=$_from;$_from=&$global->properties[\'from\'];}$_from=$x994;}unset($x1002,$W1002,$S1002,$U1002);$x1003=_61c60c86aef535e2824e55eb30517a85_4($global,$scope,$leThis,JS::toString(\'length\',$global),292,10,\'<image>/04_array.js\');$x1002=&$x1003[0];list(,$W1002,$S1002,$U1002)=$x1003;$x999=JS::toPrimitive($x1002,$global);$x1000=JS::toPrimitive(1.0,$global);$x1001=(is_string($x999)&&is_string($x1000)?strcmp($x999,$x1000)<0:(!is_nan($x1004=JS::toNumber($x999,$global))&&!is_nan($x1005=JS::toNumber($x1000,$global))&&$x1004<$x1005));$x998=$x1001;if(!JS::toBoolean($x998,$global)){unset($x1009,$W1009,$S1009,$U1009);$x1010=_61c60c86aef535e2824e55eb30517a85_4($global,$scope,$leThis,JS::toString(\'length\',$global),292,37,\'<image>/04_array.js\');$x1009=&$x1010[0];list(,$W1009,$S1009,$U1009)=$x1010;$x1006=JS::toPrimitive($_from,$global);$x1007=JS::toPrimitive($x1009,$global);$x1008=!(is_string($x1006)&&is_string($x1007)?strcmp($x1006,$x1007)<0:(!is_nan($x1011=JS::toNumber($x1006,$global))&&!is_nan($x1012=JS::toNumber($x1007,$global))&&$x1011<$x1012));$x998=$x1008;}if(JS::toBoolean($x998,$global)){return(-1.0*JS::toNumber(1.0,$global));}for($x1013=0;;++$x1013){if($x1013===0){unset($x1014,$W1014,$S1014,$U1014);$x1015=_61c60c86aef535e2824e55eb30517a85_4($global,$scope,$leThis,JS::toString(\'length\',$global),296,19,\'<image>/04_array.js\');$x1014=&$x1015[0];list(,$W1014,$S1014,$U1014)=$x1015;$scope->properties[\'i\']=JS::$undefined;$_i=&$scope->properties[\'i\'];$Ui=FALSE;$_i=(JS::toNumber($x1014,$global)-JS::toNumber(1.0,$global));}if($x1013!==0){$x1016=--$_i;}$x1017=JS::toPrimitive($_i,$global);$x1018=JS::toPrimitive($_from,$global);$x1019=!(is_string($x1017)&&is_string($x1018)?strcmp($x1017,$x1018)<0:(!is_nan($x1020=JS::toNumber($x1017,$global))&&!is_nan($x1021=JS::toNumber($x1018,$global))&&$x1020<$x1021));if(!JS::toBoolean($x1019,$global)){break;}unset($x1025,$W1025,$S1025,$U1025);$x1026=_61c60c86aef535e2824e55eb30517a85_4($global,$scope,$leThis,JS::toString($_i,$global),297,11,\'<image>/04_array.js\');$x1025=&$x1026[0];list(,$W1025,$S1025,$U1025)=$x1026;$x1023=$x1025;$x1024=$_search;if(gettype($x1023)===gettype($x1024)){$x1022=$x1023===$x1024;}else if($x1023===JS::$undefined&&$x1024===NULL||$x1023===NULL&&$x1024===JS::$undefined){$x1022=TRUE;}else if($x1023===NULL||$x1024===NULL){$x1022=FALSE;}else{$x1023=JS::toPrimitive($x1023,$global);$x1024=JS::toPrimitive($x1024,$global);if(is_bool($x1023)){$x1023=(int)$x1023;}if(is_bool($x1024)){$x1024=(int)$x1024;}if(is_numeric($x1023)||is_numeric($x1024)){$x1023=JS::toNumber($x1023,$global);$x1024=JS::toNumber($x1024,$global);}$x1022=$x1023===$x1024;}if(JS::toBoolean($x1022,$global)){return$_i;}}return(-1.0*JS::toNumber(1.0,$global));return JS::$undefined;}', "\n";
function _61c60c86aef535e2824e55eb30517a85_20($global, $leThis, $fn, $args, $constructor = FALSE) {
...
unset($_arguments, $Warguments, $Sarguments, $Uarguments);
$x1045 = _61c60c86aef535e2824e55eb30517a85_2($global, $scope, $scope, JS::toString('arguments', $global), 308, 6, '<image>/04_array.js');
$_arguments =& $x1045[0]; list(,$Warguments,$Sarguments,$Uarguments) = $x1045;
if ($Uarguments) {
unset($_ReferenceError, $WReferenceError, $SReferenceError, $UReferenceError);
$x1046 = _61c60c86aef535e2824e55eb30517a85_2($global, $scope, $scope, JS::toString('ReferenceError', $global), 308, 6, '<image>/04_array.js');
...
$x1050 = _61c60c86aef535e2824e55eb30517a85_4($global, $scope, $_arguments, JS::toString('length', $global), 308, 15, '<image>/04_array.js');
$x1049 =& $x1050[0]; list(,$W1049,$S1049,$U1049) = $x1050;
$x1042 = JS::toPrimitive($x1049, $global);
$x1043 = JS::toPrimitive(1.0, $global);
...
$x1054 = _61c60c86aef535e2824e55eb30517a85_4($global, $scope, $_arguments, JS::toString(1.0, $global), 309, 22, '<image>/04_array.js');
...
$x1057 = _61c60c86aef535e2824e55eb30517a85_4($global, $scope, $leThis, JS::toString('length', $global), 312, 26, '<image>/04_array.js');
...
unset($_TypeError, $WTypeError, $STypeError, $UTypeError);
$x1065 = _61c60c86aef535e2824e55eb30517a85_2($global, $scope, $scope, JS::toString('TypeError', $global), 313, 23, '<image>/04_array.js');
...
$x1069 = _61c60c86aef535e2824e55eb30517a85_4($global, $scope, $x1064, JS::toString('call', $global), 313, 23, '<image>/04_array.js');
$x1068 =& $x1069[0]; list(,$W1068,$S1068,$U1068) = $x1069;
unset($x1070, $W1070, $S1070, $U1070);
$x1071 = _61c60c86aef535e2824e55eb30517a85_4($global, $scope, $leThis, JS::toString($_i, $global), 313, 37, '<image>/04_array.js');
$x1070 =& $x1071[0]; list(,$W1070,$S1070,$U1070) = $x1071;
if (!(is_object($x1068) && isset($x1068->call))) { 
unset($_TypeError, $WTypeError, $STypeError, $UTypeError);
$x1074 = _61c60c86aef535e2824e55eb30517a85_2($global, $scope, $scope, JS::toString('TypeError', $global), 313, 23, '<image>/04_array.js');
...
echo 'function _61c60c86aef535e2824e55eb30517a85_20($global,$leThis,$fn,$args,$constructor=FALSE){if(isset($fn->boundThis)&&!$constructor){$leThis=$fn->boundThis;}if(isset($fn->boundArgs)){$args=array_merge($fn->boundArgs,$args);}$scope=clone JS::$emptyScope;$scope->up=$fn->scope;$scope->properties[\'arguments\']=clone JS::$argumentsTemplate;$x1041=&$scope->properties[\'arguments\'];$x1041->properties[\'length\']=count($args);foreach($args as$i=>$arg){$x1041->properties[$i]=$args[$i];$x1041->attributes[$i]=JS::WRITABLE|JS::ENUMERABLE|JS::CONFIGURABLE;}$scope->properties[\'callbackFn\']=array_key_exists(0,$args)?$args[0]:JS::$undefined;$_callbackFn=&$scope->properties[\'callbackFn\'];$UcallbackFn=FALSE;$global->scope[++$global->scope_sp]=$scope;$scope->properties[\'thisArg\']=JS::$undefined;$_thisArg=&$scope->properties[\'thisArg\'];$UthisArg=FALSE;$_thisArg=JS::$undefined;unset($_arguments,$Warguments,$Sarguments,$Uarguments);$x1045=_61c60c86aef535e2824e55eb30517a85_2($global,$scope,$scope,JS::toString(\'arguments\',$global),308,6,\'<image>/04_array.js\');$_arguments=&$x1045[0];list(,$Warguments,$Sarguments,$Uarguments)=$x1045;if($Uarguments){unset($_ReferenceError,$WReferenceError,$SReferenceError,$UReferenceError);$x1046=_61c60c86aef535e2824e55eb30517a85_2($global,$scope,$scope,JS::toString(\'ReferenceError\',$global),308,6,\'<image>/04_array.js\');$_ReferenceError=&$x1046[0];list(,$WReferenceError,$SReferenceError,$UReferenceError)=$x1046;$x1047=$_ReferenceError->call;$global->trace[++$global->trace_sp]=array(\'<image>/04_array.js\',308,6);$x1048=$x1047($global,$global,$_ReferenceError,array(\'arguments is not defined\'),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);if(isset($x1048->class)&&$x1048->class===\'Error\'&&!isset($x1048->properties[\'file\'])&&!isset($x1048->properties[\'line\'])&&!isset($x1048->properties[\'column\'])){$x1048->properties[\'file\']=\'<image>/04_array.js\';$x1048->properties[\'line\']=308;$x1048->properties[\'column\']=6;$x1048->attributes[\'file\']=$x1048->attributes[\'line\']=$x1048->attributes[\'column\']=0;}throw new JSException($x1048,308,6,\'<image>/04_array.js\');}unset($x1049,$W1049,$S1049,$U1049);$x1050=_61c60c86aef535e2824e55eb30517a85_4($global,$scope,$_arguments,JS::toString(\'length\',$global),308,15,\'<image>/04_array.js\');$x1049=&$x1050[0];list(,$W1049,$S1049,$U1049)=$x1050;$x1042=JS::toPrimitive($x1049,$global);$x1043=JS::toPrimitive(1.0,$global);$x1044=(is_string($x1043)&&is_string($x1042)?strcmp($x1043,$x1042)<0:(!is_nan($x1051=JS::toNumber($x1043,$global))&&!is_nan($x1052=JS::toNumber($x1042,$global))&&$x1051<$x1052));if(JS::toBoolean($x1044,$global)){unset($x1053,$W1053,$S1053,$U1053);$x1054=_61c60c86aef535e2824e55eb30517a85_4($global,$scope,$_arguments,JS::toString(1.0,$global),309,22,\'<image>/04_array.js\');$x1053=&$x1054[0];list(,$W1053,$S1053,$U1053)=$x1054;if($UthisArg){$global->properties[\'thisArg\']=$_thisArg;$_thisArg=&$global->properties[\'thisArg\'];}$_thisArg=$x1053;}for($x1055=0;;++$x1055){if($x1055===0){$scope->properties[\'i\']=JS::$undefined;$_i=&$scope->properties[\'i\'];$Ui=FALSE;$_i=0.0;unset($x1056,$W1056,$S1056,$U1056);$x1057=_61c60c86aef535e2824e55eb30517a85_4($global,$scope,$leThis,JS::toString(\'length\',$global),312,26,\'<image>/04_array.js\');$x1056=&$x1057[0];list(,$W1056,$S1056,$U1056)=$x1057;$scope->properties[\'l\']=JS::$undefined;$_l=&$scope->properties[\'l\'];$Ul=FALSE;$_l=$x1056;}if($x1055!==0){$x1058=++$_i;}$x1059=JS::toPrimitive($_i,$global);$x1060=JS::toPrimitive($_l,$global);$x1061=(is_string($x1059)&&is_string($x1060)?strcmp($x1059,$x1060)<0:(!is_nan($x1062=JS::toNumber($x1059,$global))&&!is_nan($x1063=JS::toNumber($x1060,$global))&&$x1062<$x1063));if(!JS::toBoolean($x1061,$global)){break;}if($_callbackFn===JS::$undefined||$_callbackFn===NULL){unset($_TypeError,$WTypeError,$STypeError,$UTypeError);$x1065=_61c60c86aef535e2824e55eb30517a85_2($global,$scope,$scope,JS::toString(\'TypeError\',$global),313,23,\'<image>/04_array.js\');$_TypeError=&$x1065[0];list(,$WTypeError,$STypeError,$UTypeError)=$x1065;$x1066=$_TypeError->call;$global->trace[++$global->trace_sp]=array(\'<image>/04_array.js\',313,23);$x1067=$x1066($global,$global,$_TypeError,array(\'Cannot call function on undefined/null.\'),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);if(isset($x1067->class)&&$x1067->class===\'Error\'&&!isset($x1067->properties[\'file\'])&&!isset($x1067->properties[\'line\'])&&!isset($x1067->properties[\'column\'])){$x1067->properties[\'file\']=\'<image>/04_array.js\';$x1067->properties[\'line\']=313;$x1067->properties[\'column\']=23;$x1067->attributes[\'file\']=$x1067->attributes[\'line\']=$x1067->attributes[\'column\']=0;}throw new JSException($x1067,313,23,\'<image>/04_array.js\');}$x1064=JS::toObject($_callbackFn,$global);unset($x1068,$W1068,$S1068,$U1068);$x1069=_61c60c86aef535e2824e55eb30517a85_4($global,$scope,$x1064,JS::toString(\'call\',$global),313,23,\'<image>/04_array.js\');$x1068=&$x1069[0];list(,$W1068,$S1068,$U1068)=$x1069;unset($x1070,$W1070,$S1070,$U1070);$x1071=_61c60c86aef535e2824e55eb30517a85_4($global,$scope,$leThis,JS::toString($_i,$global),313,37,\'<image>/04_array.js\');$x1070=&$x1071[0];list(,$W1070,$S1070,$U1070)=$x1071;if(!(is_object($x1068)&&isset($x1068->call))){unset($_TypeError,$WTypeError,$STypeError,$UTypeError);$x1074=_61c60c86aef535e2824e55eb30517a85_2($global,$scope,$scope,JS::toString(\'TypeError\',$global),313,23,\'<image>/04_array.js\');$_TypeError=&$x1074[0];list(,$WTypeError,$STypeError,$UTypeError)=$x1074;$x1075=$_TypeError->call;$global->trace[++$global->trace_sp]=array(\'<image>/04_array.js\',313,23);$x1076=$x1075($global,$global,$_TypeError,array(\'Trying to call what is not a function.\'),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);if(isset($x1076->class)&&$x1076->class===\'Error\'&&!isset($x1076->properties[\'file\'])&&!isset($x1076->properties[\'line\'])&&!isset($x1076->properties[\'column\'])){$x1076->properties[\'file\']=\'<image>/04_array.js\';$x1076->properties[\'line\']=313;$x1076->properties[\'column\']=23;$x1076->attributes[\'file\']=$x1076->attributes[\'line\']=$x1076->attributes[\'column\']=0;}throw new JSException($x1076,313,23,\'<image>/04_array.js\');}$x1072=$x1068->call;$global->trace[++$global->trace_sp]=array(\'<image>/04_array.js\',313,23);$x1073=$x1072($global,$x1064,$x1068,array($_thisArg,$x1070,$_i,$leThis),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);if(JS::toBoolean((!JS::toBoolean($x1073,$global)),$global)){return false;}}return true;return JS::$undefined;}', "\n";
function _61c60c86aef535e2824e55eb30517a85_21($global, $leThis, $fn, $args, $constructor = FALSE) {
...
$_thisArg = JS::$undefined;
unset($_arguments, $Warguments, $Sarguments, $Uarguments);
$x1095 = _61c60c86aef535e2824e55eb30517a85_2($global, $scope, $scope, JS::toString('arguments', $global), 324, 6, '<image>/04_array.js');
$_arguments =& $x1095[0]; list(,$Warguments,$Sarguments,$Uarguments) = $x1095;
if ($Uarguments) {
unset($_ReferenceError, $WReferenceError, $SReferenceError, $UReferenceError);
$x1096 = _61c60c86aef535e2824e55eb30517a85_2($global, $scope, $scope, JS::toString('ReferenceError', $global), 324, 6, '<image>/04_array.js');
...
$x1100 = _61c60c86aef535e2824e55eb30517a85_4($global, $scope, $_arguments, JS::toString('length', $global), 324, 15, '<image>/04_array.js');
$x1099 =& $x1100[0]; list(,$W1099,$S1099,$U1099) = $x1100;
$x1092 = JS::toPrimitive($x1099, $global);
$x1093 = JS::toPrimitive(1.0, $global);
...
$x1104 = _61c60c86aef535e2824e55eb30517a85_4($global, $scope, $_arguments, JS::toString(1.0, $global), 325, 22, '<image>/04_array.js');
...
$x1107 = _61c60c86aef535e2824e55eb30517a85_4($global, $scope, $leThis, JS::toString('length', $global), 328, 26, '<image>/04_array.js');
...
if ($_callbackFn === JS::$undefined || $_callbackFn === NULL) {
unset($_TypeError, $WTypeError, $STypeError, $UTypeError);
$x1115 = _61c60c86aef535e2824e55eb30517a85_2($global, $scope, $scope, JS::toString('TypeError', $global), 329, 22, '<image>/04_array.js');
...
$x1119 = _61c60c86aef535e2824e55eb30517a85_4($global, $scope, $x1114, JS::toString('call', $global), 329, 22, '<image>/04_array.js');
$x1118 =& $x1119[0]; list(,$W1118,$S1118,$U1118) = $x1119;
unset($x1120, $W1120, $S1120, $U1120);
$x1121 = _61c60c86aef535e2824e55eb30517a85_4($global, $scope, $leThis, JS::toString($_i, $global), 329, 36, '<image>/04_array.js');
$x1120 =& $x1121[0]; list(,$W1120,$S1120,$U1120) = $x1121;
if (!(is_object($x1118) && isset($x1118->call))) { 
unset($_TypeError, $WTypeError, $STypeError, $UTypeError);
$x1124 = _61c60c86aef535e2824e55eb30517a85_2($global, $scope, $scope, JS::toString('TypeError', $global), 329, 22, '<image>/04_array.js');
...
echo 'function _61c60c86aef535e2824e55eb30517a85_21($global,$leThis,$fn,$args,$constructor=FALSE){if(isset($fn->boundThis)&&!$constructor){$leThis=$fn->boundThis;}if(isset($fn->boundArgs)){$args=array_merge($fn->boundArgs,$args);}$scope=clone JS::$emptyScope;$scope->up=$fn->scope;$scope->properties[\'arguments\']=clone JS::$argumentsTemplate;$x1091=&$scope->properties[\'arguments\'];$x1091->properties[\'length\']=count($args);foreach($args as$i=>$arg){$x1091->properties[$i]=$args[$i];$x1091->attributes[$i]=JS::WRITABLE|JS::ENUMERABLE|JS::CONFIGURABLE;}$scope->properties[\'callbackFn\']=array_key_exists(0,$args)?$args[0]:JS::$undefined;$_callbackFn=&$scope->properties[\'callbackFn\'];$UcallbackFn=FALSE;$global->scope[++$global->scope_sp]=$scope;$scope->properties[\'thisArg\']=JS::$undefined;$_thisArg=&$scope->properties[\'thisArg\'];$UthisArg=FALSE;$_thisArg=JS::$undefined;unset($_arguments,$Warguments,$Sarguments,$Uarguments);$x1095=_61c60c86aef535e2824e55eb30517a85_2($global,$scope,$scope,JS::toString(\'arguments\',$global),324,6,\'<image>/04_array.js\');$_arguments=&$x1095[0];list(,$Warguments,$Sarguments,$Uarguments)=$x1095;if($Uarguments){unset($_ReferenceError,$WReferenceError,$SReferenceError,$UReferenceError);$x1096=_61c60c86aef535e2824e55eb30517a85_2($global,$scope,$scope,JS::toString(\'ReferenceError\',$global),324,6,\'<image>/04_array.js\');$_ReferenceError=&$x1096[0];list(,$WReferenceError,$SReferenceError,$UReferenceError)=$x1096;$x1097=$_ReferenceError->call;$global->trace[++$global->trace_sp]=array(\'<image>/04_array.js\',324,6);$x1098=$x1097($global,$global,$_ReferenceError,array(\'arguments is not defined\'),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);if(isset($x1098->class)&&$x1098->class===\'Error\'&&!isset($x1098->properties[\'file\'])&&!isset($x1098->properties[\'line\'])&&!isset($x1098->properties[\'column\'])){$x1098->properties[\'file\']=\'<image>/04_array.js\';$x1098->properties[\'line\']=324;$x1098->properties[\'column\']=6;$x1098->attributes[\'file\']=$x1098->attributes[\'line\']=$x1098->attributes[\'column\']=0;}throw new JSException($x1098,324,6,\'<image>/04_array.js\');}unset($x1099,$W1099,$S1099,$U1099);$x1100=_61c60c86aef535e2824e55eb30517a85_4($global,$scope,$_arguments,JS::toString(\'length\',$global),324,15,\'<image>/04_array.js\');$x1099=&$x1100[0];list(,$W1099,$S1099,$U1099)=$x1100;$x1092=JS::toPrimitive($x1099,$global);$x1093=JS::toPrimitive(1.0,$global);$x1094=(is_string($x1093)&&is_string($x1092)?strcmp($x1093,$x1092)<0:(!is_nan($x1101=JS::toNumber($x1093,$global))&&!is_nan($x1102=JS::toNumber($x1092,$global))&&$x1101<$x1102));if(JS::toBoolean($x1094,$global)){unset($x1103,$W1103,$S1103,$U1103);$x1104=_61c60c86aef535e2824e55eb30517a85_4($global,$scope,$_arguments,JS::toString(1.0,$global),325,22,\'<image>/04_array.js\');$x1103=&$x1104[0];list(,$W1103,$S1103,$U1103)=$x1104;if($UthisArg){$global->properties[\'thisArg\']=$_thisArg;$_thisArg=&$global->properties[\'thisArg\'];}$_thisArg=$x1103;}for($x1105=0;;++$x1105){if($x1105===0){$scope->properties[\'i\']=JS::$undefined;$_i=&$scope->properties[\'i\'];$Ui=FALSE;$_i=0.0;unset($x1106,$W1106,$S1106,$U1106);$x1107=_61c60c86aef535e2824e55eb30517a85_4($global,$scope,$leThis,JS::toString(\'length\',$global),328,26,\'<image>/04_array.js\');$x1106=&$x1107[0];list(,$W1106,$S1106,$U1106)=$x1107;$scope->properties[\'l\']=JS::$undefined;$_l=&$scope->properties[\'l\'];$Ul=FALSE;$_l=$x1106;}if($x1105!==0){$x1108=++$_i;}$x1109=JS::toPrimitive($_i,$global);$x1110=JS::toPrimitive($_l,$global);$x1111=(is_string($x1109)&&is_string($x1110)?strcmp($x1109,$x1110)<0:(!is_nan($x1112=JS::toNumber($x1109,$global))&&!is_nan($x1113=JS::toNumber($x1110,$global))&&$x1112<$x1113));if(!JS::toBoolean($x1111,$global)){break;}if($_callbackFn===JS::$undefined||$_callbackFn===NULL){unset($_TypeError,$WTypeError,$STypeError,$UTypeError);$x1115=_61c60c86aef535e2824e55eb30517a85_2($global,$scope,$scope,JS::toString(\'TypeError\',$global),329,22,\'<image>/04_array.js\');$_TypeError=&$x1115[0];list(,$WTypeError,$STypeError,$UTypeError)=$x1115;$x1116=$_TypeError->call;$global->trace[++$global->trace_sp]=array(\'<image>/04_array.js\',329,22);$x1117=$x1116($global,$global,$_TypeError,array(\'Cannot call function on undefined/null.\'),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);if(isset($x1117->class)&&$x1117->class===\'Error\'&&!isset($x1117->properties[\'file\'])&&!isset($x1117->properties[\'line\'])&&!isset($x1117->properties[\'column\'])){$x1117->properties[\'file\']=\'<image>/04_array.js\';$x1117->properties[\'line\']=329;$x1117->properties[\'column\']=22;$x1117->attributes[\'file\']=$x1117->attributes[\'line\']=$x1117->attributes[\'column\']=0;}throw new JSException($x1117,329,22,\'<image>/04_array.js\');}$x1114=JS::toObject($_callbackFn,$global);unset($x1118,$W1118,$S1118,$U1118);$x1119=_61c60c86aef535e2824e55eb30517a85_4($global,$scope,$x1114,JS::toString(\'call\',$global),329,22,\'<image>/04_array.js\');$x1118=&$x1119[0];list(,$W1118,$S1118,$U1118)=$x1119;unset($x1120,$W1120,$S1120,$U1120);$x1121=_61c60c86aef535e2824e55eb30517a85_4($global,$scope,$leThis,JS::toString($_i,$global),329,36,\'<image>/04_array.js\');$x1120=&$x1121[0];list(,$W1120,$S1120,$U1120)=$x1121;if(!(is_object($x1118)&&isset($x1118->call))){unset($_TypeError,$WTypeError,$STypeError,$UTypeError);$x1124=_61c60c86aef535e2824e55eb30517a85_2($global,$scope,$scope,JS::toString(\'TypeError\',$global),329,22,\'<image>/04_array.js\');$_TypeError=&$x1124[0];list(,$WTypeError,$STypeError,$UTypeError)=$x1124;$x1125=$_TypeError->call;$global->trace[++$global->trace_sp]=array(\'<image>/04_array.js\',329,22);$x1126=$x1125($global,$global,$_TypeError,array(\'Trying to call what is not a function.\'),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);if(isset($x1126->class)&&$x1126->class===\'Error\'&&!isset($x1126->properties[\'file\'])&&!isset($x1126->properties[\'line\'])&&!isset($x1126->properties[\'column\'])){$x1126->properties[\'file\']=\'<image>/04_array.js\';$x1126->properties[\'line\']=329;$x1126->properties[\'column\']=22;$x1126->attributes[\'file\']=$x1126->attributes[\'line\']=$x1126->attributes[\'column\']=0;}throw new JSException($x1126,329,22,\'<image>/04_array.js\');}$x1122=$x1118->call;$global->trace[++$global->trace_sp]=array(\'<image>/04_array.js\',329,22);$x1123=$x1122($global,$x1114,$x1118,array($_thisArg,$x1120,$_i,$leThis),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);if(JS::toBoolean($x1123,$global)){return true;}}return false;return JS::$undefined;}', "\n";
function _61c60c86aef535e2824e55eb30517a85_22($global, $leThis, $fn, $args, $constructor = FALSE) {
...
$_thisArg = JS::$undefined;
unset($_arguments, $Warguments, $Sarguments, $Uarguments);
$x1145 = _61c60c86aef535e2824e55eb30517a85_2($global, $scope, $scope, JS::toString('arguments', $global), 340, 6, '<image>/04_array.js');
$_arguments =& $x1145[0]; list(,$Warguments,$Sarguments,$Uarguments) = $x1145;
if ($Uarguments) {
unset($_ReferenceError, $WReferenceError, $SReferenceError, $UReferenceError);
$x1146 = _61c60c86aef535e2824e55eb30517a85_2($global, $scope, $scope, JS::toString('ReferenceError', $global), 340, 6, '<image>/04_array.js');
...
$x1150 = _61c60c86aef535e2824e55eb30517a85_4($global, $scope, $_arguments, JS::toString('length', $global), 340, 15, '<image>/04_array.js');
$x1149 =& $x1150[0]; list(,$W1149,$S1149,$U1149) = $x1150;
$x1142 = JS::toPrimitive($x1149, $global);
$x1143 = JS::toPrimitive(1.0, $global);
...
$x1154 = _61c60c86aef535e2824e55eb30517a85_4($global, $scope, $_arguments, JS::toString(1.0, $global), 341, 22, '<image>/04_array.js');
...
$x1157 = _61c60c86aef535e2824e55eb30517a85_4($global, $scope, $leThis, JS::toString('length', $global), 344, 26, '<image>/04_array.js');
...
if ($_callbackFn === JS::$undefined || $_callbackFn === NULL) {
unset($_TypeError, $WTypeError, $STypeError, $UTypeError);
$x1165 = _61c60c86aef535e2824e55eb30517a85_2($global, $scope, $scope, JS::toString('TypeError', $global), 345, 18, '<image>/04_array.js');
...
$x1169 = _61c60c86aef535e2824e55eb30517a85_4($global, $scope, $x1164, JS::toString('call', $global), 345, 18, '<image>/04_array.js');
$x1168 =& $x1169[0]; list(,$W1168,$S1168,$U1168) = $x1169;
unset($x1170, $W1170, $S1170, $U1170);
$x1171 = _61c60c86aef535e2824e55eb30517a85_4($global, $scope, $leThis, JS::toString($_i, $global), 345, 32, '<image>/04_array.js');
$x1170 =& $x1171[0]; list(,$W1170,$S1170,$U1170) = $x1171;
if (!(is_object($x1168) && isset($x1168->call))) { 
unset($_TypeError, $WTypeError, $STypeError, $UTypeError);
$x1174 = _61c60c86aef535e2824e55eb30517a85_2($global, $scope, $scope, JS::toString('TypeError', $global), 345, 18, '<image>/04_array.js');
...
echo 'function _61c60c86aef535e2824e55eb30517a85_22($global,$leThis,$fn,$args,$constructor=FALSE){if(isset($fn->boundThis)&&!$constructor){$leThis=$fn->boundThis;}if(isset($fn->boundArgs)){$args=array_merge($fn->boundArgs,$args);}$scope=clone JS::$emptyScope;$scope->up=$fn->scope;$scope->properties[\'arguments\']=clone JS::$argumentsTemplate;$x1141=&$scope->properties[\'arguments\'];$x1141->properties[\'length\']=count($args);foreach($args as$i=>$arg){$x1141->properties[$i]=$args[$i];$x1141->attributes[$i]=JS::WRITABLE|JS::ENUMERABLE|JS::CONFIGURABLE;}$scope->properties[\'callbackFn\']=array_key_exists(0,$args)?$args[0]:JS::$undefined;$_callbackFn=&$scope->properties[\'callbackFn\'];$UcallbackFn=FALSE;$global->scope[++$global->scope_sp]=$scope;$scope->properties[\'thisArg\']=JS::$undefined;$_thisArg=&$scope->properties[\'thisArg\'];$UthisArg=FALSE;$_thisArg=JS::$undefined;unset($_arguments,$Warguments,$Sarguments,$Uarguments);$x1145=_61c60c86aef535e2824e55eb30517a85_2($global,$scope,$scope,JS::toString(\'arguments\',$global),340,6,\'<image>/04_array.js\');$_arguments=&$x1145[0];list(,$Warguments,$Sarguments,$Uarguments)=$x1145;if($Uarguments){unset($_ReferenceError,$WReferenceError,$SReferenceError,$UReferenceError);$x1146=_61c60c86aef535e2824e55eb30517a85_2($global,$scope,$scope,JS::toString(\'ReferenceError\',$global),340,6,\'<image>/04_array.js\');$_ReferenceError=&$x1146[0];list(,$WReferenceError,$SReferenceError,$UReferenceError)=$x1146;$x1147=$_ReferenceError->call;$global->trace[++$global->trace_sp]=array(\'<image>/04_array.js\',340,6);$x1148=$x1147($global,$global,$_ReferenceError,array(\'arguments is not defined\'),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);if(isset($x1148->class)&&$x1148->class===\'Error\'&&!isset($x1148->properties[\'file\'])&&!isset($x1148->properties[\'line\'])&&!isset($x1148->properties[\'column\'])){$x1148->properties[\'file\']=\'<image>/04_array.js\';$x1148->properties[\'line\']=340;$x1148->properties[\'column\']=6;$x1148->attributes[\'file\']=$x1148->attributes[\'line\']=$x1148->attributes[\'column\']=0;}throw new JSException($x1148,340,6,\'<image>/04_array.js\');}unset($x1149,$W1149,$S1149,$U1149);$x1150=_61c60c86aef535e2824e55eb30517a85_4($global,$scope,$_arguments,JS::toString(\'length\',$global),340,15,\'<image>/04_array.js\');$x1149=&$x1150[0];list(,$W1149,$S1149,$U1149)=$x1150;$x1142=JS::toPrimitive($x1149,$global);$x1143=JS::toPrimitive(1.0,$global);$x1144=(is_string($x1143)&&is_string($x1142)?strcmp($x1143,$x1142)<0:(!is_nan($x1151=JS::toNumber($x1143,$global))&&!is_nan($x1152=JS::toNumber($x1142,$global))&&$x1151<$x1152));if(JS::toBoolean($x1144,$global)){unset($x1153,$W1153,$S1153,$U1153);$x1154=_61c60c86aef535e2824e55eb30517a85_4($global,$scope,$_arguments,JS::toString(1.0,$global),341,22,\'<image>/04_array.js\');$x1153=&$x1154[0];list(,$W1153,$S1153,$U1153)=$x1154;if($UthisArg){$global->properties[\'thisArg\']=$_thisArg;$_thisArg=&$global->properties[\'thisArg\'];}$_thisArg=$x1153;}for($x1155=0;;++$x1155){if($x1155===0){$scope->properties[\'i\']=JS::$undefined;$_i=&$scope->properties[\'i\'];$Ui=FALSE;$_i=0.0;unset($x1156,$W1156,$S1156,$U1156);$x1157=_61c60c86aef535e2824e55eb30517a85_4($global,$scope,$leThis,JS::toString(\'length\',$global),344,26,\'<image>/04_array.js\');$x1156=&$x1157[0];list(,$W1156,$S1156,$U1156)=$x1157;$scope->properties[\'l\']=JS::$undefined;$_l=&$scope->properties[\'l\'];$Ul=FALSE;$_l=$x1156;}if($x1155!==0){$x1158=++$_i;}$x1159=JS::toPrimitive($_i,$global);$x1160=JS::toPrimitive($_l,$global);$x1161=(is_string($x1159)&&is_string($x1160)?strcmp($x1159,$x1160)<0:(!is_nan($x1162=JS::toNumber($x1159,$global))&&!is_nan($x1163=JS::toNumber($x1160,$global))&&$x1162<$x1163));if(!JS::toBoolean($x1161,$global)){break;}if($_callbackFn===JS::$undefined||$_callbackFn===NULL){unset($_TypeError,$WTypeError,$STypeError,$UTypeError);$x1165=_61c60c86aef535e2824e55eb30517a85_2($global,$scope,$scope,JS::toString(\'TypeError\',$global),345,18,\'<image>/04_array.js\');$_TypeError=&$x1165[0];list(,$WTypeError,$STypeError,$UTypeError)=$x1165;$x1166=$_TypeError->call;$global->trace[++$global->trace_sp]=array(\'<image>/04_array.js\',345,18);$x1167=$x1166($global,$global,$_TypeError,array(\'Cannot call function on undefined/null.\'),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);if(isset($x1167->class)&&$x1167->class===\'Error\'&&!isset($x1167->properties[\'file\'])&&!isset($x1167->properties[\'line\'])&&!isset($x1167->properties[\'column\'])){$x1167->properties[\'file\']=\'<image>/04_array.js\';$x1167->properties[\'line\']=345;$x1167->properties[\'column\']=18;$x1167->attributes[\'file\']=$x1167->attributes[\'line\']=$x1167->attributes[\'column\']=0;}throw new JSException($x1167,345,18,\'<image>/04_array.js\');}$x1164=JS::toObject($_callbackFn,$global);unset($x1168,$W1168,$S1168,$U1168);$x1169=_61c60c86aef535e2824e55eb30517a85_4($global,$scope,$x1164,JS::toString(\'call\',$global),345,18,\'<image>/04_array.js\');$x1168=&$x1169[0];list(,$W1168,$S1168,$U1168)=$x1169;unset($x1170,$W1170,$S1170,$U1170);$x1171=_61c60c86aef535e2824e55eb30517a85_4($global,$scope,$leThis,JS::toString($_i,$global),345,32,\'<image>/04_array.js\');$x1170=&$x1171[0];list(,$W1170,$S1170,$U1170)=$x1171;if(!(is_object($x1168)&&isset($x1168->call))){unset($_TypeError,$WTypeError,$STypeError,$UTypeError);$x1174=_61c60c86aef535e2824e55eb30517a85_2($global,$scope,$scope,JS::toString(\'TypeError\',$global),345,18,\'<image>/04_array.js\');$_TypeError=&$x1174[0];list(,$WTypeError,$STypeError,$UTypeError)=$x1174;$x1175=$_TypeError->call;$global->trace[++$global->trace_sp]=array(\'<image>/04_array.js\',345,18);$x1176=$x1175($global,$global,$_TypeError,array(\'Trying to call what is not a function.\'),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);if(isset($x1176->class)&&$x1176->class===\'Error\'&&!isset($x1176->properties[\'file\'])&&!isset($x1176->properties[\'line\'])&&!isset($x1176->properties[\'column\'])){$x1176->properties[\'file\']=\'<image>/04_array.js\';$x1176->properties[\'line\']=345;$x1176->properties[\'column\']=18;$x1176->attributes[\'file\']=$x1176->attributes[\'line\']=$x1176->attributes[\'column\']=0;}throw new JSException($x1176,345,18,\'<image>/04_array.js\');}$x1172=$x1168->call;$global->trace[++$global->trace_sp]=array(\'<image>/04_array.js\',345,18);$x1173=$x1172($global,$x1164,$x1168,array($_thisArg,$x1170,$_i,$leThis),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);}return JS::$undefined;}', "\n";
function _61c60c86aef535e2824e55eb30517a85_23($global, $leThis, $fn, $args, $constructor = FALSE) {
...
$_returnArray = $x1192;
unset($_arguments, $Warguments, $Sarguments, $Uarguments);
$x1196 = _61c60c86aef535e2824e55eb30517a85_2($global, $scope, $scope, JS::toString('arguments', $global), 352, 6, '<image>/04_array.js');
$_arguments =& $x1196[0]; list(,$Warguments,$Sarguments,$Uarguments) = $x1196;
if ($Uarguments) {
unset($_ReferenceError, $WReferenceError, $SReferenceError, $UReferenceError);
$x1197 = _61c60c86aef535e2824e55eb30517a85_2($global, $scope, $scope, JS::toString('ReferenceError', $global), 352, 6, '<image>/04_array.js');
...
$x1201 = _61c60c86aef535e2824e55eb30517a85_4($global, $scope, $_arguments, JS::toString('length', $global), 352, 15, '<image>/04_array.js');
$x1200 =& $x1201[0]; list(,$W1200,$S1200,$U1200) = $x1201;
$x1193 = JS::toPrimitive($x1200, $global);
$x1194 = JS::toPrimitive(1.0, $global);
...
$x1205 = _61c60c86aef535e2824e55eb30517a85_4($global, $scope, $_arguments, JS::toString(1.0, $global), 353, 22, '<image>/04_array.js');
...
$x1208 = _61c60c86aef535e2824e55eb30517a85_4($global, $scope, $leThis, JS::toString('length', $global), 356, 26, '<image>/04_array.js');
...
if ($_returnArray === JS::$undefined || $_returnArray === NULL) {
unset($_TypeError, $WTypeError, $STypeError, $UTypeError);
$x1216 = _61c60c86aef535e2824e55eb30517a85_2($global, $scope, $scope, JS::toString('TypeError', $global), 357, 19, '<image>/04_array.js');
...
$x1220 = _61c60c86aef535e2824e55eb30517a85_4($global, $scope, $x1215, JS::toString('push', $global), 357, 19, '<image>/04_array.js');
$x1219 =& $x1220[0]; list(,$W1219,$S1219,$U1219) = $x1220;
if ($_callbackFn === JS::$undefined || $_callbackFn === NULL) {
unset($_TypeError, $WTypeError, $STypeError, $UTypeError);
$x1222 = _61c60c86aef535e2824e55eb30517a85_2($global, $scope, $scope, JS::toString('TypeError', $global), 357, 35, '<image>/04_array.js');
...
$x1226 = _61c60c86aef535e2824e55eb30517a85_4($global, $scope, $x1221, JS::toString('call', $global), 357, 35, '<image>/04_array.js');
$x1225 =& $x1226[0]; list(,$W1225,$S1225,$U1225) = $x1226;
unset($x1227, $W1227, $S1227, $U1227);
$x1228 = _61c60c86aef535e2824e55eb30517a85_4($global, $scope, $leThis, JS::toString($_i, $global), 357, 49, '<image>/04_array.js');
$x1227 =& $x1228[0]; list(,$W1227,$S1227,$U1227) = $x1228;
if (!(is_object($x1225) && isset($x1225->call))) { 
unset($_TypeError, $WTypeError, $STypeError, $UTypeError);
$x1231 = _61c60c86aef535e2824e55eb30517a85_2($global, $scope, $scope, JS::toString('TypeError', $global), 357, 35, '<image>/04_array.js');
...
unset($_TypeError, $WTypeError, $STypeError, $UTypeError);
$x1236 = _61c60c86aef535e2824e55eb30517a85_2($global, $scope, $scope, JS::toString('TypeError', $global), 357, 19, '<image>/04_array.js');
...
echo 'function _61c60c86aef535e2824e55eb30517a85_23($global,$leThis,$fn,$args,$constructor=FALSE){if(isset($fn->boundThis)&&!$constructor){$leThis=$fn->boundThis;}if(isset($fn->boundArgs)){$args=array_merge($fn->boundArgs,$args);}$scope=clone JS::$emptyScope;$scope->up=$fn->scope;$scope->properties[\'arguments\']=clone JS::$argumentsTemplate;$x1191=&$scope->properties[\'arguments\'];$x1191->properties[\'length\']=count($args);foreach($args as$i=>$arg){$x1191->properties[$i]=$args[$i];$x1191->attributes[$i]=JS::WRITABLE|JS::ENUMERABLE|JS::CONFIGURABLE;}$scope->properties[\'callbackFn\']=array_key_exists(0,$args)?$args[0]:JS::$undefined;$_callbackFn=&$scope->properties[\'callbackFn\'];$UcallbackFn=FALSE;$global->scope[++$global->scope_sp]=$scope;$scope->properties[\'thisArg\']=JS::$undefined;$_thisArg=&$scope->properties[\'thisArg\'];$UthisArg=FALSE;$_thisArg=JS::$undefined;$x1192=clone JS::$arrayTemplate;$x1192->properties[\'length\']=0;$x1192->attributes[\'length\']=JS::WRITABLE;$scope->properties[\'returnArray\']=JS::$undefined;$_returnArray=&$scope->properties[\'returnArray\'];$UreturnArray=FALSE;$_returnArray=$x1192;unset($_arguments,$Warguments,$Sarguments,$Uarguments);$x1196=_61c60c86aef535e2824e55eb30517a85_2($global,$scope,$scope,JS::toString(\'arguments\',$global),352,6,\'<image>/04_array.js\');$_arguments=&$x1196[0];list(,$Warguments,$Sarguments,$Uarguments)=$x1196;if($Uarguments){unset($_ReferenceError,$WReferenceError,$SReferenceError,$UReferenceError);$x1197=_61c60c86aef535e2824e55eb30517a85_2($global,$scope,$scope,JS::toString(\'ReferenceError\',$global),352,6,\'<image>/04_array.js\');$_ReferenceError=&$x1197[0];list(,$WReferenceError,$SReferenceError,$UReferenceError)=$x1197;$x1198=$_ReferenceError->call;$global->trace[++$global->trace_sp]=array(\'<image>/04_array.js\',352,6);$x1199=$x1198($global,$global,$_ReferenceError,array(\'arguments is not defined\'),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);if(isset($x1199->class)&&$x1199->class===\'Error\'&&!isset($x1199->properties[\'file\'])&&!isset($x1199->properties[\'line\'])&&!isset($x1199->properties[\'column\'])){$x1199->properties[\'file\']=\'<image>/04_array.js\';$x1199->properties[\'line\']=352;$x1199->properties[\'column\']=6;$x1199->attributes[\'file\']=$x1199->attributes[\'line\']=$x1199->attributes[\'column\']=0;}throw new JSException($x1199,352,6,\'<image>/04_array.js\');}unset($x1200,$W1200,$S1200,$U1200);$x1201=_61c60c86aef535e2824e55eb30517a85_4($global,$scope,$_arguments,JS::toString(\'length\',$global),352,15,\'<image>/04_array.js\');$x1200=&$x1201[0];list(,$W1200,$S1200,$U1200)=$x1201;$x1193=JS::toPrimitive($x1200,$global);$x1194=JS::toPrimitive(1.0,$global);$x1195=(is_string($x1194)&&is_string($x1193)?strcmp($x1194,$x1193)<0:(!is_nan($x1202=JS::toNumber($x1194,$global))&&!is_nan($x1203=JS::toNumber($x1193,$global))&&$x1202<$x1203));if(JS::toBoolean($x1195,$global)){unset($x1204,$W1204,$S1204,$U1204);$x1205=_61c60c86aef535e2824e55eb30517a85_4($global,$scope,$_arguments,JS::toString(1.0,$global),353,22,\'<image>/04_array.js\');$x1204=&$x1205[0];list(,$W1204,$S1204,$U1204)=$x1205;if($UthisArg){$global->properties[\'thisArg\']=$_thisArg;$_thisArg=&$global->properties[\'thisArg\'];}$_thisArg=$x1204;}for($x1206=0;;++$x1206){if($x1206===0){$scope->properties[\'i\']=JS::$undefined;$_i=&$scope->properties[\'i\'];$Ui=FALSE;$_i=0.0;unset($x1207,$W1207,$S1207,$U1207);$x1208=_61c60c86aef535e2824e55eb30517a85_4($global,$scope,$leThis,JS::toString(\'length\',$global),356,26,\'<image>/04_array.js\');$x1207=&$x1208[0];list(,$W1207,$S1207,$U1207)=$x1208;$scope->properties[\'l\']=JS::$undefined;$_l=&$scope->properties[\'l\'];$Ul=FALSE;$_l=$x1207;}if($x1206!==0){$x1209=++$_i;}$x1210=JS::toPrimitive($_i,$global);$x1211=JS::toPrimitive($_l,$global);$x1212=(is_string($x1210)&&is_string($x1211)?strcmp($x1210,$x1211)<0:(!is_nan($x1213=JS::toNumber($x1210,$global))&&!is_nan($x1214=JS::toNumber($x1211,$global))&&$x1213<$x1214));if(!JS::toBoolean($x1212,$global)){break;}if($_returnArray===JS::$undefined||$_returnArray===NULL){unset($_TypeError,$WTypeError,$STypeError,$UTypeError);$x1216=_61c60c86aef535e2824e55eb30517a85_2($global,$scope,$scope,JS::toString(\'TypeError\',$global),357,19,\'<image>/04_array.js\');$_TypeError=&$x1216[0];list(,$WTypeError,$STypeError,$UTypeError)=$x1216;$x1217=$_TypeError->call;$global->trace[++$global->trace_sp]=array(\'<image>/04_array.js\',357,19);$x1218=$x1217($global,$global,$_TypeError,array(\'Cannot call function on undefined/null.\'),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);if(isset($x1218->class)&&$x1218->class===\'Error\'&&!isset($x1218->properties[\'file\'])&&!isset($x1218->properties[\'line\'])&&!isset($x1218->properties[\'column\'])){$x1218->properties[\'file\']=\'<image>/04_array.js\';$x1218->properties[\'line\']=357;$x1218->properties[\'column\']=19;$x1218->attributes[\'file\']=$x1218->attributes[\'line\']=$x1218->attributes[\'column\']=0;}throw new JSException($x1218,357,19,\'<image>/04_array.js\');}$x1215=JS::toObject($_returnArray,$global);unset($x1219,$W1219,$S1219,$U1219);$x1220=_61c60c86aef535e2824e55eb30517a85_4($global,$scope,$x1215,JS::toString(\'push\',$global),357,19,\'<image>/04_array.js\');$x1219=&$x1220[0];list(,$W1219,$S1219,$U1219)=$x1220;if($_callbackFn===JS::$undefined||$_callbackFn===NULL){unset($_TypeError,$WTypeError,$STypeError,$UTypeError);$x1222=_61c60c86aef535e2824e55eb30517a85_2($global,$scope,$scope,JS::toString(\'TypeError\',$global),357,35,\'<image>/04_array.js\');$_TypeError=&$x1222[0];list(,$WTypeError,$STypeError,$UTypeError)=$x1222;$x1223=$_TypeError->call;$global->trace[++$global->trace_sp]=array(\'<image>/04_array.js\',357,35);$x1224=$x1223($global,$global,$_TypeError,array(\'Cannot call function on undefined/null.\'),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);if(isset($x1224->class)&&$x1224->class===\'Error\'&&!isset($x1224->properties[\'file\'])&&!isset($x1224->properties[\'line\'])&&!isset($x1224->properties[\'column\'])){$x1224->properties[\'file\']=\'<image>/04_array.js\';$x1224->properties[\'line\']=357;$x1224->properties[\'column\']=35;$x1224->attributes[\'file\']=$x1224->attributes[\'line\']=$x1224->attributes[\'column\']=0;}throw new JSException($x1224,357,35,\'<image>/04_array.js\');}$x1221=JS::toObject($_callbackFn,$global);unset($x1225,$W1225,$S1225,$U1225);$x1226=_61c60c86aef535e2824e55eb30517a85_4($global,$scope,$x1221,JS::toString(\'call\',$global),357,35,\'<image>/04_array.js\');$x1225=&$x1226[0];list(,$W1225,$S1225,$U1225)=$x1226;unset($x1227,$W1227,$S1227,$U1227);$x1228=_61c60c86aef535e2824e55eb30517a85_4($global,$scope,$leThis,JS::toString($_i,$global),357,49,\'<image>/04_array.js\');$x1227=&$x1228[0];list(,$W1227,$S1227,$U1227)=$x1228;if(!(is_object($x1225)&&isset($x1225->call))){unset($_TypeError,$WTypeError,$STypeError,$UTypeError);$x1231=_61c60c86aef535e2824e55eb30517a85_2($global,$scope,$scope,JS::toString(\'TypeError\',$global),357,35,\'<image>/04_array.js\');$_TypeError=&$x1231[0];list(,$WTypeError,$STypeError,$UTypeError)=$x1231;$x1232=$_TypeError->call;$global->trace[++$global->trace_sp]=array(\'<image>/04_array.js\',357,35);$x1233=$x1232($global,$global,$_TypeError,array(\'Trying to call what is not a function.\'),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);if(isset($x1233->class)&&$x1233->class===\'Error\'&&!isset($x1233->properties[\'file\'])&&!isset($x1233->properties[\'line\'])&&!isset($x1233->properties[\'column\'])){$x1233->properties[\'file\']=\'<image>/04_array.js\';$x1233->properties[\'line\']=357;$x1233->properties[\'column\']=35;$x1233->attributes[\'file\']=$x1233->attributes[\'line\']=$x1233->attributes[\'column\']=0;}throw new JSException($x1233,357,35,\'<image>/04_array.js\');}$x1229=$x1225->call;$global->trace[++$global->trace_sp]=array(\'<image>/04_array.js\',357,35);$x1230=$x1229($global,$x1221,$x1225,array($_thisArg,$x1227,$_i,$leThis),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);if(!(is_object($x1219)&&isset($x1219->call))){unset($_TypeError,$WTypeError,$STypeError,$UTypeError);$x1236=_61c60c86aef535e2824e55eb30517a85_2($global,$scope,$scope,JS::toString(\'TypeError\',$global),357,19,\'<image>/04_array.js\');$_TypeError=&$x1236[0];list(,$WTypeError,$STypeError,$UTypeError)=$x1236;$x1237=$_TypeError->call;$global->trace[++$global->trace_sp]=array(\'<image>/04_array.js\',357,19);$x1238=$x1237($global,$global,$_TypeError,array(\'Trying to call what is not a function.\'),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);if(isset($x1238->class)&&$x1238->class===\'Error\'&&!isset($x1238->properties[\'file\'])&&!isset($x1238->properties[\'line\'])&&!isset($x1238->properties[\'column\'])){$x1238->properties[\'file\']=\'<image>/04_array.js\';$x1238->properties[\'line\']=357;$x1238->properties[\'column\']=19;$x1238->attributes[\'file\']=$x1238->attributes[\'line\']=$x1238->attributes[\'column\']=0;}throw new JSException($x1238,357,19,\'<image>/04_array.js\');}$x1234=$x1219->call;$global->trace[++$global->trace_sp]=array(\'<image>/04_array.js\',357,19);$x1235=$x1234($global,$x1215,$x1219,array($x1230),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);}return$_returnArray;return JS::$undefined;}', "\n";
function _61c60c86aef535e2824e55eb30517a85_24($global, $leThis, $fn, $args, $constructor = FALSE) {
...
$_returnArray = $x1254;
unset($_arguments, $Warguments, $Sarguments, $Uarguments);
$x1258 = _61c60c86aef535e2824e55eb30517a85_2($global, $scope, $scope, JS::toString('arguments', $global), 366, 6, '<image>/04_array.js');
$_arguments =& $x1258[0]; list(,$Warguments,$Sarguments,$Uarguments) = $x1258;
if ($Uarguments) {
unset($_ReferenceError, $WReferenceError, $SReferenceError, $UReferenceError);
$x1259 = _61c60c86aef535e2824e55eb30517a85_2($global, $scope, $scope, JS::toString('ReferenceError', $global), 366, 6, '<image>/04_array.js');
...
$x1263 = _61c60c86aef535e2824e55eb30517a85_4($global, $scope, $_arguments, JS::toString('length', $global), 366, 15, '<image>/04_array.js');
$x1262 =& $x1263[0]; list(,$W1262,$S1262,$U1262) = $x1263;
$x1255 = JS::toPrimitive($x1262, $global);
$x1256 = JS::toPrimitive(1.0, $global);
...
$x1267 = _61c60c86aef535e2824e55eb30517a85_4($global, $scope, $_arguments, JS::toString(1.0, $global), 367, 22, '<image>/04_array.js');
...
$x1270 = _61c60c86aef535e2824e55eb30517a85_4($global, $scope, $leThis, JS::toString('length', $global), 370, 26, '<image>/04_array.js');
...
if ($_callbackFn === JS::$undefined || $_callbackFn === NULL) {
unset($_TypeError, $WTypeError, $STypeError, $UTypeError);
$x1278 = _61c60c86aef535e2824e55eb30517a85_2($global, $scope, $scope, JS::toString('TypeError', $global), 371, 22, '<image>/04_array.js');
...
$x1282 = _61c60c86aef535e2824e55eb30517a85_4($global, $scope, $x1277, JS::toString('call', $global), 371, 22, '<image>/04_array.js');
$x1281 =& $x1282[0]; list(,$W1281,$S1281,$U1281) = $x1282;
unset($x1283, $W1283, $S1283, $U1283);
$x1284 = _61c60c86aef535e2824e55eb30517a85_4($global, $scope, $leThis, JS::toString($_i, $global), 371, 36, '<image>/04_array.js');
$x1283 =& $x1284[0]; list(,$W1283,$S1283,$U1283) = $x1284;
if (!(is_object($x1281) && isset($x1281->call))) { 
unset($_TypeError, $WTypeError, $STypeError, $UTypeError);
$x1287 = _61c60c86aef535e2824e55eb30517a85_2($global, $scope, $scope, JS::toString('TypeError', $global), 371, 22, '<image>/04_array.js');
...
if ($_returnArray === JS::$undefined || $_returnArray === NULL) {
unset($_TypeError, $WTypeError, $STypeError, $UTypeError);
$x1291 = _61c60c86aef535e2824e55eb30517a85_2($global, $scope, $scope, JS::toString('TypeError', $global), 372, 20, '<image>/04_array.js');
...
$x1295 = _61c60c86aef535e2824e55eb30517a85_4($global, $scope, $x1290, JS::toString('push', $global), 372, 20, '<image>/04_array.js');
$x1294 =& $x1295[0]; list(,$W1294,$S1294,$U1294) = $x1295;
unset($x1296, $W1296, $S1296, $U1296);
$x1297 = _61c60c86aef535e2824e55eb30517a85_4($global, $scope, $leThis, JS::toString($_i, $global), 372, 25, '<image>/04_array.js');
$x1296 =& $x1297[0]; list(,$W1296,$S1296,$U1296) = $x1297;
if (!(is_object($x1294) && isset($x1294->call))) { 
unset($_TypeError, $WTypeError, $STypeError, $UTypeError);
$x1300 = _61c60c86aef535e2824e55eb30517a85_2($global, $scope, $scope, JS::toString('TypeError', $global), 372, 20, '<image>/04_array.js');
...
echo 'function _61c60c86aef535e2824e55eb30517a85_24($global,$leThis,$fn,$args,$constructor=FALSE){if(isset($fn->boundThis)&&!$constructor){$leThis=$fn->boundThis;}if(isset($fn->boundArgs)){$args=array_merge($fn->boundArgs,$args);}$scope=clone JS::$emptyScope;$scope->up=$fn->scope;$scope->properties[\'arguments\']=clone JS::$argumentsTemplate;$x1253=&$scope->properties[\'arguments\'];$x1253->properties[\'length\']=count($args);foreach($args as$i=>$arg){$x1253->properties[$i]=$args[$i];$x1253->attributes[$i]=JS::WRITABLE|JS::ENUMERABLE|JS::CONFIGURABLE;}$scope->properties[\'callbackFn\']=array_key_exists(0,$args)?$args[0]:JS::$undefined;$_callbackFn=&$scope->properties[\'callbackFn\'];$UcallbackFn=FALSE;$global->scope[++$global->scope_sp]=$scope;$scope->properties[\'thisArg\']=JS::$undefined;$_thisArg=&$scope->properties[\'thisArg\'];$UthisArg=FALSE;$_thisArg=JS::$undefined;$x1254=clone JS::$arrayTemplate;$x1254->properties[\'length\']=0;$x1254->attributes[\'length\']=JS::WRITABLE;$scope->properties[\'returnArray\']=JS::$undefined;$_returnArray=&$scope->properties[\'returnArray\'];$UreturnArray=FALSE;$_returnArray=$x1254;unset($_arguments,$Warguments,$Sarguments,$Uarguments);$x1258=_61c60c86aef535e2824e55eb30517a85_2($global,$scope,$scope,JS::toString(\'arguments\',$global),366,6,\'<image>/04_array.js\');$_arguments=&$x1258[0];list(,$Warguments,$Sarguments,$Uarguments)=$x1258;if($Uarguments){unset($_ReferenceError,$WReferenceError,$SReferenceError,$UReferenceError);$x1259=_61c60c86aef535e2824e55eb30517a85_2($global,$scope,$scope,JS::toString(\'ReferenceError\',$global),366,6,\'<image>/04_array.js\');$_ReferenceError=&$x1259[0];list(,$WReferenceError,$SReferenceError,$UReferenceError)=$x1259;$x1260=$_ReferenceError->call;$global->trace[++$global->trace_sp]=array(\'<image>/04_array.js\',366,6);$x1261=$x1260($global,$global,$_ReferenceError,array(\'arguments is not defined\'),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);if(isset($x1261->class)&&$x1261->class===\'Error\'&&!isset($x1261->properties[\'file\'])&&!isset($x1261->properties[\'line\'])&&!isset($x1261->properties[\'column\'])){$x1261->properties[\'file\']=\'<image>/04_array.js\';$x1261->properties[\'line\']=366;$x1261->properties[\'column\']=6;$x1261->attributes[\'file\']=$x1261->attributes[\'line\']=$x1261->attributes[\'column\']=0;}throw new JSException($x1261,366,6,\'<image>/04_array.js\');}unset($x1262,$W1262,$S1262,$U1262);$x1263=_61c60c86aef535e2824e55eb30517a85_4($global,$scope,$_arguments,JS::toString(\'length\',$global),366,15,\'<image>/04_array.js\');$x1262=&$x1263[0];list(,$W1262,$S1262,$U1262)=$x1263;$x1255=JS::toPrimitive($x1262,$global);$x1256=JS::toPrimitive(1.0,$global);$x1257=(is_string($x1256)&&is_string($x1255)?strcmp($x1256,$x1255)<0:(!is_nan($x1264=JS::toNumber($x1256,$global))&&!is_nan($x1265=JS::toNumber($x1255,$global))&&$x1264<$x1265));if(JS::toBoolean($x1257,$global)){unset($x1266,$W1266,$S1266,$U1266);$x1267=_61c60c86aef535e2824e55eb30517a85_4($global,$scope,$_arguments,JS::toString(1.0,$global),367,22,\'<image>/04_array.js\');$x1266=&$x1267[0];list(,$W1266,$S1266,$U1266)=$x1267;if($UthisArg){$global->properties[\'thisArg\']=$_thisArg;$_thisArg=&$global->properties[\'thisArg\'];}$_thisArg=$x1266;}for($x1268=0;;++$x1268){if($x1268===0){$scope->properties[\'i\']=JS::$undefined;$_i=&$scope->properties[\'i\'];$Ui=FALSE;$_i=0.0;unset($x1269,$W1269,$S1269,$U1269);$x1270=_61c60c86aef535e2824e55eb30517a85_4($global,$scope,$leThis,JS::toString(\'length\',$global),370,26,\'<image>/04_array.js\');$x1269=&$x1270[0];list(,$W1269,$S1269,$U1269)=$x1270;$scope->properties[\'l\']=JS::$undefined;$_l=&$scope->properties[\'l\'];$Ul=FALSE;$_l=$x1269;}if($x1268!==0){$x1271=++$_i;}$x1272=JS::toPrimitive($_i,$global);$x1273=JS::toPrimitive($_l,$global);$x1274=(is_string($x1272)&&is_string($x1273)?strcmp($x1272,$x1273)<0:(!is_nan($x1275=JS::toNumber($x1272,$global))&&!is_nan($x1276=JS::toNumber($x1273,$global))&&$x1275<$x1276));if(!JS::toBoolean($x1274,$global)){break;}if($_callbackFn===JS::$undefined||$_callbackFn===NULL){unset($_TypeError,$WTypeError,$STypeError,$UTypeError);$x1278=_61c60c86aef535e2824e55eb30517a85_2($global,$scope,$scope,JS::toString(\'TypeError\',$global),371,22,\'<image>/04_array.js\');$_TypeError=&$x1278[0];list(,$WTypeError,$STypeError,$UTypeError)=$x1278;$x1279=$_TypeError->call;$global->trace[++$global->trace_sp]=array(\'<image>/04_array.js\',371,22);$x1280=$x1279($global,$global,$_TypeError,array(\'Cannot call function on undefined/null.\'),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);if(isset($x1280->class)&&$x1280->class===\'Error\'&&!isset($x1280->properties[\'file\'])&&!isset($x1280->properties[\'line\'])&&!isset($x1280->properties[\'column\'])){$x1280->properties[\'file\']=\'<image>/04_array.js\';$x1280->properties[\'line\']=371;$x1280->properties[\'column\']=22;$x1280->attributes[\'file\']=$x1280->attributes[\'line\']=$x1280->attributes[\'column\']=0;}throw new JSException($x1280,371,22,\'<image>/04_array.js\');}$x1277=JS::toObject($_callbackFn,$global);unset($x1281,$W1281,$S1281,$U1281);$x1282=_61c60c86aef535e2824e55eb30517a85_4($global,$scope,$x1277,JS::toString(\'call\',$global),371,22,\'<image>/04_array.js\');$x1281=&$x1282[0];list(,$W1281,$S1281,$U1281)=$x1282;unset($x1283,$W1283,$S1283,$U1283);$x1284=_61c60c86aef535e2824e55eb30517a85_4($global,$scope,$leThis,JS::toString($_i,$global),371,36,\'<image>/04_array.js\');$x1283=&$x1284[0];list(,$W1283,$S1283,$U1283)=$x1284;if(!(is_object($x1281)&&isset($x1281->call))){unset($_TypeError,$WTypeError,$STypeError,$UTypeError);$x1287=_61c60c86aef535e2824e55eb30517a85_2($global,$scope,$scope,JS::toString(\'TypeError\',$global),371,22,\'<image>/04_array.js\');$_TypeError=&$x1287[0];list(,$WTypeError,$STypeError,$UTypeError)=$x1287;$x1288=$_TypeError->call;$global->trace[++$global->trace_sp]=array(\'<image>/04_array.js\',371,22);$x1289=$x1288($global,$global,$_TypeError,array(\'Trying to call what is not a function.\'),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);if(isset($x1289->class)&&$x1289->class===\'Error\'&&!isset($x1289->properties[\'file\'])&&!isset($x1289->properties[\'line\'])&&!isset($x1289->properties[\'column\'])){$x1289->properties[\'file\']=\'<image>/04_array.js\';$x1289->properties[\'line\']=371;$x1289->properties[\'column\']=22;$x1289->attributes[\'file\']=$x1289->attributes[\'line\']=$x1289->attributes[\'column\']=0;}throw new JSException($x1289,371,22,\'<image>/04_array.js\');}$x1285=$x1281->call;$global->trace[++$global->trace_sp]=array(\'<image>/04_array.js\',371,22);$x1286=$x1285($global,$x1277,$x1281,array($_thisArg,$x1283,$_i,$leThis),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);if(JS::toBoolean($x1286,$global)){if($_returnArray===JS::$undefined||$_returnArray===NULL){unset($_TypeError,$WTypeError,$STypeError,$UTypeError);$x1291=_61c60c86aef535e2824e55eb30517a85_2($global,$scope,$scope,JS::toString(\'TypeError\',$global),372,20,\'<image>/04_array.js\');$_TypeError=&$x1291[0];list(,$WTypeError,$STypeError,$UTypeError)=$x1291;$x1292=$_TypeError->call;$global->trace[++$global->trace_sp]=array(\'<image>/04_array.js\',372,20);$x1293=$x1292($global,$global,$_TypeError,array(\'Cannot call function on undefined/null.\'),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);if(isset($x1293->class)&&$x1293->class===\'Error\'&&!isset($x1293->properties[\'file\'])&&!isset($x1293->properties[\'line\'])&&!isset($x1293->properties[\'column\'])){$x1293->properties[\'file\']=\'<image>/04_array.js\';$x1293->properties[\'line\']=372;$x1293->properties[\'column\']=20;$x1293->attributes[\'file\']=$x1293->attributes[\'line\']=$x1293->attributes[\'column\']=0;}throw new JSException($x1293,372,20,\'<image>/04_array.js\');}$x1290=JS::toObject($_returnArray,$global);unset($x1294,$W1294,$S1294,$U1294);$x1295=_61c60c86aef535e2824e55eb30517a85_4($global,$scope,$x1290,JS::toString(\'push\',$global),372,20,\'<image>/04_array.js\');$x1294=&$x1295[0];list(,$W1294,$S1294,$U1294)=$x1295;unset($x1296,$W1296,$S1296,$U1296);$x1297=_61c60c86aef535e2824e55eb30517a85_4($global,$scope,$leThis,JS::toString($_i,$global),372,25,\'<image>/04_array.js\');$x1296=&$x1297[0];list(,$W1296,$S1296,$U1296)=$x1297;if(!(is_object($x1294)&&isset($x1294->call))){unset($_TypeError,$WTypeError,$STypeError,$UTypeError);$x1300=_61c60c86aef535e2824e55eb30517a85_2($global,$scope,$scope,JS::toString(\'TypeError\',$global),372,20,\'<image>/04_array.js\');$_TypeError=&$x1300[0];list(,$WTypeError,$STypeError,$UTypeError)=$x1300;$x1301=$_TypeError->call;$global->trace[++$global->trace_sp]=array(\'<image>/04_array.js\',372,20);$x1302=$x1301($global,$global,$_TypeError,array(\'Trying to call what is not a function.\'),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);if(isset($x1302->class)&&$x1302->class===\'Error\'&&!isset($x1302->properties[\'file\'])&&!isset($x1302->properties[\'line\'])&&!isset($x1302->properties[\'column\'])){$x1302->properties[\'file\']=\'<image>/04_array.js\';$x1302->properties[\'line\']=372;$x1302->properties[\'column\']=20;$x1302->attributes[\'file\']=$x1302->attributes[\'line\']=$x1302->attributes[\'column\']=0;}throw new JSException($x1302,372,20,\'<image>/04_array.js\');}$x1298=$x1294->call;$global->trace[++$global->trace_sp]=array(\'<image>/04_array.js\',372,20);$x1299=$x1298($global,$x1290,$x1294,array($x1296),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);}}return$_returnArray;return JS::$undefined;}', "\n";
function _61c60c86aef535e2824e55eb30517a85_25($global, $leThis, $fn, $args, $constructor = FALSE) {
...
$x1323 = _61c60c86aef535e2824e55eb30517a85_4($global, $scope, $leThis, JS::toString('length', $global), 380, 10, '<image>/04_array.js');
$x1322 =& $x1323[0]; list(,$W1322,$S1322,$U1322) = $x1323;
$x1319 = JS::toPrimitive($x1322, $global);
$x1320 = JS::toPrimitive(1.0, $global);
...
unset($_arguments, $Warguments, $Sarguments, $Uarguments);
$x1329 = _61c60c86aef535e2824e55eb30517a85_2($global, $scope, $scope, JS::toString('arguments', $global), 380, 25, '<image>/04_array.js');
$_arguments =& $x1329[0]; list(,$Warguments,$Sarguments,$Uarguments) = $x1329;
if ($Uarguments) {
unset($_ReferenceError, $WReferenceError, $SReferenceError, $UReferenceError);
$x1330 = _61c60c86aef535e2824e55eb30517a85_2($global, $scope, $scope, JS::toString('ReferenceError', $global), 380, 25, '<image>/04_array.js');
...
$x1334 = _61c60c86aef535e2824e55eb30517a85_4($global, $scope, $_arguments, JS::toString('length', $global), 380, 34, '<image>/04_array.js');
$x1333 =& $x1334[0]; list(,$W1333,$S1333,$U1333) = $x1334;
$x1326 = JS::toPrimitive($x1333, $global);
$x1327 = JS::toPrimitive(2.0, $global);
...
if (JS::toBoolean($x1318, $global)) {
unset($_TypeError, $WTypeError, $STypeError, $UTypeError);
$x1339 = _61c60c86aef535e2824e55eb30517a85_2($global, $scope, $scope, JS::toString('TypeError', $global), 381, 13, '<image>/04_array.js');
$_TypeError =& $x1339[0]; list(,$WTypeError,$STypeError,$UTypeError) = $x1339;
if ($UTypeError) {
unset($_ReferenceError, $WReferenceError, $SReferenceError, $UReferenceError);
$x1340 = _61c60c86aef535e2824e55eb30517a85_2($global, $scope, $scope, JS::toString('ReferenceError', $global), 381, 13, '<image>/04_array.js');
...
$x1344 = _61c60c86aef535e2824e55eb30517a85_4($global, $scope, $_TypeError, JS::toString('prototype', $global), 381, 9, '<image>/04_array.js');
...
$_i = JS::$undefined;
unset($_arguments, $Warguments, $Sarguments, $Uarguments);
$x1352 = _61c60c86aef535e2824e55eb30517a85_2($global, $scope, $scope, JS::toString('arguments', $global), 386, 6, '<image>/04_array.js');
$_arguments =& $x1352[0]; list(,$Warguments,$Sarguments,$Uarguments) = $x1352;
if ($Uarguments) {
unset($_ReferenceError, $WReferenceError, $SReferenceError, $UReferenceError);
$x1353 = _61c60c86aef535e2824e55eb30517a85_2($global, $scope, $scope, JS::toString('ReferenceError', $global), 386, 6, '<image>/04_array.js');
...
$x1357 = _61c60c86aef535e2824e55eb30517a85_4($global, $scope, $_arguments, JS::toString('length', $global), 386, 15, '<image>/04_array.js');
$x1356 =& $x1357[0]; list(,$W1356,$S1356,$U1356) = $x1357;
$x1349 = JS::toPrimitive($x1356, $global);
$x1350 = JS::toPrimitive(1.0, $global);
...
$x1361 = _61c60c86aef535e2824e55eb30517a85_4($global, $scope, $_arguments, JS::toString(1.0, $global), 387, 20, '<image>/04_array.js');
...
$x1371 = _61c60c86aef535e2824e55eb30517a85_4($global, $scope, $leThis, JS::toString('length', $global), 391, 23, '<image>/04_array.js');
...
$x1376 = _61c60c86aef535e2824e55eb30517a85_4($global, $scope, $leThis, JS::toString($_i, $global), 391, 38, '<image>/04_array.js');
...
$x1378 = _61c60c86aef535e2824e55eb30517a85_4($global, $scope, $leThis, JS::toString($_i, $global), 392, 15, '<image>/04_array.js');
$x1377 =& $x1378[0]; list(,$W1377,$S1377,$U1377) = $x1378;
if ($Uvalue) {$global->properties['value'] = $_value; $_value =& $global->properties['value']; }
$_value = $x1377;
$x1379 = JS::toPrimitive($_i, $global);
$x1380 = JS::toPrimitive(1.0, $global);
...
$x1384 = _61c60c86aef535e2824e55eb30517a85_4($global, $scope, $leThis, JS::toString('length', $global), 396, 19, '<image>/04_array.js');
...
$x1393 = _61c60c86aef535e2824e55eb30517a85_4($global, $scope, $leThis, JS::toString($_i, $global), 397, 11, '<image>/04_array.js');
...
$x1395 = _61c60c86aef535e2824e55eb30517a85_4($global, $scope, $leThis, JS::toString($_i, $global), 398, 34, '<image>/04_array.js');
$x1394 =& $x1395[0]; list(,$W1394,$S1394,$U1394) = $x1395;
if (!(is_object($_callbackFn) && isset($_callbackFn->call))) { 
unset($_TypeError, $WTypeError, $STypeError, $UTypeError);
$x1398 = _61c60c86aef535e2824e55eb30517a85_2($global, $scope, $scope, JS::toString('TypeError', $global), 398, 22, '<image>/04_array.js');
...
echo 'function _61c60c86aef535e2824e55eb30517a85_25($global,$leThis,$fn,$args,$constructor=FALSE){if(isset($fn->boundThis)&&!$constructor){$leThis=$fn->boundThis;}if(isset($fn->boundArgs)){$args=array_merge($fn->boundArgs,$args);}$scope=clone JS::$emptyScope;$scope->up=$fn->scope;$scope->properties[\'arguments\']=clone JS::$argumentsTemplate;$x1317=&$scope->properties[\'arguments\'];$x1317->properties[\'length\']=count($args);foreach($args as$i=>$arg){$x1317->properties[$i]=$args[$i];$x1317->attributes[$i]=JS::WRITABLE|JS::ENUMERABLE|JS::CONFIGURABLE;}$scope->properties[\'callbackFn\']=array_key_exists(0,$args)?$args[0]:JS::$undefined;$_callbackFn=&$scope->properties[\'callbackFn\'];$UcallbackFn=FALSE;$global->scope[++$global->scope_sp]=$scope;unset($x1322,$W1322,$S1322,$U1322);$x1323=_61c60c86aef535e2824e55eb30517a85_4($global,$scope,$leThis,JS::toString(\'length\',$global),380,10,\'<image>/04_array.js\');$x1322=&$x1323[0];list(,$W1322,$S1322,$U1322)=$x1323;$x1319=JS::toPrimitive($x1322,$global);$x1320=JS::toPrimitive(1.0,$global);$x1321=(is_string($x1319)&&is_string($x1320)?strcmp($x1319,$x1320)<0:(!is_nan($x1324=JS::toNumber($x1319,$global))&&!is_nan($x1325=JS::toNumber($x1320,$global))&&$x1324<$x1325));$x1318=$x1321;if(JS::toBoolean($x1318,$global)){unset($_arguments,$Warguments,$Sarguments,$Uarguments);$x1329=_61c60c86aef535e2824e55eb30517a85_2($global,$scope,$scope,JS::toString(\'arguments\',$global),380,25,\'<image>/04_array.js\');$_arguments=&$x1329[0];list(,$Warguments,$Sarguments,$Uarguments)=$x1329;if($Uarguments){unset($_ReferenceError,$WReferenceError,$SReferenceError,$UReferenceError);$x1330=_61c60c86aef535e2824e55eb30517a85_2($global,$scope,$scope,JS::toString(\'ReferenceError\',$global),380,25,\'<image>/04_array.js\');$_ReferenceError=&$x1330[0];list(,$WReferenceError,$SReferenceError,$UReferenceError)=$x1330;$x1331=$_ReferenceError->call;$global->trace[++$global->trace_sp]=array(\'<image>/04_array.js\',380,25);$x1332=$x1331($global,$global,$_ReferenceError,array(\'arguments is not defined\'),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);if(isset($x1332->class)&&$x1332->class===\'Error\'&&!isset($x1332->properties[\'file\'])&&!isset($x1332->properties[\'line\'])&&!isset($x1332->properties[\'column\'])){$x1332->properties[\'file\']=\'<image>/04_array.js\';$x1332->properties[\'line\']=380;$x1332->properties[\'column\']=25;$x1332->attributes[\'file\']=$x1332->attributes[\'line\']=$x1332->attributes[\'column\']=0;}throw new JSException($x1332,380,25,\'<image>/04_array.js\');}unset($x1333,$W1333,$S1333,$U1333);$x1334=_61c60c86aef535e2824e55eb30517a85_4($global,$scope,$_arguments,JS::toString(\'length\',$global),380,34,\'<image>/04_array.js\');$x1333=&$x1334[0];list(,$W1333,$S1333,$U1333)=$x1334;$x1326=JS::toPrimitive($x1333,$global);$x1327=JS::toPrimitive(2.0,$global);$x1328=(is_string($x1326)&&is_string($x1327)?strcmp($x1326,$x1327)<0:(!is_nan($x1335=JS::toNumber($x1326,$global))&&!is_nan($x1336=JS::toNumber($x1327,$global))&&$x1335<$x1336));$x1318=$x1328;}if(JS::toBoolean($x1318,$global)){unset($_TypeError,$WTypeError,$STypeError,$UTypeError);$x1339=_61c60c86aef535e2824e55eb30517a85_2($global,$scope,$scope,JS::toString(\'TypeError\',$global),381,13,\'<image>/04_array.js\');$_TypeError=&$x1339[0];list(,$WTypeError,$STypeError,$UTypeError)=$x1339;if($UTypeError){unset($_ReferenceError,$WReferenceError,$SReferenceError,$UReferenceError);$x1340=_61c60c86aef535e2824e55eb30517a85_2($global,$scope,$scope,JS::toString(\'ReferenceError\',$global),381,13,\'<image>/04_array.js\');$_ReferenceError=&$x1340[0];list(,$WReferenceError,$SReferenceError,$UReferenceError)=$x1340;$x1341=$_ReferenceError->call;$global->trace[++$global->trace_sp]=array(\'<image>/04_array.js\',381,13);$x1342=$x1341($global,$global,$_ReferenceError,array(\'TypeError is not defined\'),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);if(isset($x1342->class)&&$x1342->class===\'Error\'&&!isset($x1342->properties[\'file\'])&&!isset($x1342->properties[\'line\'])&&!isset($x1342->properties[\'column\'])){$x1342->properties[\'file\']=\'<image>/04_array.js\';$x1342->properties[\'line\']=381;$x1342->properties[\'column\']=13;$x1342->attributes[\'file\']=$x1342->attributes[\'line\']=$x1342->attributes[\'column\']=0;}throw new JSException($x1342,381,13,\'<image>/04_array.js\');}$x1337=clone JS::$objectTemplate;unset($x1343,$W1343,$S1343,$U1343);$x1344=_61c60c86aef535e2824e55eb30517a85_4($global,$scope,$_TypeError,JS::toString(\'prototype\',$global),381,9,\'<image>/04_array.js\');$x1343=&$x1344[0];list(,$W1343,$S1343,$U1343)=$x1344;$x1338=$x1343;$x1337->prototype=$x1338;if(!(is_object($_TypeError)&&isset($_TypeError->call))){$x1347=$_TypeError->call;$global->trace[++$global->trace_sp]=array(\'<image>/04_array.js\',381,9);$x1348=$x1347($global,$global,$_TypeError,array(\'Trying to call what is not a function.\'),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);if(isset($x1348->class)&&$x1348->class===\'Error\'&&!isset($x1348->properties[\'file\'])&&!isset($x1348->properties[\'line\'])&&!isset($x1348->properties[\'column\'])){$x1348->properties[\'file\']=\'<image>/04_array.js\';$x1348->properties[\'line\']=381;$x1348->properties[\'column\']=9;$x1348->attributes[\'file\']=$x1348->attributes[\'line\']=$x1348->attributes[\'column\']=0;}throw new JSException($x1348,381,9,\'<image>/04_array.js\');}$x1345=$_TypeError->call;$global->trace[++$global->trace_sp]=array(\'<image>/04_array.js\',381,9);$x1346=$x1345($global,$x1337,$_TypeError,array(\'Array.prototype.reduce(): Array empty, no initial value.\'),true);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);$x1338=$x1346;if(is_object($x1338)&&$x1338!==JS::$undefined){$x1337=$x1338;}if(isset($x1337->class)&&$x1337->class===\'Error\'&&!isset($x1337->properties[\'file\'])&&!isset($x1337->properties[\'line\'])&&!isset($x1337->properties[\'column\'])){$x1337->properties[\'file\']=\'<image>/04_array.js\';$x1337->properties[\'line\']=381;$x1337->properties[\'column\']=3;$x1337->attributes[\'file\']=$x1337->attributes[\'line\']=$x1337->attributes[\'column\']=0;}throw new JSException($x1337,381,3,\'<image>/04_array.js\');}$scope->properties[\'value\']=JS::$undefined;$_value=&$scope->properties[\'value\'];$Uvalue=FALSE;$_value=JS::$undefined;$scope->properties[\'i\']=JS::$undefined;$_i=&$scope->properties[\'i\'];$Ui=FALSE;$_i=JS::$undefined;unset($_arguments,$Warguments,$Sarguments,$Uarguments);$x1352=_61c60c86aef535e2824e55eb30517a85_2($global,$scope,$scope,JS::toString(\'arguments\',$global),386,6,\'<image>/04_array.js\');$_arguments=&$x1352[0];list(,$Warguments,$Sarguments,$Uarguments)=$x1352;if($Uarguments){unset($_ReferenceError,$WReferenceError,$SReferenceError,$UReferenceError);$x1353=_61c60c86aef535e2824e55eb30517a85_2($global,$scope,$scope,JS::toString(\'ReferenceError\',$global),386,6,\'<image>/04_array.js\');$_ReferenceError=&$x1353[0];list(,$WReferenceError,$SReferenceError,$UReferenceError)=$x1353;$x1354=$_ReferenceError->call;$global->trace[++$global->trace_sp]=array(\'<image>/04_array.js\',386,6);$x1355=$x1354($global,$global,$_ReferenceError,array(\'arguments is not defined\'),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);if(isset($x1355->class)&&$x1355->class===\'Error\'&&!isset($x1355->properties[\'file\'])&&!isset($x1355->properties[\'line\'])&&!isset($x1355->properties[\'column\'])){$x1355->properties[\'file\']=\'<image>/04_array.js\';$x1355->properties[\'line\']=386;$x1355->properties[\'column\']=6;$x1355->attributes[\'file\']=$x1355->attributes[\'line\']=$x1355->attributes[\'column\']=0;}throw new JSException($x1355,386,6,\'<image>/04_array.js\');}unset($x1356,$W1356,$S1356,$U1356);$x1357=_61c60c86aef535e2824e55eb30517a85_4($global,$scope,$_arguments,JS::toString(\'length\',$global),386,15,\'<image>/04_array.js\');$x1356=&$x1357[0];list(,$W1356,$S1356,$U1356)=$x1357;$x1349=JS::toPrimitive($x1356,$global);$x1350=JS::toPrimitive(1.0,$global);$x1351=(is_string($x1350)&&is_string($x1349)?strcmp($x1350,$x1349)<0:(!is_nan($x1358=JS::toNumber($x1350,$global))&&!is_nan($x1359=JS::toNumber($x1349,$global))&&$x1358<$x1359));if(JS::toBoolean($x1351,$global)){unset($x1360,$W1360,$S1360,$U1360);$x1361=_61c60c86aef535e2824e55eb30517a85_4($global,$scope,$_arguments,JS::toString(1.0,$global),387,20,\'<image>/04_array.js\');$x1360=&$x1361[0];list(,$W1360,$S1360,$U1360)=$x1361;if($Uvalue){$global->properties[\'value\']=$_value;$_value=&$global->properties[\'value\'];}$_value=$x1360;$x1362=0.0;if($Ui){$global->properties[\'i\']=$_i;$_i=&$global->properties[\'i\'];}$_i=$x1362;}else{for($x1363=0;;++$x1363){if($x1363===0){$x1364=0.0;if($Ui){$global->properties[\'i\']=$_i;$_i=&$global->properties[\'i\'];}$_i=$x1364;}if($x1363!==0){$x1365=++$_i;}unset($x1370,$W1370,$S1370,$U1370);$x1371=_61c60c86aef535e2824e55eb30517a85_4($global,$scope,$leThis,JS::toString(\'length\',$global),391,23,\'<image>/04_array.js\');$x1370=&$x1371[0];list(,$W1370,$S1370,$U1370)=$x1371;$x1367=JS::toPrimitive($_i,$global);$x1368=JS::toPrimitive($x1370,$global);$x1369=(is_string($x1367)&&is_string($x1368)?strcmp($x1367,$x1368)<0:(!is_nan($x1372=JS::toNumber($x1367,$global))&&!is_nan($x1373=JS::toNumber($x1368,$global))&&$x1372<$x1373));$x1366=$x1369;if(JS::toBoolean($x1366,$global)){unset($x1375,$W1375,$S1375,$U1375);$x1376=_61c60c86aef535e2824e55eb30517a85_4($global,$scope,$leThis,JS::toString($_i,$global),391,38,\'<image>/04_array.js\');$x1375=&$x1376[0];list(,$W1375,$S1375,$U1375)=$x1376;$x1374=(((gettype($x1375)===gettype(JS::$undefined)&&$x1375===JS::$undefined))||(((is_float($x1375)||is_int($x1375))&&(is_float(JS::$undefined)||is_int(JS::$undefined)))&&$x1375==JS::$undefined));$x1366=$x1374;}if(!JS::toBoolean($x1366,$global)){break;}}unset($x1377,$W1377,$S1377,$U1377);$x1378=_61c60c86aef535e2824e55eb30517a85_4($global,$scope,$leThis,JS::toString($_i,$global),392,15,\'<image>/04_array.js\');$x1377=&$x1378[0];list(,$W1377,$S1377,$U1377)=$x1378;if($Uvalue){$global->properties[\'value\']=$_value;$_value=&$global->properties[\'value\'];}$_value=$x1377;$x1379=JS::toPrimitive($_i,$global);$x1380=JS::toPrimitive(1.0,$global);$x1381=(is_string($x1379)||is_string($x1380)?JS::toString($x1379,$global).JS::toString($x1380,$global):JS::toNumber($x1379,$global)+JS::toNumber($x1380,$global));if($Ui){$global->properties[\'i\']=$_i;$_i=&$global->properties[\'i\'];}$_i=$x1381;}for($x1382=0;;++$x1382){if($x1382===0){unset($x1383,$W1383,$S1383,$U1383);$x1384=_61c60c86aef535e2824e55eb30517a85_4($global,$scope,$leThis,JS::toString(\'length\',$global),396,19,\'<image>/04_array.js\');$x1383=&$x1384[0];list(,$W1383,$S1383,$U1383)=$x1384;$scope->properties[\'l\']=JS::$undefined;$_l=&$scope->properties[\'l\'];$Ul=FALSE;$_l=$x1383;}if($x1382!==0){$x1385=++$_i;}$x1386=JS::toPrimitive($_i,$global);$x1387=JS::toPrimitive($_l,$global);$x1388=(is_string($x1386)&&is_string($x1387)?strcmp($x1386,$x1387)<0:(!is_nan($x1389=JS::toNumber($x1386,$global))&&!is_nan($x1390=JS::toNumber($x1387,$global))&&$x1389<$x1390));if(!JS::toBoolean($x1388,$global)){break;}unset($x1392,$W1392,$S1392,$U1392);$x1393=_61c60c86aef535e2824e55eb30517a85_4($global,$scope,$leThis,JS::toString($_i,$global),397,11,\'<image>/04_array.js\');$x1392=&$x1393[0];list(,$W1392,$S1392,$U1392)=$x1393;$x1391=!(((gettype($x1392)===gettype(JS::$undefined)&&$x1392===JS::$undefined))||(((is_float($x1392)||is_int($x1392))&&(is_float(JS::$undefined)||is_int(JS::$undefined)))&&$x1392==JS::$undefined));if(JS::toBoolean($x1391,$global)){unset($x1394,$W1394,$S1394,$U1394);$x1395=_61c60c86aef535e2824e55eb30517a85_4($global,$scope,$leThis,JS::toString($_i,$global),398,34,\'<image>/04_array.js\');$x1394=&$x1395[0];list(,$W1394,$S1394,$U1394)=$x1395;if(!(is_object($_callbackFn)&&isset($_callbackFn->call))){unset($_TypeError,$WTypeError,$STypeError,$UTypeError);$x1398=_61c60c86aef535e2824e55eb30517a85_2($global,$scope,$scope,JS::toString(\'TypeError\',$global),398,22,\'<image>/04_array.js\');$_TypeError=&$x1398[0];list(,$WTypeError,$STypeError,$UTypeError)=$x1398;$x1399=$_TypeError->call;$global->trace[++$global->trace_sp]=array(\'<image>/04_array.js\',398,22);$x1400=$x1399($global,$global,$_TypeError,array(\'Trying to call what is not a function.\'),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);if(isset($x1400->class)&&$x1400->class===\'Error\'&&!isset($x1400->properties[\'file\'])&&!isset($x1400->properties[\'line\'])&&!isset($x1400->properties[\'column\'])){$x1400->properties[\'file\']=\'<image>/04_array.js\';$x1400->properties[\'line\']=398;$x1400->properties[\'column\']=22;$x1400->attributes[\'file\']=$x1400->attributes[\'line\']=$x1400->attributes[\'column\']=0;}throw new JSException($x1400,398,22,\'<image>/04_array.js\');}$x1396=$_callbackFn->call;$global->trace[++$global->trace_sp]=array(\'<image>/04_array.js\',398,22);$x1397=$x1396($global,$global,$_callbackFn,array($_value,$x1394,$_i,$leThis),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);if($Uvalue){$global->properties[\'value\']=$_value;$_value=&$global->properties[\'value\'];}$_value=$x1397;}}return$_value;return JS::$undefined;}', "\n";
function _61c60c86aef535e2824e55eb30517a85_26($global, $leThis, $fn, $args, $constructor = FALSE) {
...
$x1421 = _61c60c86aef535e2824e55eb30517a85_4($global, $scope, $leThis, JS::toString('length', $global), 406, 10, '<image>/04_array.js');
$x1420 =& $x1421[0]; list(,$W1420,$S1420,$U1420) = $x1421;
$x1417 = JS::toPrimitive($x1420, $global);
$x1418 = JS::toPrimitive(1.0, $global);
...
unset($_arguments, $Warguments, $Sarguments, $Uarguments);
$x1427 = _61c60c86aef535e2824e55eb30517a85_2($global, $scope, $scope, JS::toString('arguments', $global), 406, 25, '<image>/04_array.js');
$_arguments =& $x1427[0]; list(,$Warguments,$Sarguments,$Uarguments) = $x1427;
if ($Uarguments) {
unset($_ReferenceError, $WReferenceError, $SReferenceError, $UReferenceError);
$x1428 = _61c60c86aef535e2824e55eb30517a85_2($global, $scope, $scope, JS::toString('ReferenceError', $global), 406, 25, '<image>/04_array.js');
...
$x1432 = _61c60c86aef535e2824e55eb30517a85_4($global, $scope, $_arguments, JS::toString('length', $global), 406, 34, '<image>/04_array.js');
$x1431 =& $x1432[0]; list(,$W1431,$S1431,$U1431) = $x1432;
$x1424 = JS::toPrimitive($x1431, $global);
$x1425 = JS::toPrimitive(2.0, $global);
...
if (JS::toBoolean($x1416, $global)) {
unset($_TypeError, $WTypeError, $STypeError, $UTypeError);
$x1437 = _61c60c86aef535e2824e55eb30517a85_2($global, $scope, $scope, JS::toString('TypeError', $global), 407, 13, '<image>/04_array.js');
$_TypeError =& $x1437[0]; list(,$WTypeError,$STypeError,$UTypeError) = $x1437;
if ($UTypeError) {
unset($_ReferenceError, $WReferenceError, $SReferenceError, $UReferenceError);
$x1438 = _61c60c86aef535e2824e55eb30517a85_2($global, $scope, $scope, JS::toString('ReferenceError', $global), 407, 13, '<image>/04_array.js');
...
$x1442 = _61c60c86aef535e2824e55eb30517a85_4($global, $scope, $_TypeError, JS::toString('prototype', $global), 407, 9, '<image>/04_array.js');
...
$_i = JS::$undefined;
unset($_arguments, $Warguments, $Sarguments, $Uarguments);
$x1450 = _61c60c86aef535e2824e55eb30517a85_2($global, $scope, $scope, JS::toString('arguments', $global), 412, 6, '<image>/04_array.js');
$_arguments =& $x1450[0]; list(,$Warguments,$Sarguments,$Uarguments) = $x1450;
if ($Uarguments) {
unset($_ReferenceError, $WReferenceError, $SReferenceError, $UReferenceError);
$x1451 = _61c60c86aef535e2824e55eb30517a85_2($global, $scope, $scope, JS::toString('ReferenceError', $global), 412, 6, '<image>/04_array.js');
...
$x1455 = _61c60c86aef535e2824e55eb30517a85_4($global, $scope, $_arguments, JS::toString('length', $global), 412, 15, '<image>/04_array.js');
$x1454 =& $x1455[0]; list(,$W1454,$S1454,$U1454) = $x1455;
$x1447 = JS::toPrimitive($x1454, $global);
$x1448 = JS::toPrimitive(1.0, $global);
...
$x1459 = _61c60c86aef535e2824e55eb30517a85_4($global, $scope, $_arguments, JS::toString(1.0, $global), 413, 20, '<image>/04_array.js');
$x1458 =& $x1459[0]; list(,$W1458,$S1458,$U1458) = $x1459;
if ($Uvalue) {$global->properties['value'] = $_value; $_value =& $global->properties['value']; }
$_value = $x1458;
unset($x1460, $W1460, $S1460, $U1460);
$x1461 = _61c60c86aef535e2824e55eb30517a85_4($global, $scope, $leThis, JS::toString('length', $global), 414, 11, '<image>/04_array.js');
$x1460 =& $x1461[0]; list(,$W1460,$S1460,$U1460) = $x1461;
$x1462 = (JS::toNumber($x1460, $global) - JS::toNumber(1.0, $global));
if ($Ui) {$global->properties['i'] = $_i; $_i =& $global->properties['i']; }
$_i = $x1462;;
}
else {
...
$x1465 = _61c60c86aef535e2824e55eb30517a85_4($global, $scope, $leThis, JS::toString('length', $global), 417, 16, '<image>/04_array.js');
$x1464 =& $x1465[0]; list(,$W1464,$S1464,$U1464) = $x1465;
$x1466 = (JS::toNumber($x1464, $global) - JS::toNumber(1.0, $global));
if ($Ui) {$global->properties['i'] = $_i; $_i =& $global->properties['i']; }
$_i = $x1466;
}
if ($x1463 !== 0) {
...
$x1470 = JS::toPrimitive(0.0, $global);
...
$x1476 = _61c60c86aef535e2824e55eb30517a85_4($global, $scope, $leThis, JS::toString($_i, $global), 417, 43, '<image>/04_array.js');
...
$x1478 = _61c60c86aef535e2824e55eb30517a85_4($global, $scope, $leThis, JS::toString($_i, $global), 418, 15, '<image>/04_array.js');
$x1477 =& $x1478[0]; list(,$W1477,$S1477,$U1477) = $x1478;
if ($Uvalue) {$global->properties['value'] = $_value; $_value =& $global->properties['value']; }
$_value = $x1477;
$x1479 = (JS::toNumber($_i, $global) - JS::toNumber(1.0, $global));
if ($Ui) {$global->properties['i'] = $_i; $_i =& $global->properties['i']; }
$_i = $x1479;;
};
for ($x1480 = 0;; ++$x1480) {
...
$x1483 = JS::toPrimitive(0.0, $global);
...
$x1489 = _61c60c86aef535e2824e55eb30517a85_4($global, $scope, $leThis, JS::toString($_i, $global), 423, 11, '<image>/04_array.js');
...
$x1491 = _61c60c86aef535e2824e55eb30517a85_4($global, $scope, $leThis, JS::toString($_i, $global), 424, 34, '<image>/04_array.js');
$x1490 =& $x1491[0]; list(,$W1490,$S1490,$U1490) = $x1491;
if (!(is_object($_callbackFn) && isset($_callbackFn->call))) { 
unset($_TypeError, $WTypeError, $STypeError, $UTypeError);
$x1494 = _61c60c86aef535e2824e55eb30517a85_2($global, $scope, $scope, JS::toString('TypeError', $global), 424, 22, '<image>/04_array.js');
...
echo 'function _61c60c86aef535e2824e55eb30517a85_26($global,$leThis,$fn,$args,$constructor=FALSE){if(isset($fn->boundThis)&&!$constructor){$leThis=$fn->boundThis;}if(isset($fn->boundArgs)){$args=array_merge($fn->boundArgs,$args);}$scope=clone JS::$emptyScope;$scope->up=$fn->scope;$scope->properties[\'arguments\']=clone JS::$argumentsTemplate;$x1415=&$scope->properties[\'arguments\'];$x1415->properties[\'length\']=count($args);foreach($args as$i=>$arg){$x1415->properties[$i]=$args[$i];$x1415->attributes[$i]=JS::WRITABLE|JS::ENUMERABLE|JS::CONFIGURABLE;}$scope->properties[\'callbackFn\']=array_key_exists(0,$args)?$args[0]:JS::$undefined;$_callbackFn=&$scope->properties[\'callbackFn\'];$UcallbackFn=FALSE;$global->scope[++$global->scope_sp]=$scope;unset($x1420,$W1420,$S1420,$U1420);$x1421=_61c60c86aef535e2824e55eb30517a85_4($global,$scope,$leThis,JS::toString(\'length\',$global),406,10,\'<image>/04_array.js\');$x1420=&$x1421[0];list(,$W1420,$S1420,$U1420)=$x1421;$x1417=JS::toPrimitive($x1420,$global);$x1418=JS::toPrimitive(1.0,$global);$x1419=(is_string($x1417)&&is_string($x1418)?strcmp($x1417,$x1418)<0:(!is_nan($x1422=JS::toNumber($x1417,$global))&&!is_nan($x1423=JS::toNumber($x1418,$global))&&$x1422<$x1423));$x1416=$x1419;if(JS::toBoolean($x1416,$global)){unset($_arguments,$Warguments,$Sarguments,$Uarguments);$x1427=_61c60c86aef535e2824e55eb30517a85_2($global,$scope,$scope,JS::toString(\'arguments\',$global),406,25,\'<image>/04_array.js\');$_arguments=&$x1427[0];list(,$Warguments,$Sarguments,$Uarguments)=$x1427;if($Uarguments){unset($_ReferenceError,$WReferenceError,$SReferenceError,$UReferenceError);$x1428=_61c60c86aef535e2824e55eb30517a85_2($global,$scope,$scope,JS::toString(\'ReferenceError\',$global),406,25,\'<image>/04_array.js\');$_ReferenceError=&$x1428[0];list(,$WReferenceError,$SReferenceError,$UReferenceError)=$x1428;$x1429=$_ReferenceError->call;$global->trace[++$global->trace_sp]=array(\'<image>/04_array.js\',406,25);$x1430=$x1429($global,$global,$_ReferenceError,array(\'arguments is not defined\'),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);if(isset($x1430->class)&&$x1430->class===\'Error\'&&!isset($x1430->properties[\'file\'])&&!isset($x1430->properties[\'line\'])&&!isset($x1430->properties[\'column\'])){$x1430->properties[\'file\']=\'<image>/04_array.js\';$x1430->properties[\'line\']=406;$x1430->properties[\'column\']=25;$x1430->attributes[\'file\']=$x1430->attributes[\'line\']=$x1430->attributes[\'column\']=0;}throw new JSException($x1430,406,25,\'<image>/04_array.js\');}unset($x1431,$W1431,$S1431,$U1431);$x1432=_61c60c86aef535e2824e55eb30517a85_4($global,$scope,$_arguments,JS::toString(\'length\',$global),406,34,\'<image>/04_array.js\');$x1431=&$x1432[0];list(,$W1431,$S1431,$U1431)=$x1432;$x1424=JS::toPrimitive($x1431,$global);$x1425=JS::toPrimitive(2.0,$global);$x1426=(is_string($x1424)&&is_string($x1425)?strcmp($x1424,$x1425)<0:(!is_nan($x1433=JS::toNumber($x1424,$global))&&!is_nan($x1434=JS::toNumber($x1425,$global))&&$x1433<$x1434));$x1416=$x1426;}if(JS::toBoolean($x1416,$global)){unset($_TypeError,$WTypeError,$STypeError,$UTypeError);$x1437=_61c60c86aef535e2824e55eb30517a85_2($global,$scope,$scope,JS::toString(\'TypeError\',$global),407,13,\'<image>/04_array.js\');$_TypeError=&$x1437[0];list(,$WTypeError,$STypeError,$UTypeError)=$x1437;if($UTypeError){unset($_ReferenceError,$WReferenceError,$SReferenceError,$UReferenceError);$x1438=_61c60c86aef535e2824e55eb30517a85_2($global,$scope,$scope,JS::toString(\'ReferenceError\',$global),407,13,\'<image>/04_array.js\');$_ReferenceError=&$x1438[0];list(,$WReferenceError,$SReferenceError,$UReferenceError)=$x1438;$x1439=$_ReferenceError->call;$global->trace[++$global->trace_sp]=array(\'<image>/04_array.js\',407,13);$x1440=$x1439($global,$global,$_ReferenceError,array(\'TypeError is not defined\'),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);if(isset($x1440->class)&&$x1440->class===\'Error\'&&!isset($x1440->properties[\'file\'])&&!isset($x1440->properties[\'line\'])&&!isset($x1440->properties[\'column\'])){$x1440->properties[\'file\']=\'<image>/04_array.js\';$x1440->properties[\'line\']=407;$x1440->properties[\'column\']=13;$x1440->attributes[\'file\']=$x1440->attributes[\'line\']=$x1440->attributes[\'column\']=0;}throw new JSException($x1440,407,13,\'<image>/04_array.js\');}$x1435=clone JS::$objectTemplate;unset($x1441,$W1441,$S1441,$U1441);$x1442=_61c60c86aef535e2824e55eb30517a85_4($global,$scope,$_TypeError,JS::toString(\'prototype\',$global),407,9,\'<image>/04_array.js\');$x1441=&$x1442[0];list(,$W1441,$S1441,$U1441)=$x1442;$x1436=$x1441;$x1435->prototype=$x1436;if(!(is_object($_TypeError)&&isset($_TypeError->call))){$x1445=$_TypeError->call;$global->trace[++$global->trace_sp]=array(\'<image>/04_array.js\',407,9);$x1446=$x1445($global,$global,$_TypeError,array(\'Trying to call what is not a function.\'),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);if(isset($x1446->class)&&$x1446->class===\'Error\'&&!isset($x1446->properties[\'file\'])&&!isset($x1446->properties[\'line\'])&&!isset($x1446->properties[\'column\'])){$x1446->properties[\'file\']=\'<image>/04_array.js\';$x1446->properties[\'line\']=407;$x1446->properties[\'column\']=9;$x1446->attributes[\'file\']=$x1446->attributes[\'line\']=$x1446->attributes[\'column\']=0;}throw new JSException($x1446,407,9,\'<image>/04_array.js\');}$x1443=$_TypeError->call;$global->trace[++$global->trace_sp]=array(\'<image>/04_array.js\',407,9);$x1444=$x1443($global,$x1435,$_TypeError,array(\'Array.prototype.reduceRight(): Array empty, no initial value.\'),true);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);$x1436=$x1444;if(is_object($x1436)&&$x1436!==JS::$undefined){$x1435=$x1436;}if(isset($x1435->class)&&$x1435->class===\'Error\'&&!isset($x1435->properties[\'file\'])&&!isset($x1435->properties[\'line\'])&&!isset($x1435->properties[\'column\'])){$x1435->properties[\'file\']=\'<image>/04_array.js\';$x1435->properties[\'line\']=407;$x1435->properties[\'column\']=3;$x1435->attributes[\'file\']=$x1435->attributes[\'line\']=$x1435->attributes[\'column\']=0;}throw new JSException($x1435,407,3,\'<image>/04_array.js\');}$scope->properties[\'value\']=JS::$undefined;$_value=&$scope->properties[\'value\'];$Uvalue=FALSE;$_value=JS::$undefined;$scope->properties[\'i\']=JS::$undefined;$_i=&$scope->properties[\'i\'];$Ui=FALSE;$_i=JS::$undefined;unset($_arguments,$Warguments,$Sarguments,$Uarguments);$x1450=_61c60c86aef535e2824e55eb30517a85_2($global,$scope,$scope,JS::toString(\'arguments\',$global),412,6,\'<image>/04_array.js\');$_arguments=&$x1450[0];list(,$Warguments,$Sarguments,$Uarguments)=$x1450;if($Uarguments){unset($_ReferenceError,$WReferenceError,$SReferenceError,$UReferenceError);$x1451=_61c60c86aef535e2824e55eb30517a85_2($global,$scope,$scope,JS::toString(\'ReferenceError\',$global),412,6,\'<image>/04_array.js\');$_ReferenceError=&$x1451[0];list(,$WReferenceError,$SReferenceError,$UReferenceError)=$x1451;$x1452=$_ReferenceError->call;$global->trace[++$global->trace_sp]=array(\'<image>/04_array.js\',412,6);$x1453=$x1452($global,$global,$_ReferenceError,array(\'arguments is not defined\'),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);if(isset($x1453->class)&&$x1453->class===\'Error\'&&!isset($x1453->properties[\'file\'])&&!isset($x1453->properties[\'line\'])&&!isset($x1453->properties[\'column\'])){$x1453->properties[\'file\']=\'<image>/04_array.js\';$x1453->properties[\'line\']=412;$x1453->properties[\'column\']=6;$x1453->attributes[\'file\']=$x1453->attributes[\'line\']=$x1453->attributes[\'column\']=0;}throw new JSException($x1453,412,6,\'<image>/04_array.js\');}unset($x1454,$W1454,$S1454,$U1454);$x1455=_61c60c86aef535e2824e55eb30517a85_4($global,$scope,$_arguments,JS::toString(\'length\',$global),412,15,\'<image>/04_array.js\');$x1454=&$x1455[0];list(,$W1454,$S1454,$U1454)=$x1455;$x1447=JS::toPrimitive($x1454,$global);$x1448=JS::toPrimitive(1.0,$global);$x1449=(is_string($x1448)&&is_string($x1447)?strcmp($x1448,$x1447)<0:(!is_nan($x1456=JS::toNumber($x1448,$global))&&!is_nan($x1457=JS::toNumber($x1447,$global))&&$x1456<$x1457));if(JS::toBoolean($x1449,$global)){unset($x1458,$W1458,$S1458,$U1458);$x1459=_61c60c86aef535e2824e55eb30517a85_4($global,$scope,$_arguments,JS::toString(1.0,$global),413,20,\'<image>/04_array.js\');$x1458=&$x1459[0];list(,$W1458,$S1458,$U1458)=$x1459;if($Uvalue){$global->properties[\'value\']=$_value;$_value=&$global->properties[\'value\'];}$_value=$x1458;unset($x1460,$W1460,$S1460,$U1460);$x1461=_61c60c86aef535e2824e55eb30517a85_4($global,$scope,$leThis,JS::toString(\'length\',$global),414,11,\'<image>/04_array.js\');$x1460=&$x1461[0];list(,$W1460,$S1460,$U1460)=$x1461;$x1462=(JS::toNumber($x1460,$global)-JS::toNumber(1.0,$global));if($Ui){$global->properties[\'i\']=$_i;$_i=&$global->properties[\'i\'];}$_i=$x1462;}else{for($x1463=0;;++$x1463){if($x1463===0){unset($x1464,$W1464,$S1464,$U1464);$x1465=_61c60c86aef535e2824e55eb30517a85_4($global,$scope,$leThis,JS::toString(\'length\',$global),417,16,\'<image>/04_array.js\');$x1464=&$x1465[0];list(,$W1464,$S1464,$U1464)=$x1465;$x1466=(JS::toNumber($x1464,$global)-JS::toNumber(1.0,$global));if($Ui){$global->properties[\'i\']=$_i;$_i=&$global->properties[\'i\'];}$_i=$x1466;}if($x1463!==0){$x1467=--$_i;}$x1469=JS::toPrimitive($_i,$global);$x1470=JS::toPrimitive(0.0,$global);$x1471=!(is_string($x1469)&&is_string($x1470)?strcmp($x1469,$x1470)<0:(!is_nan($x1472=JS::toNumber($x1469,$global))&&!is_nan($x1473=JS::toNumber($x1470,$global))&&$x1472<$x1473));$x1468=$x1471;if(JS::toBoolean($x1468,$global)){unset($x1475,$W1475,$S1475,$U1475);$x1476=_61c60c86aef535e2824e55eb30517a85_4($global,$scope,$leThis,JS::toString($_i,$global),417,43,\'<image>/04_array.js\');$x1475=&$x1476[0];list(,$W1475,$S1475,$U1475)=$x1476;$x1474=(((gettype($x1475)===gettype(JS::$undefined)&&$x1475===JS::$undefined))||(((is_float($x1475)||is_int($x1475))&&(is_float(JS::$undefined)||is_int(JS::$undefined)))&&$x1475==JS::$undefined));$x1468=$x1474;}if(!JS::toBoolean($x1468,$global)){break;}}unset($x1477,$W1477,$S1477,$U1477);$x1478=_61c60c86aef535e2824e55eb30517a85_4($global,$scope,$leThis,JS::toString($_i,$global),418,15,\'<image>/04_array.js\');$x1477=&$x1478[0];list(,$W1477,$S1477,$U1477)=$x1478;if($Uvalue){$global->properties[\'value\']=$_value;$_value=&$global->properties[\'value\'];}$_value=$x1477;$x1479=(JS::toNumber($_i,$global)-JS::toNumber(1.0,$global));if($Ui){$global->properties[\'i\']=$_i;$_i=&$global->properties[\'i\'];}$_i=$x1479;}for($x1480=0;;++$x1480){if($x1480!==0){$x1481=--$_i;}$x1482=JS::toPrimitive($_i,$global);$x1483=JS::toPrimitive(0.0,$global);$x1484=!(is_string($x1482)&&is_string($x1483)?strcmp($x1482,$x1483)<0:(!is_nan($x1485=JS::toNumber($x1482,$global))&&!is_nan($x1486=JS::toNumber($x1483,$global))&&$x1485<$x1486));if(!JS::toBoolean($x1484,$global)){break;}unset($x1488,$W1488,$S1488,$U1488);$x1489=_61c60c86aef535e2824e55eb30517a85_4($global,$scope,$leThis,JS::toString($_i,$global),423,11,\'<image>/04_array.js\');$x1488=&$x1489[0];list(,$W1488,$S1488,$U1488)=$x1489;$x1487=!(((gettype($x1488)===gettype(JS::$undefined)&&$x1488===JS::$undefined))||(((is_float($x1488)||is_int($x1488))&&(is_float(JS::$undefined)||is_int(JS::$undefined)))&&$x1488==JS::$undefined));if(JS::toBoolean($x1487,$global)){unset($x1490,$W1490,$S1490,$U1490);$x1491=_61c60c86aef535e2824e55eb30517a85_4($global,$scope,$leThis,JS::toString($_i,$global),424,34,\'<image>/04_array.js\');$x1490=&$x1491[0];list(,$W1490,$S1490,$U1490)=$x1491;if(!(is_object($_callbackFn)&&isset($_callbackFn->call))){unset($_TypeError,$WTypeError,$STypeError,$UTypeError);$x1494=_61c60c86aef535e2824e55eb30517a85_2($global,$scope,$scope,JS::toString(\'TypeError\',$global),424,22,\'<image>/04_array.js\');$_TypeError=&$x1494[0];list(,$WTypeError,$STypeError,$UTypeError)=$x1494;$x1495=$_TypeError->call;$global->trace[++$global->trace_sp]=array(\'<image>/04_array.js\',424,22);$x1496=$x1495($global,$global,$_TypeError,array(\'Trying to call what is not a function.\'),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);if(isset($x1496->class)&&$x1496->class===\'Error\'&&!isset($x1496->properties[\'file\'])&&!isset($x1496->properties[\'line\'])&&!isset($x1496->properties[\'column\'])){$x1496->properties[\'file\']=\'<image>/04_array.js\';$x1496->properties[\'line\']=424;$x1496->properties[\'column\']=22;$x1496->attributes[\'file\']=$x1496->attributes[\'line\']=$x1496->attributes[\'column\']=0;}throw new JSException($x1496,424,22,\'<image>/04_array.js\');}$x1492=$_callbackFn->call;$global->trace[++$global->trace_sp]=array(\'<image>/04_array.js\',424,22);$x1493=$x1492($global,$global,$_callbackFn,array($_value,$x1490,$_i,$leThis),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);if($Uvalue){$global->properties[\'value\']=$_value;$_value=&$global->properties[\'value\'];}$_value=$x1493;}}return$_value;return JS::$undefined;}', "\n";
function _61c60c86aef535e2824e55eb30517a85_28($global, $leThis, $fn, $args, $constructor = FALSE) {
...
$scope->up = $fn->scope;
$scope->properties['arguments'] = clone JS::$argumentsTemplate;
$x1522 =& $scope->properties['arguments'];
$x1522->properties['length'] = count($args);
foreach ($args as $i => $arg) {
$x1522->properties[$i] = $args[$i];
$x1522->attributes[$i] = JS::WRITABLE | JS::ENUMERABLE | JS::CONFIGURABLE;
}
...
$Uy = FALSE;
$scope->properties['sameValueZero'] = $fn;
$_sameValueZero =& $scope->properties['sameValueZero'];
$global->scope[++$global->scope_sp] = $scope;
$x1524 = (((gettype($_x) === gettype($_y) && $_x === $_y))|| (((is_float($_x) || is_int($_x)) && (is_float($_y) || is_int($_y))) && $_x == $_y));
$x1523 = $x1524;
if (!JS::toBoolean($x1523, $global)) {
$x1529 = $_x;
$x1529 = ($x1529 === JS::$undefined ? 'undefined' : (is_int($x1529) || is_float($x1529) ? 'number' : (is_bool($x1529) ? 'boolean' : (is_string($x1529) ? 'string' : (is_object($x1529) && isset($x1529->call) ? 'function' : 'object')))));
$x1528 = (((gettype($x1529) === gettype('number') && $x1529 === 'number'))|| (((is_float($x1529) || is_int($x1529)) && (is_float('number') || is_int('number'))) && $x1529 == 'number'));
$x1527 = $x1528;
if (JS::toBoolean($x1527, $global)) {
$x1531 = $_y;
$x1531 = ($x1531 === JS::$undefined ? 'undefined' : (is_int($x1531) || is_float($x1531) ? 'number' : (is_bool($x1531) ? 'boolean' : (is_string($x1531) ? 'string' : (is_object($x1531) && isset($x1531->call) ? 'function' : 'object')))));
$x1530 = (((gettype($x1531) === gettype('number') && $x1531 === 'number'))|| (((is_float($x1531) || is_int($x1531)) && (is_float('number') || is_int('number'))) && $x1531 == 'number'));
$x1527 = $x1530; }
$x1526 = $x1527;
if (JS::toBoolean($x1526, $global)) {
unset($_isNaN, $WisNaN, $SisNaN, $UisNaN);
$x1532 = _61c60c86aef535e2824e55eb30517a85_2($global, $scope, $scope, JS::toString('isNaN', $global), 461, 73, '<image>/04_array.js');
$_isNaN =& $x1532[0]; list(,$WisNaN,$SisNaN,$UisNaN) = $x1532;
if ($UisNaN) {
unset($_ReferenceError, $WReferenceError, $SReferenceError, $UReferenceError);
$x1533 = _61c60c86aef535e2824e55eb30517a85_2($global, $scope, $scope, JS::toString('ReferenceError', $global), 461, 73, '<image>/04_array.js');
$_ReferenceError =& $x1533[0]; list(,$WReferenceError,$SReferenceError,$UReferenceError) = $x1533;
$x1534 = $_ReferenceError->call;
$global->trace[++$global->trace_sp] = array('<image>/04_array.js', 461, 73);
$x1535 = $x1534($global, $global, $_ReferenceError, array('isNaN is not defined'), false);
unset($global->trace[$global->trace_sp--], $global->scope[$global->scope_sp--]);
if (isset($x1535->class) && $x1535->class === 'Error' && !isset($x1535->properties['file']) && !isset($x1535->properties['line']) && !isset($x1535->properties['column'])) {$x1535->properties['file'] = '<image>/04_array.js';$x1535->properties['line'] = 461;$x1535->properties['column'] = 73;$x1535->attributes['file'] = $x1535->attributes['line'] = $x1535->attributes['column'] = 0; }
throw new JSException($x1535, 461, 73, '<image>/04_array.js');
}
if (!(is_object($_isNaN) && isset($_isNaN->call))) { 
unset($_TypeError, $WTypeError, $STypeError, $UTypeError);
$x1538 = _61c60c86aef535e2824e55eb30517a85_2($global, $scope, $scope, JS::toString('TypeError', $global), 461, 78, '<image>/04_array.js');
$_TypeError =& $x1538[0]; list(,$WTypeError,$STypeError,$UTypeError) = $x1538;
$x1539 = $_TypeError->call;
$global->trace[++$global->trace_sp] = array('<image>/04_array.js', 461, 78);
$x1540 = $x1539($global, $global, $_TypeError, array('Trying to call what is not a function.'), false);
unset($global->trace[$global->trace_sp--], $global->scope[$global->scope_sp--]);
if (isset($x1540->class) && $x1540->class === 'Error' && !isset($x1540->properties['file']) && !isset($x1540->properties['line']) && !isset($x1540->properties['column'])) {$x1540->properties['file'] = '<image>/04_array.js';$x1540->properties['line'] = 461;$x1540->properties['column'] = 78;$x1540->attributes['file'] = $x1540->attributes['line'] = $x1540->attributes['column'] = 0; }
throw new JSException($x1540, 461, 78, '<image>/04_array.js');
}
$x1536 = $_isNaN->call;
$global->trace[++$global->trace_sp] = array('<image>/04_array.js', 461, 78);
$x1537 = $x1536($global, $global, $_isNaN, array($_x), false);
unset($global->trace[$global->trace_sp--], $global->scope[$global->scope_sp--]);
$x1526 = $x1537; }
$x1525 = $x1526;
if (JS::toBoolean($x1525, $global)) {
unset($_isNaN, $WisNaN, $SisNaN, $UisNaN);
$x1541 = _61c60c86aef535e2824e55eb30517a85_2($global, $scope, $scope, JS::toString('isNaN', $global), 461, 85, '<image>/04_array.js');
$_isNaN =& $x1541[0]; list(,$WisNaN,$SisNaN,$UisNaN) = $x1541;
if ($UisNaN) {
unset($_ReferenceError, $WReferenceError, $SReferenceError, $UReferenceError);
$x1542 = _61c60c86aef535e2824e55eb30517a85_2($global, $scope, $scope, JS::toString('ReferenceError', $global), 461, 85, '<image>/04_array.js');
$_ReferenceError =& $x1542[0]; list(,$WReferenceError,$SReferenceError,$UReferenceError) = $x1542;
$x1543 = $_ReferenceError->call;
$global->trace[++$global->trace_sp] = array('<image>/04_array.js', 461, 85);
$x1544 = $x1543($global, $global, $_ReferenceError, array('isNaN is not defined'), false);
unset($global->trace[$global->trace_sp--], $global->scope[$global->scope_sp--]);
if (isset($x1544->class) && $x1544->class === 'Error' && !isset($x1544->properties['file']) && !isset($x1544->properties['line']) && !isset($x1544->properties['column'])) {$x1544->properties['file'] = '<image>/04_array.js';$x1544->properties['line'] = 461;$x1544->properties['column'] = 85;$x1544->attributes['file'] = $x1544->attributes['line'] = $x1544->attributes['column'] = 0; }
throw new JSException($x1544, 461, 85, '<image>/04_array.js');
}
if (!(is_object($_isNaN) && isset($_isNaN->call))) { 
unset($_TypeError, $WTypeError, $STypeError, $UTypeError);
$x1547 = _61c60c86aef535e2824e55eb30517a85_2($global, $scope, $scope, JS::toString('TypeError', $global), 461, 90, '<image>/04_array.js');
$_TypeError =& $x1547[0]; list(,$WTypeError,$STypeError,$UTypeError) = $x1547;
$x1548 = $_TypeError->call;
$global->trace[++$global->trace_sp] = array('<image>/04_array.js', 461, 90);
$x1549 = $x1548($global, $global, $_TypeError, array('Trying to call what is not a function.'), false);
unset($global->trace[$global->trace_sp--], $global->scope[$global->scope_sp--]);
if (isset($x1549->class) && $x1549->class === 'Error' && !isset($x1549->properties['file']) && !isset($x1549->properties['line']) && !isset($x1549->properties['column'])) {$x1549->properties['file'] = '<image>/04_array.js';$x1549->properties['line'] = 461;$x1549->properties['column'] = 90;$x1549->attributes['file'] = $x1549->attributes['line'] = $x1549->attributes['column'] = 0; }
throw new JSException($x1549, 461, 90, '<image>/04_array.js');
}
$x1545 = $_isNaN->call;
$global->trace[++$global->trace_sp] = array('<image>/04_array.js', 461, 90);
$x1546 = $x1545($global, $global, $_isNaN, array($_y), false);
unset($global->trace[$global->trace_sp--], $global->scope[$global->scope_sp--]);
$x1525 = $x1546; }
$x1523 = $x1525; }
return $x1523;
...
echo 'function _61c60c86aef535e2824e55eb30517a85_28($global,$leThis,$fn,$args,$constructor=FALSE){if(isset($fn->boundThis)&&!$constructor){$leThis=$fn->boundThis;}if(isset($fn->boundArgs)){$args=array_merge($fn->boundArgs,$args);}$scope=clone JS::$emptyScope;$scope->up=$fn->scope;$scope->properties[\'arguments\']=clone JS::$argumentsTemplate;$x1522=&$scope->properties[\'arguments\'];$x1522->properties[\'length\']=count($args);foreach($args as$i=>$arg){$x1522->properties[$i]=$args[$i];$x1522->attributes[$i]=JS::WRITABLE|JS::ENUMERABLE|JS::CONFIGURABLE;}$scope->properties[\'x\']=array_key_exists(0,$args)?$args[0]:JS::$undefined;$_x=&$scope->properties[\'x\'];$Ux=FALSE;$scope->properties[\'y\']=array_key_exists(1,$args)?$args[1]:JS::$undefined;$_y=&$scope->properties[\'y\'];$Uy=FALSE;$scope->properties[\'sameValueZero\']=$fn;$_sameValueZero=&$scope->properties[\'sameValueZero\'];$global->scope[++$global->scope_sp]=$scope;$x1524=(((gettype($_x)===gettype($_y)&&$_x===$_y))||(((is_float($_x)||is_int($_x))&&(is_float($_y)||is_int($_y)))&&$_x==$_y));$x1523=$x1524;if(!JS::toBoolean($x1523,$global)){$x1529=$_x;$x1529=($x1529===JS::$undefined?\'undefined\':(is_int($x1529)||is_float($x1529)?\'number\':(is_bool($x1529)?\'boolean\':(is_string($x1529)?\'string\':(is_object($x1529)&&isset($x1529->call)?\'function\':\'object\')))));$x1528=(((gettype($x1529)===gettype(\'number\')&&$x1529===\'number\'))||(((is_float($x1529)||is_int($x1529))&&(is_float(\'number\')||is_int(\'number\')))&&$x1529==\'number\'));$x1527=$x1528;if(JS::toBoolean($x1527,$global)){$x1531=$_y;$x1531=($x1531===JS::$undefined?\'undefined\':(is_int($x1531)||is_float($x1531)?\'number\':(is_bool($x1531)?\'boolean\':(is_string($x1531)?\'string\':(is_object($x1531)&&isset($x1531->call)?\'function\':\'object\')))));$x1530=(((gettype($x1531)===gettype(\'number\')&&$x1531===\'number\'))||(((is_float($x1531)||is_int($x1531))&&(is_float(\'number\')||is_int(\'number\')))&&$x1531==\'number\'));$x1527=$x1530;}$x1526=$x1527;if(JS::toBoolean($x1526,$global)){unset($_isNaN,$WisNaN,$SisNaN,$UisNaN);$x1532=_61c60c86aef535e2824e55eb30517a85_2($global,$scope,$scope,JS::toString(\'isNaN\',$global),461,73,\'<image>/04_array.js\');$_isNaN=&$x1532[0];list(,$WisNaN,$SisNaN,$UisNaN)=$x1532;if($UisNaN){unset($_ReferenceError,$WReferenceError,$SReferenceError,$UReferenceError);$x1533=_61c60c86aef535e2824e55eb30517a85_2($global,$scope,$scope,JS::toString(\'ReferenceError\',$global),461,73,\'<image>/04_array.js\');$_ReferenceError=&$x1533[0];list(,$WReferenceError,$SReferenceError,$UReferenceError)=$x1533;$x1534=$_ReferenceError->call;$global->trace[++$global->trace_sp]=array(\'<image>/04_array.js\',461,73);$x1535=$x1534($global,$global,$_ReferenceError,array(\'isNaN is not defined\'),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);if(isset($x1535->class)&&$x1535->class===\'Error\'&&!isset($x1535->properties[\'file\'])&&!isset($x1535->properties[\'line\'])&&!isset($x1535->properties[\'column\'])){$x1535->properties[\'file\']=\'<image>/04_array.js\';$x1535->properties[\'line\']=461;$x1535->properties[\'column\']=73;$x1535->attributes[\'file\']=$x1535->attributes[\'line\']=$x1535->attributes[\'column\']=0;}throw new JSException($x1535,461,73,\'<image>/04_array.js\');}if(!(is_object($_isNaN)&&isset($_isNaN->call))){unset($_TypeError,$WTypeError,$STypeError,$UTypeError);$x1538=_61c60c86aef535e2824e55eb30517a85_2($global,$scope,$scope,JS::toString(\'TypeError\',$global),461,78,\'<image>/04_array.js\');$_TypeError=&$x1538[0];list(,$WTypeError,$STypeError,$UTypeError)=$x1538;$x1539=$_TypeError->call;$global->trace[++$global->trace_sp]=array(\'<image>/04_array.js\',461,78);$x1540=$x1539($global,$global,$_TypeError,array(\'Trying to call what is not a function.\'),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);if(isset($x1540->class)&&$x1540->class===\'Error\'&&!isset($x1540->properties[\'file\'])&&!isset($x1540->properties[\'line\'])&&!isset($x1540->properties[\'column\'])){$x1540->properties[\'file\']=\'<image>/04_array.js\';$x1540->properties[\'line\']=461;$x1540->properties[\'column\']=78;$x1540->attributes[\'file\']=$x1540->attributes[\'line\']=$x1540->attributes[\'column\']=0;}throw new JSException($x1540,461,78,\'<image>/04_array.js\');}$x1536=$_isNaN->call;$global->trace[++$global->trace_sp]=array(\'<image>/04_array.js\',461,78);$x1537=$x1536($global,$global,$_isNaN,array($_x),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);$x1526=$x1537;}$x1525=$x1526;if(JS::toBoolean($x1525,$global)){unset($_isNaN,$WisNaN,$SisNaN,$UisNaN);$x1541=_61c60c86aef535e2824e55eb30517a85_2($global,$scope,$scope,JS::toString(\'isNaN\',$global),461,85,\'<image>/04_array.js\');$_isNaN=&$x1541[0];list(,$WisNaN,$SisNaN,$UisNaN)=$x1541;if($UisNaN){unset($_ReferenceError,$WReferenceError,$SReferenceError,$UReferenceError);$x1542=_61c60c86aef535e2824e55eb30517a85_2($global,$scope,$scope,JS::toString(\'ReferenceError\',$global),461,85,\'<image>/04_array.js\');$_ReferenceError=&$x1542[0];list(,$WReferenceError,$SReferenceError,$UReferenceError)=$x1542;$x1543=$_ReferenceError->call;$global->trace[++$global->trace_sp]=array(\'<image>/04_array.js\',461,85);$x1544=$x1543($global,$global,$_ReferenceError,array(\'isNaN is not defined\'),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);if(isset($x1544->class)&&$x1544->class===\'Error\'&&!isset($x1544->properties[\'file\'])&&!isset($x1544->properties[\'line\'])&&!isset($x1544->properties[\'column\'])){$x1544->properties[\'file\']=\'<image>/04_array.js\';$x1544->properties[\'line\']=461;$x1544->properties[\'column\']=85;$x1544->attributes[\'file\']=$x1544->attributes[\'line\']=$x1544->attributes[\'column\']=0;}throw new JSException($x1544,461,85,\'<image>/04_array.js\');}if(!(is_object($_isNaN)&&isset($_isNaN->call))){unset($_TypeError,$WTypeError,$STypeError,$UTypeError);$x1547=_61c60c86aef535e2824e55eb30517a85_2($global,$scope,$scope,JS::toString(\'TypeError\',$global),461,90,\'<image>/04_array.js\');$_TypeError=&$x1547[0];list(,$WTypeError,$STypeError,$UTypeError)=$x1547;$x1548=$_TypeError->call;$global->trace[++$global->trace_sp]=array(\'<image>/04_array.js\',461,90);$x1549=$x1548($global,$global,$_TypeError,array(\'Trying to call what is not a function.\'),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);if(isset($x1549->class)&&$x1549->class===\'Error\'&&!isset($x1549->properties[\'file\'])&&!isset($x1549->properties[\'line\'])&&!isset($x1549->properties[\'column\'])){$x1549->properties[\'file\']=\'<image>/04_array.js\';$x1549->properties[\'line\']=461;$x1549->properties[\'column\']=90;$x1549->attributes[\'file\']=$x1549->attributes[\'line\']=$x1549->attributes[\'column\']=0;}throw new JSException($x1549,461,90,\'<image>/04_array.js\');}$x1545=$_isNaN->call;$global->trace[++$global->trace_sp]=array(\'<image>/04_array.js\',461,90);$x1546=$x1545($global,$global,$_isNaN,array($_y),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);$x1525=$x1546;}$x1523=$x1525;}return$x1523;return JS::$undefined;}', "\n";
function _61c60c86aef535e2824e55eb30517a85_27($global, $leThis, $fn, $args, $constructor = FALSE) {
...
$scope->up = $fn->scope;
$scope->properties['arguments'] = clone JS::$argumentsTemplate;
$x1520 =& $scope->properties['arguments'];
$x1520->properties['length'] = count($args);
foreach ($args as $i => $arg) {
$x1520->properties[$i] = $args[$i];
$x1520->attributes[$i] = JS::WRITABLE | JS::ENUMERABLE | JS::CONFIGURABLE;
}
$scope->properties['searchElement'] = array_key_exists(0, $args) ? $args[0] : JS::$undefined;
$_searchElement =& $scope->properties['searchElement'];
$UsearchElement = FALSE;
$scope->properties['fromIndex'] = array_key_exists(1, $args) ? $args[1] : JS::$undefined;
$_fromIndex =& $scope->properties['fromIndex'];
$UfromIndex = FALSE;
$global->scope[++$global->scope_sp] = $scope;
$x1550 = clone JS::$functionTemplate; $x1550->call = '_61c60c86aef535e2824e55eb30517a85_28'; $x1550->parameters = array (
  0 => 'x',
  1 => 'y',
); $x1550->name = 'sameValueZero'; $x1550->scope = $scope; $x1550->properties['prototype'] = clone JS::$objectTemplate; $x1550->attributes['prototype'] = JS::WRITABLE; $x1550->properties['prototype']->properties['constructor'] = $x1550; $x1550->properties['prototype']->attributes['constructor'] = JS::WRITABLE | JS::CONFIGURABLE; $x1550->properties['length'] = 2; $x1550->attributes['length'] = 0;
$scope->properties['sameValueZero'] = JS::$undefined; $_sameValueZero =& $scope->properties['sameValueZero'];
$UsameValueZero = FALSE;
$_sameValueZero = $x1550;
$x1552 = $leThis;
$x1553 = NULL;
if (gettype($x1552) === gettype($x1553)) { $x1551 = $x1552===$x1553; }
else if ($x1552 === JS::$undefined && $x1553 === NULL || $x1552 === NULL && $x1553 === JS::$undefined) { $x1551 = TRUE; }
else if ($x1552 === NULL || $x1553 === NULL) { $x1551 = FALSE; }
else { $x1552 = JS::toPrimitive($x1552, $global); $x1553 = JS::toPrimitive($x1553, $global); 
if (is_bool($x1552)) { $x1552 = (int) $x1552; }
if (is_bool($x1553)) { $x1553 = (int) $x1553; }
if (is_numeric($x1552) || is_numeric($x1553)) { $x1552 = JS::toNumber($x1552, $global); $x1553 = JS::toNumber($x1553, $global); }
$x1551 = $x1552===$x1553;}
if (JS::toBoolean($x1551, $global)) {
unset($_TypeError, $WTypeError, $STypeError, $UTypeError);
$x1556 = _61c60c86aef535e2824e55eb30517a85_2($global, $scope, $scope, JS::toString('TypeError', $global), 435, 14, '<image>/04_array.js');
$_TypeError =& $x1556[0]; list(,$WTypeError,$STypeError,$UTypeError) = $x1556;
if ($UTypeError) {
unset($_ReferenceError, $WReferenceError, $SReferenceError, $UReferenceError);
$x1557 = _61c60c86aef535e2824e55eb30517a85_2($global, $scope, $scope, JS::toString('ReferenceError', $global), 435, 14, '<image>/04_array.js');
$_ReferenceError =& $x1557[0]; list(,$WReferenceError,$SReferenceError,$UReferenceError) = $x1557;
$x1558 = $_ReferenceError->call;
$global->trace[++$global->trace_sp] = array('<image>/04_array.js', 435, 14);
$x1559 = $x1558($global, $global, $_ReferenceError, array('TypeError is not defined'), false);
unset($global->trace[$global->trace_sp--], $global->scope[$global->scope_sp--]);
if (isset($x1559->class) && $x1559->class === 'Error' && !isset($x1559->properties['file']) && !isset($x1559->properties['line']) && !isset($x1559->properties['column'])) {$x1559->properties['file'] = '<image>/04_array.js';$x1559->properties['line'] = 435;$x1559->properties['column'] = 14;$x1559->attributes['file'] = $x1559->attributes['line'] = $x1559->attributes['column'] = 0; }
throw new JSException($x1559, 435, 14, '<image>/04_array.js');
}
$x1554 = clone JS::$objectTemplate;
unset($x1560, $W1560, $S1560, $U1560);
$x1561 = _61c60c86aef535e2824e55eb30517a85_4($global, $scope, $_TypeError, JS::toString('prototype', $global), 435, 10, '<image>/04_array.js');
$x1560 =& $x1561[0]; list(,$W1560,$S1560,$U1560) = $x1561;
$x1555 = $x1560;
$x1554->prototype = $x1555;
if (!(is_object($_TypeError) && isset($_TypeError->call))) { 
$x1564 = $_TypeError->call;
$global->trace[++$global->trace_sp] = array('<image>/04_array.js', 435, 10);
$x1565 = $x1564($global, $global, $_TypeError, array('Trying to call what is not a function.'), false);
unset($global->trace[$global->trace_sp--], $global->scope[$global->scope_sp--]);
if (isset($x1565->class) && $x1565->class === 'Error' && !isset($x1565->properties['file']) && !isset($x1565->properties['line']) && !isset($x1565->properties['column'])) {$x1565->properties['file'] = '<image>/04_array.js';$x1565->properties['line'] = 435;$x1565->properties['column'] = 10;$x1565->attributes['file'] = $x1565->attributes['line'] = $x1565->attributes['column'] = 0; }
throw new JSException($x1565, 435, 10, '<image>/04_array.js');
}
$x1562 = $_TypeError->call;
$global->trace[++$global->trace_sp] = array('<image>/04_array.js', 435, 10);
$x1563 = $x1562($global, $x1554, $_TypeError, array('"this" is null or not defined'), true);
unset($global->trace[$global->trace_sp--], $global->scope[$global->scope_sp--]);
$x1555 = $x1563;
if (is_object($x1555) && $x1555 !== JS::$undefined) { $x1554 = $x1555; }
if (isset($x1554->class) && $x1554->class === 'Error' && !isset($x1554->properties['file']) && !isset($x1554->properties['line']) && !isset($x1554->properties['column'])) {$x1554->properties['file'] = '<image>/04_array.js';$x1554->properties['line'] = 435;$x1554->properties['column'] = 4;$x1554->attributes['file'] = $x1554->attributes['line'] = $x1554->attributes['column'] = 0; }
throw new JSException($x1554, 435, 4, '<image>/04_array.js');;
};
unset($_Object, $WObject, $SObject, $UObject);
$x1566 = _61c60c86aef535e2824e55eb30517a85_2($global, $scope, $scope, JS::toString('Object', $global), 439, 10, '<image>/04_array.js');
$_Object =& $x1566[0]; list(,$WObject,$SObject,$UObject) = $x1566;
if ($UObject) {
unset($_ReferenceError, $WReferenceError, $SReferenceError, $UReferenceError);
$x1567 = _61c60c86aef535e2824e55eb30517a85_2($global, $scope, $scope, JS::toString('ReferenceError', $global), 439, 10, '<image>/04_array.js');
$_ReferenceError =& $x1567[0]; list(,$WReferenceError,$SReferenceError,$UReferenceError) = $x1567;
$x1568 = $_ReferenceError->call;
$global->trace[++$global->trace_sp] = array('<image>/04_array.js', 439, 10);
$x1569 = $x1568($global, $global, $_ReferenceError, array('Object is not defined'), false);
unset($global->trace[$global->trace_sp--], $global->scope[$global->scope_sp--]);
if (isset($x1569->class) && $x1569->class === 'Error' && !isset($x1569->properties['file']) && !isset($x1569->properties['line']) && !isset($x1569->properties['column'])) {$x1569->properties['file'] = '<image>/04_array.js';$x1569->properties['line'] = 439;$x1569->properties['column'] = 10;$x1569->attributes['file'] = $x1569->attributes['line'] = $x1569->attributes['column'] = 0; }
throw new JSException($x1569, 439, 10, '<image>/04_array.js');
}
if (!(is_object($_Object) && isset($_Object->call))) { 
unset($_TypeError, $WTypeError, $STypeError, $UTypeError);
$x1572 = _61c60c86aef535e2824e55eb30517a85_2($global, $scope, $scope, JS::toString('TypeError', $global), 439, 16, '<image>/04_array.js');
$_TypeError =& $x1572[0]; list(,$WTypeError,$STypeError,$UTypeError) = $x1572;
$x1573 = $_TypeError->call;
$global->trace[++$global->trace_sp] = array('<image>/04_array.js', 439, 16);
$x1574 = $x1573($global, $global, $_TypeError, array('Trying to call what is not a function.'), false);
unset($global->trace[$global->trace_sp--], $global->scope[$global->scope_sp--]);
if (isset($x1574->class) && $x1574->class === 'Error' && !isset($x1574->properties['file']) && !isset($x1574->properties['line']) && !isset($x1574->properties['column'])) {$x1574->properties['file'] = '<image>/04_array.js';$x1574->properties['line'] = 439;$x1574->properties['column'] = 16;$x1574->attributes['file'] = $x1574->attributes['line'] = $x1574->attributes['column'] = 0; }
throw new JSException($x1574, 439, 16, '<image>/04_array.js');
}
$x1570 = $_Object->call;
$global->trace[++$global->trace_sp] = array('<image>/04_array.js', 439, 16);
$x1571 = $x1570($global, $global, $_Object, array($leThis), false);
unset($global->trace[$global->trace_sp--], $global->scope[$global->scope_sp--]);
$scope->properties['o'] = JS::$undefined; $_o =& $scope->properties['o'];
$Uo = FALSE;
$_o = $x1571;
unset($x1575, $W1575, $S1575, $U1575);
$x1576 = _61c60c86aef535e2824e55eb30517a85_4($global, $scope, $_o, JS::toString('length', $global), 442, 13, '<image>/04_array.js');
$x1575 =& $x1576[0]; list(,$W1575,$S1575,$U1575) = $x1576;
$scope->properties['len'] = JS::$undefined; $_len =& $scope->properties['len'];
$Ulen = FALSE;
$_len = $x1575;
$x1577 = (((gettype($_len) === gettype(0.0) && $_len === 0.0))|| (((is_float($_len) || is_int($_len)) && (is_float(0.0) || is_int(0.0))) && $_len == 0.0));
if (JS::toBoolean($x1577, $global)) {

return false;;
};
$x1578 = JS::toNumber($_fromIndex, $global);
$x1579 = JS::toNumber(0.0, $global);
if (is_nan($x1578)) { $x1578 = 0; }
if (is_nan($x1579)) { $x1579 = 0; }
$x1580 = $x1578 | $x1579;
$scope->properties['n'] = JS::$undefined; $_n =& $scope->properties['n'];
$Un = FALSE;
$_n = $x1580;
unset($_Math, $WMath, $SMath, $UMath);
$x1581 = _61c60c86aef535e2824e55eb30517a85_2($global, $scope, $scope, JS::toString('Math', $global), 458, 10, '<image>/04_array.js');
$_Math =& $x1581[0]; list(,$WMath,$SMath,$UMath) = $x1581;
if ($UMath) {
unset($_ReferenceError, $WReferenceError, $SReferenceError, $UReferenceError);
$x1582 = _61c60c86aef535e2824e55eb30517a85_2($global, $scope, $scope, JS::toString('ReferenceError', $global), 458, 10, '<image>/04_array.js');
$_ReferenceError =& $x1582[0]; list(,$WReferenceError,$SReferenceError,$UReferenceError) = $x1582;
$x1583 = $_ReferenceError->call;
$global->trace[++$global->trace_sp] = array('<image>/04_array.js', 458, 10);
$x1584 = $x1583($global, $global, $_ReferenceError, array('Math is not defined'), false);
unset($global->trace[$global->trace_sp--], $global->scope[$global->scope_sp--]);
if (isset($x1584->class) && $x1584->class === 'Error' && !isset($x1584->properties['file']) && !isset($x1584->properties['line']) && !isset($x1584->properties['column'])) {$x1584->properties['file'] = '<image>/04_array.js';$x1584->properties['line'] = 458;$x1584->properties['column'] = 10;$x1584->attributes['file'] = $x1584->attributes['line'] = $x1584->attributes['column'] = 0; }
throw new JSException($x1584, 458, 10, '<image>/04_array.js');
}
if ($_Math === JS::$undefined || $_Math === NULL) {
unset($_TypeError, $WTypeError, $STypeError, $UTypeError);
$x1586 = _61c60c86aef535e2824e55eb30517a85_2($global, $scope, $scope, JS::toString('TypeError', $global), 458, 18, '<image>/04_array.js');
$_TypeError =& $x1586[0]; list(,$WTypeError,$STypeError,$UTypeError) = $x1586;
$x1587 = $_TypeError->call;
$global->trace[++$global->trace_sp] = array('<image>/04_array.js', 458, 18);
$x1588 = $x1587($global, $global, $_TypeError, array('Cannot call function on undefined/null.'), false);
unset($global->trace[$global->trace_sp--], $global->scope[$global->scope_sp--]);
if (isset($x1588->class) && $x1588->class === 'Error' && !isset($x1588->properties['file']) && !isset($x1588->properties['line']) && !isset($x1588->properties['column'])) {$x1588->properties['file'] = '<image>/04_array.js';$x1588->properties['line'] = 458;$x1588->properties['column'] = 18;$x1588->attributes['file'] = $x1588->attributes['line'] = $x1588->attributes['column'] = 0; }
throw new JSException($x1588, 458, 18, '<image>/04_array.js');
}
$x1585 = JS::toObject($_Math, $global);
unset($x1589, $W1589, $S1589, $U1589);
$x1590 = _61c60c86aef535e2824e55eb30517a85_4($global, $scope, $x1585, JS::toString('max', $global), 458, 18, '<image>/04_array.js');
$x1589 =& $x1590[0]; list(,$W1589,$S1589,$U1589) = $x1590;
$x1592 = JS::toPrimitive($_n, $global);
$x1593 = JS::toPrimitive(0.0, $global);
$x1594 = !(is_string($x1592) && is_string($x1593) ? strcmp($x1592, $x1593) < 0 : (!is_nan($x1595 = JS::toNumber($x1592, $global)) && !is_nan($x1596 = JS::toNumber($x1593, $global)) && $x1595 < $x1596));
if (JS::toBoolean($x1594, $global)) {
$x1591 = $_n;
} else {
if ($_Math === JS::$undefined || $_Math === NULL) {
unset($_TypeError, $WTypeError, $STypeError, $UTypeError);
$x1598 = _61c60c86aef535e2824e55eb30517a85_2($global, $scope, $scope, JS::toString('TypeError', $global), 458, 46, '<image>/04_array.js');
$_TypeError =& $x1598[0]; list(,$WTypeError,$STypeError,$UTypeError) = $x1598;
$x1599 = $_TypeError->call;
$global->trace[++$global->trace_sp] = array('<image>/04_array.js', 458, 46);
$x1600 = $x1599($global, $global, $_TypeError, array('Cannot call function on undefined/null.'), false);
unset($global->trace[$global->trace_sp--], $global->scope[$global->scope_sp--]);
if (isset($x1600->class) && $x1600->class === 'Error' && !isset($x1600->properties['file']) && !isset($x1600->properties['line']) && !isset($x1600->properties['column'])) {$x1600->properties['file'] = '<image>/04_array.js';$x1600->properties['line'] = 458;$x1600->properties['column'] = 46;$x1600->attributes['file'] = $x1600->attributes['line'] = $x1600->attributes['column'] = 0; }
throw new JSException($x1600, 458, 46, '<image>/04_array.js');
}
$x1597 = JS::toObject($_Math, $global);
unset($x1601, $W1601, $S1601, $U1601);
$x1602 = _61c60c86aef535e2824e55eb30517a85_4($global, $scope, $x1597, JS::toString('abs', $global), 458, 46, '<image>/04_array.js');
$x1601 =& $x1602[0]; list(,$W1601,$S1601,$U1601) = $x1602;
if (!(is_object($x1601) && isset($x1601->call))) { 
unset($_TypeError, $WTypeError, $STypeError, $UTypeError);
$x1605 = _61c60c86aef535e2824e55eb30517a85_2($global, $scope, $scope, JS::toString('TypeError', $global), 458, 46, '<image>/04_array.js');
$_TypeError =& $x1605[0]; list(,$WTypeError,$STypeError,$UTypeError) = $x1605;
$x1606 = $_TypeError->call;
$global->trace[++$global->trace_sp] = array('<image>/04_array.js', 458, 46);
$x1607 = $x1606($global, $global, $_TypeError, array('Trying to call what is not a function.'), false);
unset($global->trace[$global->trace_sp--], $global->scope[$global->scope_sp--]);
if (isset($x1607->class) && $x1607->class === 'Error' && !isset($x1607->properties['file']) && !isset($x1607->properties['line']) && !isset($x1607->properties['column'])) {$x1607->properties['file'] = '<image>/04_array.js';$x1607->properties['line'] = 458;$x1607->properties['column'] = 46;$x1607->attributes['file'] = $x1607->attributes['line'] = $x1607->attributes['column'] = 0; }
throw new JSException($x1607, 458, 46, '<image>/04_array.js');
}
$x1603 = $x1601->call;
$global->trace[++$global->trace_sp] = array('<image>/04_array.js', 458, 46);
$x1604 = $x1603($global, $x1597, $x1601, array($_n), false);
unset($global->trace[$global->trace_sp--], $global->scope[$global->scope_sp--]);
$x1591 = (JS::toNumber($_len, $global) - JS::toNumber($x1604, $global));
}
if (!(is_object($x1589) && isset($x1589->call))) { 
unset($_TypeError, $WTypeError, $STypeError, $UTypeError);
$x1610 = _61c60c86aef535e2824e55eb30517a85_2($global, $scope, $scope, JS::toString('TypeError', $global), 458, 18, '<image>/04_array.js');
$_TypeError =& $x1610[0]; list(,$WTypeError,$STypeError,$UTypeError) = $x1610;
$x1611 = $_TypeError->call;
$global->trace[++$global->trace_sp] = array('<image>/04_array.js', 458, 18);
$x1612 = $x1611($global, $global, $_TypeError, array('Trying to call what is not a function.'), false);
unset($global->trace[$global->trace_sp--], $global->scope[$global->scope_sp--]);
if (isset($x1612->class) && $x1612->class === 'Error' && !isset($x1612->properties['file']) && !isset($x1612->properties['line']) && !isset($x1612->properties['column'])) {$x1612->properties['file'] = '<image>/04_array.js';$x1612->properties['line'] = 458;$x1612->properties['column'] = 18;$x1612->attributes['file'] = $x1612->attributes['line'] = $x1612->attributes['column'] = 0; }
throw new JSException($x1612, 458, 18, '<image>/04_array.js');
}
$x1608 = $x1589->call;
$global->trace[++$global->trace_sp] = array('<image>/04_array.js', 458, 18);
$x1609 = $x1608($global, $x1585, $x1589, array($x1591, 0.0), false);
unset($global->trace[$global->trace_sp--], $global->scope[$global->scope_sp--]);
$scope->properties['k'] = JS::$undefined; $_k =& $scope->properties['k'];
$Uk = FALSE;
$_k = $x1609;
for (;;) {
$x1613 = JS::toPrimitive($_k, $global);
$x1614 = JS::toPrimitive($_len, $global);
$x1615 = (is_string($x1613) && is_string($x1614) ? strcmp($x1613, $x1614) < 0 : (!is_nan($x1616 = JS::toNumber($x1613, $global)) && !is_nan($x1617 = JS::toNumber($x1614, $global)) && $x1616 < $x1617));
if (!JS::toBoolean($x1615, $global)) { break; }

unset($x1618, $W1618, $S1618, $U1618);
$x1619 = _61c60c86aef535e2824e55eb30517a85_4($global, $scope, $_o, JS::toString($_k, $global), 468, 23, '<image>/04_array.js');
$x1618 =& $x1619[0]; list(,$W1618,$S1618,$U1618) = $x1619;
if (!(is_object($_sameValueZero) && isset($_sameValueZero->call))) { 
unset($_TypeError, $WTypeError, $STypeError, $UTypeError);
$x1622 = _61c60c86aef535e2824e55eb30517a85_2($global, $scope, $scope, JS::toString('TypeError', $global), 468, 21, '<image>/04_array.js');
$_TypeError =& $x1622[0]; list(,$WTypeError,$STypeError,$UTypeError) = $x1622;
$x1623 = $_TypeError->call;
$global->trace[++$global->trace_sp] = array('<image>/04_array.js', 468, 21);
$x1624 = $x1623($global, $global, $_TypeError, array('Trying to call what is not a function.'), false);
unset($global->trace[$global->trace_sp--], $global->scope[$global->scope_sp--]);
if (isset($x1624->class) && $x1624->class === 'Error' && !isset($x1624->properties['file']) && !isset($x1624->properties['line']) && !isset($x1624->properties['column'])) {$x1624->properties['file'] = '<image>/04_array.js';$x1624->properties['line'] = 468;$x1624->properties['column'] = 21;$x1624->attributes['file'] = $x1624->attributes['line'] = $x1624->attributes['column'] = 0; }
throw new JSException($x1624, 468, 21, '<image>/04_array.js');
}
$x1620 = $_sameValueZero->call;
$global->trace[++$global->trace_sp] = array('<image>/04_array.js', 468, 21);
$x1621 = $x1620($global, $global, $_sameValueZero, array($x1618, $_searchElement), false);
unset($global->trace[$global->trace_sp--], $global->scope[$global->scope_sp--]);
if (JS::toBoolean($x1621, $global)) {
...
echo 'function _61c60c86aef535e2824e55eb30517a85_27($global,$leThis,$fn,$args,$constructor=FALSE){$_sameValueZero;if(isset($fn->boundThis)&&!$constructor){$leThis=$fn->boundThis;}if(isset($fn->boundArgs)){$args=array_merge($fn->boundArgs,$args);}$scope=clone JS::$emptyScope;$scope->up=$fn->scope;$scope->properties[\'arguments\']=clone JS::$argumentsTemplate;$x1520=&$scope->properties[\'arguments\'];$x1520->properties[\'length\']=count($args);foreach($args as$i=>$arg){$x1520->properties[$i]=$args[$i];$x1520->attributes[$i]=JS::WRITABLE|JS::ENUMERABLE|JS::CONFIGURABLE;}$scope->properties[\'searchElement\']=array_key_exists(0,$args)?$args[0]:JS::$undefined;$_searchElement=&$scope->properties[\'searchElement\'];$UsearchElement=FALSE;$scope->properties[\'fromIndex\']=array_key_exists(1,$args)?$args[1]:JS::$undefined;$_fromIndex=&$scope->properties[\'fromIndex\'];$UfromIndex=FALSE;$global->scope[++$global->scope_sp]=$scope;$x1550=clone JS::$functionTemplate;$x1550->call=\'_61c60c86aef535e2824e55eb30517a85_28\';$x1550->parameters=array(0=>\'x\',1=>\'y\',);$x1550->name=\'sameValueZero\';$x1550->scope=$scope;$x1550->properties[\'prototype\']=clone JS::$objectTemplate;$x1550->attributes[\'prototype\']=JS::WRITABLE;$x1550->properties[\'prototype\']->properties[\'constructor\']=$x1550;$x1550->properties[\'prototype\']->attributes[\'constructor\']=JS::WRITABLE|JS::CONFIGURABLE;$x1550->properties[\'length\']=2;$x1550->attributes[\'length\']=0;$scope->properties[\'sameValueZero\']=JS::$undefined;$_sameValueZero=&$scope->properties[\'sameValueZero\'];$UsameValueZero=FALSE;$_sameValueZero=$x1550;$x1552=$leThis;$x1553=NULL;if(gettype($x1552)===gettype($x1553)){$x1551=$x1552===$x1553;}else if($x1552===JS::$undefined&&$x1553===NULL||$x1552===NULL&&$x1553===JS::$undefined){$x1551=TRUE;}else if($x1552===NULL||$x1553===NULL){$x1551=FALSE;}else{$x1552=JS::toPrimitive($x1552,$global);$x1553=JS::toPrimitive($x1553,$global);if(is_bool($x1552)){$x1552=(int)$x1552;}if(is_bool($x1553)){$x1553=(int)$x1553;}if(is_numeric($x1552)||is_numeric($x1553)){$x1552=JS::toNumber($x1552,$global);$x1553=JS::toNumber($x1553,$global);}$x1551=$x1552===$x1553;}if(JS::toBoolean($x1551,$global)){unset($_TypeError,$WTypeError,$STypeError,$UTypeError);$x1556=_61c60c86aef535e2824e55eb30517a85_2($global,$scope,$scope,JS::toString(\'TypeError\',$global),435,14,\'<image>/04_array.js\');$_TypeError=&$x1556[0];list(,$WTypeError,$STypeError,$UTypeError)=$x1556;if($UTypeError){unset($_ReferenceError,$WReferenceError,$SReferenceError,$UReferenceError);$x1557=_61c60c86aef535e2824e55eb30517a85_2($global,$scope,$scope,JS::toString(\'ReferenceError\',$global),435,14,\'<image>/04_array.js\');$_ReferenceError=&$x1557[0];list(,$WReferenceError,$SReferenceError,$UReferenceError)=$x1557;$x1558=$_ReferenceError->call;$global->trace[++$global->trace_sp]=array(\'<image>/04_array.js\',435,14);$x1559=$x1558($global,$global,$_ReferenceError,array(\'TypeError is not defined\'),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);if(isset($x1559->class)&&$x1559->class===\'Error\'&&!isset($x1559->properties[\'file\'])&&!isset($x1559->properties[\'line\'])&&!isset($x1559->properties[\'column\'])){$x1559->properties[\'file\']=\'<image>/04_array.js\';$x1559->properties[\'line\']=435;$x1559->properties[\'column\']=14;$x1559->attributes[\'file\']=$x1559->attributes[\'line\']=$x1559->attributes[\'column\']=0;}throw new JSException($x1559,435,14,\'<image>/04_array.js\');}$x1554=clone JS::$objectTemplate;unset($x1560,$W1560,$S1560,$U1560);$x1561=_61c60c86aef535e2824e55eb30517a85_4($global,$scope,$_TypeError,JS::toString(\'prototype\',$global),435,10,\'<image>/04_array.js\');$x1560=&$x1561[0];list(,$W1560,$S1560,$U1560)=$x1561;$x1555=$x1560;$x1554->prototype=$x1555;if(!(is_object($_TypeError)&&isset($_TypeError->call))){$x1564=$_TypeError->call;$global->trace[++$global->trace_sp]=array(\'<image>/04_array.js\',435,10);$x1565=$x1564($global,$global,$_TypeError,array(\'Trying to call what is not a function.\'),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);if(isset($x1565->class)&&$x1565->class===\'Error\'&&!isset($x1565->properties[\'file\'])&&!isset($x1565->properties[\'line\'])&&!isset($x1565->properties[\'column\'])){$x1565->properties[\'file\']=\'<image>/04_array.js\';$x1565->properties[\'line\']=435;$x1565->properties[\'column\']=10;$x1565->attributes[\'file\']=$x1565->attributes[\'line\']=$x1565->attributes[\'column\']=0;}throw new JSException($x1565,435,10,\'<image>/04_array.js\');}$x1562=$_TypeError->call;$global->trace[++$global->trace_sp]=array(\'<image>/04_array.js\',435,10);$x1563=$x1562($global,$x1554,$_TypeError,array(\'"this" is null or not defined\'),true);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);$x1555=$x1563;if(is_object($x1555)&&$x1555!==JS::$undefined){$x1554=$x1555;}if(isset($x1554->class)&&$x1554->class===\'Error\'&&!isset($x1554->properties[\'file\'])&&!isset($x1554->properties[\'line\'])&&!isset($x1554->properties[\'column\'])){$x1554->properties[\'file\']=\'<image>/04_array.js\';$x1554->properties[\'line\']=435;$x1554->properties[\'column\']=4;$x1554->attributes[\'file\']=$x1554->attributes[\'line\']=$x1554->attributes[\'column\']=0;}throw new JSException($x1554,435,4,\'<image>/04_array.js\');}unset($_Object,$WObject,$SObject,$UObject);$x1566=_61c60c86aef535e2824e55eb30517a85_2($global,$scope,$scope,JS::toString(\'Object\',$global),439,10,\'<image>/04_array.js\');$_Object=&$x1566[0];list(,$WObject,$SObject,$UObject)=$x1566;if($UObject){unset($_ReferenceError,$WReferenceError,$SReferenceError,$UReferenceError);$x1567=_61c60c86aef535e2824e55eb30517a85_2($global,$scope,$scope,JS::toString(\'ReferenceError\',$global),439,10,\'<image>/04_array.js\');$_ReferenceError=&$x1567[0];list(,$WReferenceError,$SReferenceError,$UReferenceError)=$x1567;$x1568=$_ReferenceError->call;$global->trace[++$global->trace_sp]=array(\'<image>/04_array.js\',439,10);$x1569=$x1568($global,$global,$_ReferenceError,array(\'Object is not defined\'),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);if(isset($x1569->class)&&$x1569->class===\'Error\'&&!isset($x1569->properties[\'file\'])&&!isset($x1569->properties[\'line\'])&&!isset($x1569->properties[\'column\'])){$x1569->properties[\'file\']=\'<image>/04_array.js\';$x1569->properties[\'line\']=439;$x1569->properties[\'column\']=10;$x1569->attributes[\'file\']=$x1569->attributes[\'line\']=$x1569->attributes[\'column\']=0;}throw new JSException($x1569,439,10,\'<image>/04_array.js\');}if(!(is_object($_Object)&&isset($_Object->call))){unset($_TypeError,$WTypeError,$STypeError,$UTypeError);$x1572=_61c60c86aef535e2824e55eb30517a85_2($global,$scope,$scope,JS::toString(\'TypeError\',$global),439,16,\'<image>/04_array.js\');$_TypeError=&$x1572[0];list(,$WTypeError,$STypeError,$UTypeError)=$x1572;$x1573=$_TypeError->call;$global->trace[++$global->trace_sp]=array(\'<image>/04_array.js\',439,16);$x1574=$x1573($global,$global,$_TypeError,array(\'Trying to call what is not a function.\'),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);if(isset($x1574->class)&&$x1574->class===\'Error\'&&!isset($x1574->properties[\'file\'])&&!isset($x1574->properties[\'line\'])&&!isset($x1574->properties[\'column\'])){$x1574->properties[\'file\']=\'<image>/04_array.js\';$x1574->properties[\'line\']=439;$x1574->properties[\'column\']=16;$x1574->attributes[\'file\']=$x1574->attributes[\'line\']=$x1574->attributes[\'column\']=0;}throw new JSException($x1574,439,16,\'<image>/04_array.js\');}$x1570=$_Object->call;$global->trace[++$global->trace_sp]=array(\'<image>/04_array.js\',439,16);$x1571=$x1570($global,$global,$_Object,array($leThis),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);$scope->properties[\'o\']=JS::$undefined;$_o=&$scope->properties[\'o\'];$Uo=FALSE;$_o=$x1571;unset($x1575,$W1575,$S1575,$U1575);$x1576=_61c60c86aef535e2824e55eb30517a85_4($global,$scope,$_o,JS::toString(\'length\',$global),442,13,\'<image>/04_array.js\');$x1575=&$x1576[0];list(,$W1575,$S1575,$U1575)=$x1576;$scope->properties[\'len\']=JS::$undefined;$_len=&$scope->properties[\'len\'];$Ulen=FALSE;$_len=$x1575;$x1577=(((gettype($_len)===gettype(0.0)&&$_len===0.0))||(((is_float($_len)||is_int($_len))&&(is_float(0.0)||is_int(0.0)))&&$_len==0.0));if(JS::toBoolean($x1577,$global)){return false;}$x1578=JS::toNumber($_fromIndex,$global);$x1579=JS::toNumber(0.0,$global);if(is_nan($x1578)){$x1578=0;}if(is_nan($x1579)){$x1579=0;}$x1580=$x1578|$x1579;$scope->properties[\'n\']=JS::$undefined;$_n=&$scope->properties[\'n\'];$Un=FALSE;$_n=$x1580;unset($_Math,$WMath,$SMath,$UMath);$x1581=_61c60c86aef535e2824e55eb30517a85_2($global,$scope,$scope,JS::toString(\'Math\',$global),458,10,\'<image>/04_array.js\');$_Math=&$x1581[0];list(,$WMath,$SMath,$UMath)=$x1581;if($UMath){unset($_ReferenceError,$WReferenceError,$SReferenceError,$UReferenceError);$x1582=_61c60c86aef535e2824e55eb30517a85_2($global,$scope,$scope,JS::toString(\'ReferenceError\',$global),458,10,\'<image>/04_array.js\');$_ReferenceError=&$x1582[0];list(,$WReferenceError,$SReferenceError,$UReferenceError)=$x1582;$x1583=$_ReferenceError->call;$global->trace[++$global->trace_sp]=array(\'<image>/04_array.js\',458,10);$x1584=$x1583($global,$global,$_ReferenceError,array(\'Math is not defined\'),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);if(isset($x1584->class)&&$x1584->class===\'Error\'&&!isset($x1584->properties[\'file\'])&&!isset($x1584->properties[\'line\'])&&!isset($x1584->properties[\'column\'])){$x1584->properties[\'file\']=\'<image>/04_array.js\';$x1584->properties[\'line\']=458;$x1584->properties[\'column\']=10;$x1584->attributes[\'file\']=$x1584->attributes[\'line\']=$x1584->attributes[\'column\']=0;}throw new JSException($x1584,458,10,\'<image>/04_array.js\');}if($_Math===JS::$undefined||$_Math===NULL){unset($_TypeError,$WTypeError,$STypeError,$UTypeError);$x1586=_61c60c86aef535e2824e55eb30517a85_2($global,$scope,$scope,JS::toString(\'TypeError\',$global),458,18,\'<image>/04_array.js\');$_TypeError=&$x1586[0];list(,$WTypeError,$STypeError,$UTypeError)=$x1586;$x1587=$_TypeError->call;$global->trace[++$global->trace_sp]=array(\'<image>/04_array.js\',458,18);$x1588=$x1587($global,$global,$_TypeError,array(\'Cannot call function on undefined/null.\'),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);if(isset($x1588->class)&&$x1588->class===\'Error\'&&!isset($x1588->properties[\'file\'])&&!isset($x1588->properties[\'line\'])&&!isset($x1588->properties[\'column\'])){$x1588->properties[\'file\']=\'<image>/04_array.js\';$x1588->properties[\'line\']=458;$x1588->properties[\'column\']=18;$x1588->attributes[\'file\']=$x1588->attributes[\'line\']=$x1588->attributes[\'column\']=0;}throw new JSException($x1588,458,18,\'<image>/04_array.js\');}$x1585=JS::toObject($_Math,$global);unset($x1589,$W1589,$S1589,$U1589);$x1590=_61c60c86aef535e2824e55eb30517a85_4($global,$scope,$x1585,JS::toString(\'max\',$global),458,18,\'<image>/04_array.js\');$x1589=&$x1590[0];list(,$W1589,$S1589,$U1589)=$x1590;$x1592=JS::toPrimitive($_n,$global);$x1593=JS::toPrimitive(0.0,$global);$x1594=!(is_string($x1592)&&is_string($x1593)?strcmp($x1592,$x1593)<0:(!is_nan($x1595=JS::toNumber($x1592,$global))&&!is_nan($x1596=JS::toNumber($x1593,$global))&&$x1595<$x1596));if(JS::toBoolean($x1594,$global)){$x1591=$_n;}else{if($_Math===JS::$undefined||$_Math===NULL){unset($_TypeError,$WTypeError,$STypeError,$UTypeError);$x1598=_61c60c86aef535e2824e55eb30517a85_2($global,$scope,$scope,JS::toString(\'TypeError\',$global),458,46,\'<image>/04_array.js\');$_TypeError=&$x1598[0];list(,$WTypeError,$STypeError,$UTypeError)=$x1598;$x1599=$_TypeError->call;$global->trace[++$global->trace_sp]=array(\'<image>/04_array.js\',458,46);$x1600=$x1599($global,$global,$_TypeError,array(\'Cannot call function on undefined/null.\'),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);if(isset($x1600->class)&&$x1600->class===\'Error\'&&!isset($x1600->properties[\'file\'])&&!isset($x1600->properties[\'line\'])&&!isset($x1600->properties[\'column\'])){$x1600->properties[\'file\']=\'<image>/04_array.js\';$x1600->properties[\'line\']=458;$x1600->properties[\'column\']=46;$x1600->attributes[\'file\']=$x1600->attributes[\'line\']=$x1600->attributes[\'column\']=0;}throw new JSException($x1600,458,46,\'<image>/04_array.js\');}$x1597=JS::toObject($_Math,$global);unset($x1601,$W1601,$S1601,$U1601);$x1602=_61c60c86aef535e2824e55eb30517a85_4($global,$scope,$x1597,JS::toString(\'abs\',$global),458,46,\'<image>/04_array.js\');$x1601=&$x1602[0];list(,$W1601,$S1601,$U1601)=$x1602;if(!(is_object($x1601)&&isset($x1601->call))){unset($_TypeError,$WTypeError,$STypeError,$UTypeError);$x1605=_61c60c86aef535e2824e55eb30517a85_2($global,$scope,$scope,JS::toString(\'TypeError\',$global),458,46,\'<image>/04_array.js\');$_TypeError=&$x1605[0];list(,$WTypeError,$STypeError,$UTypeError)=$x1605;$x1606=$_TypeError->call;$global->trace[++$global->trace_sp]=array(\'<image>/04_array.js\',458,46);$x1607=$x1606($global,$global,$_TypeError,array(\'Trying to call what is not a function.\'),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);if(isset($x1607->class)&&$x1607->class===\'Error\'&&!isset($x1607->properties[\'file\'])&&!isset($x1607->properties[\'line\'])&&!isset($x1607->properties[\'column\'])){$x1607->properties[\'file\']=\'<image>/04_array.js\';$x1607->properties[\'line\']=458;$x1607->properties[\'column\']=46;$x1607->attributes[\'file\']=$x1607->attributes[\'line\']=$x1607->attributes[\'column\']=0;}throw new JSException($x1607,458,46,\'<image>/04_array.js\');}$x1603=$x1601->call;$global->trace[++$global->trace_sp]=array(\'<image>/04_array.js\',458,46);$x1604=$x1603($global,$x1597,$x1601,array($_n),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);$x1591=(JS::toNumber($_len,$global)-JS::toNumber($x1604,$global));}if(!(is_object($x1589)&&isset($x1589->call))){unset($_TypeError,$WTypeError,$STypeError,$UTypeError);$x1610=_61c60c86aef535e2824e55eb30517a85_2($global,$scope,$scope,JS::toString(\'TypeError\',$global),458,18,\'<image>/04_array.js\');$_TypeError=&$x1610[0];list(,$WTypeError,$STypeError,$UTypeError)=$x1610;$x1611=$_TypeError->call;$global->trace[++$global->trace_sp]=array(\'<image>/04_array.js\',458,18);$x1612=$x1611($global,$global,$_TypeError,array(\'Trying to call what is not a function.\'),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);if(isset($x1612->class)&&$x1612->class===\'Error\'&&!isset($x1612->properties[\'file\'])&&!isset($x1612->properties[\'line\'])&&!isset($x1612->properties[\'column\'])){$x1612->properties[\'file\']=\'<image>/04_array.js\';$x1612->properties[\'line\']=458;$x1612->properties[\'column\']=18;$x1612->attributes[\'file\']=$x1612->attributes[\'line\']=$x1612->attributes[\'column\']=0;}throw new JSException($x1612,458,18,\'<image>/04_array.js\');}$x1608=$x1589->call;$global->trace[++$global->trace_sp]=array(\'<image>/04_array.js\',458,18);$x1609=$x1608($global,$x1585,$x1589,array($x1591,0.0),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);$scope->properties[\'k\']=JS::$undefined;$_k=&$scope->properties[\'k\'];$Uk=FALSE;$_k=$x1609;for(;;){$x1613=JS::toPrimitive($_k,$global);$x1614=JS::toPrimitive($_len,$global);$x1615=(is_string($x1613)&&is_string($x1614)?strcmp($x1613,$x1614)<0:(!is_nan($x1616=JS::toNumber($x1613,$global))&&!is_nan($x1617=JS::toNumber($x1614,$global))&&$x1616<$x1617));if(!JS::toBoolean($x1615,$global)){break;}unset($x1618,$W1618,$S1618,$U1618);$x1619=_61c60c86aef535e2824e55eb30517a85_4($global,$scope,$_o,JS::toString($_k,$global),468,23,\'<image>/04_array.js\');$x1618=&$x1619[0];list(,$W1618,$S1618,$U1618)=$x1619;if(!(is_object($_sameValueZero)&&isset($_sameValueZero->call))){unset($_TypeError,$WTypeError,$STypeError,$UTypeError);$x1622=_61c60c86aef535e2824e55eb30517a85_2($global,$scope,$scope,JS::toString(\'TypeError\',$global),468,21,\'<image>/04_array.js\');$_TypeError=&$x1622[0];list(,$WTypeError,$STypeError,$UTypeError)=$x1622;$x1623=$_TypeError->call;$global->trace[++$global->trace_sp]=array(\'<image>/04_array.js\',468,21);$x1624=$x1623($global,$global,$_TypeError,array(\'Trying to call what is not a function.\'),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);if(isset($x1624->class)&&$x1624->class===\'Error\'&&!isset($x1624->properties[\'file\'])&&!isset($x1624->properties[\'line\'])&&!isset($x1624->properties[\'column\'])){$x1624->properties[\'file\']=\'<image>/04_array.js\';$x1624->properties[\'line\']=468;$x1624->properties[\'column\']=21;$x1624->attributes[\'file\']=$x1624->attributes[\'line\']=$x1624->attributes[\'column\']=0;}throw new JSException($x1624,468,21,\'<image>/04_array.js\');}$x1620=$_sameValueZero->call;$global->trace[++$global->trace_sp]=array(\'<image>/04_array.js\',468,21);$x1621=$x1620($global,$global,$_sameValueZero,array($x1618,$_searchElement),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);if(JS::toBoolean($x1621,$global)){return true;}$x1625=$_k;++$_k;}return false;return JS::$undefined;}', "\n";
function _61c60c86aef535e2824e55eb30517a85_0($global = NULL, $scope = NULL) {
...
$leThis = $global;
$_Array;
$x82 = clone JS::$functionTemplate; $x82->call = '_61c60c86aef535e2824e55eb30517a85_1'; $x82->parameters = array (
...
$UArray = FALSE;
$_Array = $x82;
$x89 = clone JS::$functionTemplate; $x89->call = '_61c60c86aef535e2824e55eb30517a85_5'; $x89->parameters = array (
  0 => 'arg',
...
if ($_Array === JS::$undefined || $_Array === NULL) {
unset($_TypeError, $WTypeError, $STypeError, $UTypeError);
$x91 = _61c60c86aef535e2824e55eb30517a85_2($global, $scope, $scope, JS::toString('TypeError', $global), 30, 15, '<image>/04_array.js');
...
$x95 = _61c60c86aef535e2824e55eb30517a85_3($global, $scope, $_Array, JS::toString($x90, $global), 30, 15, '<image>/04_array.js');
...
if ($_Array === JS::$undefined || $_Array === NULL) {
unset($_TypeError, $WTypeError, $STypeError, $UTypeError);
$x102 = _61c60c86aef535e2824e55eb30517a85_2($global, $scope, $scope, JS::toString('TypeError', $global), 38, 17, '<image>/04_array.js');
...
$x106 = _61c60c86aef535e2824e55eb30517a85_3($global, $scope, $_Array, JS::toString($x101, $global), 38, 17, '<image>/04_array.js');
...
$_Array->prototype =$_Array->properties['prototype'];
unset($_Object, $WObject, $SObject, $UObject);
$x111 = _61c60c86aef535e2824e55eb30517a85_2($global, $scope, $scope, JS::toString('Object', $global), 40, 50, '<image>/04_array.js');
$_Object =& $x111[0]; list(,$WObject,$SObject,$UObject) = $x111;
if ($UObject) {
unset($_ReferenceError, $WReferenceError, $SReferenceError, $UReferenceError);
$x112 = _61c60c86aef535e2824e55eb30517a85_2($global, $scope, $scope, JS::toString('ReferenceError', $global), 40, 50, '<image>/04_array.js');
...
$x116 = _61c60c86aef535e2824e55eb30517a85_4($global, $scope, $_Array, JS::toString('prototype', $global), 43, 6, '<image>/04_array.js');
$x115 =& $x116[0]; list(,$W115,$S115,$U115) = $x116;
$x117 = JS::toString('constructor', $global);
if ($x115 === JS::$undefined || $x115 === NULL) {
unset($_TypeError, $WTypeError, $STypeError, $UTypeError);
$x118 = _61c60c86aef535e2824e55eb30517a85_2($global, $scope, $scope, JS::toString('TypeError', $global), 43, 29, '<image>/04_array.js');
...
$x122 = _61c60c86aef535e2824e55eb30517a85_3($global, $scope, $x115, JS::toString($x117, $global), 43, 29, '<image>/04_array.js');
...
$x129 = _61c60c86aef535e2824e55eb30517a85_4($global, $scope, $_Array, JS::toString('prototype', $global), 44, 6, '<image>/04_array.js');
$x128 =& $x129[0]; list(,$W128,$S128,$U128) = $x129;
$x130 = JS::toString('length', $global);
if ($x128 === JS::$undefined || $x128 === NULL) {
unset($_TypeError, $WTypeError, $STypeError, $UTypeError);
$x131 = _61c60c86aef535e2824e55eb30517a85_2($global, $scope, $scope, JS::toString('TypeError', $global), 44, 24, '<image>/04_array.js');
...
$x135 = _61c60c86aef535e2824e55eb30517a85_3($global, $scope, $x128, JS::toString($x130, $global), 44, 24, '<image>/04_array.js');
...
$x153 = clone JS::$functionTemplate; $x153->call = '_61c60c86aef535e2824e55eb30517a85_6'; $x153->parameters = array (
...
$x155 = _61c60c86aef535e2824e55eb30517a85_4($global, $scope, $_Array, JS::toString('prototype', $global), 46, 6, '<image>/04_array.js');
$x154 =& $x155[0]; list(,$W154,$S154,$U154) = $x155;
$x156 = JS::toString('toString', $global);
if ($x154 === JS::$undefined || $x154 === NULL) {
unset($_TypeError, $WTypeError, $STypeError, $UTypeError);
$x157 = _61c60c86aef535e2824e55eb30517a85_2($global, $scope, $scope, JS::toString('TypeError', $global), 46, 26, '<image>/04_array.js');
...
$x161 = _61c60c86aef535e2824e55eb30517a85_3($global, $scope, $x154, JS::toString($x156, $global), 46, 26, '<image>/04_array.js');
...
$x167 = _61c60c86aef535e2824e55eb30517a85_4($global, $scope, $_Array, JS::toString('prototype', $global), 50, 39, '<image>/04_array.js');
$x166 =& $x167[0]; list(,$W166,$S166,$U166) = $x167;
unset($x168, $W168, $S168, $U168);
$x169 = _61c60c86aef535e2824e55eb30517a85_4($global, $scope, $x166, JS::toString('toString', $global), 50, 49, '<image>/04_array.js');
$x168 =& $x169[0]; list(,$W168,$S168,$U168) = $x169;
unset($x170, $W170, $S170, $U170);
$x171 = _61c60c86aef535e2824e55eb30517a85_4($global, $scope, $_Array, JS::toString('prototype', $global), 50, 6, '<image>/04_array.js');
$x170 =& $x171[0]; list(,$W170,$S170,$U170) = $x171;
$x172 = JS::toString('toLocaleString', $global);
if ($x170 === JS::$undefined || $x170 === NULL) {
unset($_TypeError, $WTypeError, $STypeError, $UTypeError);
$x173 = _61c60c86aef535e2824e55eb30517a85_2($global, $scope, $scope, JS::toString('TypeError', $global), 50, 32, '<image>/04_array.js');
...
$x177 = _61c60c86aef535e2824e55eb30517a85_3($global, $scope, $x170, JS::toString($x172, $global), 50, 32, '<image>/04_array.js');
...
$x276 = clone JS::$functionTemplate; $x276->call = '_61c60c86aef535e2824e55eb30517a85_7'; $x276->parameters = array (
  0 => 'item',
...
$x278 = _61c60c86aef535e2824e55eb30517a85_4($global, $scope, $_Array, JS::toString('prototype', $global), 52, 6, '<image>/04_array.js');
$x277 =& $x278[0]; list(,$W277,$S277,$U277) = $x278;
$x279 = JS::toString('concat', $global);
if ($x277 === JS::$undefined || $x277 === NULL) {
unset($_TypeError, $WTypeError, $STypeError, $UTypeError);
$x280 = _61c60c86aef535e2824e55eb30517a85_2($global, $scope, $scope, JS::toString('TypeError', $global), 52, 24, '<image>/04_array.js');
...
$x284 = _61c60c86aef535e2824e55eb30517a85_3($global, $scope, $x277, JS::toString($x279, $global), 52, 24, '<image>/04_array.js');
...
$x320 = clone JS::$functionTemplate; $x320->call = '_61c60c86aef535e2824e55eb30517a85_8'; $x320->parameters = array (
  0 => 'separator',
...
$x322 = _61c60c86aef535e2824e55eb30517a85_4($global, $scope, $_Array, JS::toString('prototype', $global), 73, 6, '<image>/04_array.js');
$x321 =& $x322[0]; list(,$W321,$S321,$U321) = $x322;
$x323 = JS::toString('join', $global);
if ($x321 === JS::$undefined || $x321 === NULL) {
unset($_TypeError, $WTypeError, $STypeError, $UTypeError);
$x324 = _61c60c86aef535e2824e55eb30517a85_2($global, $scope, $scope, JS::toString('TypeError', $global), 73, 22, '<image>/04_array.js');
...
$x328 = _61c60c86aef535e2824e55eb30517a85_3($global, $scope, $x321, JS::toString($x323, $global), 73, 22, '<image>/04_array.js');
...
$x362 = clone JS::$functionTemplate; $x362->call = '_61c60c86aef535e2824e55eb30517a85_9'; $x362->parameters = array (
...
$x364 = _61c60c86aef535e2824e55eb30517a85_4($global, $scope, $_Array, JS::toString('prototype', $global), 99, 6, '<image>/04_array.js');
$x363 =& $x364[0]; list(,$W363,$S363,$U363) = $x364;
$x365 = JS::toString('pop', $global);
if ($x363 === JS::$undefined || $x363 === NULL) {
unset($_TypeError, $WTypeError, $STypeError, $UTypeError);
$x366 = _61c60c86aef535e2824e55eb30517a85_2($global, $scope, $scope, JS::toString('TypeError', $global), 99, 21, '<image>/04_array.js');
...
$x370 = _61c60c86aef535e2824e55eb30517a85_3($global, $scope, $x363, JS::toString($x365, $global), 99, 21, '<image>/04_array.js');
...
$x406 = clone JS::$functionTemplate; $x406->call = '_61c60c86aef535e2824e55eb30517a85_10'; $x406->parameters = array (
  0 => 'item',
...
$x408 = _61c60c86aef535e2824e55eb30517a85_4($global, $scope, $_Array, JS::toString('prototype', $global), 111, 6, '<image>/04_array.js');
$x407 =& $x408[0]; list(,$W407,$S407,$U407) = $x408;
$x409 = JS::toString('push', $global);
if ($x407 === JS::$undefined || $x407 === NULL) {
unset($_TypeError, $WTypeError, $STypeError, $UTypeError);
$x410 = _61c60c86aef535e2824e55eb30517a85_2($global, $scope, $scope, JS::toString('TypeError', $global), 111, 22, '<image>/04_array.js');
...
$x414 = _61c60c86aef535e2824e55eb30517a85_3($global, $scope, $x407, JS::toString($x409, $global), 111, 22, '<image>/04_array.js');
...
$x455 = clone JS::$functionTemplate; $x455->call = '_61c60c86aef535e2824e55eb30517a85_11'; $x455->parameters = array (
...
$x457 = _61c60c86aef535e2824e55eb30517a85_4($global, $scope, $_Array, JS::toString('prototype', $global), 119, 6, '<image>/04_array.js');
$x456 =& $x457[0]; list(,$W456,$S456,$U456) = $x457;
$x458 = JS::toString('reverse', $global);
if ($x456 === JS::$undefined || $x456 === NULL) {
unset($_TypeError, $WTypeError, $STypeError, $UTypeError);
$x459 = _61c60c86aef535e2824e55eb30517a85_2($global, $scope, $scope, JS::toString('TypeError', $global), 119, 25, '<image>/04_array.js');
...
$x463 = _61c60c86aef535e2824e55eb30517a85_3($global, $scope, $x456, JS::toString($x458, $global), 119, 25, '<image>/04_array.js');
...
$x513 = clone JS::$functionTemplate; $x513->call = '_61c60c86aef535e2824e55eb30517a85_12'; $x513->parameters = array (
...
$x515 = _61c60c86aef535e2824e55eb30517a85_4($global, $scope, $_Array, JS::toString('prototype', $global), 129, 6, '<image>/04_array.js');
$x514 =& $x515[0]; list(,$W514,$S514,$U514) = $x515;
$x516 = JS::toString('shift', $global);
if ($x514 === JS::$undefined || $x514 === NULL) {
unset($_TypeError, $WTypeError, $STypeError, $UTypeError);
$x517 = _61c60c86aef535e2824e55eb30517a85_2($global, $scope, $scope, JS::toString('TypeError', $global), 129, 23, '<image>/04_array.js');
...
$x521 = _61c60c86aef535e2824e55eb30517a85_3($global, $scope, $x514, JS::toString($x516, $global), 129, 23, '<image>/04_array.js');
...
$x588 = clone JS::$functionTemplate; $x588->call = '_61c60c86aef535e2824e55eb30517a85_13'; $x588->parameters = array (
  0 => 'start',
  1 => 'end',
...
$x590 = _61c60c86aef535e2824e55eb30517a85_4($global, $scope, $_Array, JS::toString('prototype', $global), 145, 6, '<image>/04_array.js');
$x589 =& $x590[0]; list(,$W589,$S589,$U589) = $x590;
$x591 = JS::toString('slice', $global);
if ($x589 === JS::$undefined || $x589 === NULL) {
unset($_TypeError, $WTypeError, $STypeError, $UTypeError);
$x592 = _61c60c86aef535e2824e55eb30517a85_2($global, $scope, $scope, JS::toString('TypeError', $global), 145, 23, '<image>/04_array.js');
...
$x596 = _61c60c86aef535e2824e55eb30517a85_3($global, $scope, $x589, JS::toString($x591, $global), 145, 23, '<image>/04_array.js');
...
$x756 = clone JS::$functionTemplate; $x756->call = '_61c60c86aef535e2824e55eb30517a85_14'; $x756->parameters = array (
  0 => 'compareFn',
...
$x758 = _61c60c86aef535e2824e55eb30517a85_4($global, $scope, $_Array, JS::toString('prototype', $global), 171, 6, '<image>/04_array.js');
$x757 =& $x758[0]; list(,$W757,$S757,$U757) = $x758;
$x759 = JS::toString('sort', $global);
if ($x757 === JS::$undefined || $x757 === NULL) {
unset($_TypeError, $WTypeError, $STypeError, $UTypeError);
$x760 = _61c60c86aef535e2824e55eb30517a85_2($global, $scope, $scope, JS::toString('TypeError', $global), 171, 22, '<image>/04_array.js');
...
$x764 = _61c60c86aef535e2824e55eb30517a85_3($global, $scope, $x757, JS::toString($x759, $global), 171, 22, '<image>/04_array.js');
...
$x835 = clone JS::$functionTemplate; $x835->call = '_61c60c86aef535e2824e55eb30517a85_16'; $x835->parameters = array (
  0 => 'start',
  1 => 'deleteCount',
...
$x837 = _61c60c86aef535e2824e55eb30517a85_4($global, $scope, $_Array, JS::toString('prototype', $global), 220, 6, '<image>/04_array.js');
$x836 =& $x837[0]; list(,$W836,$S836,$U836) = $x837;
$x838 = JS::toString('splice', $global);
if ($x836 === JS::$undefined || $x836 === NULL) {
unset($_TypeError, $WTypeError, $STypeError, $UTypeError);
$x839 = _61c60c86aef535e2824e55eb30517a85_2($global, $scope, $scope, JS::toString('TypeError', $global), 220, 24, '<image>/04_array.js');
...
$x843 = _61c60c86aef535e2824e55eb30517a85_3($global, $scope, $x836, JS::toString($x838, $global), 220, 24, '<image>/04_array.js');
...
$x906 = clone JS::$functionTemplate; $x906->call = '_61c60c86aef535e2824e55eb30517a85_17'; $x906->parameters = array (
  0 => 'item',
...
$x908 = _61c60c86aef535e2824e55eb30517a85_4($global, $scope, $_Array, JS::toString('prototype', $global), 257, 6, '<image>/04_array.js');
$x907 =& $x908[0]; list(,$W907,$S907,$U907) = $x908;
$x909 = JS::toString('unshift', $global);
if ($x907 === JS::$undefined || $x907 === NULL) {
unset($_TypeError, $WTypeError, $STypeError, $UTypeError);
$x910 = _61c60c86aef535e2824e55eb30517a85_2($global, $scope, $scope, JS::toString('TypeError', $global), 257, 25, '<image>/04_array.js');
...
$x914 = _61c60c86aef535e2824e55eb30517a85_3($global, $scope, $x907, JS::toString($x909, $global), 257, 25, '<image>/04_array.js');
...
$x958 = clone JS::$functionTemplate; $x958->call = '_61c60c86aef535e2824e55eb30517a85_18'; $x958->parameters = array (
  0 => 'search',
  1 => 'from',
...
$x960 = _61c60c86aef535e2824e55eb30517a85_4($global, $scope, $_Array, JS::toString('prototype', $global), 269, 6, '<image>/04_array.js');
$x959 =& $x960[0]; list(,$W959,$S959,$U959) = $x960;
$x961 = JS::toString('indexOf', $global);
if ($x959 === JS::$undefined || $x959 === NULL) {
unset($_TypeError, $WTypeError, $STypeError, $UTypeError);
$x962 = _61c60c86aef535e2824e55eb30517a85_2($global, $scope, $scope, JS::toString('TypeError', $global), 269, 25, '<image>/04_array.js');
...
$x966 = _61c60c86aef535e2824e55eb30517a85_3($global, $scope, $x959, JS::toString($x961, $global), 269, 25, '<image>/04_array.js');
...
$x1027 = clone JS::$functionTemplate; $x1027->call = '_61c60c86aef535e2824e55eb30517a85_19'; $x1027->parameters = array (
  0 => 'search',
  1 => 'from',
...
$x1029 = _61c60c86aef535e2824e55eb30517a85_4($global, $scope, $_Array, JS::toString('prototype', $global), 285, 6, '<image>/04_array.js');
$x1028 =& $x1029[0]; list(,$W1028,$S1028,$U1028) = $x1029;
$x1030 = JS::toString('lastIndexOf', $global);
if ($x1028 === JS::$undefined || $x1028 === NULL) {
unset($_TypeError, $WTypeError, $STypeError, $UTypeError);
$x1031 = _61c60c86aef535e2824e55eb30517a85_2($global, $scope, $scope, JS::toString('TypeError', $global), 285, 29, '<image>/04_array.js');
...
$x1035 = _61c60c86aef535e2824e55eb30517a85_3($global, $scope, $x1028, JS::toString($x1030, $global), 285, 29, '<image>/04_array.js');
...
$x1077 = clone JS::$functionTemplate; $x1077->call = '_61c60c86aef535e2824e55eb30517a85_20'; $x1077->parameters = array (
  0 => 'callbackFn',
...
$x1079 = _61c60c86aef535e2824e55eb30517a85_4($global, $scope, $_Array, JS::toString('prototype', $global), 305, 6, '<image>/04_array.js');
$x1078 =& $x1079[0]; list(,$W1078,$S1078,$U1078) = $x1079;
$x1080 = JS::toString('every', $global);
if ($x1078 === JS::$undefined || $x1078 === NULL) {
unset($_TypeError, $WTypeError, $STypeError, $UTypeError);
$x1081 = _61c60c86aef535e2824e55eb30517a85_2($global, $scope, $scope, JS::toString('TypeError', $global), 305, 23, '<image>/04_array.js');
...
$x1085 = _61c60c86aef535e2824e55eb30517a85_3($global, $scope, $x1078, JS::toString($x1080, $global), 305, 23, '<image>/04_array.js');
...
$x1127 = clone JS::$functionTemplate; $x1127->call = '_61c60c86aef535e2824e55eb30517a85_21'; $x1127->parameters = array (
  0 => 'callbackFn',
...
$x1129 = _61c60c86aef535e2824e55eb30517a85_4($global, $scope, $_Array, JS::toString('prototype', $global), 321, 6, '<image>/04_array.js');
$x1128 =& $x1129[0]; list(,$W1128,$S1128,$U1128) = $x1129;
$x1130 = JS::toString('some', $global);
if ($x1128 === JS::$undefined || $x1128 === NULL) {
unset($_TypeError, $WTypeError, $STypeError, $UTypeError);
$x1131 = _61c60c86aef535e2824e55eb30517a85_2($global, $scope, $scope, JS::toString('TypeError', $global), 321, 22, '<image>/04_array.js');
...
$x1135 = _61c60c86aef535e2824e55eb30517a85_3($global, $scope, $x1128, JS::toString($x1130, $global), 321, 22, '<image>/04_array.js');
...
$x1177 = clone JS::$functionTemplate; $x1177->call = '_61c60c86aef535e2824e55eb30517a85_22'; $x1177->parameters = array (
  0 => 'callbackFn',
...
$x1179 = _61c60c86aef535e2824e55eb30517a85_4($global, $scope, $_Array, JS::toString('prototype', $global), 337, 6, '<image>/04_array.js');
$x1178 =& $x1179[0]; list(,$W1178,$S1178,$U1178) = $x1179;
$x1180 = JS::toString('forEach', $global);
if ($x1178 === JS::$undefined || $x1178 === NULL) {
unset($_TypeError, $WTypeError, $STypeError, $UTypeError);
$x1181 = _61c60c86aef535e2824e55eb30517a85_2($global, $scope, $scope, JS::toString('TypeError', $global), 337, 25, '<image>/04_array.js');
...
$x1185 = _61c60c86aef535e2824e55eb30517a85_3($global, $scope, $x1178, JS::toString($x1180, $global), 337, 25, '<image>/04_array.js');
...
$x1239 = clone JS::$functionTemplate; $x1239->call = '_61c60c86aef535e2824e55eb30517a85_23'; $x1239->parameters = array (
  0 => 'callbackFn',
...
$x1241 = _61c60c86aef535e2824e55eb30517a85_4($global, $scope, $_Array, JS::toString('prototype', $global), 349, 6, '<image>/04_array.js');
$x1240 =& $x1241[0]; list(,$W1240,$S1240,$U1240) = $x1241;
$x1242 = JS::toString('map', $global);
if ($x1240 === JS::$undefined || $x1240 === NULL) {
unset($_TypeError, $WTypeError, $STypeError, $UTypeError);
$x1243 = _61c60c86aef535e2824e55eb30517a85_2($global, $scope, $scope, JS::toString('TypeError', $global), 349, 21, '<image>/04_array.js');
...
$x1247 = _61c60c86aef535e2824e55eb30517a85_3($global, $scope, $x1240, JS::toString($x1242, $global), 349, 21, '<image>/04_array.js');
...
$x1303 = clone JS::$functionTemplate; $x1303->call = '_61c60c86aef535e2824e55eb30517a85_24'; $x1303->parameters = array (
  0 => 'callbackFn',
...
$x1305 = _61c60c86aef535e2824e55eb30517a85_4($global, $scope, $_Array, JS::toString('prototype', $global), 363, 6, '<image>/04_array.js');
$x1304 =& $x1305[0]; list(,$W1304,$S1304,$U1304) = $x1305;
$x1306 = JS::toString('filter', $global);
if ($x1304 === JS::$undefined || $x1304 === NULL) {
unset($_TypeError, $WTypeError, $STypeError, $UTypeError);
$x1307 = _61c60c86aef535e2824e55eb30517a85_2($global, $scope, $scope, JS::toString('TypeError', $global), 363, 24, '<image>/04_array.js');
...
$x1311 = _61c60c86aef535e2824e55eb30517a85_3($global, $scope, $x1304, JS::toString($x1306, $global), 363, 24, '<image>/04_array.js');
...
$x1401 = clone JS::$functionTemplate; $x1401->call = '_61c60c86aef535e2824e55eb30517a85_25'; $x1401->parameters = array (
  0 => 'callbackFn',
...
$x1403 = _61c60c86aef535e2824e55eb30517a85_4($global, $scope, $_Array, JS::toString('prototype', $global), 379, 6, '<image>/04_array.js');
$x1402 =& $x1403[0]; list(,$W1402,$S1402,$U1402) = $x1403;
$x1404 = JS::toString('reduce', $global);
if ($x1402 === JS::$undefined || $x1402 === NULL) {
unset($_TypeError, $WTypeError, $STypeError, $UTypeError);
$x1405 = _61c60c86aef535e2824e55eb30517a85_2($global, $scope, $scope, JS::toString('TypeError', $global), 379, 24, '<image>/04_array.js');
...
$x1409 = _61c60c86aef535e2824e55eb30517a85_3($global, $scope, $x1402, JS::toString($x1404, $global), 379, 24, '<image>/04_array.js');
...
$x1497 = clone JS::$functionTemplate; $x1497->call = '_61c60c86aef535e2824e55eb30517a85_26'; $x1497->parameters = array (
  0 => 'callbackFn',
...
$x1499 = _61c60c86aef535e2824e55eb30517a85_4($global, $scope, $_Array, JS::toString('prototype', $global), 405, 6, '<image>/04_array.js');
$x1498 =& $x1499[0]; list(,$W1498,$S1498,$U1498) = $x1499;
$x1500 = JS::toString('reduceRight', $global);
if ($x1498 === JS::$undefined || $x1498 === NULL) {
unset($_TypeError, $WTypeError, $STypeError, $UTypeError);
$x1501 = _61c60c86aef535e2824e55eb30517a85_2($global, $scope, $scope, JS::toString('TypeError', $global), 405, 29, '<image>/04_array.js');
...
$x1505 = _61c60c86aef535e2824e55eb30517a85_3($global, $scope, $x1498, JS::toString($x1500, $global), 405, 29, '<image>/04_array.js');
...
unset($_TypeError, $WTypeError, $STypeError, $UTypeError);
$x1511 = _61c60c86aef535e2824e55eb30517a85_2($global, $scope, $scope, JS::toString('TypeError', $global), 431, 22, '<image>/04_array.js');
$_TypeError =& $x1511[0]; list(,$WTypeError,$STypeError,$UTypeError) = $x1511;
$x1512 = $_TypeError->call;
$global->trace[++$global->trace_sp] = array('<image>/04_array.js', 431, 22);
$x1513 = $x1512($global, $global, $_TypeError, array('Cannot call function on undefined/null.'), false);
unset($global->trace[$global->trace_sp--], $global->scope[$global->scope_sp--]);
if (isset($x1513->class) && $x1513->class === 'Error' && !isset($x1513->properties['file']) && !isset($x1513->properties['line']) && !isset($x1513->properties['column'])) {$x1513->properties['file'] = '<image>/04_array.js';$x1513->properties['line'] = 431;$x1513->properties['column'] = 22;$x1513->attributes['file'] = $x1513->attributes['line'] = $x1513->attributes['column'] = 0; }
throw new JSException($x1513, 431, 22, '<image>/04_array.js');
}
$x1510 = JS::toObject($_Object, $global);
unset($x1514, $W1514, $S1514, $U1514);
$x1515 = _61c60c86aef535e2824e55eb30517a85_4($global, $scope, $x1510, JS::toString('defineProperty', $global), 431, 22, '<image>/04_array.js');
$x1514 =& $x1515[0]; list(,$W1514,$S1514,$U1514) = $x1515;
unset($x1516, $W1516, $S1516, $U1516);
$x1517 = _61c60c86aef535e2824e55eb30517a85_4($global, $scope, $_Array, JS::toString('prototype', $global), 431, 28, '<image>/04_array.js');
$x1516 =& $x1517[0]; list(,$W1516,$S1516,$U1516) = $x1517;
$x1518 = clone JS::$objectTemplate;
$x1626 = clone JS::$functionTemplate; $x1626->call = '_61c60c86aef535e2824e55eb30517a85_27'; $x1626->parameters = array (
  0 => 'searchElement',
  1 => 'fromIndex',
); $x1626->scope = $scope; $x1626->properties['prototype'] = clone JS::$objectTemplate; $x1626->attributes['prototype'] = JS::WRITABLE; $x1626->properties['prototype']->properties['constructor'] = $x1626; $x1626->properties['prototype']->attributes['constructor'] = JS::WRITABLE | JS::CONFIGURABLE; $x1626->properties['length'] = 2; $x1626->attributes['length'] = 0;
$x1518->properties['value'] = $x1626;
$x1518->attributes['value'] = JS::WRITABLE | JS::ENUMERABLE | JS::CONFIGURABLE;
if (!(is_object($x1514) && isset($x1514->call))) { 
unset($_TypeError, $WTypeError, $STypeError, $UTypeError);
$x1629 = _61c60c86aef535e2824e55eb30517a85_2($global, $scope, $scope, JS::toString('TypeError', $global), 431, 22, '<image>/04_array.js');
$_TypeError =& $x1629[0]; list(,$WTypeError,$STypeError,$UTypeError) = $x1629;
$x1630 = $_TypeError->call;
$global->trace[++$global->trace_sp] = array('<image>/04_array.js', 431, 22);
$x1631 = $x1630($global, $global, $_TypeError, array('Trying to call what is not a function.'), false);
unset($global->trace[$global->trace_sp--], $global->scope[$global->scope_sp--]);
if (isset($x1631->class) && $x1631->class === 'Error' && !isset($x1631->properties['file']) && !isset($x1631->properties['line']) && !isset($x1631->properties['column'])) {$x1631->properties['file'] = '<image>/04_array.js';$x1631->properties['line'] = 431;$x1631->properties['column'] = 22;$x1631->attributes['file'] = $x1631->attributes['line'] = $x1631->attributes['column'] = 0; }
throw new JSException($x1631, 431, 22, '<image>/04_array.js');
}
$x1627 = $x1514->call;
$global->trace[++$global->trace_sp] = array('<image>/04_array.js', 431, 22);
$x1628 = $x1627($global, $x1510, $x1514, array($x1516, 'includes', $x1518), false);
unset($global->trace[$global->trace_sp--], $global->scope[$global->scope_sp--]);
;
return JS::$undefined;
}
