function _a6798eddb4d8b054110f0587bbe9a935_1($global, $leThis, $fn, $args, $constructor = FALSE) {
...
$x20 = _a6798eddb4d8b054110f0587bbe9a935_3($global, $scope, $scope, JS::toString('TypeError', $global), 11, 13, '<image>/02_object.js');
$_TypeError =& $x20[0]; list(,$WTypeError,$STypeError,$UTypeError) = $x20;
if ($UTypeError) {
unset($_ReferenceError, $WReferenceError, $SReferenceError, $UReferenceError);
$x21 = _a6798eddb4d8b054110f0587bbe9a935_3($global, $scope, $scope, JS::toString('ReferenceError', $global), 11, 13, '<image>/02_object.js');
...
$x29 = _a6798eddb4d8b054110f0587bbe9a935_4($global, $scope, $_TypeError, JS::toString('prototype', $global), 11, 9, '<image>/02_object.js');
...
if (JS::toBoolean($x50, $global)) {
unset($_TypeError, $WTypeError, $STypeError, $UTypeError);
$x59 = _a6798eddb4d8b054110f0587bbe9a935_3($global, $scope, $scope, JS::toString('TypeError', $global), 19, 13, '<image>/02_object.js');
$_TypeError =& $x59[0]; list(,$WTypeError,$STypeError,$UTypeError) = $x59;
if ($UTypeError) {
unset($_ReferenceError, $WReferenceError, $SReferenceError, $UReferenceError);
$x60 = _a6798eddb4d8b054110f0587bbe9a935_3($global, $scope, $scope, JS::toString('ReferenceError', $global), 19, 13, '<image>/02_object.js');
...
$x64 = _a6798eddb4d8b054110f0587bbe9a935_4($global, $scope, $_TypeError, JS::toString('prototype', $global), 19, 9, '<image>/02_object.js');
...
$x71 = _a6798eddb4d8b054110f0587bbe9a935_4($global, $scope, $_o, JS::toString($_p, $global), 29, 17, '<image>/02_object.js');
$x70 =& $x71[0]; list(,$W70,$S70,$U70) = $x71;
$x72 = JS::toString('value', $global);
if ($_desc === JS::$undefined || $_desc === NULL) {
unset($_TypeError, $WTypeError, $STypeError, $UTypeError);
$x73 = _a6798eddb4d8b054110f0587bbe9a935_3($global, $scope, $scope, JS::toString('TypeError', $global), 29, 14, '<image>/02_object.js');
...
$x77 = _a6798eddb4d8b054110f0587bbe9a935_5($global, $scope, $_desc, JS::toString($x72, $global), 29, 14, '<image>/02_object.js');
...
if ($_desc === JS::$undefined || $_desc === NULL) {
unset($_TypeError, $WTypeError, $STypeError, $UTypeError);
$x84 = _a6798eddb4d8b054110f0587bbe9a935_3($global, $scope, $scope, JS::toString('TypeError', $global), 30, 17, '<image>/02_object.js');
...
$x88 = _a6798eddb4d8b054110f0587bbe9a935_5($global, $scope, $_desc, JS::toString($x83, $global), 30, 17, '<image>/02_object.js');
...
if ($_desc === JS::$undefined || $_desc === NULL) {
unset($_TypeError, $WTypeError, $STypeError, $UTypeError);
$x94 = _a6798eddb4d8b054110f0587bbe9a935_3($global, $scope, $scope, JS::toString('TypeError', $global), 34, 13, '<image>/02_object.js');
...
$x98 = _a6798eddb4d8b054110f0587bbe9a935_5($global, $scope, $_desc, JS::toString($x93, $global), 34, 13, '<image>/02_object.js');
...
if ($_desc === JS::$undefined || $_desc === NULL) {
unset($_TypeError, $WTypeError, $STypeError, $UTypeError);
$x104 = _a6798eddb4d8b054110f0587bbe9a935_3($global, $scope, $scope, JS::toString('TypeError', $global), 38, 13, '<image>/02_object.js');
...
$x108 = _a6798eddb4d8b054110f0587bbe9a935_5($global, $scope, $_desc, JS::toString($x103, $global), 38, 13, '<image>/02_object.js');
...
if ($_desc === JS::$undefined || $_desc === NULL) {
unset($_TypeError, $WTypeError, $STypeError, $UTypeError);
$x115 = _a6798eddb4d8b054110f0587bbe9a935_3($global, $scope, $scope, JS::toString('TypeError', $global), 42, 18, '<image>/02_object.js');
...
$x119 = _a6798eddb4d8b054110f0587bbe9a935_5($global, $scope, $_desc, JS::toString($x114, $global), 42, 18, '<image>/02_object.js');
...
if ($_desc === JS::$undefined || $_desc === NULL) {
unset($_TypeError, $WTypeError, $STypeError, $UTypeError);
$x126 = _a6798eddb4d8b054110f0587bbe9a935_3($global, $scope, $scope, JS::toString('TypeError', $global), 43, 20, '<image>/02_object.js');
...
$x130 = _a6798eddb4d8b054110f0587bbe9a935_5($global, $scope, $_desc, JS::toString($x125, $global), 43, 20, '<image>/02_object.js');
...
echo 'function _a6798eddb4d8b054110f0587bbe9a935_6($global,$leThis,$fn,$args,$constructor=FALSE){if(isset($fn->boundThis)&&!$constructor){$leThis=$fn->boundThis;}if(isset($fn->boundArgs)){$args=array_merge($fn->boundArgs,$args);}$scope=clone JS::$emptyScope;$scope->up=$fn->scope;$scope->properties[\'arguments\']=clone JS::$argumentsTemplate;$x49=&$scope->properties[\'arguments\'];$x49->properties[\'length\']=count($args);foreach($args as$i=>$arg){$x49->properties[$i]=$args[$i];$x49->attributes[$i]=JS::WRITABLE|JS::ENUMERABLE|JS::CONFIGURABLE;}$scope->properties[\'o\']=array_key_exists(0,$args)?$args[0]:JS::$undefined;$_o=&$scope->properties[\'o\'];$Uo=FALSE;$scope->properties[\'p\']=array_key_exists(1,$args)?$args[1]:JS::$undefined;$_p=&$scope->properties[\'p\'];$Up=FALSE;$global->scope[++$global->scope_sp]=$scope;$x51=(((gettype($_o)===gettype(NULL)&&$_o===NULL))||(((is_float($_o)||is_int($_o))&&(is_float(NULL)||is_int(NULL)))&&$_o==NULL));$x50=$x51;if(!JS::toBoolean($x50,$global)){$x54=$_o;$x54=($x54===JS::$undefined?\'undefined\':(is_int($x54)||is_float($x54)?\'number\':(is_bool($x54)?\'boolean\':(is_string($x54)?\'string\':(is_object($x54)&&isset($x54->call)?\'function\':\'object\')))));$x53=!(((gettype($x54)===gettype(\'object\')&&$x54===\'object\'))||(((is_float($x54)||is_int($x54))&&(is_float(\'object\')||is_int(\'object\')))&&$x54==\'object\'));$x52=$x53;if(JS::toBoolean($x52,$global)){$x56=$_o;$x56=($x56===JS::$undefined?\'undefined\':(is_int($x56)||is_float($x56)?\'number\':(is_bool($x56)?\'boolean\':(is_string($x56)?\'string\':(is_object($x56)&&isset($x56->call)?\'function\':\'object\')))));$x55=!(((gettype($x56)===gettype(\'function\')&&$x56===\'function\'))||(((is_float($x56)||is_int($x56))&&(is_float(\'function\')||is_int(\'function\')))&&$x56==\'function\'));$x52=$x55;}$x50=$x52;}if(JS::toBoolean($x50,$global)){unset($_TypeError,$WTypeError,$STypeError,$UTypeError);$x59=_a6798eddb4d8b054110f0587bbe9a935_3($global,$scope,$scope,JS::toString(\'TypeError\',$global),19,13,\'<image>/02_object.js\');$_TypeError=&$x59[0];list(,$WTypeError,$STypeError,$UTypeError)=$x59;if($UTypeError){unset($_ReferenceError,$WReferenceError,$SReferenceError,$UReferenceError);$x60=_a6798eddb4d8b054110f0587bbe9a935_3($global,$scope,$scope,JS::toString(\'ReferenceError\',$global),19,13,\'<image>/02_object.js\');$_ReferenceError=&$x60[0];list(,$WReferenceError,$SReferenceError,$UReferenceError)=$x60;$x61=$_ReferenceError->call;$global->trace[++$global->trace_sp]=array(\'<image>/02_object.js\',19,13);$x62=$x61($global,$global,$_ReferenceError,array(\'TypeError is not defined\'),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);if(isset($x62->class)&&$x62->class===\'Error\'&&!isset($x62->properties[\'file\'])&&!isset($x62->properties[\'line\'])&&!isset($x62->properties[\'column\'])){$x62->properties[\'file\']=\'<image>/02_object.js\';$x62->properties[\'line\']=19;$x62->properties[\'column\']=13;$x62->attributes[\'file\']=$x62->attributes[\'line\']=$x62->attributes[\'column\']=0;}throw new JSException($x62,19,13,\'<image>/02_object.js\');}$x57=clone JS::$objectTemplate;unset($x63,$W63,$S63,$U63);$x64=_a6798eddb4d8b054110f0587bbe9a935_4($global,$scope,$_TypeError,JS::toString(\'prototype\',$global),19,9,\'<image>/02_object.js\');$x63=&$x64[0];list(,$W63,$S63,$U63)=$x64;$x58=$x63;$x57->prototype=$x58;if(!(is_object($_TypeError)&&isset($_TypeError->call))){$x67=$_TypeError->call;$global->trace[++$global->trace_sp]=array(\'<image>/02_object.js\',19,9);$x68=$x67($global,$global,$_TypeError,array(\'Trying to call what is not a function.\'),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);if(isset($x68->class)&&$x68->class===\'Error\'&&!isset($x68->properties[\'file\'])&&!isset($x68->properties[\'line\'])&&!isset($x68->properties[\'column\'])){$x68->properties[\'file\']=\'<image>/02_object.js\';$x68->properties[\'line\']=19;$x68->properties[\'column\']=9;$x68->attributes[\'file\']=$x68->attributes[\'line\']=$x68->attributes[\'column\']=0;}throw new JSException($x68,19,9,\'<image>/02_object.js\');}$x65=$_TypeError->call;$global->trace[++$global->trace_sp]=array(\'<image>/02_object.js\',19,9);$x66=$x65($global,$x57,$_TypeError,array(\'Object.getOwnPropertyDescriptor(): Cannot get property descriptor of non-object.\'),true);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);$x58=$x66;if(is_object($x58)&&$x58!==JS::$undefined){$x57=$x58;}if(isset($x57->class)&&$x57->class===\'Error\'&&!isset($x57->properties[\'file\'])&&!isset($x57->properties[\'line\'])&&!isset($x57->properties[\'column\'])){$x57->properties[\'file\']=\'<image>/02_object.js\';$x57->properties[\'line\']=19;$x57->properties[\'column\']=3;$x57->attributes[\'file\']=$x57->attributes[\'line\']=$x57->attributes[\'column\']=0;}throw new JSException($x57,19,3,\'<image>/02_object.js\');}if(JS::toBoolean((!JS::toBoolean(array_key_exists($_p,$_o->properties)||array_key_exists($_p,$_o->attributes),$global)),$global)){return JS::$undefined;}$x69=clone JS::$objectTemplate;$scope->properties[\'desc\']=JS::$undefined;$_desc=&$scope->properties[\'desc\'];$Udesc=FALSE;$_desc=$x69;if(JS::toBoolean(array_key_exists($_p,$_o->properties),$global)){unset($x70,$W70,$S70,$U70);$x71=_a6798eddb4d8b054110f0587bbe9a935_4($global,$scope,$_o,JS::toString($_p,$global),29,17,\'<image>/02_object.js\');$x70=&$x71[0];list(,$W70,$S70,$U70)=$x71;$x72=JS::toString(\'value\',$global);if($_desc===JS::$undefined||$_desc===NULL){unset($_TypeError,$WTypeError,$STypeError,$UTypeError);$x73=_a6798eddb4d8b054110f0587bbe9a935_3($global,$scope,$scope,JS::toString(\'TypeError\',$global),29,14,\'<image>/02_object.js\');$_TypeError=&$x73[0];list(,$WTypeError,$STypeError,$UTypeError)=$x73;$x74=$_TypeError->call;$global->trace[++$global->trace_sp]=array(\'<image>/02_object.js\',29,14);$x75=$x74($global,$global,$_TypeError,array(\'Cannot assign property of undefined/null.\'),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);if(isset($x75->class)&&$x75->class===\'Error\'&&!isset($x75->properties[\'file\'])&&!isset($x75->properties[\'line\'])&&!isset($x75->properties[\'column\'])){$x75->properties[\'file\']=\'<image>/02_object.js\';$x75->properties[\'line\']=29;$x75->properties[\'column\']=14;$x75->attributes[\'file\']=$x75->attributes[\'line\']=$x75->attributes[\'column\']=0;}throw new JSException($x75,29,14,\'<image>/02_object.js\');}$_desc=JS::toObject($_desc,$global);unset($x76,$W76,$S76,$U76);$x77=_a6798eddb4d8b054110f0587bbe9a935_5($global,$scope,$_desc,JS::toString($x72,$global),29,14,\'<image>/02_object.js\');$x76=&$x77[0];list(,$W76,$S76,$U76)=$x77;if($U76&&(!isset($_desc->extensible)||$_desc->extensible)){$_desc->properties[$x72]=$x76;$x76=&$_desc->properties[$x72];$_desc->attributes[$x72]=JS::WRITABLE|JS::ENUMERABLE|JS::CONFIGURABLE;$U76=FALSE;$W76=TRUE;}if(isset($_desc->class)&&$_desc->class===\'Array\'){if(isset($_desc->properties[\'length\'])&&$_desc->properties[\'length\']!==JS::$undefined){$x79=$_desc->properties[\'length\'];}else{$x79=0;}}if(isset($S76)){$x80=$S76->call;$global->trace[++$global->trace_sp]=array(\'<image>/02_object.js\',29,14);$x81=$x80($global,$_desc,$S76,array($x70),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);$x78=$x81;}else{if(!$U76){$x78=$x70;if($W76){$x76=$x70;}}else{$x78=JS::$undefined;}}if(isset($_desc->class)&&$_desc->class===\'Array\'){if(is_int(\'value\')&&\'value\'>=$_desc->properties[\'length\']){$_desc->properties[\'length\']=\'value\'+1;}else if($x72===\'length\'&&is_int($x70)&&$x79>$x70){for($i=$x70;$i<$x79;++$i){unset($_desc->properties[$i],$_desc->attributes[$i]);}}}$x82=JS::toBoolean($_o->attributes[$_p]&JS::WRITABLE,$global);$x83=JS::toString(\'writable\',$global);if($_desc===JS::$undefined||$_desc===NULL){unset($_TypeError,$WTypeError,$STypeError,$UTypeError);$x84=_a6798eddb4d8b054110f0587bbe9a935_3($global,$scope,$scope,JS::toString(\'TypeError\',$global),30,17,\'<image>/02_object.js\');$_TypeError=&$x84[0];list(,$WTypeError,$STypeError,$UTypeError)=$x84;$x85=$_TypeError->call;$global->trace[++$global->trace_sp]=array(\'<image>/02_object.js\',30,17);$x86=$x85($global,$global,$_TypeError,array(\'Cannot assign property of undefined/null.\'),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);if(isset($x86->class)&&$x86->class===\'Error\'&&!isset($x86->properties[\'file\'])&&!isset($x86->properties[\'line\'])&&!isset($x86->properties[\'column\'])){$x86->properties[\'file\']=\'<image>/02_object.js\';$x86->properties[\'line\']=30;$x86->properties[\'column\']=17;$x86->attributes[\'file\']=$x86->attributes[\'line\']=$x86->attributes[\'column\']=0;}throw new JSException($x86,30,17,\'<image>/02_object.js\');}$_desc=JS::toObject($_desc,$global);unset($x87,$W87,$S87,$U87);$x88=_a6798eddb4d8b054110f0587bbe9a935_5($global,$scope,$_desc,JS::toString($x83,$global),30,17,\'<image>/02_object.js\');$x87=&$x88[0];list(,$W87,$S87,$U87)=$x88;if($U87&&(!isset($_desc->extensible)||$_desc->extensible)){$_desc->properties[$x83]=$x87;$x87=&$_desc->properties[$x83];$_desc->attributes[$x83]=JS::WRITABLE|JS::ENUMERABLE|JS::CONFIGURABLE;$U87=FALSE;$W87=TRUE;}if(isset($_desc->class)&&$_desc->class===\'Array\'){if(isset($_desc->properties[\'length\'])&&$_desc->properties[\'length\']!==JS::$undefined){$x90=$_desc->properties[\'length\'];}else{$x90=0;}}if(isset($S87)){$x91=$S87->call;$global->trace[++$global->trace_sp]=array(\'<image>/02_object.js\',30,17);$x92=$x91($global,$_desc,$S87,array($x82),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);$x89=$x92;}else{if(!$U87){$x89=$x82;if($W87){$x87=$x82;}}else{$x89=JS::$undefined;}}if(isset($_desc->class)&&$_desc->class===\'Array\'){if(is_int(\'writable\')&&\'writable\'>=$_desc->properties[\'length\']){$_desc->properties[\'length\']=\'writable\'+1;}else if($x83===\'length\'&&is_int($x82)&&$x90>$x82){for($i=$x82;$i<$x90;++$i){unset($_desc->properties[$i],$_desc->attributes[$i]);}}}}else{if(JS::toBoolean($_o->attributes[$_p]&JS::HAS_GETTER,$global)){$x93=JS::toString(\'get\',$global);if($_desc===JS::$undefined||$_desc===NULL){unset($_TypeError,$WTypeError,$STypeError,$UTypeError);$x94=_a6798eddb4d8b054110f0587bbe9a935_3($global,$scope,$scope,JS::toString(\'TypeError\',$global),34,13,\'<image>/02_object.js\');$_TypeError=&$x94[0];list(,$WTypeError,$STypeError,$UTypeError)=$x94;$x95=$_TypeError->call;$global->trace[++$global->trace_sp]=array(\'<image>/02_object.js\',34,13);$x96=$x95($global,$global,$_TypeError,array(\'Cannot assign property of undefined/null.\'),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);if(isset($x96->class)&&$x96->class===\'Error\'&&!isset($x96->properties[\'file\'])&&!isset($x96->properties[\'line\'])&&!isset($x96->properties[\'column\'])){$x96->properties[\'file\']=\'<image>/02_object.js\';$x96->properties[\'line\']=34;$x96->properties[\'column\']=13;$x96->attributes[\'file\']=$x96->attributes[\'line\']=$x96->attributes[\'column\']=0;}throw new JSException($x96,34,13,\'<image>/02_object.js\');}$_desc=JS::toObject($_desc,$global);unset($x97,$W97,$S97,$U97);$x98=_a6798eddb4d8b054110f0587bbe9a935_5($global,$scope,$_desc,JS::toString($x93,$global),34,13,\'<image>/02_object.js\');$x97=&$x98[0];list(,$W97,$S97,$U97)=$x98;if($U97&&(!isset($_desc->extensible)||$_desc->extensible)){$_desc->properties[$x93]=$x97;$x97=&$_desc->properties[$x93];$_desc->attributes[$x93]=JS::WRITABLE|JS::ENUMERABLE|JS::CONFIGURABLE;$U97=FALSE;$W97=TRUE;}if(isset($_desc->class)&&$_desc->class===\'Array\'){if(isset($_desc->properties[\'length\'])&&$_desc->properties[\'length\']!==JS::$undefined){$x100=$_desc->properties[\'length\'];}else{$x100=0;}}if(isset($S97)){$x101=$S97->call;$global->trace[++$global->trace_sp]=array(\'<image>/02_object.js\',34,13);$x102=$x101($global,$_desc,$S97,array($_o->getters[$_p]),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);$x99=$x102;}else{if(!$U97){$x99=$_o->getters[$_p];if($W97){$x97=$_o->getters[$_p];}}else{$x99=JS::$undefined;}}if(isset($_desc->class)&&$_desc->class===\'Array\'){if(is_int(\'get\')&&\'get\'>=$_desc->properties[\'length\']){$_desc->properties[\'length\']=\'get\'+1;}else if($x93===\'length\'&&is_int($_o->getters[$_p])&&$x100>$_o->getters[$_p]){for($i=$_o->getters[$_p];$i<$x100;++$i){unset($_desc->properties[$i],$_desc->attributes[$i]);}}}}if(JS::toBoolean($_o->attributes[$_p]&JS::HAS_SETTER,$global)){$x103=JS::toString(\'set\',$global);if($_desc===JS::$undefined||$_desc===NULL){unset($_TypeError,$WTypeError,$STypeError,$UTypeError);$x104=_a6798eddb4d8b054110f0587bbe9a935_3($global,$scope,$scope,JS::toString(\'TypeError\',$global),38,13,\'<image>/02_object.js\');$_TypeError=&$x104[0];list(,$WTypeError,$STypeError,$UTypeError)=$x104;$x105=$_TypeError->call;$global->trace[++$global->trace_sp]=array(\'<image>/02_object.js\',38,13);$x106=$x105($global,$global,$_TypeError,array(\'Cannot assign property of undefined/null.\'),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);if(isset($x106->class)&&$x106->class===\'Error\'&&!isset($x106->properties[\'file\'])&&!isset($x106->properties[\'line\'])&&!isset($x106->properties[\'column\'])){$x106->properties[\'file\']=\'<image>/02_object.js\';$x106->properties[\'line\']=38;$x106->properties[\'column\']=13;$x106->attributes[\'file\']=$x106->attributes[\'line\']=$x106->attributes[\'column\']=0;}throw new JSException($x106,38,13,\'<image>/02_object.js\');}$_desc=JS::toObject($_desc,$global);unset($x107,$W107,$S107,$U107);$x108=_a6798eddb4d8b054110f0587bbe9a935_5($global,$scope,$_desc,JS::toString($x103,$global),38,13,\'<image>/02_object.js\');$x107=&$x108[0];list(,$W107,$S107,$U107)=$x108;if($U107&&(!isset($_desc->extensible)||$_desc->extensible)){$_desc->properties[$x103]=$x107;$x107=&$_desc->properties[$x103];$_desc->attributes[$x103]=JS::WRITABLE|JS::ENUMERABLE|JS::CONFIGURABLE;$U107=FALSE;$W107=TRUE;}if(isset($_desc->class)&&$_desc->class===\'Array\'){if(isset($_desc->properties[\'length\'])&&$_desc->properties[\'length\']!==JS::$undefined){$x110=$_desc->properties[\'length\'];}else{$x110=0;}}if(isset($S107)){$x111=$S107->call;$global->trace[++$global->trace_sp]=array(\'<image>/02_object.js\',38,13);$x112=$x111($global,$_desc,$S107,array($_o->setters[$_p]),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);$x109=$x112;}else{if(!$U107){$x109=$_o->setters[$_p];if($W107){$x107=$_o->setters[$_p];}}else{$x109=JS::$undefined;}}if(isset($_desc->class)&&$_desc->class===\'Array\'){if(is_int(\'set\')&&\'set\'>=$_desc->properties[\'length\']){$_desc->properties[\'length\']=\'set\'+1;}else if($x103===\'length\'&&is_int($_o->setters[$_p])&&$x110>$_o->setters[$_p]){for($i=$_o->setters[$_p];$i<$x110;++$i){unset($_desc->properties[$i],$_desc->attributes[$i]);}}}}}$x113=JS::toBoolean($_o->attributes[$_p]&JS::ENUMERABLE,$global);$x114=JS::toString(\'enumerable\',$global);if($_desc===JS::$undefined||$_desc===NULL){unset($_TypeError,$WTypeError,$STypeError,$UTypeError);$x115=_a6798eddb4d8b054110f0587bbe9a935_3($global,$scope,$scope,JS::toString(\'TypeError\',$global),42,18,\'<image>/02_object.js\');$_TypeError=&$x115[0];list(,$WTypeError,$STypeError,$UTypeError)=$x115;$x116=$_TypeError->call;$global->trace[++$global->trace_sp]=array(\'<image>/02_object.js\',42,18);$x117=$x116($global,$global,$_TypeError,array(\'Cannot assign property of undefined/null.\'),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);if(isset($x117->class)&&$x117->class===\'Error\'&&!isset($x117->properties[\'file\'])&&!isset($x117->properties[\'line\'])&&!isset($x117->properties[\'column\'])){$x117->properties[\'file\']=\'<image>/02_object.js\';$x117->properties[\'line\']=42;$x117->properties[\'column\']=18;$x117->attributes[\'file\']=$x117->attributes[\'line\']=$x117->attributes[\'column\']=0;}throw new JSException($x117,42,18,\'<image>/02_object.js\');}$_desc=JS::toObject($_desc,$global);unset($x118,$W118,$S118,$U118);$x119=_a6798eddb4d8b054110f0587bbe9a935_5($global,$scope,$_desc,JS::toString($x114,$global),42,18,\'<image>/02_object.js\');$x118=&$x119[0];list(,$W118,$S118,$U118)=$x119;if($U118&&(!isset($_desc->extensible)||$_desc->extensible)){$_desc->properties[$x114]=$x118;$x118=&$_desc->properties[$x114];$_desc->attributes[$x114]=JS::WRITABLE|JS::ENUMERABLE|JS::CONFIGURABLE;$U118=FALSE;$W118=TRUE;}if(isset($_desc->class)&&$_desc->class===\'Array\'){if(isset($_desc->properties[\'length\'])&&$_desc->properties[\'length\']!==JS::$undefined){$x121=$_desc->properties[\'length\'];}else{$x121=0;}}if(isset($S118)){$x122=$S118->call;$global->trace[++$global->trace_sp]=array(\'<image>/02_object.js\',42,18);$x123=$x122($global,$_desc,$S118,array($x113),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);$x120=$x123;}else{if(!$U118){$x120=$x113;if($W118){$x118=$x113;}}else{$x120=JS::$undefined;}}if(isset($_desc->class)&&$_desc->class===\'Array\'){if(is_int(\'enumerable\')&&\'enumerable\'>=$_desc->properties[\'length\']){$_desc->properties[\'length\']=\'enumerable\'+1;}else if($x114===\'length\'&&is_int($x113)&&$x121>$x113){for($i=$x113;$i<$x121;++$i){unset($_desc->properties[$i],$_desc->attributes[$i]);}}}$x124=JS::toBoolean($_o->attributes[$_p]&JS::CONFIGURABLE,$global);$x125=JS::toString(\'configurable\',$global);if($_desc===JS::$undefined||$_desc===NULL){unset($_TypeError,$WTypeError,$STypeError,$UTypeError);$x126=_a6798eddb4d8b054110f0587bbe9a935_3($global,$scope,$scope,JS::toString(\'TypeError\',$global),43,20,\'<image>/02_object.js\');$_TypeError=&$x126[0];list(,$WTypeError,$STypeError,$UTypeError)=$x126;$x127=$_TypeError->call;$global->trace[++$global->trace_sp]=array(\'<image>/02_object.js\',43,20);$x128=$x127($global,$global,$_TypeError,array(\'Cannot assign property of undefined/null.\'),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);if(isset($x128->class)&&$x128->class===\'Error\'&&!isset($x128->properties[\'file\'])&&!isset($x128->properties[\'line\'])&&!isset($x128->properties[\'column\'])){$x128->properties[\'file\']=\'<image>/02_object.js\';$x128->properties[\'line\']=43;$x128->properties[\'column\']=20;$x128->attributes[\'file\']=$x128->attributes[\'line\']=$x128->attributes[\'column\']=0;}throw new JSException($x128,43,20,\'<image>/02_object.js\');}$_desc=JS::toObject($_desc,$global);unset($x129,$W129,$S129,$U129);$x130=_a6798eddb4d8b054110f0587bbe9a935_5($global,$scope,$_desc,JS::toString($x125,$global),43,20,\'<image>/02_object.js\');$x129=&$x130[0];list(,$W129,$S129,$U129)=$x130;if($U129&&(!isset($_desc->extensible)||$_desc->extensible)){$_desc->properties[$x125]=$x129;$x129=&$_desc->properties[$x125];$_desc->attributes[$x125]=JS::WRITABLE|JS::ENUMERABLE|JS::CONFIGURABLE;$U129=FALSE;$W129=TRUE;}if(isset($_desc->class)&&$_desc->class===\'Array\'){if(isset($_desc->properties[\'length\'])&&$_desc->properties[\'length\']!==JS::$undefined){$x132=$_desc->properties[\'length\'];}else{$x132=0;}}if(isset($S129)){$x133=$S129->call;$global->trace[++$global->trace_sp]=array(\'<image>/02_object.js\',43,20);$x134=$x133($global,$_desc,$S129,array($x124),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);$x131=$x134;}else{if(!$U129){$x131=$x124;if($W129){$x129=$x124;}}else{$x131=JS::$undefined;}}if(isset($_desc->class)&&$_desc->class===\'Array\'){if(is_int(\'configurable\')&&\'configurable\'>=$_desc->properties[\'length\']){$_desc->properties[\'length\']=\'configurable\'+1;}else if($x125===\'length\'&&is_int($x124)&&$x132>$x124){for($i=$x124;$i<$x132;++$i){unset($_desc->properties[$i],$_desc->attributes[$i]);}}}return$_desc;return JS::$undefined;}', "\n";
function _a6798eddb4d8b054110f0587bbe9a935_7($global, $leThis, $fn, $args, $constructor = FALSE) {
...
if (JS::toBoolean($x148, $global)) {
unset($_TypeError, $WTypeError, $STypeError, $UTypeError);
$x157 = _a6798eddb4d8b054110f0587bbe9a935_3($global, $scope, $scope, JS::toString('TypeError', $global), 50, 13, '<image>/02_object.js');
$_TypeError =& $x157[0]; list(,$WTypeError,$STypeError,$UTypeError) = $x157;
if ($UTypeError) {
unset($_ReferenceError, $WReferenceError, $SReferenceError, $UReferenceError);
$x158 = _a6798eddb4d8b054110f0587bbe9a935_3($global, $scope, $scope, JS::toString('ReferenceError', $global), 50, 13, '<image>/02_object.js');
...
$x162 = _a6798eddb4d8b054110f0587bbe9a935_4($global, $scope, $_TypeError, JS::toString('prototype', $global), 50, 9, '<image>/02_object.js');
...
unset($_TypeError, $WTypeError, $STypeError, $UTypeError);
$x169 = _a6798eddb4d8b054110f0587bbe9a935_3($global, $scope, $scope, JS::toString('TypeError', $global), 56, 13, '<image>/02_object.js');
...
$x173 = _a6798eddb4d8b054110f0587bbe9a935_4($global, $scope, $x168, JS::toString('push', $global), 56, 13, '<image>/02_object.js');
$x172 =& $x173[0]; list(,$W172,$S172,$U172) = $x173;
if (!(is_object($x172) && isset($x172->call))) { 
unset($_TypeError, $WTypeError, $STypeError, $UTypeError);
$x176 = _a6798eddb4d8b054110f0587bbe9a935_3($global, $scope, $scope, JS::toString('TypeError', $global), 56, 13, '<image>/02_object.js');
...
echo 'function _a6798eddb4d8b054110f0587bbe9a935_7($global,$leThis,$fn,$args,$constructor=FALSE){if(isset($fn->boundThis)&&!$constructor){$leThis=$fn->boundThis;}if(isset($fn->boundArgs)){$args=array_merge($fn->boundArgs,$args);}$scope=clone JS::$emptyScope;$scope->up=$fn->scope;$scope->properties[\'arguments\']=clone JS::$argumentsTemplate;$x147=&$scope->properties[\'arguments\'];$x147->properties[\'length\']=count($args);foreach($args as$i=>$arg){$x147->properties[$i]=$args[$i];$x147->attributes[$i]=JS::WRITABLE|JS::ENUMERABLE|JS::CONFIGURABLE;}$scope->properties[\'o\']=array_key_exists(0,$args)?$args[0]:JS::$undefined;$_o=&$scope->properties[\'o\'];$Uo=FALSE;$global->scope[++$global->scope_sp]=$scope;$x149=(((gettype($_o)===gettype(NULL)&&$_o===NULL))||(((is_float($_o)||is_int($_o))&&(is_float(NULL)||is_int(NULL)))&&$_o==NULL));$x148=$x149;if(!JS::toBoolean($x148,$global)){$x152=$_o;$x152=($x152===JS::$undefined?\'undefined\':(is_int($x152)||is_float($x152)?\'number\':(is_bool($x152)?\'boolean\':(is_string($x152)?\'string\':(is_object($x152)&&isset($x152->call)?\'function\':\'object\')))));$x151=!(((gettype($x152)===gettype(\'object\')&&$x152===\'object\'))||(((is_float($x152)||is_int($x152))&&(is_float(\'object\')||is_int(\'object\')))&&$x152==\'object\'));$x150=$x151;if(JS::toBoolean($x150,$global)){$x154=$_o;$x154=($x154===JS::$undefined?\'undefined\':(is_int($x154)||is_float($x154)?\'number\':(is_bool($x154)?\'boolean\':(is_string($x154)?\'string\':(is_object($x154)&&isset($x154->call)?\'function\':\'object\')))));$x153=!(((gettype($x154)===gettype(\'function\')&&$x154===\'function\'))||(((is_float($x154)||is_int($x154))&&(is_float(\'function\')||is_int(\'function\')))&&$x154==\'function\'));$x150=$x153;}$x148=$x150;}if(JS::toBoolean($x148,$global)){unset($_TypeError,$WTypeError,$STypeError,$UTypeError);$x157=_a6798eddb4d8b054110f0587bbe9a935_3($global,$scope,$scope,JS::toString(\'TypeError\',$global),50,13,\'<image>/02_object.js\');$_TypeError=&$x157[0];list(,$WTypeError,$STypeError,$UTypeError)=$x157;if($UTypeError){unset($_ReferenceError,$WReferenceError,$SReferenceError,$UReferenceError);$x158=_a6798eddb4d8b054110f0587bbe9a935_3($global,$scope,$scope,JS::toString(\'ReferenceError\',$global),50,13,\'<image>/02_object.js\');$_ReferenceError=&$x158[0];list(,$WReferenceError,$SReferenceError,$UReferenceError)=$x158;$x159=$_ReferenceError->call;$global->trace[++$global->trace_sp]=array(\'<image>/02_object.js\',50,13);$x160=$x159($global,$global,$_ReferenceError,array(\'TypeError is not defined\'),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);if(isset($x160->class)&&$x160->class===\'Error\'&&!isset($x160->properties[\'file\'])&&!isset($x160->properties[\'line\'])&&!isset($x160->properties[\'column\'])){$x160->properties[\'file\']=\'<image>/02_object.js\';$x160->properties[\'line\']=50;$x160->properties[\'column\']=13;$x160->attributes[\'file\']=$x160->attributes[\'line\']=$x160->attributes[\'column\']=0;}throw new JSException($x160,50,13,\'<image>/02_object.js\');}$x155=clone JS::$objectTemplate;unset($x161,$W161,$S161,$U161);$x162=_a6798eddb4d8b054110f0587bbe9a935_4($global,$scope,$_TypeError,JS::toString(\'prototype\',$global),50,9,\'<image>/02_object.js\');$x161=&$x162[0];list(,$W161,$S161,$U161)=$x162;$x156=$x161;$x155->prototype=$x156;if(!(is_object($_TypeError)&&isset($_TypeError->call))){$x165=$_TypeError->call;$global->trace[++$global->trace_sp]=array(\'<image>/02_object.js\',50,9);$x166=$x165($global,$global,$_TypeError,array(\'Trying to call what is not a function.\'),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);if(isset($x166->class)&&$x166->class===\'Error\'&&!isset($x166->properties[\'file\'])&&!isset($x166->properties[\'line\'])&&!isset($x166->properties[\'column\'])){$x166->properties[\'file\']=\'<image>/02_object.js\';$x166->properties[\'line\']=50;$x166->properties[\'column\']=9;$x166->attributes[\'file\']=$x166->attributes[\'line\']=$x166->attributes[\'column\']=0;}throw new JSException($x166,50,9,\'<image>/02_object.js\');}$x163=$_TypeError->call;$global->trace[++$global->trace_sp]=array(\'<image>/02_object.js\',50,9);$x164=$x163($global,$x155,$_TypeError,array(\'Object.getOwnPropertyNames(): Cannot get property names of non-object.\'),true);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);$x156=$x164;if(is_object($x156)&&$x156!==JS::$undefined){$x155=$x156;}if(isset($x155->class)&&$x155->class===\'Error\'&&!isset($x155->properties[\'file\'])&&!isset($x155->properties[\'line\'])&&!isset($x155->properties[\'column\'])){$x155->properties[\'file\']=\'<image>/02_object.js\';$x155->properties[\'line\']=50;$x155->properties[\'column\']=3;$x155->attributes[\'file\']=$x155->attributes[\'line\']=$x155->attributes[\'column\']=0;}throw new JSException($x155,50,3,\'<image>/02_object.js\');}$x167=clone JS::$arrayTemplate;$x167->properties[\'length\']=0;$x167->attributes[\'length\']=JS::WRITABLE;$scope->properties[\'names\']=JS::$undefined;$_names=&$scope->properties[\'names\'];$Unames=FALSE;$_names=$x167;foreach(array_unique(array_merge(array_keys($_o->properties),array_keys($_o->attributes)))as$i=>$name){;if($_names===JS::$undefined||$_names===NULL){unset($_TypeError,$WTypeError,$STypeError,$UTypeError);$x169=_a6798eddb4d8b054110f0587bbe9a935_3($global,$scope,$scope,JS::toString(\'TypeError\',$global),56,13,\'<image>/02_object.js\');$_TypeError=&$x169[0];list(,$WTypeError,$STypeError,$UTypeError)=$x169;$x170=$_TypeError->call;$global->trace[++$global->trace_sp]=array(\'<image>/02_object.js\',56,13);$x171=$x170($global,$global,$_TypeError,array(\'Cannot call function on undefined/null.\'),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);if(isset($x171->class)&&$x171->class===\'Error\'&&!isset($x171->properties[\'file\'])&&!isset($x171->properties[\'line\'])&&!isset($x171->properties[\'column\'])){$x171->properties[\'file\']=\'<image>/02_object.js\';$x171->properties[\'line\']=56;$x171->properties[\'column\']=13;$x171->attributes[\'file\']=$x171->attributes[\'line\']=$x171->attributes[\'column\']=0;}throw new JSException($x171,56,13,\'<image>/02_object.js\');}$x168=JS::toObject($_names,$global);unset($x172,$W172,$S172,$U172);$x173=_a6798eddb4d8b054110f0587bbe9a935_4($global,$scope,$x168,JS::toString(\'push\',$global),56,13,\'<image>/02_object.js\');$x172=&$x173[0];list(,$W172,$S172,$U172)=$x173;if(!(is_object($x172)&&isset($x172->call))){unset($_TypeError,$WTypeError,$STypeError,$UTypeError);$x176=_a6798eddb4d8b054110f0587bbe9a935_3($global,$scope,$scope,JS::toString(\'TypeError\',$global),56,13,\'<image>/02_object.js\');$_TypeError=&$x176[0];list(,$WTypeError,$STypeError,$UTypeError)=$x176;$x177=$_TypeError->call;$global->trace[++$global->trace_sp]=array(\'<image>/02_object.js\',56,13);$x178=$x177($global,$global,$_TypeError,array(\'Trying to call what is not a function.\'),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);if(isset($x178->class)&&$x178->class===\'Error\'&&!isset($x178->properties[\'file\'])&&!isset($x178->properties[\'line\'])&&!isset($x178->properties[\'column\'])){$x178->properties[\'file\']=\'<image>/02_object.js\';$x178->properties[\'line\']=56;$x178->properties[\'column\']=13;$x178->attributes[\'file\']=$x178->attributes[\'line\']=$x178->attributes[\'column\']=0;}throw new JSException($x178,56,13,\'<image>/02_object.js\');}$x174=$x172->call;$global->trace[++$global->trace_sp]=array(\'<image>/02_object.js\',56,13);$x175=$x174($global,$x168,$x172,array($name),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);}return$_names;return JS::$undefined;}', "\n";
function _a6798eddb4d8b054110f0587bbe9a935_8($global, $leThis, $fn, $args, $constructor = FALSE) {
...
if (JS::toBoolean($x192, $global)) {
unset($_TypeError, $WTypeError, $STypeError, $UTypeError);
$x199 = _a6798eddb4d8b054110f0587bbe9a935_3($global, $scope, $scope, JS::toString('TypeError', $global), 64, 13, '<image>/02_object.js');
$_TypeError =& $x199[0]; list(,$WTypeError,$STypeError,$UTypeError) = $x199;
if ($UTypeError) {
unset($_ReferenceError, $WReferenceError, $SReferenceError, $UReferenceError);
$x200 = _a6798eddb4d8b054110f0587bbe9a935_3($global, $scope, $scope, JS::toString('ReferenceError', $global), 64, 13, '<image>/02_object.js');
...
$x204 = _a6798eddb4d8b054110f0587bbe9a935_4($global, $scope, $_TypeError, JS::toString('prototype', $global), 64, 9, '<image>/02_object.js');
...
$x210 = _a6798eddb4d8b054110f0587bbe9a935_3($global, $scope, $scope, JS::toString('Object', $global), 72, 3, '<image>/02_object.js');
$_Object =& $x210[0]; list(,$WObject,$SObject,$UObject) = $x210;
if ($UObject) {
unset($_ReferenceError, $WReferenceError, $SReferenceError, $UReferenceError);
$x211 = _a6798eddb4d8b054110f0587bbe9a935_3($global, $scope, $scope, JS::toString('ReferenceError', $global), 72, 3, '<image>/02_object.js');
...
unset($_TypeError, $WTypeError, $STypeError, $UTypeError);
$x215 = _a6798eddb4d8b054110f0587bbe9a935_3($global, $scope, $scope, JS::toString('TypeError', $global), 72, 26, '<image>/02_object.js');
...
$x219 = _a6798eddb4d8b054110f0587bbe9a935_4($global, $scope, $x214, JS::toString('defineProperties', $global), 72, 26, '<image>/02_object.js');
$x218 =& $x219[0]; list(,$W218,$S218,$U218) = $x219;
if (!(is_object($x218) && isset($x218->call))) { 
unset($_TypeError, $WTypeError, $STypeError, $UTypeError);
$x222 = _a6798eddb4d8b054110f0587bbe9a935_3($global, $scope, $scope, JS::toString('TypeError', $global), 72, 26, '<image>/02_object.js');
...
echo 'function _a6798eddb4d8b054110f0587bbe9a935_8($global,$leThis,$fn,$args,$constructor=FALSE){if(isset($fn->boundThis)&&!$constructor){$leThis=$fn->boundThis;}if(isset($fn->boundArgs)){$args=array_merge($fn->boundArgs,$args);}$scope=clone JS::$emptyScope;$scope->up=$fn->scope;$scope->properties[\'arguments\']=clone JS::$argumentsTemplate;$x191=&$scope->properties[\'arguments\'];$x191->properties[\'length\']=count($args);foreach($args as$i=>$arg){$x191->properties[$i]=$args[$i];$x191->attributes[$i]=JS::WRITABLE|JS::ENUMERABLE|JS::CONFIGURABLE;}$scope->properties[\'o\']=array_key_exists(0,$args)?$args[0]:JS::$undefined;$_o=&$scope->properties[\'o\'];$Uo=FALSE;$scope->properties[\'properties\']=array_key_exists(1,$args)?$args[1]:JS::$undefined;$_properties=&$scope->properties[\'properties\'];$Uproperties=FALSE;$global->scope[++$global->scope_sp]=$scope;$x194=$_o;$x194=($x194===JS::$undefined?\'undefined\':(is_int($x194)||is_float($x194)?\'number\':(is_bool($x194)?\'boolean\':(is_string($x194)?\'string\':(is_object($x194)&&isset($x194->call)?\'function\':\'object\')))));$x193=!(((gettype($x194)===gettype(\'object\')&&$x194===\'object\'))||(((is_float($x194)||is_int($x194))&&(is_float(\'object\')||is_int(\'object\')))&&$x194==\'object\'));$x192=$x193;if(JS::toBoolean($x192,$global)){$x196=$_o;$x196=($x196===JS::$undefined?\'undefined\':(is_int($x196)||is_float($x196)?\'number\':(is_bool($x196)?\'boolean\':(is_string($x196)?\'string\':(is_object($x196)&&isset($x196->call)?\'function\':\'object\')))));$x195=!(((gettype($x196)===gettype(\'function\')&&$x196===\'function\'))||(((is_float($x196)||is_int($x196))&&(is_float(\'function\')||is_int(\'function\')))&&$x196==\'function\'));$x192=$x195;}if(JS::toBoolean($x192,$global)){unset($_TypeError,$WTypeError,$STypeError,$UTypeError);$x199=_a6798eddb4d8b054110f0587bbe9a935_3($global,$scope,$scope,JS::toString(\'TypeError\',$global),64,13,\'<image>/02_object.js\');$_TypeError=&$x199[0];list(,$WTypeError,$STypeError,$UTypeError)=$x199;if($UTypeError){unset($_ReferenceError,$WReferenceError,$SReferenceError,$UReferenceError);$x200=_a6798eddb4d8b054110f0587bbe9a935_3($global,$scope,$scope,JS::toString(\'ReferenceError\',$global),64,13,\'<image>/02_object.js\');$_ReferenceError=&$x200[0];list(,$WReferenceError,$SReferenceError,$UReferenceError)=$x200;$x201=$_ReferenceError->call;$global->trace[++$global->trace_sp]=array(\'<image>/02_object.js\',64,13);$x202=$x201($global,$global,$_ReferenceError,array(\'TypeError is not defined\'),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);if(isset($x202->class)&&$x202->class===\'Error\'&&!isset($x202->properties[\'file\'])&&!isset($x202->properties[\'line\'])&&!isset($x202->properties[\'column\'])){$x202->properties[\'file\']=\'<image>/02_object.js\';$x202->properties[\'line\']=64;$x202->properties[\'column\']=13;$x202->attributes[\'file\']=$x202->attributes[\'line\']=$x202->attributes[\'column\']=0;}throw new JSException($x202,64,13,\'<image>/02_object.js\');}$x197=clone JS::$objectTemplate;unset($x203,$W203,$S203,$U203);$x204=_a6798eddb4d8b054110f0587bbe9a935_4($global,$scope,$_TypeError,JS::toString(\'prototype\',$global),64,9,\'<image>/02_object.js\');$x203=&$x204[0];list(,$W203,$S203,$U203)=$x204;$x198=$x203;$x197->prototype=$x198;if(!(is_object($_TypeError)&&isset($_TypeError->call))){$x207=$_TypeError->call;$global->trace[++$global->trace_sp]=array(\'<image>/02_object.js\',64,9);$x208=$x207($global,$global,$_TypeError,array(\'Trying to call what is not a function.\'),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);if(isset($x208->class)&&$x208->class===\'Error\'&&!isset($x208->properties[\'file\'])&&!isset($x208->properties[\'line\'])&&!isset($x208->properties[\'column\'])){$x208->properties[\'file\']=\'<image>/02_object.js\';$x208->properties[\'line\']=64;$x208->properties[\'column\']=9;$x208->attributes[\'file\']=$x208->attributes[\'line\']=$x208->attributes[\'column\']=0;}throw new JSException($x208,64,9,\'<image>/02_object.js\');}$x205=$_TypeError->call;$global->trace[++$global->trace_sp]=array(\'<image>/02_object.js\',64,9);$x206=$x205($global,$x197,$_TypeError,array(\'Object.create(): Cannot create object with non-object prototype.\'),true);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);$x198=$x206;if(is_object($x198)&&$x198!==JS::$undefined){$x197=$x198;}if(isset($x197->class)&&$x197->class===\'Error\'&&!isset($x197->properties[\'file\'])&&!isset($x197->properties[\'line\'])&&!isset($x197->properties[\'column\'])){$x197->properties[\'file\']=\'<image>/02_object.js\';$x197->properties[\'line\']=64;$x197->properties[\'column\']=3;$x197->attributes[\'file\']=$x197->attributes[\'line\']=$x197->attributes[\'column\']=0;}throw new JSException($x197,64,3,\'<image>/02_object.js\');}$x209=clone JS::$objectTemplate;$scope->properties[\'newObject\']=JS::$undefined;$_newObject=&$scope->properties[\'newObject\'];$UnewObject=FALSE;$_newObject=$x209;$_newObject->prototype=$_o;if(JS::toBoolean(is_object($_properties)&&$_properties!==JS::$undefined,$global)){unset($_Object,$WObject,$SObject,$UObject);$x210=_a6798eddb4d8b054110f0587bbe9a935_3($global,$scope,$scope,JS::toString(\'Object\',$global),72,3,\'<image>/02_object.js\');$_Object=&$x210[0];list(,$WObject,$SObject,$UObject)=$x210;if($UObject){unset($_ReferenceError,$WReferenceError,$SReferenceError,$UReferenceError);$x211=_a6798eddb4d8b054110f0587bbe9a935_3($global,$scope,$scope,JS::toString(\'ReferenceError\',$global),72,3,\'<image>/02_object.js\');$_ReferenceError=&$x211[0];list(,$WReferenceError,$SReferenceError,$UReferenceError)=$x211;$x212=$_ReferenceError->call;$global->trace[++$global->trace_sp]=array(\'<image>/02_object.js\',72,3);$x213=$x212($global,$global,$_ReferenceError,array(\'Object is not defined\'),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);if(isset($x213->class)&&$x213->class===\'Error\'&&!isset($x213->properties[\'file\'])&&!isset($x213->properties[\'line\'])&&!isset($x213->properties[\'column\'])){$x213->properties[\'file\']=\'<image>/02_object.js\';$x213->properties[\'line\']=72;$x213->properties[\'column\']=3;$x213->attributes[\'file\']=$x213->attributes[\'line\']=$x213->attributes[\'column\']=0;}throw new JSException($x213,72,3,\'<image>/02_object.js\');}if($_Object===JS::$undefined||$_Object===NULL){unset($_TypeError,$WTypeError,$STypeError,$UTypeError);$x215=_a6798eddb4d8b054110f0587bbe9a935_3($global,$scope,$scope,JS::toString(\'TypeError\',$global),72,26,\'<image>/02_object.js\');$_TypeError=&$x215[0];list(,$WTypeError,$STypeError,$UTypeError)=$x215;$x216=$_TypeError->call;$global->trace[++$global->trace_sp]=array(\'<image>/02_object.js\',72,26);$x217=$x216($global,$global,$_TypeError,array(\'Cannot call function on undefined/null.\'),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);if(isset($x217->class)&&$x217->class===\'Error\'&&!isset($x217->properties[\'file\'])&&!isset($x217->properties[\'line\'])&&!isset($x217->properties[\'column\'])){$x217->properties[\'file\']=\'<image>/02_object.js\';$x217->properties[\'line\']=72;$x217->properties[\'column\']=26;$x217->attributes[\'file\']=$x217->attributes[\'line\']=$x217->attributes[\'column\']=0;}throw new JSException($x217,72,26,\'<image>/02_object.js\');}$x214=JS::toObject($_Object,$global);unset($x218,$W218,$S218,$U218);$x219=_a6798eddb4d8b054110f0587bbe9a935_4($global,$scope,$x214,JS::toString(\'defineProperties\',$global),72,26,\'<image>/02_object.js\');$x218=&$x219[0];list(,$W218,$S218,$U218)=$x219;if(!(is_object($x218)&&isset($x218->call))){unset($_TypeError,$WTypeError,$STypeError,$UTypeError);$x222=_a6798eddb4d8b054110f0587bbe9a935_3($global,$scope,$scope,JS::toString(\'TypeError\',$global),72,26,\'<image>/02_object.js\');$_TypeError=&$x222[0];list(,$WTypeError,$STypeError,$UTypeError)=$x222;$x223=$_TypeError->call;$global->trace[++$global->trace_sp]=array(\'<image>/02_object.js\',72,26);$x224=$x223($global,$global,$_TypeError,array(\'Trying to call what is not a function.\'),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);if(isset($x224->class)&&$x224->class===\'Error\'&&!isset($x224->properties[\'file\'])&&!isset($x224->properties[\'line\'])&&!isset($x224->properties[\'column\'])){$x224->properties[\'file\']=\'<image>/02_object.js\';$x224->properties[\'line\']=72;$x224->properties[\'column\']=26;$x224->attributes[\'file\']=$x224->attributes[\'line\']=$x224->attributes[\'column\']=0;}throw new JSException($x224,72,26,\'<image>/02_object.js\');}$x220=$x218->call;$global->trace[++$global->trace_sp]=array(\'<image>/02_object.js\',72,26);$x221=$x220($global,$x214,$x218,array($_newObject,$_properties),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);}return$_newObject;return JS::$undefined;}', "\n";
function _a6798eddb4d8b054110f0587bbe9a935_9($global, $leThis, $fn, $args, $constructor = FALSE) {
...
if (JS::toBoolean($x238, $global)) {
unset($_TypeError, $WTypeError, $STypeError, $UTypeError);
$x247 = _a6798eddb4d8b054110f0587bbe9a935_3($global, $scope, $scope, JS::toString('TypeError', $global), 80, 13, '<image>/02_object.js');
$_TypeError =& $x247[0]; list(,$WTypeError,$STypeError,$UTypeError) = $x247;
if ($UTypeError) {
unset($_ReferenceError, $WReferenceError, $SReferenceError, $UReferenceError);
$x248 = _a6798eddb4d8b054110f0587bbe9a935_3($global, $scope, $scope, JS::toString('ReferenceError', $global), 80, 13, '<image>/02_object.js');
...
$x252 = _a6798eddb4d8b054110f0587bbe9a935_4($global, $scope, $_TypeError, JS::toString('prototype', $global), 80, 9, '<image>/02_object.js');
...
$x260 = _a6798eddb4d8b054110f0587bbe9a935_4($global, $scope, $_attributes, JS::toString('get', $global), 83, 16, '<image>/02_object.js');
...
$x263 = _a6798eddb4d8b054110f0587bbe9a935_4($global, $scope, $_attributes, JS::toString('get', $global), 83, 55, '<image>/02_object.js');
...
if (JS::toBoolean($x257, $global)) {
unset($_TypeError, $WTypeError, $STypeError, $UTypeError);
$x267 = _a6798eddb4d8b054110f0587bbe9a935_3($global, $scope, $scope, JS::toString('TypeError', $global), 84, 13, '<image>/02_object.js');
$_TypeError =& $x267[0]; list(,$WTypeError,$STypeError,$UTypeError) = $x267;
if ($UTypeError) {
unset($_ReferenceError, $WReferenceError, $SReferenceError, $UReferenceError);
$x268 = _a6798eddb4d8b054110f0587bbe9a935_3($global, $scope, $scope, JS::toString('ReferenceError', $global), 84, 13, '<image>/02_object.js');
...
$x272 = _a6798eddb4d8b054110f0587bbe9a935_4($global, $scope, $_TypeError, JS::toString('prototype', $global), 84, 9, '<image>/02_object.js');
...
$x280 = _a6798eddb4d8b054110f0587bbe9a935_4($global, $scope, $_attributes, JS::toString('set', $global), 87, 16, '<image>/02_object.js');
...
$x283 = _a6798eddb4d8b054110f0587bbe9a935_4($global, $scope, $_attributes, JS::toString('set', $global), 87, 55, '<image>/02_object.js');
...
if (JS::toBoolean($x277, $global)) {
unset($_TypeError, $WTypeError, $STypeError, $UTypeError);
$x287 = _a6798eddb4d8b054110f0587bbe9a935_3($global, $scope, $scope, JS::toString('TypeError', $global), 88, 13, '<image>/02_object.js');
$_TypeError =& $x287[0]; list(,$WTypeError,$STypeError,$UTypeError) = $x287;
if ($UTypeError) {
unset($_ReferenceError, $WReferenceError, $SReferenceError, $UReferenceError);
$x288 = _a6798eddb4d8b054110f0587bbe9a935_3($global, $scope, $scope, JS::toString('ReferenceError', $global), 88, 13, '<image>/02_object.js');
...
$x292 = _a6798eddb4d8b054110f0587bbe9a935_4($global, $scope, $_TypeError, JS::toString('prototype', $global), 88, 9, '<image>/02_object.js');
...
$x301 = _a6798eddb4d8b054110f0587bbe9a935_4($global, $scope, $_attributes, JS::toString('value', $global), 94, 24, '<image>/02_object.js');
...
$x303 = _a6798eddb4d8b054110f0587bbe9a935_4($global, $scope, $_attributes, JS::toString('get', $global), 95, 19, '<image>/02_object.js');
$x302 =& $x303[0]; list(,$W302,$S302,$U302) = $x303;
$scope->properties['get'] = JS::$undefined; $_get =& $scope->properties['get'];
$Uget = FALSE;
$_get = $x302;
unset($x304, $W304, $S304, $U304);
$x305 = _a6798eddb4d8b054110f0587bbe9a935_4($global, $scope, $_attributes, JS::toString('set', $global), 96, 19, '<image>/02_object.js');
...
$x317 = _a6798eddb4d8b054110f0587bbe9a935_4($global, $scope, $_attributes, JS::toString('writable', $global), 113, 16, '<image>/02_object.js');
...
$x323 = _a6798eddb4d8b054110f0587bbe9a935_4($global, $scope, $_attributes, JS::toString('enumerable', $global), 117, 16, '<image>/02_object.js');
...
$x329 = _a6798eddb4d8b054110f0587bbe9a935_4($global, $scope, $_attributes, JS::toString('configurable', $global), 121, 16, '<image>/02_object.js');
...
echo 'function _a6798eddb4d8b054110f0587bbe9a935_9($global,$leThis,$fn,$args,$constructor=FALSE){if(isset($fn->boundThis)&&!$constructor){$leThis=$fn->boundThis;}if(isset($fn->boundArgs)){$args=array_merge($fn->boundArgs,$args);}$scope=clone JS::$emptyScope;$scope->up=$fn->scope;$scope->properties[\'arguments\']=clone JS::$argumentsTemplate;$x237=&$scope->properties[\'arguments\'];$x237->properties[\'length\']=count($args);foreach($args as$i=>$arg){$x237->properties[$i]=$args[$i];$x237->attributes[$i]=JS::WRITABLE|JS::ENUMERABLE|JS::CONFIGURABLE;}$scope->properties[\'o\']=array_key_exists(0,$args)?$args[0]:JS::$undefined;$_o=&$scope->properties[\'o\'];$Uo=FALSE;$scope->properties[\'p\']=array_key_exists(1,$args)?$args[1]:JS::$undefined;$_p=&$scope->properties[\'p\'];$Up=FALSE;$scope->properties[\'attributes\']=array_key_exists(2,$args)?$args[2]:JS::$undefined;$_attributes=&$scope->properties[\'attributes\'];$Uattributes=FALSE;$global->scope[++$global->scope_sp]=$scope;$x239=(((gettype($_o)===gettype(NULL)&&$_o===NULL))||(((is_float($_o)||is_int($_o))&&(is_float(NULL)||is_int(NULL)))&&$_o==NULL));$x238=$x239;if(!JS::toBoolean($x238,$global)){$x242=$_o;$x242=($x242===JS::$undefined?\'undefined\':(is_int($x242)||is_float($x242)?\'number\':(is_bool($x242)?\'boolean\':(is_string($x242)?\'string\':(is_object($x242)&&isset($x242->call)?\'function\':\'object\')))));$x241=!(((gettype($x242)===gettype(\'object\')&&$x242===\'object\'))||(((is_float($x242)||is_int($x242))&&(is_float(\'object\')||is_int(\'object\')))&&$x242==\'object\'));$x240=$x241;if(JS::toBoolean($x240,$global)){$x244=$_o;$x244=($x244===JS::$undefined?\'undefined\':(is_int($x244)||is_float($x244)?\'number\':(is_bool($x244)?\'boolean\':(is_string($x244)?\'string\':(is_object($x244)&&isset($x244->call)?\'function\':\'object\')))));$x243=!(((gettype($x244)===gettype(\'function\')&&$x244===\'function\'))||(((is_float($x244)||is_int($x244))&&(is_float(\'function\')||is_int(\'function\')))&&$x244==\'function\'));$x240=$x243;}$x238=$x240;}if(JS::toBoolean($x238,$global)){unset($_TypeError,$WTypeError,$STypeError,$UTypeError);$x247=_a6798eddb4d8b054110f0587bbe9a935_3($global,$scope,$scope,JS::toString(\'TypeError\',$global),80,13,\'<image>/02_object.js\');$_TypeError=&$x247[0];list(,$WTypeError,$STypeError,$UTypeError)=$x247;if($UTypeError){unset($_ReferenceError,$WReferenceError,$SReferenceError,$UReferenceError);$x248=_a6798eddb4d8b054110f0587bbe9a935_3($global,$scope,$scope,JS::toString(\'ReferenceError\',$global),80,13,\'<image>/02_object.js\');$_ReferenceError=&$x248[0];list(,$WReferenceError,$SReferenceError,$UReferenceError)=$x248;$x249=$_ReferenceError->call;$global->trace[++$global->trace_sp]=array(\'<image>/02_object.js\',80,13);$x250=$x249($global,$global,$_ReferenceError,array(\'TypeError is not defined\'),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);if(isset($x250->class)&&$x250->class===\'Error\'&&!isset($x250->properties[\'file\'])&&!isset($x250->properties[\'line\'])&&!isset($x250->properties[\'column\'])){$x250->properties[\'file\']=\'<image>/02_object.js\';$x250->properties[\'line\']=80;$x250->properties[\'column\']=13;$x250->attributes[\'file\']=$x250->attributes[\'line\']=$x250->attributes[\'column\']=0;}throw new JSException($x250,80,13,\'<image>/02_object.js\');}$x245=clone JS::$objectTemplate;unset($x251,$W251,$S251,$U251);$x252=_a6798eddb4d8b054110f0587bbe9a935_4($global,$scope,$_TypeError,JS::toString(\'prototype\',$global),80,9,\'<image>/02_object.js\');$x251=&$x252[0];list(,$W251,$S251,$U251)=$x252;$x246=$x251;$x245->prototype=$x246;if(!(is_object($_TypeError)&&isset($_TypeError->call))){$x255=$_TypeError->call;$global->trace[++$global->trace_sp]=array(\'<image>/02_object.js\',80,9);$x256=$x255($global,$global,$_TypeError,array(\'Trying to call what is not a function.\'),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);if(isset($x256->class)&&$x256->class===\'Error\'&&!isset($x256->properties[\'file\'])&&!isset($x256->properties[\'line\'])&&!isset($x256->properties[\'column\'])){$x256->properties[\'file\']=\'<image>/02_object.js\';$x256->properties[\'line\']=80;$x256->properties[\'column\']=9;$x256->attributes[\'file\']=$x256->attributes[\'line\']=$x256->attributes[\'column\']=0;}throw new JSException($x256,80,9,\'<image>/02_object.js\');}$x253=$_TypeError->call;$global->trace[++$global->trace_sp]=array(\'<image>/02_object.js\',80,9);$x254=$x253($global,$x245,$_TypeError,array(\'Object.defineProperty(): Cannot define property on non-object.\'),true);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);$x246=$x254;if(is_object($x246)&&$x246!==JS::$undefined){$x245=$x246;}if(isset($x245->class)&&$x245->class===\'Error\'&&!isset($x245->properties[\'file\'])&&!isset($x245->properties[\'line\'])&&!isset($x245->properties[\'column\'])){$x245->properties[\'file\']=\'<image>/02_object.js\';$x245->properties[\'line\']=80;$x245->properties[\'column\']=3;$x245->attributes[\'file\']=$x245->attributes[\'line\']=$x245->attributes[\'column\']=0;}throw new JSException($x245,80,3,\'<image>/02_object.js\');}unset($x259,$W259,$S259,$U259);$x260=_a6798eddb4d8b054110f0587bbe9a935_4($global,$scope,$_attributes,JS::toString(\'get\',$global),83,16,\'<image>/02_object.js\');$x259=&$x260[0];list(,$W259,$S259,$U259)=$x260;$x258=!(((gettype($x259)===gettype(JS::$undefined)&&$x259===JS::$undefined))||(((is_float($x259)||is_int($x259))&&(is_float(JS::$undefined)||is_int(JS::$undefined)))&&$x259==JS::$undefined));$x257=$x258;if(JS::toBoolean($x257,$global)){unset($x262,$W262,$S262,$U262);$x263=_a6798eddb4d8b054110f0587bbe9a935_4($global,$scope,$_attributes,JS::toString(\'get\',$global),83,55,\'<image>/02_object.js\');$x262=&$x263[0];list(,$W262,$S262,$U262)=$x263;$x264=$x262;$x264=($x264===JS::$undefined?\'undefined\':(is_int($x264)||is_float($x264)?\'number\':(is_bool($x264)?\'boolean\':(is_string($x264)?\'string\':(is_object($x264)&&isset($x264->call)?\'function\':\'object\')))));$x261=!(((gettype($x264)===gettype(\'function\')&&$x264===\'function\'))||(((is_float($x264)||is_int($x264))&&(is_float(\'function\')||is_int(\'function\')))&&$x264==\'function\'));$x257=$x261;}if(JS::toBoolean($x257,$global)){unset($_TypeError,$WTypeError,$STypeError,$UTypeError);$x267=_a6798eddb4d8b054110f0587bbe9a935_3($global,$scope,$scope,JS::toString(\'TypeError\',$global),84,13,\'<image>/02_object.js\');$_TypeError=&$x267[0];list(,$WTypeError,$STypeError,$UTypeError)=$x267;if($UTypeError){unset($_ReferenceError,$WReferenceError,$SReferenceError,$UReferenceError);$x268=_a6798eddb4d8b054110f0587bbe9a935_3($global,$scope,$scope,JS::toString(\'ReferenceError\',$global),84,13,\'<image>/02_object.js\');$_ReferenceError=&$x268[0];list(,$WReferenceError,$SReferenceError,$UReferenceError)=$x268;$x269=$_ReferenceError->call;$global->trace[++$global->trace_sp]=array(\'<image>/02_object.js\',84,13);$x270=$x269($global,$global,$_ReferenceError,array(\'TypeError is not defined\'),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);if(isset($x270->class)&&$x270->class===\'Error\'&&!isset($x270->properties[\'file\'])&&!isset($x270->properties[\'line\'])&&!isset($x270->properties[\'column\'])){$x270->properties[\'file\']=\'<image>/02_object.js\';$x270->properties[\'line\']=84;$x270->properties[\'column\']=13;$x270->attributes[\'file\']=$x270->attributes[\'line\']=$x270->attributes[\'column\']=0;}throw new JSException($x270,84,13,\'<image>/02_object.js\');}$x265=clone JS::$objectTemplate;unset($x271,$W271,$S271,$U271);$x272=_a6798eddb4d8b054110f0587bbe9a935_4($global,$scope,$_TypeError,JS::toString(\'prototype\',$global),84,9,\'<image>/02_object.js\');$x271=&$x272[0];list(,$W271,$S271,$U271)=$x272;$x266=$x271;$x265->prototype=$x266;if(!(is_object($_TypeError)&&isset($_TypeError->call))){$x275=$_TypeError->call;$global->trace[++$global->trace_sp]=array(\'<image>/02_object.js\',84,9);$x276=$x275($global,$global,$_TypeError,array(\'Trying to call what is not a function.\'),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);if(isset($x276->class)&&$x276->class===\'Error\'&&!isset($x276->properties[\'file\'])&&!isset($x276->properties[\'line\'])&&!isset($x276->properties[\'column\'])){$x276->properties[\'file\']=\'<image>/02_object.js\';$x276->properties[\'line\']=84;$x276->properties[\'column\']=9;$x276->attributes[\'file\']=$x276->attributes[\'line\']=$x276->attributes[\'column\']=0;}throw new JSException($x276,84,9,\'<image>/02_object.js\');}$x273=$_TypeError->call;$global->trace[++$global->trace_sp]=array(\'<image>/02_object.js\',84,9);$x274=$x273($global,$x265,$_TypeError,array(\'Object.defineProperty(): Given getter is not a function.\'),true);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);$x266=$x274;if(is_object($x266)&&$x266!==JS::$undefined){$x265=$x266;}if(isset($x265->class)&&$x265->class===\'Error\'&&!isset($x265->properties[\'file\'])&&!isset($x265->properties[\'line\'])&&!isset($x265->properties[\'column\'])){$x265->properties[\'file\']=\'<image>/02_object.js\';$x265->properties[\'line\']=84;$x265->properties[\'column\']=3;$x265->attributes[\'file\']=$x265->attributes[\'line\']=$x265->attributes[\'column\']=0;}throw new JSException($x265,84,3,\'<image>/02_object.js\');}unset($x279,$W279,$S279,$U279);$x280=_a6798eddb4d8b054110f0587bbe9a935_4($global,$scope,$_attributes,JS::toString(\'set\',$global),87,16,\'<image>/02_object.js\');$x279=&$x280[0];list(,$W279,$S279,$U279)=$x280;$x278=!(((gettype($x279)===gettype(JS::$undefined)&&$x279===JS::$undefined))||(((is_float($x279)||is_int($x279))&&(is_float(JS::$undefined)||is_int(JS::$undefined)))&&$x279==JS::$undefined));$x277=$x278;if(JS::toBoolean($x277,$global)){unset($x282,$W282,$S282,$U282);$x283=_a6798eddb4d8b054110f0587bbe9a935_4($global,$scope,$_attributes,JS::toString(\'set\',$global),87,55,\'<image>/02_object.js\');$x282=&$x283[0];list(,$W282,$S282,$U282)=$x283;$x284=$x282;$x284=($x284===JS::$undefined?\'undefined\':(is_int($x284)||is_float($x284)?\'number\':(is_bool($x284)?\'boolean\':(is_string($x284)?\'string\':(is_object($x284)&&isset($x284->call)?\'function\':\'object\')))));$x281=!(((gettype($x284)===gettype(\'function\')&&$x284===\'function\'))||(((is_float($x284)||is_int($x284))&&(is_float(\'function\')||is_int(\'function\')))&&$x284==\'function\'));$x277=$x281;}if(JS::toBoolean($x277,$global)){unset($_TypeError,$WTypeError,$STypeError,$UTypeError);$x287=_a6798eddb4d8b054110f0587bbe9a935_3($global,$scope,$scope,JS::toString(\'TypeError\',$global),88,13,\'<image>/02_object.js\');$_TypeError=&$x287[0];list(,$WTypeError,$STypeError,$UTypeError)=$x287;if($UTypeError){unset($_ReferenceError,$WReferenceError,$SReferenceError,$UReferenceError);$x288=_a6798eddb4d8b054110f0587bbe9a935_3($global,$scope,$scope,JS::toString(\'ReferenceError\',$global),88,13,\'<image>/02_object.js\');$_ReferenceError=&$x288[0];list(,$WReferenceError,$SReferenceError,$UReferenceError)=$x288;$x289=$_ReferenceError->call;$global->trace[++$global->trace_sp]=array(\'<image>/02_object.js\',88,13);$x290=$x289($global,$global,$_ReferenceError,array(\'TypeError is not defined\'),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);if(isset($x290->class)&&$x290->class===\'Error\'&&!isset($x290->properties[\'file\'])&&!isset($x290->properties[\'line\'])&&!isset($x290->properties[\'column\'])){$x290->properties[\'file\']=\'<image>/02_object.js\';$x290->properties[\'line\']=88;$x290->properties[\'column\']=13;$x290->attributes[\'file\']=$x290->attributes[\'line\']=$x290->attributes[\'column\']=0;}throw new JSException($x290,88,13,\'<image>/02_object.js\');}$x285=clone JS::$objectTemplate;unset($x291,$W291,$S291,$U291);$x292=_a6798eddb4d8b054110f0587bbe9a935_4($global,$scope,$_TypeError,JS::toString(\'prototype\',$global),88,9,\'<image>/02_object.js\');$x291=&$x292[0];list(,$W291,$S291,$U291)=$x292;$x286=$x291;$x285->prototype=$x286;if(!(is_object($_TypeError)&&isset($_TypeError->call))){$x295=$_TypeError->call;$global->trace[++$global->trace_sp]=array(\'<image>/02_object.js\',88,9);$x296=$x295($global,$global,$_TypeError,array(\'Trying to call what is not a function.\'),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);if(isset($x296->class)&&$x296->class===\'Error\'&&!isset($x296->properties[\'file\'])&&!isset($x296->properties[\'line\'])&&!isset($x296->properties[\'column\'])){$x296->properties[\'file\']=\'<image>/02_object.js\';$x296->properties[\'line\']=88;$x296->properties[\'column\']=9;$x296->attributes[\'file\']=$x296->attributes[\'line\']=$x296->attributes[\'column\']=0;}throw new JSException($x296,88,9,\'<image>/02_object.js\');}$x293=$_TypeError->call;$global->trace[++$global->trace_sp]=array(\'<image>/02_object.js\',88,9);$x294=$x293($global,$x285,$_TypeError,array(\'Object.defineProperty(): Given setter is not a function.\'),true);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);$x286=$x294;if(is_object($x286)&&$x286!==JS::$undefined){$x285=$x286;}if(isset($x285->class)&&$x285->class===\'Error\'&&!isset($x285->properties[\'file\'])&&!isset($x285->properties[\'line\'])&&!isset($x285->properties[\'column\'])){$x285->properties[\'file\']=\'<image>/02_object.js\';$x285->properties[\'line\']=88;$x285->properties[\'column\']=3;$x285->attributes[\'file\']=$x285->attributes[\'line\']=$x285->attributes[\'column\']=0;}throw new JSException($x285,88,3,\'<image>/02_object.js\');}$x297=$_attributes;if(!JS::toBoolean($x297,$global)){$x298=clone JS::$objectTemplate;$x297=$x298;}if($Uattributes){$global->properties[\'attributes\']=$_attributes;$_attributes=&$global->properties[\'attributes\'];}$_attributes=$x297;$x299=JS::toString($_p,$global);if($Up){$global->properties[\'p\']=$_p;$_p=&$global->properties[\'p\'];}$_p=$x299;unset($x300,$W300,$S300,$U300);$x301=_a6798eddb4d8b054110f0587bbe9a935_4($global,$scope,$_attributes,JS::toString(\'value\',$global),94,24,\'<image>/02_object.js\');$x300=&$x301[0];list(,$W300,$S300,$U300)=$x301;$scope->properties[\'value\']=JS::$undefined;$_value=&$scope->properties[\'value\'];$Uvalue=FALSE;$_value=$x300;unset($x302,$W302,$S302,$U302);$x303=_a6798eddb4d8b054110f0587bbe9a935_4($global,$scope,$_attributes,JS::toString(\'get\',$global),95,19,\'<image>/02_object.js\');$x302=&$x303[0];list(,$W302,$S302,$U302)=$x303;$scope->properties[\'get\']=JS::$undefined;$_get=&$scope->properties[\'get\'];$Uget=FALSE;$_get=$x302;unset($x304,$W304,$S304,$U304);$x305=_a6798eddb4d8b054110f0587bbe9a935_4($global,$scope,$_attributes,JS::toString(\'set\',$global),96,19,\'<image>/02_object.js\');$x304=&$x305[0];list(,$W304,$S304,$U304)=$x305;$scope->properties[\'set\']=JS::$undefined;$_set=&$scope->properties[\'set\'];$Uset=FALSE;$_set=$x304;$scope->properties[\'attrs\']=JS::$undefined;$_attrs=&$scope->properties[\'attrs\'];$Uattrs=FALSE;$_attrs=0.0;$x307=$_value;$x307=($x307===JS::$undefined?\'undefined\':(is_int($x307)||is_float($x307)?\'number\':(is_bool($x307)?\'boolean\':(is_string($x307)?\'string\':(is_object($x307)&&isset($x307->call)?\'function\':\'object\')))));$x306=!(((gettype($x307)===gettype(\'undefined\')&&$x307===\'undefined\'))||(((is_float($x307)||is_int($x307))&&(is_float(\'undefined\')||is_int(\'undefined\')))&&$x307==\'undefined\'));if(JS::toBoolean($x306,$global)){$_o->properties[$_p]=$_value;}if(JS::toBoolean($_get,$global)){$_o->getters[$_p]=$_get;$x308=JS::HAS_GETTER;if($Uattrs){$global->properties[\'attrs\']=$_attrs;$_attrs=&$global->properties[\'attrs\'];}$x309=JS::toNumber($_attrs,$global);$x310=JS::toNumber($x308,$global);if(is_nan($x309)){$x309=0;}if(is_nan($x310)){$x310=0;}$x311=$x309|$x310;$_attrs=$x311;}if(JS::toBoolean($_set,$global)){$_o->setters[$_p]=$_set;$x312=JS::HAS_SETTER;if($Uattrs){$global->properties[\'attrs\']=$_attrs;$_attrs=&$global->properties[\'attrs\'];}$x313=JS::toNumber($_attrs,$global);$x314=JS::toNumber($x312,$global);if(is_nan($x313)){$x313=0;}if(is_nan($x314)){$x314=0;}$x315=$x313|$x314;$_attrs=$x315;}unset($x316,$W316,$S316,$U316);$x317=_a6798eddb4d8b054110f0587bbe9a935_4($global,$scope,$_attributes,JS::toString(\'writable\',$global),113,16,\'<image>/02_object.js\');$x316=&$x317[0];list(,$W316,$S316,$U316)=$x317;if(JS::toBoolean($x316,$global)){$x318=JS::WRITABLE;if($Uattrs){$global->properties[\'attrs\']=$_attrs;$_attrs=&$global->properties[\'attrs\'];}$x319=JS::toNumber($_attrs,$global);$x320=JS::toNumber($x318,$global);if(is_nan($x319)){$x319=0;}if(is_nan($x320)){$x320=0;}$x321=$x319|$x320;$_attrs=$x321;}unset($x322,$W322,$S322,$U322);$x323=_a6798eddb4d8b054110f0587bbe9a935_4($global,$scope,$_attributes,JS::toString(\'enumerable\',$global),117,16,\'<image>/02_object.js\');$x322=&$x323[0];list(,$W322,$S322,$U322)=$x323;if(JS::toBoolean($x322,$global)){$x324=JS::ENUMERABLE;if($Uattrs){$global->properties[\'attrs\']=$_attrs;$_attrs=&$global->properties[\'attrs\'];}$x325=JS::toNumber($_attrs,$global);$x326=JS::toNumber($x324,$global);if(is_nan($x325)){$x325=0;}if(is_nan($x326)){$x326=0;}$x327=$x325|$x326;$_attrs=$x327;}unset($x328,$W328,$S328,$U328);$x329=_a6798eddb4d8b054110f0587bbe9a935_4($global,$scope,$_attributes,JS::toString(\'configurable\',$global),121,16,\'<image>/02_object.js\');$x328=&$x329[0];list(,$W328,$S328,$U328)=$x329;if(JS::toBoolean($x328,$global)){$x330=JS::CONFIGURABLE;if($Uattrs){$global->properties[\'attrs\']=$_attrs;$_attrs=&$global->properties[\'attrs\'];}$x331=JS::toNumber($_attrs,$global);$x332=JS::toNumber($x330,$global);if(is_nan($x331)){$x331=0;}if(is_nan($x332)){$x332=0;}$x333=$x331|$x332;$_attrs=$x333;}$_o->attributes[$_p]=$_attrs;return$_o;return JS::$undefined;}', "\n";
function _a6798eddb4d8b054110f0587bbe9a935_10($global, $leThis, $fn, $args, $constructor = FALSE) {
...
if (JS::toBoolean($x347, $global)) {
unset($_TypeError, $WTypeError, $STypeError, $UTypeError);
$x356 = _a6798eddb4d8b054110f0587bbe9a935_3($global, $scope, $scope, JS::toString('TypeError', $global), 132, 13, '<image>/02_object.js');
$_TypeError =& $x356[0]; list(,$WTypeError,$STypeError,$UTypeError) = $x356;
if ($UTypeError) {
unset($_ReferenceError, $WReferenceError, $SReferenceError, $UReferenceError);
$x357 = _a6798eddb4d8b054110f0587bbe9a935_3($global, $scope, $scope, JS::toString('ReferenceError', $global), 132, 13, '<image>/02_object.js');
...
$x361 = _a6798eddb4d8b054110f0587bbe9a935_4($global, $scope, $_TypeError, JS::toString('prototype', $global), 132, 9, '<image>/02_object.js');
...
unset($_TypeError, $WTypeError, $STypeError, $UTypeError);
$x370 = _a6798eddb4d8b054110f0587bbe9a935_3($global, $scope, $scope, JS::toString('TypeError', $global), 136, 13, '<image>/02_object.js');
$_TypeError =& $x370[0]; list(,$WTypeError,$STypeError,$UTypeError) = $x370;
if ($UTypeError) {
unset($_ReferenceError, $WReferenceError, $SReferenceError, $UReferenceError);
$x371 = _a6798eddb4d8b054110f0587bbe9a935_3($global, $scope, $scope, JS::toString('ReferenceError', $global), 136, 13, '<image>/02_object.js');
...
$x375 = _a6798eddb4d8b054110f0587bbe9a935_4($global, $scope, $_TypeError, JS::toString('prototype', $global), 136, 9, '<image>/02_object.js');
...
unset($_Object, $WObject, $SObject, $UObject);
$x382 = _a6798eddb4d8b054110f0587bbe9a935_3($global, $scope, $scope, JS::toString('Object', $global), 140, 3, '<image>/02_object.js');
$_Object =& $x382[0]; list(,$WObject,$SObject,$UObject) = $x382;
if ($UObject) {
unset($_ReferenceError, $WReferenceError, $SReferenceError, $UReferenceError);
$x383 = _a6798eddb4d8b054110f0587bbe9a935_3($global, $scope, $scope, JS::toString('ReferenceError', $global), 140, 3, '<image>/02_object.js');
...
if ($_Object === JS::$undefined || $_Object === NULL) {
unset($_TypeError, $WTypeError, $STypeError, $UTypeError);
$x387 = _a6798eddb4d8b054110f0587bbe9a935_3($global, $scope, $scope, JS::toString('TypeError', $global), 140, 24, '<image>/02_object.js');
...
$x391 = _a6798eddb4d8b054110f0587bbe9a935_4($global, $scope, $x386, JS::toString('defineProperty', $global), 140, 24, '<image>/02_object.js');
$x390 =& $x391[0]; list(,$W390,$S390,$U390) = $x391;
unset($x392, $W392, $S392, $U392);
$x393 = _a6798eddb4d8b054110f0587bbe9a935_4($global, $scope, $_properties, JS::toString($_p, $global), 140, 41, '<image>/02_object.js');
$x392 =& $x393[0]; list(,$W392,$S392,$U392) = $x393;
if (!(is_object($x390) && isset($x390->call))) { 
unset($_TypeError, $WTypeError, $STypeError, $UTypeError);
$x396 = _a6798eddb4d8b054110f0587bbe9a935_3($global, $scope, $scope, JS::toString('TypeError', $global), 140, 24, '<image>/02_object.js');
...
if (JS::toBoolean($x412, $global)) {
unset($_TypeError, $WTypeError, $STypeError, $UTypeError);
$x421 = _a6798eddb4d8b054110f0587bbe9a935_3($global, $scope, $scope, JS::toString('TypeError', $global), 148, 13, '<image>/02_object.js');
$_TypeError =& $x421[0]; list(,$WTypeError,$STypeError,$UTypeError) = $x421;
if ($UTypeError) {
unset($_ReferenceError, $WReferenceError, $SReferenceError, $UReferenceError);
$x422 = _a6798eddb4d8b054110f0587bbe9a935_3($global, $scope, $scope, JS::toString('ReferenceError', $global), 148, 13, '<image>/02_object.js');
...
$x426 = _a6798eddb4d8b054110f0587bbe9a935_4($global, $scope, $_TypeError, JS::toString('prototype', $global), 148, 9, '<image>/02_object.js');
...
if (JS::toBoolean($x444, $global)) {
unset($_TypeError, $WTypeError, $STypeError, $UTypeError);
$x453 = _a6798eddb4d8b054110f0587bbe9a935_3($global, $scope, $scope, JS::toString('TypeError', $global), 164, 13, '<image>/02_object.js');
$_TypeError =& $x453[0]; list(,$WTypeError,$STypeError,$UTypeError) = $x453;
if ($UTypeError) {
unset($_ReferenceError, $WReferenceError, $SReferenceError, $UReferenceError);
$x454 = _a6798eddb4d8b054110f0587bbe9a935_3($global, $scope, $scope, JS::toString('ReferenceError', $global), 164, 13, '<image>/02_object.js');
...
$x458 = _a6798eddb4d8b054110f0587bbe9a935_4($global, $scope, $_TypeError, JS::toString('prototype', $global), 164, 9, '<image>/02_object.js');
...
if (JS::toBoolean($x476, $global)) {
unset($_TypeError, $WTypeError, $STypeError, $UTypeError);
$x485 = _a6798eddb4d8b054110f0587bbe9a935_3($global, $scope, $scope, JS::toString('TypeError', $global), 181, 13, '<image>/02_object.js');
$_TypeError =& $x485[0]; list(,$WTypeError,$STypeError,$UTypeError) = $x485;
if ($UTypeError) {
unset($_ReferenceError, $WReferenceError, $SReferenceError, $UReferenceError);
$x486 = _a6798eddb4d8b054110f0587bbe9a935_3($global, $scope, $scope, JS::toString('ReferenceError', $global), 181, 13, '<image>/02_object.js');
...
$x490 = _a6798eddb4d8b054110f0587bbe9a935_4($global, $scope, $_TypeError, JS::toString('prototype', $global), 181, 9, '<image>/02_object.js');
...
echo 'function _a6798eddb4d8b054110f0587bbe9a935_13($global,$leThis,$fn,$args,$constructor=FALSE){if(isset($fn->boundThis)&&!$constructor){$leThis=$fn->boundThis;}if(isset($fn->boundArgs)){$args=array_merge($fn->boundArgs,$args);}$scope=clone JS::$emptyScope;$scope->up=$fn->scope;$scope->properties[\'arguments\']=clone JS::$argumentsTemplate;$x475=&$scope->properties[\'arguments\'];$x475->properties[\'length\']=count($args);foreach($args as$i=>$arg){$x475->properties[$i]=$args[$i];$x475->attributes[$i]=JS::WRITABLE|JS::ENUMERABLE|JS::CONFIGURABLE;}$scope->properties[\'o\']=array_key_exists(0,$args)?$args[0]:JS::$undefined;$_o=&$scope->properties[\'o\'];$Uo=FALSE;$global->scope[++$global->scope_sp]=$scope;$x477=(((gettype($_o)===gettype(NULL)&&$_o===NULL))||(((is_float($_o)||is_int($_o))&&(is_float(NULL)||is_int(NULL)))&&$_o==NULL));$x476=$x477;if(!JS::toBoolean($x476,$global)){$x480=$_o;$x480=($x480===JS::$undefined?\'undefined\':(is_int($x480)||is_float($x480)?\'number\':(is_bool($x480)?\'boolean\':(is_string($x480)?\'string\':(is_object($x480)&&isset($x480->call)?\'function\':\'object\')))));$x479=!(((gettype($x480)===gettype(\'object\')&&$x480===\'object\'))||(((is_float($x480)||is_int($x480))&&(is_float(\'object\')||is_int(\'object\')))&&$x480==\'object\'));$x478=$x479;if(JS::toBoolean($x478,$global)){$x482=$_o;$x482=($x482===JS::$undefined?\'undefined\':(is_int($x482)||is_float($x482)?\'number\':(is_bool($x482)?\'boolean\':(is_string($x482)?\'string\':(is_object($x482)&&isset($x482->call)?\'function\':\'object\')))));$x481=!(((gettype($x482)===gettype(\'function\')&&$x482===\'function\'))||(((is_float($x482)||is_int($x482))&&(is_float(\'function\')||is_int(\'function\')))&&$x482==\'function\'));$x478=$x481;}$x476=$x478;}if(JS::toBoolean($x476,$global)){unset($_TypeError,$WTypeError,$STypeError,$UTypeError);$x485=_a6798eddb4d8b054110f0587bbe9a935_3($global,$scope,$scope,JS::toString(\'TypeError\',$global),181,13,\'<image>/02_object.js\');$_TypeError=&$x485[0];list(,$WTypeError,$STypeError,$UTypeError)=$x485;if($UTypeError){unset($_ReferenceError,$WReferenceError,$SReferenceError,$UReferenceError);$x486=_a6798eddb4d8b054110f0587bbe9a935_3($global,$scope,$scope,JS::toString(\'ReferenceError\',$global),181,13,\'<image>/02_object.js\');$_ReferenceError=&$x486[0];list(,$WReferenceError,$SReferenceError,$UReferenceError)=$x486;$x487=$_ReferenceError->call;$global->trace[++$global->trace_sp]=array(\'<image>/02_object.js\',181,13);$x488=$x487($global,$global,$_ReferenceError,array(\'TypeError is not defined\'),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);if(isset($x488->class)&&$x488->class===\'Error\'&&!isset($x488->properties[\'file\'])&&!isset($x488->properties[\'line\'])&&!isset($x488->properties[\'column\'])){$x488->properties[\'file\']=\'<image>/02_object.js\';$x488->properties[\'line\']=181;$x488->properties[\'column\']=13;$x488->attributes[\'file\']=$x488->attributes[\'line\']=$x488->attributes[\'column\']=0;}throw new JSException($x488,181,13,\'<image>/02_object.js\');}$x483=clone JS::$objectTemplate;unset($x489,$W489,$S489,$U489);$x490=_a6798eddb4d8b054110f0587bbe9a935_4($global,$scope,$_TypeError,JS::toString(\'prototype\',$global),181,9,\'<image>/02_object.js\');$x489=&$x490[0];list(,$W489,$S489,$U489)=$x490;$x484=$x489;$x483->prototype=$x484;if(!(is_object($_TypeError)&&isset($_TypeError->call))){$x493=$_TypeError->call;$global->trace[++$global->trace_sp]=array(\'<image>/02_object.js\',181,9);$x494=$x493($global,$global,$_TypeError,array(\'Trying to call what is not a function.\'),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);if(isset($x494->class)&&$x494->class===\'Error\'&&!isset($x494->properties[\'file\'])&&!isset($x494->properties[\'line\'])&&!isset($x494->properties[\'column\'])){$x494->properties[\'file\']=\'<image>/02_object.js\';$x494->properties[\'line\']=181;$x494->properties[\'column\']=9;$x494->attributes[\'file\']=$x494->attributes[\'line\']=$x494->attributes[\'column\']=0;}throw new JSException($x494,181,9,\'<image>/02_object.js\');}$x491=$_TypeError->call;$global->trace[++$global->trace_sp]=array(\'<image>/02_object.js\',181,9);$x492=$x491($global,$x483,$_TypeError,array(\'Object.preventExtensions(): Cannot prevent extensions on non-object.\'),true);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);$x484=$x492;if(is_object($x484)&&$x484!==JS::$undefined){$x483=$x484;}if(isset($x483->class)&&$x483->class===\'Error\'&&!isset($x483->properties[\'file\'])&&!isset($x483->properties[\'line\'])&&!isset($x483->properties[\'column\'])){$x483->properties[\'file\']=\'<image>/02_object.js\';$x483->properties[\'line\']=181;$x483->properties[\'column\']=3;$x483->attributes[\'file\']=$x483->attributes[\'line\']=$x483->attributes[\'column\']=0;}throw new JSException($x483,181,3,\'<image>/02_object.js\');}$_o->extensible=FALSE;return$_o;return JS::$undefined;}', "\n";
function _a6798eddb4d8b054110f0587bbe9a935_14($global, $leThis, $fn, $args, $constructor = FALSE) {
...
if (JS::toBoolean($x508, $global)) {
unset($_TypeError, $WTypeError, $STypeError, $UTypeError);
$x517 = _a6798eddb4d8b054110f0587bbe9a935_3($global, $scope, $scope, JS::toString('TypeError', $global), 191, 13, '<image>/02_object.js');
$_TypeError =& $x517[0]; list(,$WTypeError,$STypeError,$UTypeError) = $x517;
if ($UTypeError) {
unset($_ReferenceError, $WReferenceError, $SReferenceError, $UReferenceError);
$x518 = _a6798eddb4d8b054110f0587bbe9a935_3($global, $scope, $scope, JS::toString('ReferenceError', $global), 191, 13, '<image>/02_object.js');
...
$x522 = _a6798eddb4d8b054110f0587bbe9a935_4($global, $scope, $_TypeError, JS::toString('prototype', $global), 191, 9, '<image>/02_object.js');
...
if (JS::toBoolean($x540, $global)) {
unset($_TypeError, $WTypeError, $STypeError, $UTypeError);
$x549 = _a6798eddb4d8b054110f0587bbe9a935_3($global, $scope, $scope, JS::toString('TypeError', $global), 207, 13, '<image>/02_object.js');
$_TypeError =& $x549[0]; list(,$WTypeError,$STypeError,$UTypeError) = $x549;
if ($UTypeError) {
unset($_ReferenceError, $WReferenceError, $SReferenceError, $UReferenceError);
$x550 = _a6798eddb4d8b054110f0587bbe9a935_3($global, $scope, $scope, JS::toString('ReferenceError', $global), 207, 13, '<image>/02_object.js');
...
$x554 = _a6798eddb4d8b054110f0587bbe9a935_4($global, $scope, $_TypeError, JS::toString('prototype', $global), 207, 9, '<image>/02_object.js');
...
if (JS::toBoolean($x572, $global)) {
unset($_TypeError, $WTypeError, $STypeError, $UTypeError);
$x581 = _a6798eddb4d8b054110f0587bbe9a935_3($global, $scope, $scope, JS::toString('TypeError', $global), 223, 13, '<image>/02_object.js');
$_TypeError =& $x581[0]; list(,$WTypeError,$STypeError,$UTypeError) = $x581;
if ($UTypeError) {
unset($_ReferenceError, $WReferenceError, $SReferenceError, $UReferenceError);
$x582 = _a6798eddb4d8b054110f0587bbe9a935_3($global, $scope, $scope, JS::toString('ReferenceError', $global), 223, 13, '<image>/02_object.js');
...
$x586 = _a6798eddb4d8b054110f0587bbe9a935_4($global, $scope, $_TypeError, JS::toString('prototype', $global), 223, 9, '<image>/02_object.js');
...
if (JS::toBoolean($x604, $global)) {
unset($_TypeError, $WTypeError, $STypeError, $UTypeError);
$x613 = _a6798eddb4d8b054110f0587bbe9a935_3($global, $scope, $scope, JS::toString('TypeError', $global), 231, 13, '<image>/02_object.js');
$_TypeError =& $x613[0]; list(,$WTypeError,$STypeError,$UTypeError) = $x613;
if ($UTypeError) {
unset($_ReferenceError, $WReferenceError, $SReferenceError, $UReferenceError);
$x614 = _a6798eddb4d8b054110f0587bbe9a935_3($global, $scope, $scope, JS::toString('ReferenceError', $global), 231, 13, '<image>/02_object.js');
...
$x618 = _a6798eddb4d8b054110f0587bbe9a935_4($global, $scope, $_TypeError, JS::toString('prototype', $global), 231, 9, '<image>/02_object.js');
...
unset($_TypeError, $WTypeError, $STypeError, $UTypeError);
$x627 = _a6798eddb4d8b054110f0587bbe9a935_3($global, $scope, $scope, JS::toString('TypeError', $global), 237, 12, '<image>/02_object.js');
...
$x631 = _a6798eddb4d8b054110f0587bbe9a935_4($global, $scope, $x626, JS::toString('push', $global), 237, 12, '<image>/02_object.js');
$x630 =& $x631[0]; list(,$W630,$S630,$U630) = $x631;
if (!(is_object($x630) && isset($x630->call))) { 
unset($_TypeError, $WTypeError, $STypeError, $UTypeError);
$x634 = _a6798eddb4d8b054110f0587bbe9a935_3($global, $scope, $scope, JS::toString('TypeError', $global), 237, 12, '<image>/02_object.js');
...
echo 'function _a6798eddb4d8b054110f0587bbe9a935_17($global,$leThis,$fn,$args,$constructor=FALSE){if(isset($fn->boundThis)&&!$constructor){$leThis=$fn->boundThis;}if(isset($fn->boundArgs)){$args=array_merge($fn->boundArgs,$args);}$scope=clone JS::$emptyScope;$scope->up=$fn->scope;$scope->properties[\'arguments\']=clone JS::$argumentsTemplate;$x603=&$scope->properties[\'arguments\'];$x603->properties[\'length\']=count($args);foreach($args as$i=>$arg){$x603->properties[$i]=$args[$i];$x603->attributes[$i]=JS::WRITABLE|JS::ENUMERABLE|JS::CONFIGURABLE;}$scope->properties[\'o\']=array_key_exists(0,$args)?$args[0]:JS::$undefined;$_o=&$scope->properties[\'o\'];$Uo=FALSE;$global->scope[++$global->scope_sp]=$scope;$x605=(((gettype($_o)===gettype(NULL)&&$_o===NULL))||(((is_float($_o)||is_int($_o))&&(is_float(NULL)||is_int(NULL)))&&$_o==NULL));$x604=$x605;if(!JS::toBoolean($x604,$global)){$x608=$_o;$x608=($x608===JS::$undefined?\'undefined\':(is_int($x608)||is_float($x608)?\'number\':(is_bool($x608)?\'boolean\':(is_string($x608)?\'string\':(is_object($x608)&&isset($x608->call)?\'function\':\'object\')))));$x607=!(((gettype($x608)===gettype(\'object\')&&$x608===\'object\'))||(((is_float($x608)||is_int($x608))&&(is_float(\'object\')||is_int(\'object\')))&&$x608==\'object\'));$x606=$x607;if(JS::toBoolean($x606,$global)){$x610=$_o;$x610=($x610===JS::$undefined?\'undefined\':(is_int($x610)||is_float($x610)?\'number\':(is_bool($x610)?\'boolean\':(is_string($x610)?\'string\':(is_object($x610)&&isset($x610->call)?\'function\':\'object\')))));$x609=!(((gettype($x610)===gettype(\'function\')&&$x610===\'function\'))||(((is_float($x610)||is_int($x610))&&(is_float(\'function\')||is_int(\'function\')))&&$x610==\'function\'));$x606=$x609;}$x604=$x606;}if(JS::toBoolean($x604,$global)){unset($_TypeError,$WTypeError,$STypeError,$UTypeError);$x613=_a6798eddb4d8b054110f0587bbe9a935_3($global,$scope,$scope,JS::toString(\'TypeError\',$global),231,13,\'<image>/02_object.js\');$_TypeError=&$x613[0];list(,$WTypeError,$STypeError,$UTypeError)=$x613;if($UTypeError){unset($_ReferenceError,$WReferenceError,$SReferenceError,$UReferenceError);$x614=_a6798eddb4d8b054110f0587bbe9a935_3($global,$scope,$scope,JS::toString(\'ReferenceError\',$global),231,13,\'<image>/02_object.js\');$_ReferenceError=&$x614[0];list(,$WReferenceError,$SReferenceError,$UReferenceError)=$x614;$x615=$_ReferenceError->call;$global->trace[++$global->trace_sp]=array(\'<image>/02_object.js\',231,13);$x616=$x615($global,$global,$_ReferenceError,array(\'TypeError is not defined\'),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);if(isset($x616->class)&&$x616->class===\'Error\'&&!isset($x616->properties[\'file\'])&&!isset($x616->properties[\'line\'])&&!isset($x616->properties[\'column\'])){$x616->properties[\'file\']=\'<image>/02_object.js\';$x616->properties[\'line\']=231;$x616->properties[\'column\']=13;$x616->attributes[\'file\']=$x616->attributes[\'line\']=$x616->attributes[\'column\']=0;}throw new JSException($x616,231,13,\'<image>/02_object.js\');}$x611=clone JS::$objectTemplate;unset($x617,$W617,$S617,$U617);$x618=_a6798eddb4d8b054110f0587bbe9a935_4($global,$scope,$_TypeError,JS::toString(\'prototype\',$global),231,9,\'<image>/02_object.js\');$x617=&$x618[0];list(,$W617,$S617,$U617)=$x618;$x612=$x617;$x611->prototype=$x612;if(!(is_object($_TypeError)&&isset($_TypeError->call))){$x621=$_TypeError->call;$global->trace[++$global->trace_sp]=array(\'<image>/02_object.js\',231,9);$x622=$x621($global,$global,$_TypeError,array(\'Trying to call what is not a function.\'),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);if(isset($x622->class)&&$x622->class===\'Error\'&&!isset($x622->properties[\'file\'])&&!isset($x622->properties[\'line\'])&&!isset($x622->properties[\'column\'])){$x622->properties[\'file\']=\'<image>/02_object.js\';$x622->properties[\'line\']=231;$x622->properties[\'column\']=9;$x622->attributes[\'file\']=$x622->attributes[\'line\']=$x622->attributes[\'column\']=0;}throw new JSException($x622,231,9,\'<image>/02_object.js\');}$x619=$_TypeError->call;$global->trace[++$global->trace_sp]=array(\'<image>/02_object.js\',231,9);$x620=$x619($global,$x611,$_TypeError,array(\'Object.keys(): Cannot return keys, non-object given.\'),true);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);$x612=$x620;if(is_object($x612)&&$x612!==JS::$undefined){$x611=$x612;}if(isset($x611->class)&&$x611->class===\'Error\'&&!isset($x611->properties[\'file\'])&&!isset($x611->properties[\'line\'])&&!isset($x611->properties[\'column\'])){$x611->properties[\'file\']=\'<image>/02_object.js\';$x611->properties[\'line\']=231;$x611->properties[\'column\']=3;$x611->attributes[\'file\']=$x611->attributes[\'line\']=$x611->attributes[\'column\']=0;}throw new JSException($x611,231,3,\'<image>/02_object.js\');}$x623=clone JS::$arrayTemplate;$x623->properties[\'length\']=0;$x623->attributes[\'length\']=JS::WRITABLE;$scope->properties[\'keys\']=JS::$undefined;$_keys=&$scope->properties[\'keys\'];$Ukeys=FALSE;$_keys=$x623;$scope->properties[\'k\']=JS::$undefined;$_k=&$scope->properties[\'k\'];$Uk=FALSE;$_k=JS::$undefined;if($_o!==JS::$undefined&&$_o!==NULL){for($x625=array(),$x624=JS::toObject($_o,$global);$x624;$x624=$x624->prototype){foreach($x624->attributes as$property=>$attributes){if(!($attributes&JS::ENUMERABLE)||isset($x625[$property])){continue;}$x625[$property]=TRUE;$_k=$property;if($_keys===JS::$undefined||$_keys===NULL){unset($_TypeError,$WTypeError,$STypeError,$UTypeError);$x627=_a6798eddb4d8b054110f0587bbe9a935_3($global,$scope,$scope,JS::toString(\'TypeError\',$global),237,12,\'<image>/02_object.js\');$_TypeError=&$x627[0];list(,$WTypeError,$STypeError,$UTypeError)=$x627;$x628=$_TypeError->call;$global->trace[++$global->trace_sp]=array(\'<image>/02_object.js\',237,12);$x629=$x628($global,$global,$_TypeError,array(\'Cannot call function on undefined/null.\'),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);if(isset($x629->class)&&$x629->class===\'Error\'&&!isset($x629->properties[\'file\'])&&!isset($x629->properties[\'line\'])&&!isset($x629->properties[\'column\'])){$x629->properties[\'file\']=\'<image>/02_object.js\';$x629->properties[\'line\']=237;$x629->properties[\'column\']=12;$x629->attributes[\'file\']=$x629->attributes[\'line\']=$x629->attributes[\'column\']=0;}throw new JSException($x629,237,12,\'<image>/02_object.js\');}$x626=JS::toObject($_keys,$global);unset($x630,$W630,$S630,$U630);$x631=_a6798eddb4d8b054110f0587bbe9a935_4($global,$scope,$x626,JS::toString(\'push\',$global),237,12,\'<image>/02_object.js\');$x630=&$x631[0];list(,$W630,$S630,$U630)=$x631;if(!(is_object($x630)&&isset($x630->call))){unset($_TypeError,$WTypeError,$STypeError,$UTypeError);$x634=_a6798eddb4d8b054110f0587bbe9a935_3($global,$scope,$scope,JS::toString(\'TypeError\',$global),237,12,\'<image>/02_object.js\');$_TypeError=&$x634[0];list(,$WTypeError,$STypeError,$UTypeError)=$x634;$x635=$_TypeError->call;$global->trace[++$global->trace_sp]=array(\'<image>/02_object.js\',237,12);$x636=$x635($global,$global,$_TypeError,array(\'Trying to call what is not a function.\'),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);if(isset($x636->class)&&$x636->class===\'Error\'&&!isset($x636->properties[\'file\'])&&!isset($x636->properties[\'line\'])&&!isset($x636->properties[\'column\'])){$x636->properties[\'file\']=\'<image>/02_object.js\';$x636->properties[\'line\']=237;$x636->properties[\'column\']=12;$x636->attributes[\'file\']=$x636->attributes[\'line\']=$x636->attributes[\'column\']=0;}throw new JSException($x636,237,12,\'<image>/02_object.js\');}$x632=$x630->call;$global->trace[++$global->trace_sp]=array(\'<image>/02_object.js\',237,12);$x633=$x632($global,$x626,$x630,array($_k),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);}}}return$_keys;return JS::$undefined;}', "\n";
function _a6798eddb4d8b054110f0587bbe9a935_18($global, $leThis, $fn, $args, $constructor = FALSE) {
...
unset($_TypeError, $WTypeError, $STypeError, $UTypeError);
$x691 = _a6798eddb4d8b054110f0587bbe9a935_3($global, $scope, $scope, JS::toString('TypeError', $global), 268, 22, '<image>/02_object.js');
...
$x695 = _a6798eddb4d8b054110f0587bbe9a935_4($global, $scope, $x690, JS::toString('toString', $global), 268, 22, '<image>/02_object.js');
$x694 =& $x695[0]; list(,$W694,$S694,$U694) = $x695;
if (!(is_object($x694) && isset($x694->call))) { 
unset($_TypeError, $WTypeError, $STypeError, $UTypeError);
$x698 = _a6798eddb4d8b054110f0587bbe9a935_3($global, $scope, $scope, JS::toString('TypeError', $global), 268, 22, '<image>/02_object.js');
...
echo 'function _a6798eddb4d8b054110f0587bbe9a935_19($global,$leThis,$fn,$args,$constructor=FALSE){if(isset($fn->boundThis)&&!$constructor){$leThis=$fn->boundThis;}if(isset($fn->boundArgs)){$args=array_merge($fn->boundArgs,$args);}$scope=clone JS::$emptyScope;$scope->up=$fn->scope;$scope->properties[\'arguments\']=clone JS::$argumentsTemplate;$x689=&$scope->properties[\'arguments\'];$x689->properties[\'length\']=count($args);foreach($args as$i=>$arg){$x689->properties[$i]=$args[$i];$x689->attributes[$i]=JS::WRITABLE|JS::ENUMERABLE|JS::CONFIGURABLE;}$global->scope[++$global->scope_sp]=$scope;if($leThis===JS::$undefined||$leThis===NULL){unset($_TypeError,$WTypeError,$STypeError,$UTypeError);$x691=_a6798eddb4d8b054110f0587bbe9a935_3($global,$scope,$scope,JS::toString(\'TypeError\',$global),268,22,\'<image>/02_object.js\');$_TypeError=&$x691[0];list(,$WTypeError,$STypeError,$UTypeError)=$x691;$x692=$_TypeError->call;$global->trace[++$global->trace_sp]=array(\'<image>/02_object.js\',268,22);$x693=$x692($global,$global,$_TypeError,array(\'Cannot call function on undefined/null.\'),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);if(isset($x693->class)&&$x693->class===\'Error\'&&!isset($x693->properties[\'file\'])&&!isset($x693->properties[\'line\'])&&!isset($x693->properties[\'column\'])){$x693->properties[\'file\']=\'<image>/02_object.js\';$x693->properties[\'line\']=268;$x693->properties[\'column\']=22;$x693->attributes[\'file\']=$x693->attributes[\'line\']=$x693->attributes[\'column\']=0;}throw new JSException($x693,268,22,\'<image>/02_object.js\');}$x690=JS::toObject($leThis,$global);unset($x694,$W694,$S694,$U694);$x695=_a6798eddb4d8b054110f0587bbe9a935_4($global,$scope,$x690,JS::toString(\'toString\',$global),268,22,\'<image>/02_object.js\');$x694=&$x695[0];list(,$W694,$S694,$U694)=$x695;if(!(is_object($x694)&&isset($x694->call))){unset($_TypeError,$WTypeError,$STypeError,$UTypeError);$x698=_a6798eddb4d8b054110f0587bbe9a935_3($global,$scope,$scope,JS::toString(\'TypeError\',$global),268,22,\'<image>/02_object.js\');$_TypeError=&$x698[0];list(,$WTypeError,$STypeError,$UTypeError)=$x698;$x699=$_TypeError->call;$global->trace[++$global->trace_sp]=array(\'<image>/02_object.js\',268,22);$x700=$x699($global,$global,$_TypeError,array(\'Trying to call what is not a function.\'),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);if(isset($x700->class)&&$x700->class===\'Error\'&&!isset($x700->properties[\'file\'])&&!isset($x700->properties[\'line\'])&&!isset($x700->properties[\'column\'])){$x700->properties[\'file\']=\'<image>/02_object.js\';$x700->properties[\'line\']=268;$x700->properties[\'column\']=22;$x700->attributes[\'file\']=$x700->attributes[\'line\']=$x700->attributes[\'column\']=0;}throw new JSException($x700,268,22,\'<image>/02_object.js\');}$x696=$x694->call;$global->trace[++$global->trace_sp]=array(\'<image>/02_object.js\',268,22);$x697=$x696($global,$x690,$x694,array(),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);return$x697;return JS::$undefined;}', "\n";
function _a6798eddb4d8b054110f0587bbe9a935_20($global, $leThis, $fn, $args, $constructor = FALSE) {
...
if (JS::toBoolean($x716, $global)) {
unset($_TypeError, $WTypeError, $STypeError, $UTypeError);
$x721 = _a6798eddb4d8b054110f0587bbe9a935_3($global, $scope, $scope, JS::toString('TypeError', $global), 273, 13, '<image>/02_object.js');
$_TypeError =& $x721[0]; list(,$WTypeError,$STypeError,$UTypeError) = $x721;
if ($UTypeError) {
unset($_ReferenceError, $WReferenceError, $SReferenceError, $UReferenceError);
$x722 = _a6798eddb4d8b054110f0587bbe9a935_3($global, $scope, $scope, JS::toString('ReferenceError', $global), 273, 13, '<image>/02_object.js');
...
$x726 = _a6798eddb4d8b054110f0587bbe9a935_4($global, $scope, $_TypeError, JS::toString('prototype', $global), 273, 9, '<image>/02_object.js');
...
echo 'function _a6798eddb4d8b054110f0587bbe9a935_20($global,$leThis,$fn,$args,$constructor=FALSE){if(isset($fn->boundThis)&&!$constructor){$leThis=$fn->boundThis;}if(isset($fn->boundArgs)){$args=array_merge($fn->boundArgs,$args);}$scope=clone JS::$emptyScope;$scope->up=$fn->scope;$scope->properties[\'arguments\']=clone JS::$argumentsTemplate;$x715=&$scope->properties[\'arguments\'];$x715->properties[\'length\']=count($args);foreach($args as$i=>$arg){$x715->properties[$i]=$args[$i];$x715->attributes[$i]=JS::WRITABLE|JS::ENUMERABLE|JS::CONFIGURABLE;}$global->scope[++$global->scope_sp]=$scope;$x717=(((gettype($leThis)===gettype(JS::$undefined)&&$leThis===JS::$undefined))||(((is_float($leThis)||is_int($leThis))&&(is_float(JS::$undefined)||is_int(JS::$undefined)))&&$leThis==JS::$undefined));$x716=$x717;if(!JS::toBoolean($x716,$global)){$x718=(((gettype($leThis)===gettype(NULL)&&$leThis===NULL))||(((is_float($leThis)||is_int($leThis))&&(is_float(NULL)||is_int(NULL)))&&$leThis==NULL));$x716=$x718;}if(JS::toBoolean($x716,$global)){unset($_TypeError,$WTypeError,$STypeError,$UTypeError);$x721=_a6798eddb4d8b054110f0587bbe9a935_3($global,$scope,$scope,JS::toString(\'TypeError\',$global),273,13,\'<image>/02_object.js\');$_TypeError=&$x721[0];list(,$WTypeError,$STypeError,$UTypeError)=$x721;if($UTypeError){unset($_ReferenceError,$WReferenceError,$SReferenceError,$UReferenceError);$x722=_a6798eddb4d8b054110f0587bbe9a935_3($global,$scope,$scope,JS::toString(\'ReferenceError\',$global),273,13,\'<image>/02_object.js\');$_ReferenceError=&$x722[0];list(,$WReferenceError,$SReferenceError,$UReferenceError)=$x722;$x723=$_ReferenceError->call;$global->trace[++$global->trace_sp]=array(\'<image>/02_object.js\',273,13);$x724=$x723($global,$global,$_ReferenceError,array(\'TypeError is not defined\'),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);if(isset($x724->class)&&$x724->class===\'Error\'&&!isset($x724->properties[\'file\'])&&!isset($x724->properties[\'line\'])&&!isset($x724->properties[\'column\'])){$x724->properties[\'file\']=\'<image>/02_object.js\';$x724->properties[\'line\']=273;$x724->properties[\'column\']=13;$x724->attributes[\'file\']=$x724->attributes[\'line\']=$x724->attributes[\'column\']=0;}throw new JSException($x724,273,13,\'<image>/02_object.js\');}$x719=clone JS::$objectTemplate;unset($x725,$W725,$S725,$U725);$x726=_a6798eddb4d8b054110f0587bbe9a935_4($global,$scope,$_TypeError,JS::toString(\'prototype\',$global),273,9,\'<image>/02_object.js\');$x725=&$x726[0];list(,$W725,$S725,$U725)=$x726;$x720=$x725;$x719->prototype=$x720;if(!(is_object($_TypeError)&&isset($_TypeError->call))){$x729=$_TypeError->call;$global->trace[++$global->trace_sp]=array(\'<image>/02_object.js\',273,9);$x730=$x729($global,$global,$_TypeError,array(\'Trying to call what is not a function.\'),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);if(isset($x730->class)&&$x730->class===\'Error\'&&!isset($x730->properties[\'file\'])&&!isset($x730->properties[\'line\'])&&!isset($x730->properties[\'column\'])){$x730->properties[\'file\']=\'<image>/02_object.js\';$x730->properties[\'line\']=273;$x730->properties[\'column\']=9;$x730->attributes[\'file\']=$x730->attributes[\'line\']=$x730->attributes[\'column\']=0;}throw new JSException($x730,273,9,\'<image>/02_object.js\');}$x727=$_TypeError->call;$global->trace[++$global->trace_sp]=array(\'<image>/02_object.js\',273,9);$x728=$x727($global,$x719,$_TypeError,array(\'Object.prototype.valueOf(): this is undefined or null\'),true);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);$x720=$x728;if(is_object($x720)&&$x720!==JS::$undefined){$x719=$x720;}if(isset($x719->class)&&$x719->class===\'Error\'&&!isset($x719->properties[\'file\'])&&!isset($x719->properties[\'line\'])&&!isset($x719->properties[\'column\'])){$x719->properties[\'file\']=\'<image>/02_object.js\';$x719->properties[\'line\']=273;$x719->properties[\'column\']=3;$x719->attributes[\'file\']=$x719->attributes[\'line\']=$x719->attributes[\'column\']=0;}throw new JSException($x719,273,3,\'<image>/02_object.js\');}return JS::toObject($leThis,$global);return JS::$undefined;}', "\n";
function _a6798eddb4d8b054110f0587bbe9a935_21($global, $leThis, $fn, $args, $constructor = FALSE) {
...
$scope->properties['obj'] = array_key_exists(0, $args) ? $args[0] : JS::$undefined;
$_obj =& $scope->properties['obj'];
$Uobj = FALSE;
$global->scope[++$global->scope_sp] = $scope;
$x798 = clone JS::$arrayTemplate;
$x798->properties['length'] = 0;
$x798->attributes['length'] = JS::WRITABLE;
$scope->properties['res'] = JS::$undefined; $_res =& $scope->properties['res'];
$Ures = FALSE;
$_res = $x798;
$scope->properties['i'] = JS::$undefined; $_i =& $scope->properties['i'];
$Ui = FALSE;
$_i = JS::$undefined;
if ($_obj !== JS::$undefined && $_obj !== NULL) {
for ($x800 = array(), $x799 = JS::toObject($_obj, $global); $x799; $x799 = $x799->prototype) {
foreach ($x799->attributes as $property => $attributes) {
if (!($attributes & JS::ENUMERABLE) || isset($x800[$property])) { continue; }
$x800[$property] = TRUE;
$_i = $property;

if ($_obj === JS::$undefined || $_obj === NULL) {
unset($_TypeError, $WTypeError, $STypeError, $UTypeError);
$x802 = _a6798eddb4d8b054110f0587bbe9a935_3($global, $scope, $scope, JS::toString('TypeError', $global), 307, 30, '<image>/02_object.js');
$_TypeError =& $x802[0]; list(,$WTypeError,$STypeError,$UTypeError) = $x802;
$x803 = $_TypeError->call;
$global->trace[++$global->trace_sp] = array('<image>/02_object.js', 307, 30);
$x804 = $x803($global, $global, $_TypeError, array('Cannot call function on undefined/null.'), false);
unset($global->trace[$global->trace_sp--], $global->scope[$global->scope_sp--]);
if (isset($x804->class) && $x804->class === 'Error' && !isset($x804->properties['file']) && !isset($x804->properties['line']) && !isset($x804->properties['column'])) {$x804->properties['file'] = '<image>/02_object.js';$x804->properties['line'] = 307;$x804->properties['column'] = 30;$x804->attributes['file'] = $x804->attributes['line'] = $x804->attributes['column'] = 0; }
throw new JSException($x804, 307, 30, '<image>/02_object.js');
}
$x801 = JS::toObject($_obj, $global);
unset($x805, $W805, $S805, $U805);
$x806 = _a6798eddb4d8b054110f0587bbe9a935_4($global, $scope, $x801, JS::toString('hasOwnProperty', $global), 307, 30, '<image>/02_object.js');
$x805 =& $x806[0]; list(,$W805,$S805,$U805) = $x806;
if (!(is_object($x805) && isset($x805->call))) { 
unset($_TypeError, $WTypeError, $STypeError, $UTypeError);
$x809 = _a6798eddb4d8b054110f0587bbe9a935_3($global, $scope, $scope, JS::toString('TypeError', $global), 307, 30, '<image>/02_object.js');
$_TypeError =& $x809[0]; list(,$WTypeError,$STypeError,$UTypeError) = $x809;
$x810 = $_TypeError->call;
$global->trace[++$global->trace_sp] = array('<image>/02_object.js', 307, 30);
$x811 = $x810($global, $global, $_TypeError, array('Trying to call what is not a function.'), false);
unset($global->trace[$global->trace_sp--], $global->scope[$global->scope_sp--]);
if (isset($x811->class) && $x811->class === 'Error' && !isset($x811->properties['file']) && !isset($x811->properties['line']) && !isset($x811->properties['column'])) {$x811->properties['file'] = '<image>/02_object.js';$x811->properties['line'] = 307;$x811->properties['column'] = 30;$x811->attributes['file'] = $x811->attributes['line'] = $x811->attributes['column'] = 0; }
throw new JSException($x811, 307, 30, '<image>/02_object.js');
}
$x807 = $x805->call;
$global->trace[++$global->trace_sp] = array('<image>/02_object.js', 307, 30);
$x808 = $x807($global, $x801, $x805, array($_i), false);
unset($global->trace[$global->trace_sp--], $global->scope[$global->scope_sp--]);
if (JS::toBoolean($x808, $global)) {
if ($_res === JS::$undefined || $_res === NULL) {
unset($_TypeError, $WTypeError, $STypeError, $UTypeError);
$x813 = _a6798eddb4d8b054110f0587bbe9a935_3($global, $scope, $scope, JS::toString('TypeError', $global), 308, 19, '<image>/02_object.js');
$_TypeError =& $x813[0]; list(,$WTypeError,$STypeError,$UTypeError) = $x813;
$x814 = $_TypeError->call;
$global->trace[++$global->trace_sp] = array('<image>/02_object.js', 308, 19);
$x815 = $x814($global, $global, $_TypeError, array('Cannot call function on undefined/null.'), false);
unset($global->trace[$global->trace_sp--], $global->scope[$global->scope_sp--]);
if (isset($x815->class) && $x815->class === 'Error' && !isset($x815->properties['file']) && !isset($x815->properties['line']) && !isset($x815->properties['column'])) {$x815->properties['file'] = '<image>/02_object.js';$x815->properties['line'] = 308;$x815->properties['column'] = 19;$x815->attributes['file'] = $x815->attributes['line'] = $x815->attributes['column'] = 0; }
throw new JSException($x815, 308, 19, '<image>/02_object.js');
}
$x812 = JS::toObject($_res, $global);
unset($x816, $W816, $S816, $U816);
$x817 = _a6798eddb4d8b054110f0587bbe9a935_4($global, $scope, $x812, JS::toString('push', $global), 308, 19, '<image>/02_object.js');
$x816 =& $x817[0]; list(,$W816,$S816,$U816) = $x817;
unset($x818, $W818, $S818, $U818);
$x819 = _a6798eddb4d8b054110f0587bbe9a935_4($global, $scope, $_obj, JS::toString($_i, $global), 308, 23, '<image>/02_object.js');
$x818 =& $x819[0]; list(,$W818,$S818,$U818) = $x819;
if (!(is_object($x816) && isset($x816->call))) { 
unset($_TypeError, $WTypeError, $STypeError, $UTypeError);
$x822 = _a6798eddb4d8b054110f0587bbe9a935_3($global, $scope, $scope, JS::toString('TypeError', $global), 308, 19, '<image>/02_object.js');
...
unset($global->trace[$global->trace_sp--], $global->scope[$global->scope_sp--]);
if (isset($x824->class) && $x824->class === 'Error' && !isset($x824->properties['file']) && !isset($x824->properties['line']) && !isset($x824->properties['column'])) {$x824->properties['file'] = '<image>/02_object.js';$x824->properties['line'] = 308;$x824->properties['column'] = 19;$x824->attributes['file'] = $x824->attributes['line'] = $x824->attributes['column'] = 0; }
throw new JSException($x824, 308, 19, '<image>/02_object.js');
}
$x820 = $x816->call;
$global->trace[++$global->trace_sp] = array('<image>/02_object.js', 308, 19);
$x821 = $x820($global, $x812, $x816, array($x818), false);
unset($global->trace[$global->trace_sp--], $global->scope[$global->scope_sp--]);;
};
}
}
...
echo 'function _a6798eddb4d8b054110f0587bbe9a935_24($global,$leThis,$fn,$args,$constructor=FALSE){if(isset($fn->boundThis)&&!$constructor){$leThis=$fn->boundThis;}if(isset($fn->boundArgs)){$args=array_merge($fn->boundArgs,$args);}$scope=clone JS::$emptyScope;$scope->up=$fn->scope;$scope->properties[\'arguments\']=clone JS::$argumentsTemplate;$x797=&$scope->properties[\'arguments\'];$x797->properties[\'length\']=count($args);foreach($args as$i=>$arg){$x797->properties[$i]=$args[$i];$x797->attributes[$i]=JS::WRITABLE|JS::ENUMERABLE|JS::CONFIGURABLE;}$scope->properties[\'obj\']=array_key_exists(0,$args)?$args[0]:JS::$undefined;$_obj=&$scope->properties[\'obj\'];$Uobj=FALSE;$global->scope[++$global->scope_sp]=$scope;$x798=clone JS::$arrayTemplate;$x798->properties[\'length\']=0;$x798->attributes[\'length\']=JS::WRITABLE;$scope->properties[\'res\']=JS::$undefined;$_res=&$scope->properties[\'res\'];$Ures=FALSE;$_res=$x798;$scope->properties[\'i\']=JS::$undefined;$_i=&$scope->properties[\'i\'];$Ui=FALSE;$_i=JS::$undefined;if($_obj!==JS::$undefined&&$_obj!==NULL){for($x800=array(),$x799=JS::toObject($_obj,$global);$x799;$x799=$x799->prototype){foreach($x799->attributes as$property=>$attributes){if(!($attributes&JS::ENUMERABLE)||isset($x800[$property])){continue;}$x800[$property]=TRUE;$_i=$property;if($_obj===JS::$undefined||$_obj===NULL){unset($_TypeError,$WTypeError,$STypeError,$UTypeError);$x802=_a6798eddb4d8b054110f0587bbe9a935_3($global,$scope,$scope,JS::toString(\'TypeError\',$global),307,30,\'<image>/02_object.js\');$_TypeError=&$x802[0];list(,$WTypeError,$STypeError,$UTypeError)=$x802;$x803=$_TypeError->call;$global->trace[++$global->trace_sp]=array(\'<image>/02_object.js\',307,30);$x804=$x803($global,$global,$_TypeError,array(\'Cannot call function on undefined/null.\'),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);if(isset($x804->class)&&$x804->class===\'Error\'&&!isset($x804->properties[\'file\'])&&!isset($x804->properties[\'line\'])&&!isset($x804->properties[\'column\'])){$x804->properties[\'file\']=\'<image>/02_object.js\';$x804->properties[\'line\']=307;$x804->properties[\'column\']=30;$x804->attributes[\'file\']=$x804->attributes[\'line\']=$x804->attributes[\'column\']=0;}throw new JSException($x804,307,30,\'<image>/02_object.js\');}$x801=JS::toObject($_obj,$global);unset($x805,$W805,$S805,$U805);$x806=_a6798eddb4d8b054110f0587bbe9a935_4($global,$scope,$x801,JS::toString(\'hasOwnProperty\',$global),307,30,\'<image>/02_object.js\');$x805=&$x806[0];list(,$W805,$S805,$U805)=$x806;if(!(is_object($x805)&&isset($x805->call))){unset($_TypeError,$WTypeError,$STypeError,$UTypeError);$x809=_a6798eddb4d8b054110f0587bbe9a935_3($global,$scope,$scope,JS::toString(\'TypeError\',$global),307,30,\'<image>/02_object.js\');$_TypeError=&$x809[0];list(,$WTypeError,$STypeError,$UTypeError)=$x809;$x810=$_TypeError->call;$global->trace[++$global->trace_sp]=array(\'<image>/02_object.js\',307,30);$x811=$x810($global,$global,$_TypeError,array(\'Trying to call what is not a function.\'),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);if(isset($x811->class)&&$x811->class===\'Error\'&&!isset($x811->properties[\'file\'])&&!isset($x811->properties[\'line\'])&&!isset($x811->properties[\'column\'])){$x811->properties[\'file\']=\'<image>/02_object.js\';$x811->properties[\'line\']=307;$x811->properties[\'column\']=30;$x811->attributes[\'file\']=$x811->attributes[\'line\']=$x811->attributes[\'column\']=0;}throw new JSException($x811,307,30,\'<image>/02_object.js\');}$x807=$x805->call;$global->trace[++$global->trace_sp]=array(\'<image>/02_object.js\',307,30);$x808=$x807($global,$x801,$x805,array($_i),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);if(JS::toBoolean($x808,$global)){if($_res===JS::$undefined||$_res===NULL){unset($_TypeError,$WTypeError,$STypeError,$UTypeError);$x813=_a6798eddb4d8b054110f0587bbe9a935_3($global,$scope,$scope,JS::toString(\'TypeError\',$global),308,19,\'<image>/02_object.js\');$_TypeError=&$x813[0];list(,$WTypeError,$STypeError,$UTypeError)=$x813;$x814=$_TypeError->call;$global->trace[++$global->trace_sp]=array(\'<image>/02_object.js\',308,19);$x815=$x814($global,$global,$_TypeError,array(\'Cannot call function on undefined/null.\'),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);if(isset($x815->class)&&$x815->class===\'Error\'&&!isset($x815->properties[\'file\'])&&!isset($x815->properties[\'line\'])&&!isset($x815->properties[\'column\'])){$x815->properties[\'file\']=\'<image>/02_object.js\';$x815->properties[\'line\']=308;$x815->properties[\'column\']=19;$x815->attributes[\'file\']=$x815->attributes[\'line\']=$x815->attributes[\'column\']=0;}throw new JSException($x815,308,19,\'<image>/02_object.js\');}$x812=JS::toObject($_res,$global);unset($x816,$W816,$S816,$U816);$x817=_a6798eddb4d8b054110f0587bbe9a935_4($global,$scope,$x812,JS::toString(\'push\',$global),308,19,\'<image>/02_object.js\');$x816=&$x817[0];list(,$W816,$S816,$U816)=$x817;unset($x818,$W818,$S818,$U818);$x819=_a6798eddb4d8b054110f0587bbe9a935_4($global,$scope,$_obj,JS::toString($_i,$global),308,23,\'<image>/02_object.js\');$x818=&$x819[0];list(,$W818,$S818,$U818)=$x819;if(!(is_object($x816)&&isset($x816->call))){unset($_TypeError,$WTypeError,$STypeError,$UTypeError);$x822=_a6798eddb4d8b054110f0587bbe9a935_3($global,$scope,$scope,JS::toString(\'TypeError\',$global),308,19,\'<image>/02_object.js\');$_TypeError=&$x822[0];list(,$WTypeError,$STypeError,$UTypeError)=$x822;$x823=$_TypeError->call;$global->trace[++$global->trace_sp]=array(\'<image>/02_object.js\',308,19);$x824=$x823($global,$global,$_TypeError,array(\'Trying to call what is not a function.\'),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);if(isset($x824->class)&&$x824->class===\'Error\'&&!isset($x824->properties[\'file\'])&&!isset($x824->properties[\'line\'])&&!isset($x824->properties[\'column\'])){$x824->properties[\'file\']=\'<image>/02_object.js\';$x824->properties[\'line\']=308;$x824->properties[\'column\']=19;$x824->attributes[\'file\']=$x824->attributes[\'line\']=$x824->attributes[\'column\']=0;}throw new JSException($x824,308,19,\'<image>/02_object.js\');}$x820=$x816->call;$global->trace[++$global->trace_sp]=array(\'<image>/02_object.js\',308,19);$x821=$x820($global,$x812,$x816,array($x818),false);unset($global->trace[$global->trace_sp--],$global->scope[$global->scope_sp--]);}}}}return$_res;return JS::$undefined;}', "\n";
function _a6798eddb4d8b054110f0587bbe9a935_0($global = NULL, $scope = NULL) {
...
$leThis = $global;
$_Object;
$x6 = clone JS::$functionTemplate; $x6->call = '_a6798eddb4d8b054110f0587bbe9a935_1'; $x6->parameters = array (
  0 => 'value',
...
$UObject = FALSE;
$_Object = $x6;
$x34 = clone JS::$functionTemplate; $x34->call = '_a6798eddb4d8b054110f0587bbe9a935_2'; $x34->parameters = array (
  0 => 'o',
...
if ($_Object === JS::$undefined || $_Object === NULL) {
unset($_TypeError, $WTypeError, $STypeError, $UTypeError);
$x36 = _a6798eddb4d8b054110f0587bbe9a935_3($global, $scope, $scope, JS::toString('TypeError', $global), 9, 23, '<image>/02_object.js');
...
$x43 = _a6798eddb4d8b054110f0587bbe9a935_5($global, $scope, $_Object, JS::toString($x35, $global), 9, 23, '<image>/02_object.js');
...
$x135 = clone JS::$functionTemplate; $x135->call = '_a6798eddb4d8b054110f0587bbe9a935_6'; $x135->parameters = array (
  0 => 'o',
  1 => 'p',
...
if ($_Object === JS::$undefined || $_Object === NULL) {
unset($_TypeError, $WTypeError, $STypeError, $UTypeError);
$x137 = _a6798eddb4d8b054110f0587bbe9a935_3($global, $scope, $scope, JS::toString('TypeError', $global), 17, 33, '<image>/02_object.js');
...
$x141 = _a6798eddb4d8b054110f0587bbe9a935_5($global, $scope, $_Object, JS::toString($x136, $global), 17, 33, '<image>/02_object.js');
...
$x179 = clone JS::$functionTemplate; $x179->call = '_a6798eddb4d8b054110f0587bbe9a935_7'; $x179->parameters = array (
  0 => 'o',
...
if ($_Object === JS::$undefined || $_Object === NULL) {
unset($_TypeError, $WTypeError, $STypeError, $UTypeError);
$x181 = _a6798eddb4d8b054110f0587bbe9a935_3($global, $scope, $scope, JS::toString('TypeError', $global), 48, 28, '<image>/02_object.js');
...
$x185 = _a6798eddb4d8b054110f0587bbe9a935_5($global, $scope, $_Object, JS::toString($x180, $global), 48, 28, '<image>/02_object.js');
...
$x225 = clone JS::$functionTemplate; $x225->call = '_a6798eddb4d8b054110f0587bbe9a935_8'; $x225->parameters = array (
  0 => 'o',
  1 => 'properties',
...
if ($_Object === JS::$undefined || $_Object === NULL) {
unset($_TypeError, $WTypeError, $STypeError, $UTypeError);
$x227 = _a6798eddb4d8b054110f0587bbe9a935_3($global, $scope, $scope, JS::toString('TypeError', $global), 62, 15, '<image>/02_object.js');
...
$x231 = _a6798eddb4d8b054110f0587bbe9a935_5($global, $scope, $_Object, JS::toString($x226, $global), 62, 15, '<image>/02_object.js');
...
$x334 = clone JS::$functionTemplate; $x334->call = '_a6798eddb4d8b054110f0587bbe9a935_9'; $x334->parameters = array (
  0 => 'o',
  1 => 'p',
  2 => 'attributes',
...
if ($_Object === JS::$undefined || $_Object === NULL) {
unset($_TypeError, $WTypeError, $STypeError, $UTypeError);
$x336 = _a6798eddb4d8b054110f0587bbe9a935_3($global, $scope, $scope, JS::toString('TypeError', $global), 78, 23, '<image>/02_object.js');
...
$x340 = _a6798eddb4d8b054110f0587bbe9a935_5($global, $scope, $_Object, JS::toString($x335, $global), 78, 23, '<image>/02_object.js');
...
$x399 = clone JS::$functionTemplate; $x399->call = '_a6798eddb4d8b054110f0587bbe9a935_10'; $x399->parameters = array (
  0 => 'o',
  1 => 'properties',
...
if ($_Object === JS::$undefined || $_Object === NULL) {
unset($_TypeError, $WTypeError, $STypeError, $UTypeError);
$x401 = _a6798eddb4d8b054110f0587bbe9a935_3($global, $scope, $scope, JS::toString('TypeError', $global), 130, 25, '<image>/02_object.js');
...
$x405 = _a6798eddb4d8b054110f0587bbe9a935_5($global, $scope, $_Object, JS::toString($x400, $global), 130, 25, '<image>/02_object.js');
...
$x431 = clone JS::$functionTemplate; $x431->call = '_a6798eddb4d8b054110f0587bbe9a935_11'; $x431->parameters = array (
  0 => 'o',
...
if ($_Object === JS::$undefined || $_Object === NULL) {
unset($_TypeError, $WTypeError, $STypeError, $UTypeError);
$x433 = _a6798eddb4d8b054110f0587bbe9a935_3($global, $scope, $scope, JS::toString('TypeError', $global), 146, 13, '<image>/02_object.js');
...
$x437 = _a6798eddb4d8b054110f0587bbe9a935_5($global, $scope, $_Object, JS::toString($x432, $global), 146, 13, '<image>/02_object.js');
...
$x463 = clone JS::$functionTemplate; $x463->call = '_a6798eddb4d8b054110f0587bbe9a935_12'; $x463->parameters = array (
  0 => 'o',
...
if ($_Object === JS::$undefined || $_Object === NULL) {
unset($_TypeError, $WTypeError, $STypeError, $UTypeError);
$x465 = _a6798eddb4d8b054110f0587bbe9a935_3($global, $scope, $scope, JS::toString('TypeError', $global), 162, 15, '<image>/02_object.js');
...
$x469 = _a6798eddb4d8b054110f0587bbe9a935_5($global, $scope, $_Object, JS::toString($x464, $global), 162, 15, '<image>/02_object.js');
...
$x495 = clone JS::$functionTemplate; $x495->call = '_a6798eddb4d8b054110f0587bbe9a935_13'; $x495->parameters = array (
  0 => 'o',
...
if ($_Object === JS::$undefined || $_Object === NULL) {
unset($_TypeError, $WTypeError, $STypeError, $UTypeError);
$x497 = _a6798eddb4d8b054110f0587bbe9a935_3($global, $scope, $scope, JS::toString('TypeError', $global), 179, 26, '<image>/02_object.js');
...
$x501 = _a6798eddb4d8b054110f0587bbe9a935_5($global, $scope, $_Object, JS::toString($x496, $global), 179, 26, '<image>/02_object.js');
...
$x527 = clone JS::$functionTemplate; $x527->call = '_a6798eddb4d8b054110f0587bbe9a935_14'; $x527->parameters = array (
  0 => 'o',
...
if ($_Object === JS::$undefined || $_Object === NULL) {
unset($_TypeError, $WTypeError, $STypeError, $UTypeError);
$x529 = _a6798eddb4d8b054110f0587bbe9a935_3($global, $scope, $scope, JS::toString('TypeError', $global), 189, 17, '<image>/02_object.js');
...
$x533 = _a6798eddb4d8b054110f0587bbe9a935_5($global, $scope, $_Object, JS::toString($x528, $global), 189, 17, '<image>/02_object.js');
...
$x559 = clone JS::$functionTemplate; $x559->call = '_a6798eddb4d8b054110f0587bbe9a935_15'; $x559->parameters = array (
  0 => 'o',
...
if ($_Object === JS::$undefined || $_Object === NULL) {
unset($_TypeError, $WTypeError, $STypeError, $UTypeError);
$x561 = _a6798eddb4d8b054110f0587bbe9a935_3($global, $scope, $scope, JS::toString('TypeError', $global), 205, 17, '<image>/02_object.js');
...
$x565 = _a6798eddb4d8b054110f0587bbe9a935_5($global, $scope, $_Object, JS::toString($x560, $global), 205, 17, '<image>/02_object.js');
...
$x591 = clone JS::$functionTemplate; $x591->call = '_a6798eddb4d8b054110f0587bbe9a935_16'; $x591->parameters = array (
  0 => 'o',
...
if ($_Object === JS::$undefined || $_Object === NULL) {
unset($_TypeError, $WTypeError, $STypeError, $UTypeError);
$x593 = _a6798eddb4d8b054110f0587bbe9a935_3($global, $scope, $scope, JS::toString('TypeError', $global), 221, 21, '<image>/02_object.js');
...
$x597 = _a6798eddb4d8b054110f0587bbe9a935_5($global, $scope, $_Object, JS::toString($x592, $global), 221, 21, '<image>/02_object.js');
...
$x637 = clone JS::$functionTemplate; $x637->call = '_a6798eddb4d8b054110f0587bbe9a935_17'; $x637->parameters = array (
  0 => 'o',
...
if ($_Object === JS::$undefined || $_Object === NULL) {
unset($_TypeError, $WTypeError, $STypeError, $UTypeError);
$x639 = _a6798eddb4d8b054110f0587bbe9a935_3($global, $scope, $scope, JS::toString('TypeError', $global), 229, 13, '<image>/02_object.js');
...
$x643 = _a6798eddb4d8b054110f0587bbe9a935_5($global, $scope, $_Object, JS::toString($x638, $global), 229, 13, '<image>/02_object.js');
...
if ($_Object === JS::$undefined || $_Object === NULL) {
unset($_TypeError, $WTypeError, $STypeError, $UTypeError);
$x650 = _a6798eddb4d8b054110f0587bbe9a935_3($global, $scope, $scope, JS::toString('TypeError', $global), 243, 18, '<image>/02_object.js');
...
$x654 = _a6798eddb4d8b054110f0587bbe9a935_5($global, $scope, $_Object, JS::toString($x649, $global), 243, 18, '<image>/02_object.js');
...
$x660 = _a6798eddb4d8b054110f0587bbe9a935_4($global, $scope, $_Object, JS::toString('prototype', $global), 247, 7, '<image>/02_object.js');
$x659 =& $x660[0]; list(,$W659,$S659,$U659) = $x660;
$x661 = JS::toString('constructor', $global);
if ($x659 === JS::$undefined || $x659 === NULL) {
unset($_TypeError, $WTypeError, $STypeError, $UTypeError);
$x662 = _a6798eddb4d8b054110f0587bbe9a935_3($global, $scope, $scope, JS::toString('TypeError', $global), 247, 30, '<image>/02_object.js');
...
$x666 = _a6798eddb4d8b054110f0587bbe9a935_5($global, $scope, $x659, JS::toString($x661, $global), 247, 30, '<image>/02_object.js');
...
$x675 = clone JS::$functionTemplate; $x675->call = '_a6798eddb4d8b054110f0587bbe9a935_18'; $x675->parameters = array (
...
$x677 = _a6798eddb4d8b054110f0587bbe9a935_4($global, $scope, $_Object, JS::toString('prototype', $global), 249, 7, '<image>/02_object.js');
$x676 =& $x677[0]; list(,$W676,$S676,$U676) = $x677;
$x678 = JS::toString('toString', $global);
if ($x676 === JS::$undefined || $x676 === NULL) {
unset($_TypeError, $WTypeError, $STypeError, $UTypeError);
$x679 = _a6798eddb4d8b054110f0587bbe9a935_3($global, $scope, $scope, JS::toString('TypeError', $global), 249, 27, '<image>/02_object.js');
...
$x683 = _a6798eddb4d8b054110f0587bbe9a935_5($global, $scope, $x676, JS::toString($x678, $global), 249, 27, '<image>/02_object.js');
...
$x701 = clone JS::$functionTemplate; $x701->call = '_a6798eddb4d8b054110f0587bbe9a935_19'; $x701->parameters = array (
...
$x703 = _a6798eddb4d8b054110f0587bbe9a935_4($global, $scope, $_Object, JS::toString('prototype', $global), 267, 7, '<image>/02_object.js');
$x702 =& $x703[0]; list(,$W702,$S702,$U702) = $x703;
$x704 = JS::toString('toLocaleString', $global);
if ($x702 === JS::$undefined || $x702 === NULL) {
unset($_TypeError, $WTypeError, $STypeError, $UTypeError);
$x705 = _a6798eddb4d8b054110f0587bbe9a935_3($global, $scope, $scope, JS::toString('TypeError', $global), 267, 33, '<image>/02_object.js');
...
$x709 = _a6798eddb4d8b054110f0587bbe9a935_5($global, $scope, $x702, JS::toString($x704, $global), 267, 33, '<image>/02_object.js');
...
$x731 = clone JS::$functionTemplate; $x731->call = '_a6798eddb4d8b054110f0587bbe9a935_20'; $x731->parameters = array (
...
$x733 = _a6798eddb4d8b054110f0587bbe9a935_4($global, $scope, $_Object, JS::toString('prototype', $global), 271, 7, '<image>/02_object.js');
$x732 =& $x733[0]; list(,$W732,$S732,$U732) = $x733;
$x734 = JS::toString('valueOf', $global);
if ($x732 === JS::$undefined || $x732 === NULL) {
unset($_TypeError, $WTypeError, $STypeError, $UTypeError);
$x735 = _a6798eddb4d8b054110f0587bbe9a935_3($global, $scope, $scope, JS::toString('TypeError', $global), 271, 26, '<image>/02_object.js');
...
$x739 = _a6798eddb4d8b054110f0587bbe9a935_5($global, $scope, $x732, JS::toString($x734, $global), 271, 26, '<image>/02_object.js');
...
$x746 = clone JS::$functionTemplate; $x746->call = '_a6798eddb4d8b054110f0587bbe9a935_21'; $x746->parameters = array (
  0 => 'p',
...
$x748 = _a6798eddb4d8b054110f0587bbe9a935_4($global, $scope, $_Object, JS::toString('prototype', $global), 279, 7, '<image>/02_object.js');
$x747 =& $x748[0]; list(,$W747,$S747,$U747) = $x748;
$x749 = JS::toString('hasOwnProperty', $global);
if ($x747 === JS::$undefined || $x747 === NULL) {
unset($_TypeError, $WTypeError, $STypeError, $UTypeError);
$x750 = _a6798eddb4d8b054110f0587bbe9a935_3($global, $scope, $scope, JS::toString('TypeError', $global), 279, 33, '<image>/02_object.js');
...
$x754 = _a6798eddb4d8b054110f0587bbe9a935_5($global, $scope, $x747, JS::toString($x749, $global), 279, 33, '<image>/02_object.js');
...
$x768 = clone JS::$functionTemplate; $x768->call = '_a6798eddb4d8b054110f0587bbe9a935_22'; $x768->parameters = array (
  0 => 'v',
...
$x770 = _a6798eddb4d8b054110f0587bbe9a935_4($global, $scope, $_Object, JS::toString('prototype', $global), 283, 7, '<image>/02_object.js');
$x769 =& $x770[0]; list(,$W769,$S769,$U769) = $x770;
$x771 = JS::toString('isPrototypeOf', $global);
if ($x769 === JS::$undefined || $x769 === NULL) {
unset($_TypeError, $WTypeError, $STypeError, $UTypeError);
$x772 = _a6798eddb4d8b054110f0587bbe9a935_3($global, $scope, $scope, JS::toString('TypeError', $global), 283, 32, '<image>/02_object.js');
...
$x776 = _a6798eddb4d8b054110f0587bbe9a935_5($global, $scope, $x769, JS::toString($x771, $global), 283, 32, '<image>/02_object.js');
...
$x783 = clone JS::$functionTemplate; $x783->call = '_a6798eddb4d8b054110f0587bbe9a935_23'; $x783->parameters = array (
  0 => 'p',
...
$x785 = _a6798eddb4d8b054110f0587bbe9a935_4($global, $scope, $_Object, JS::toString('prototype', $global), 300, 7, '<image>/02_object.js');
$x784 =& $x785[0]; list(,$W784,$S784,$U784) = $x785;
$x786 = JS::toString('propertyIsEnumerable', $global);
if ($x784 === JS::$undefined || $x784 === NULL) {
unset($_TypeError, $WTypeError, $STypeError, $UTypeError);
$x787 = _a6798eddb4d8b054110f0587bbe9a935_3($global, $scope, $scope, JS::toString('TypeError', $global), 300, 39, '<image>/02_object.js');
...
$x791 = _a6798eddb4d8b054110f0587bbe9a935_5($global, $scope, $x784, JS::toString($x786, $global), 300, 39, '<image>/02_object.js');
...
$x825 = clone JS::$functionTemplate; $x825->call = '_a6798eddb4d8b054110f0587bbe9a935_24'; $x825->parameters = array (
  0 => 'obj',
); $x825->scope = $scope; $x825->properties['prototype'] = clone JS::$objectTemplate; $x825->attributes['prototype'] = JS::WRITABLE; $x825->properties['prototype']->properties['constructor'] = $x825; $x825->properties['prototype']->attributes['constructor'] = JS::WRITABLE | JS::CONFIGURABLE; $x825->properties['length'] = 1; $x825->attributes['length'] = 0;
$x826 = JS::toString('values', $global);
if ($_Object === JS::$undefined || $_Object === NULL) {
unset($_TypeError, $WTypeError, $STypeError, $UTypeError);
$x827 = _a6798eddb4d8b054110f0587bbe9a935_3($global, $scope, $scope, JS::toString('TypeError', $global), 304, 15, '<image>/02_object.js');
$_TypeError =& $x827[0]; list(,$WTypeError,$STypeError,$UTypeError) = $x827;
$x828 = $_TypeError->call;
$global->trace[++$global->trace_sp] = array('<image>/02_object.js', 304, 15);
$x829 = $x828($global, $global, $_TypeError, array('Cannot assign property of undefined/null.'), false);
unset($global->trace[$global->trace_sp--], $global->scope[$global->scope_sp--]);
if (isset($x829->class) && $x829->class === 'Error' && !isset($x829->properties['file']) && !isset($x829->properties['line']) && !isset($x829->properties['column'])) {$x829->properties['file'] = '<image>/02_object.js';$x829->properties['line'] = 304;$x829->properties['column'] = 15;$x829->attributes['file'] = $x829->attributes['line'] = $x829->attributes['column'] = 0; }
throw new JSException($x829, 304, 15, '<image>/02_object.js');
}
$_Object = JS::toObject($_Object, $global);
unset($x830, $W830, $S830, $U830);
$x831 = _a6798eddb4d8b054110f0587bbe9a935_5($global, $scope, $_Object, JS::toString($x826, $global), 304, 15, '<image>/02_object.js');
$x830 =& $x831[0]; list(,$W830,$S830,$U830) = $x831;
if ($U830 && (!isset($_Object->extensible) || $_Object->extensible)) {$_Object->properties[$x826] = $x830; $x830 =& $_Object->properties[$x826]; $_Object->attributes[$x826] = JS::WRITABLE | JS::ENUMERABLE | JS::CONFIGURABLE; $U830 = FALSE; $W830 = TRUE; }
if (isset($_Object->class) && $_Object->class === 'Array') {  if (isset($_Object->properties['length']) && $_Object->properties['length'] !== JS::$undefined) { $x833 = $_Object->properties['length']; }  else { $x833 = 0; } }
if (isset($S830)) {
$x834 = $S830->call;
$global->trace[++$global->trace_sp] = array('<image>/02_object.js', 304, 15);
$x835 = $x834($global, $_Object, $S830, array($x825), false);
unset($global->trace[$global->trace_sp--], $global->scope[$global->scope_sp--]);
$x832 = $x835;
} else {
if (!$U830) {$x832 = $x825;if ($W830) { $x830 = $x825; }  }
else { $x832 = JS::$undefined; }
}
if (isset($_Object->class) && $_Object->class === 'Array') {if (is_int('values') && 'values' >= $_Object->properties['length']) { $_Object->properties['length'] = 'values' + 1; }else if ($x826 === 'length' && is_int($x825) && $x833 > $x825) {  for ($i = $x825; $i < $x833; ++$i) {  unset($_Object->properties[$i], $_Object->attributes[$i]); }}};
;
return JS::$undefined;
}
