...
$x44 = JS::toPrimitive(36.0, $global);
...
$x58 = $_parseInt->call;
$global->trace[++$global->trace_sp] = array('<image>/01_global.js', 40, 18);
$x59 = $x58($global, $global, $_parseInt, array(substr($_string, 2), 16.0), false);
unset($global->trace[$global->trace_sp--], $global->scope[$global->scope_sp--]);
return $x59;;
};
...
if (!is_object($global)) {$global = (object) array('properties' => array(),'attributes' => array(),'getters' => array(),'setters' => array(),'prototype' => NULL,'up' => NULL,'trace' => array(), 'trace_sp' => 0, 'scope_sp' => 0);$set_scope = TRUE;$global->trace = array(array('<image>/01_global.js', NULL, NULL)); $global->trace_sp = 0;}
