...
$x59 = $x57->call;
$global->trace[++$global->trace_sp] = array('<image>/16_console.js', 10, 74);
$x60 = $x59($global, $x53, $x57, array($_arguments, 1.0), false);
unset($global->trace[$global->trace_sp--], $global->scope[$global->scope_sp--]);
...
$x100 = JS::toPrimitive(1.0, $global);
...
$x145 = $x143->call;
$global->trace[++$global->trace_sp] = array('<image>/16_console.js', 20, 74);
$x146 = $x145($global, $x139, $x143, array($_arguments, 1.0), false);
unset($global->trace[$global->trace_sp--], $global->scope[$global->scope_sp--]);
...
$x321 = JS::toPrimitive(0.0, $global);
...
$x397 = JS::toPrimitive(40.0, $global);
...
$x448 = JS::toPrimitive(40.0, $global);
...
if (!is_object($global)) {$global = (object) array('properties' => array(),'attributes' => array(),'getters' => array(),'setters' => array(),'prototype' => NULL,'up' => NULL,'trace' => array(), 'trace_sp' => 0, 'scope_sp' => 0);$set_scope = TRUE;$global->trace = array(array('<image>/16_console.js', NULL, NULL)); $global->trace_sp = 0;}
